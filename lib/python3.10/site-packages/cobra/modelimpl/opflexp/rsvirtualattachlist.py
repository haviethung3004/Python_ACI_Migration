...
# ##################################################
class RsVirtualAttachList(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.opflexp.RsVirtualAttachList", "cobra.model.vmm.VaPodInfo")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "opflexpRsVirtualAttachList"
    meta.rnFormat = "rsvirtualAttachList-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Virtual Attach List"
    ...
    prop = PropMeta("str", "tCl", "tCl", 55828, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16408
    prop.defaultValueStr = "vmmVaPodInfo"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vmmVaPodInfo", None, 16408)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 55827, PropCategory.REGULAR)
