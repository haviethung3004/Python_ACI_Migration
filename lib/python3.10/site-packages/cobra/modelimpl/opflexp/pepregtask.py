...
class PEpRegTask(Mo):
    ...
    meta = ClassMeta("cobra.model.opflexp.PEpRegTask")

    meta.moClassName = "opflexpPEpRegTask"
    meta.rnFormat = "opflexpPEpRegTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 55826, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VaAttach", "vaattach", 3679)
