...
class Http(Mo):
    ...
    prop = PropMeta("str", "nodeExporter", "nodeExporter", 65280, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "serverHeader", "serverHeader", 63693, PropCategory.REGULAR)
    prop.label = "Server Header Response"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
