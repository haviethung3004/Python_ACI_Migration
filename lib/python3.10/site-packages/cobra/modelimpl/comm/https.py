...
class Https(Mo):
    ...
    prop = PropMeta("str", "nodeExporter", "nodeExporter", 65281, PropCategory.REGULAR)
    prop.label = "Node Exporter service"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "disabled"
    prop._addConstant("disabled", "disabled", 2)
    prop._addConstant("enabled", "enabled", 1)
    meta.props.add("nodeExporter", prop)
    ...
    prop = PropMeta("str", "referer", "referer", 69126, PropCategory.REGULAR)
    prop.label = "Allowed HTTP referer space separated list"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    prop.defaultValue = ""
    prop.defaultValueStr = ""
    meta.props.add("referer", prop)
    ...
    prop = PropMeta("str", "serverHeader", "serverHeader", 63694, PropCategory.REGULAR)
    prop.label = "Server Header"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "enabled"
    prop._addConstant("disabled", "disabled", 2)
    prop._addConstant("enabled", "enabled", 1)
    meta.props.add("serverHeader", prop)
    ...
    prop._addConstant("TLSv1.3", "tlsv1.3", 8)
