...
class CSWPol(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.CSWPol")

    meta.moClassName = "pimCSWPol"
    meta.rnFormat = "cswpol"
    ...
    meta.childClasses.add("cobra.model.pim.CSWEntry")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.CSWEntry", "src-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.pim.CtxP")

    meta.superClasses.add("cobra.model.rtdmc.ACSWPol")
    ...
    prop = PropMeta("str", "annotation", "annotation", 68624, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68625, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68756, PropCategory.REGULAR)
