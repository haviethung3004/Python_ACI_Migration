...
# ##################################################
class BDSrcFilterDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.BDSrcFilterDef")

    meta.moClassName = "pimBDSrcFilterDef"
    meta.rnFormat = "pimbdsrcfilterdef"
    meta.category = MoCategory.REGULAR
    meta.label = "Source RouteMap for the BD Filter Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56172, PropCategory.REGULAR)
