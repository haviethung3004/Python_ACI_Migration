...
# ##################################################
class RsEntryPolToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pim.RsEntryPolToCtx", "cobra.model.fv.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "pimRsEntryPolToCtx"
    meta.rnFormat = "rsEntryPolToCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "InterVRF Receiver VRF"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67546, PropCategory.REGULAR)
