...
# ##################################################
class BDDestFilterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.BDDestFilterPol")

    meta.moClassName = "pimBDDestFilterPol"
    meta.rnFormat = "pimbddestfilterp"
    meta.category = MoCategory.REGULAR
    meta.label = "Destination RouteMap for the BD Filter Policy"
    ...
    meta.rnPrefixes = [
        ('pimbddestfilterp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56181, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56182, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56173, PropCategory.REGULAR)
