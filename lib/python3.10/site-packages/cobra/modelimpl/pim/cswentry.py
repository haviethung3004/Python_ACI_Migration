...
class CSWEntry(Mo):
    ...
    meta = ClassMeta("cobra.model.pim.CSWEntry")

    meta.moClassName = "pimCSWEntry"
    meta.rnFormat = "src-[%(src)s]-grp-[%(grp)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Configured Stripe Winner Entry"
    meta.writeAccessMask = 0x45
    meta.readAccessMask = 0x45
    ...
    meta.superClasses.add("cobra.model.rtdmc.ACSWEntry")
    ...
    prop = PropMeta("str", "annotation", "annotation", 68626, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 68755, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ok"
    prop._addConstant("csw-invalid-pod-id", "pod-id-associated-with-this-csw-entry-does-not-exist", 64)
    prop._addConstant("intervrf-route-map-empty", "no-routemap-associated-with-intervrf-policy-/-associated-routemap-is-empty", 32)
    prop._addConstant("missing-rp-group-range", "missing-rp-group-range-configuration.", 1)
    prop._addConstant("ok", "ok", 0)
    prop._addConstant("pim-not-supported-in-vpc-mode", "pim-is-not-supported-in-vpc-mode", 8)
    prop._addConstant("pim-not-supported-on-ext-svi", "pimv6-is-not-supported-on-external-svi-interfaces", 4)
    prop._addConstant("pim-not-supported-on-floating-svi", "pim-is-not-supported-on-floating-svis", 16)
    prop._addConstant("src-only-route-map-allowed", "only-source-based-route-maps-are-allowed-for-bsr/auto-rp.", 2)
    ...
    prop = PropMeta("str", "excludeRemoteLeafs", "excludeRemoteLeafs", 68612, PropCategory.REGULAR)
    prop.label = "Exclude Remote Leafs"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("excludeRemoteLeafs", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "grp", "grp", 68618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "podId", "podId", 68611, PropCategory.REGULAR)
    prop.label = "Pod ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 254)]
    ...
    prop = PropMeta("str", "src", "src", 68619, PropCategory.REGULAR)
    prop.label = "Interface Controls"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
