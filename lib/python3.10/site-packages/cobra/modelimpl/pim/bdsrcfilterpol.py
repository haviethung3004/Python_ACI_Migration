...
# ##################################################
class BDSrcFilterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.BDSrcFilterPol")

    meta.moClassName = "pimBDSrcFilterPol"
    meta.rnFormat = "pimbdsrcfilterp"
    meta.category = MoCategory.REGULAR
    meta.label = "Source RouteMap for the BD Filter Policy"
    ...
    meta.rnPrefixes = [
        ('pimbdsrcfilterp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56179, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56180, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56171, PropCategory.REGULAR)
