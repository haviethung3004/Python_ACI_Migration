...
# ##################################################
class BDDestFilterDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pim.BDDestFilterDef")

    meta.moClassName = "pimBDDestFilterDef"
    meta.rnFormat = "pimbddestfilterdef"
    meta.category = MoCategory.REGULAR
    meta.label = "Destination RouteMap for the BD Filter Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56174, PropCategory.REGULAR)
