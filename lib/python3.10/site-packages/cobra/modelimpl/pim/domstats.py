...
class DomStats(Mo):
    ...
    prop = PropMeta("str", "anycastRpMcastDestRegRcvd", "anycastRpMcastDestRegRcvd", 57448, PropCategory.REGULAR)
    prop.label = "Anycast RP Registers Received with Mcast Dest IP"
    prop.isOper = True
    meta.props.add("anycastRpMcastDestRegRcvd", prop)

    prop = PropMeta("str", "anycastRpMcastDestRegSent", "anycastRpMcastDestRegSent", 57447, PropCategory.REGULAR)
    prop.label = "Anycast RP Registers Sent to Mcast Dest IP"
    prop.isOper = True
    meta.props.add("anycastRpMcastDestRegSent", prop)

    prop = PropMeta("str", "anycastRpRegRcvd", "anycastRpRegRcvd", 57446, PropCategory.REGULAR)
    prop.label = "Anycast RP Registers Received"
    prop.isOper = True
    meta.props.add("anycastRpRegRcvd", prop)

    prop = PropMeta("str", "anycastRpRegSent", "anycastRpRegSent", 57445, PropCategory.REGULAR)
    prop.label = "Anycast RP Registers Sent"
    prop.isOper = True
    meta.props.add("anycastRpRegSent", prop)
