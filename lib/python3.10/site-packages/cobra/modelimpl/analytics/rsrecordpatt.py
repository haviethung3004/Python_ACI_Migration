...
class RsRecordPAtt(Mo):
    ...
    prop._addConstant("analytics:RsRecordPAttmodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("analytics:RsRecordPAttuserdom_failed_flag", None, 2305843009213693952)
