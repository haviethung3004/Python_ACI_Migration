...
class Collector(Mo):
    ...
    prop._addConstant("analytics:CollectormodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("analytics:CollectorswExport_failed_flag", None, 131072)
    prop._addConstant("analytics:Collectoruid_failed_flag", None, 4611686018427387904)
    prop._addConstant("analytics:Collectoruserdom_failed_flag", None, 2305843009213693952)
    prop._addConstant("analytics:Collectorver_failed_flag", None, 262144)
    ...
    prop = PropMeta("str", "swExport", "swExport", 67628, PropCategory.REGULAR)
