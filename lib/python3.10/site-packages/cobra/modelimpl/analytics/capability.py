...
class Capability(Mo):
    ...
    prop = PropMeta("str", "extendedOportSupport", "extendedOportSupport", 62782, PropCategory.REGULAR)
    prop.label = "Support extended oport type export for MC, CPU"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("extendedOportSupport", prop)
    ...
    prop = PropMeta("str", "fteStatus", "fteStatus", 62459, PropCategory.REGULAR)
    prop.label = "Select FTE status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "disabled"
