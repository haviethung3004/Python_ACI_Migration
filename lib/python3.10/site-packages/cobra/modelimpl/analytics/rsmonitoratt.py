...
class RsMonitorAtt(Mo):
    ...
    prop._addConstant("analytics:RsMonitorAttmodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("analytics:RsMonitorAttuserdom_failed_flag", None, 2305843009213693952)
