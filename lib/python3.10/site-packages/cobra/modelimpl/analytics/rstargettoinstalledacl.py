...
# ##################################################
class RsTargetToInstalledAcl(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.analytics.RsTargetToInstalledAcl", "cobra.model.acl.ACL")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "analyticsRsTargetToInstalledAcl"
    meta.rnFormat = "rstargetToInstalledAcl-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstargetToInstalledAcl-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69682, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fltType", "fltType", 69676, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 69678, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69677, PropCategory.REGULAR)
