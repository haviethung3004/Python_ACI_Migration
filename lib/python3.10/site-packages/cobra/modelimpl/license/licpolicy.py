...
class LicPolicy(Mo):
    ...
    prop = PropMeta("str", "actionResult", "actionResult", 65717, PropCategory.REGULAR)
    prop.label = "Action Result"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("create-rum-report-failure", "rum-report-creation-failure", 2)
    prop._addConstant("create-rum-report-success", "rum-report-creation-success", 1)
    prop._addConstant("none", "n/a", 0)
    meta.props.add("actionResult", prop)
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("create-rum-report", "create-rum-report", 13)
    ...
    prop._addConstant("install-rum-report-ack", "install-rum-report-acknowledgement", 14)
    prop._addConstant("modify-report-interval", "modify-license-reporting-interval", 12)
    prop._addConstant("none", "n/a", 0)
    ...
    prop._addConstant("renew-license-auth", "synchronize-with-cssm", 2)
    ...
    prop._addConstant("test-expire-ack-deadline", "expire-acknowledgement-deadline", 114)
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("deregister", "disconnect", 2)
    prop._addConstant("none", "n/a", 0)
    prop._addConstant("register", "connect", 1)
    meta.props.add("regAdminState", prop)

    prop = PropMeta("str", "regTokenId", "regTokenId", 36861, PropCategory.REGULAR)
    prop.label = "Product Instance ID Token"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("regTokenId", prop)

    prop = PropMeta("str", "reportInterval", "reportInterval", 64404, PropCategory.REGULAR)
    prop.label = "License Usage Reporting Interval (in day)"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 90)]
    prop.defaultValue = 30
    prop.defaultValueStr = "30"
    meta.props.add("reportInterval", prop)
