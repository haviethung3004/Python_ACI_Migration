...
class KeyRing(Mo):
    ...
    prop = PropMeta("str", "creator", "creator", 68676, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "eccCurve", "eccCurve", 68747, PropCategory.REGULAR)
    prop.label = "ECC Curve"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("none", "none", 0)
    prop._addConstant("prime256v1", "p-256", 1)
    prop._addConstant("secp384r1", "p-384", 2)
    prop._addConstant("secp521r1", "p-521", 3)
    meta.props.add("eccCurve", prop)
    ...
    prop = PropMeta("str", "keyType", "keyType", 68746, PropCategory.REGULAR)
    prop.label = "Key Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "RSA"
    prop._addConstant("ECC", "ecc", 1)
    prop._addConstant("RSA", "rsa", 0)
    ...
    prop._addConstant("mod3072", "mod-3072", 3072)
    prop._addConstant("mod4096", "mod-4096", 4096)
