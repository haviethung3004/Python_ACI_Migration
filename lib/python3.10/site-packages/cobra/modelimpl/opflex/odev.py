...
class ODev(Mo):
    ...
    meta.childClasses.add("cobra.model.fv.HvNic")
    ...
    meta.childClasses.add("cobra.model.opflexp.AgentODevFaultInfo")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.opflexp.AgentODevFaultInfo", "agentodevfault-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.HvNic", "nic-"))
    ...
    prop = PropMeta("str", "tType", "tType", 55677, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
