...
# ##################################################
class ODevInvBegin(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.ODevInvBegin")

    meta.moClassName = "opflexODevInvBegin"
    meta.rnFormat = "odevinvbegin"
    meta.category = MoCategory.REGULAR
    meta.label = "Opflex Device Inventory Begin"
