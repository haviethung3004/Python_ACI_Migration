...
# ##################################################
class ExceptionMacDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rogue.ExceptionMacDef")

    meta.moClassName = "rogueExceptionMacDef"
    ...
    meta.parentClasses.add("cobra.model.rogue.BDDef")

    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.rogue.AExceptionMacDef")
    ...
    prop = PropMeta("str", "mac", "mac", 65265, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
