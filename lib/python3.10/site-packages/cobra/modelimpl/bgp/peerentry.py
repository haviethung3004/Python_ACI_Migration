...
class PeerEntry(Mo):
    ...
    prop._addConstant("ipv4-lu", "ipv4-label-unicast", 524288)
    prop._addConstant("ipv4-mcast", "ipv4-multicast", 32768)
    prop._addConstant("ipv4-ucast", "ipv4-unicast", 512)
    prop._addConstant("ipv4-ucast-addlp-rcv", "ipv4-ucast-add-path-receive", 2097152)
    prop._addConstant("ipv4-ucast-addlp-snd", "ipv4-ucast-add-path-send", 4194304)
    prop._addConstant("ipv6-lu", "ipv6-label-unicast", 1048576)
    prop._addConstant("ipv6-mcast", "ipv6-multicast", 65536)
    prop._addConstant("ipv6-ucast", "ipv6-unicast", 4096)
    prop._addConstant("ipv6-ucast-addlp-rcv", "ipv6-ucast-add-path-receive", 8388608)
    prop._addConstant("ipv6-ucast-addlp-snd", "ipv6-ucast-add-path-send", 16777216)
    ...
    prop._addConstant("vpnv4-ucast-addlp-rcv", "vpnv4-ucast-add-path-receive", 33554432)
    prop._addConstant("vpnv4-ucast-addlp-snd", "vpnv4-ucast-add-path-send", 67108864)
    prop._addConstant("vpnv6-ucast", "vpnv6-unicast", 8192)
    prop._addConstant("vpnv6-ucast-addlp-rcv", "vpnv6-ucast-add-path-receive", 134217728)
    prop._addConstant("vpnv6-ucast-addlp-snd", "vpnv6-ucast-add-path-send", 268435456)
    ...
    prop._addConstant("admin-up", "administratively-up", 4)
    prop._addConstant("exceeded-pfxlimit", "exceeded-prefix-limit", 3)
    prop._addConstant("no-affinity", "no-affinity", 5)
