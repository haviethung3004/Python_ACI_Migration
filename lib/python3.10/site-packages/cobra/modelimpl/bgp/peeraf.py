...
class PeerAf(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.FltrCtrlP")
    meta.childClasses.add("cobra.model.bgp.ImportRt")
    meta.childClasses.add("cobra.model.bgp.MaxPfxP")
    meta.childClasses.add("cobra.model.bgp.PfxCtrlP")
    meta.childClasses.add("cobra.model.bgp.PolicyInheritRule")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.FltrCtrlP", "fltrctrl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.PfxCtrlP", "pfxctrl-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.ImportRt", "import-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.PolicyInheritRule", "pol-"))
    ...
    prop._addConstant("segment-routing-disable", "segment-routing-disable", 128)
    ...
    prop = PropMeta("str", "ctrlExt", "ctrlExt", 62468, PropCategory.REGULAR)
    prop.label = "Control"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "peerAfCapability", "peerAfCapability", 68050, PropCategory.REGULAR)
    ...
    meta.props.add("peerAfCapability", prop)
    ...
    prop = PropMeta("str", "soo", "soo", 62608, PropCategory.REGULAR)
    prop.label = "Site-of-origin extcommunity"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("soo", prop)
    ...
    prop.label = "Address Family Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop._addConstant("ipv4-lu", "ipv4-label-unicast-address-family", 9)
    prop._addConstant("ipv4-mcast", "ipv4-multicast-address-family", 7)
    prop._addConstant("ipv4-ucast", "ipv4-unicast-address-family", 1)
    prop._addConstant("ipv6-lu", "ipv6-label-unicast-address-family", 10)
