...
class EVpnImetRoute(Mo):
    ...
    prop._addConstant("hw", "is-in-hw", 1024)
    prop._addConstant("l2rib-evpn", "programmed-in-l2rib/evpn", 512)
    prop._addConstant("label", "local-label", 256)
    ...
    prop._addConstant("table-map-filtered", "filtered-by-table-map", 2048)
