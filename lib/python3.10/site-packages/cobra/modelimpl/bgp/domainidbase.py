...
# ##################################################
class DomainIdBase(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.DomainIdBase")

    meta.moClassName = "bgpDomainIdBase"
    meta.rnFormat = "domblk"
    meta.category = MoCategory.REGULAR
    meta.label = "Domain Id Base"
    meta.writeAccessMask = 0x1001
    meta.readAccessMask = 0x81001
    ...
    meta.superClasses.add("cobra.model.bgp.ADomainIdBase")
    ...
    prop = PropMeta("str", "annotation", "annotation", 62457, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "domainIdBase", "domainIdBase", 62453, PropCategory.REGULAR)
    prop.label = "BGP Domain Id Base"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("domainIdBase", prop)

    prop = PropMeta("str", "domainIdBaseIp", "domainIdBaseIp", 62454, PropCategory.REGULAR)
    prop.label = "BGP Domain Id Base"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("domainIdBaseIp", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62456, PropCategory.REGULAR)
