...
class Peer(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.MhBfdAuth")
    meta.childClasses.add("cobra.model.bgp.MhBfdIntvl")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.MhBfdIntvl", "mhbfdintvl"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.MhBfdAuth", "mhbfdauth"))
    ...
    prop._addConstant("bgp:PeerexternalDomainId_failed_flag", None, 1024)
    prop._addConstant("bgp:PeerinfraL3outName_failed_flag", None, 2048)
    prop._addConstant("bgp:Peerl3outInTag_failed_flag", None, 4096)
    prop._addConstant("bgp:PeerlcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("bgp:PeermodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("bgp:PeermonPolDn_failed_flag", None, 32768)
    prop._addConstant("bgp:Peername_failed_flag", None, 1)
    prop._addConstant("bgp:PeerpasswdSet_failed_flag", None, 65536)
    prop._addConstant("bgp:Peerpassword_failed_flag", None, 131072)
    prop._addConstant("bgp:PeerpeerRole_failed_flag", None, 262144)
    prop._addConstant("bgp:PeerprivateASctrl_failed_flag", None, 524288)
    prop._addConstant("bgp:PeersrcIf_failed_flag", None, 1048576)
    prop._addConstant("bgp:Peerttl_failed_flag", None, 4194304)
    prop._addConstant("bgp:PeertypeExt_failed_flag", None, 16777216)
    prop._addConstant("bgp:Peertype_failed_flag", None, 8388608)
    ...
    prop._addConstant("cap-neg-off", "capability-negotiate-off", 4)
    prop._addConstant("dis-conn-check", "disable-connected-check", 2)
    prop._addConstant("no-dyn-cap", "dynamic-capability", 8)
    ...
    prop = PropMeta("str", "externalDomainId", "externalDomainId", 62466, PropCategory.REGULAR)
    prop.label = "External Domain ID"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("externalDomainId", prop)

    prop = PropMeta("str", "infraL3outName", "infraL3outName", 62467, PropCategory.REGULAR)
    prop.label = "Infra L3out name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("infraL3outName", prop)

    prop = PropMeta("str", "l3outInTag", "l3outInTag", 61898, PropCategory.REGULAR)
    prop.label = "L3out In Tag"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("l3outInTag", prop)
    ...
    prop = PropMeta("str", "typeExt", "typeExt", 56503, PropCategory.REGULAR)
    prop.label = "Type Extension"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("ipn-infra", "peer-for-ipn-infra-connectivity", 4)
    prop._addConstant("isn-infra", "peer-for-isn-infra-connectivity", 8)
    prop._addConstant("multi-domain", "peer-for-multi-domain-wan-connectivity", 1)
    prop._addConstant("sr-mpls", "peer-over-sr-mpls-underlay", 2)
    meta.props.add("typeExt", prop)
