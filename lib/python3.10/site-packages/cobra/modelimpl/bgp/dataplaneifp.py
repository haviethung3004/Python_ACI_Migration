...
# ##################################################
class DataPlaneIfP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.DataPlaneIfP")

    meta.moClassName = "bgpDataPlaneIfP"
    meta.rnFormat = "dptep"
    meta.category = MoCategory.REGULAR
    meta.label = "MDP Data plane address"
    ...
    prop = PropMeta("str", "addr", "addr", 56474, PropCategory.REGULAR)
    prop.label = "MDP Data plane address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "annotation", "annotation", 56631, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56618, PropCategory.REGULAR)
