...
# ##################################################
class DomainIdAllocator(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.DomainIdAllocator")

    meta.moClassName = "bgpDomainIdAllocator"
    meta.rnFormat = "bgpdomainid"
    meta.category = MoCategory.REGULAR
    meta.label = "BGP Domain Id"
    ...
    meta.childClasses.add("cobra.model.bgp.DomainIdCons")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.DomainIdCons", "cons-"))
    ...
    meta.superClasses.add("cobra.model.bgp.ADomainIdAllocator")
    ...
    prop = PropMeta("str", "domainId", "domainId", 62452, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
