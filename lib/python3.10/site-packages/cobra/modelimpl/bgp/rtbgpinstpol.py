...
# ##################################################
class RtBgpInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtBgpInstPol", "cobra.model.pol.DefRelnHolder")

    meta.moClassName = "bgpRtBgpInstPol"
    meta.rnFormat = "rtpolBgpInstPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 64376, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 64375, PropCategory.REGULAR)
