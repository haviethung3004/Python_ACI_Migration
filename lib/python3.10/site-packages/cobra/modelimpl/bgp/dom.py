...
class Dom(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.InfraL3out")
    meta.childClasses.add("cobra.model.bgp.PathCtrl")
    meta.childClasses.add("cobra.model.bgp.Peer")
    meta.childClasses.add("cobra.model.bgp.PeerCont")
    meta.childClasses.add("cobra.model.bgp.PolicyCont")
    meta.childClasses.add("cobra.model.bgp.SessionCont")
    meta.childClasses.add("cobra.model.bgp.SgmtRtg")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.SessionCont", "sessioncont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.InfraL3out", "infraL3out-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.PolicyCont", "policycont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.PeerCont", "peercont-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.SgmtRtg", "segrt-"))
    ...
    prop = PropMeta("str", "ReloadCnvrgIntvl", "ReloadCnvrgIntvl", 65460, PropCategory.REGULAR)
    prop.label = "Reload Convergence interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 3600)]
    prop.defaultValue = 600
    prop.defaultValueStr = "600"
    meta.props.add("ReloadCnvrgIntvl", prop)

    prop = PropMeta("str", "bgpCfgFailedBmp", "bgpCfgFailedBmp", 14981, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("bgp:DomReloadCnvrgIntvl_failed_flag", None, 2)
    prop._addConstant("bgp:DomclusterId_failed_flag", None, 32)
    prop._addConstant("bgp:Domctrl_failed_flag", None, 64)
    prop._addConstant("bgp:Domencap_failed_flag", None, 128)
    prop._addConstant("bgp:DomevpnRd_failed_flag", None, 256)
    prop._addConstant("bgp:DomfirstBestPathDelay_failed_flag", None, 512)
    prop._addConstant("bgp:DomholdIntvl_failed_flag", None, 4096)
    prop._addConstant("bgp:DominternalDomainId_failed_flag", None, 8192)
    prop._addConstant("bgp:DomkaIntvl_failed_flag", None, 16384)
    prop._addConstant("bgp:DomlcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("bgp:DommaxAsLimit_failed_flag", None, 32768)
    prop._addConstant("bgp:DommodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("bgp:Dommode_failed_flag", None, 65536)
    prop._addConstant("bgp:DommonPolDn_failed_flag", None, 131072)
    prop._addConstant("bgp:DommplsVPNLabelIndex_failed_flag", None, 262144)
    prop._addConstant("bgp:DommsiteClusterId_failed_flag", None, 524288)
    prop._addConstant("bgp:Domname_failed_flag", None, 1)
    prop._addConstant("bgp:Domrd_failed_flag", None, 16777216)
    prop._addConstant("bgp:DomrtrId_failed_flag", None, 33554432)
    prop._addConstant("bgp:Domtype_failed_flag", None, 67108864)
    ...
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("encapMPLS", "mpls-encapsulation", 2)
    ...
    prop = PropMeta("str", "evpnRd", "evpnRd", 57400, PropCategory.REGULAR)
    prop.label = "EVPN Route Distinguisher"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("evpnRd", prop)
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("reload-converge-done", "reload-timer", 2)
    ...
    prop = PropMeta("str", "internalDomainId", "internalDomainId", 62462, PropCategory.REGULAR)
    prop.label = "internal Domain ID"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("internalDomainId", prop)
    ...
    prop = PropMeta("str", "mplsVPNLabelIndex", "mplsVPNLabelIndex", 56725, PropCategory.REGULAR)
