...
class InfraPeerDef(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.DataPlaneIfDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.DataPlaneIfDef", "dptepdef"))
    ...
    prop._addConstant("mdp-wan", "mdp-connectivity", 8)
    prop._addConstant("sr-mpls", "sr-mpls-connectivity", 16)
