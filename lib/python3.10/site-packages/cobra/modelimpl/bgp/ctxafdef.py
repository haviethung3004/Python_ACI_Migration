...
class CtxAfDef(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.CtxAddlPathDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.CtxAddlPathDef", "bgpCtxAddlPathP"))
    ...
    prop = PropMeta("str", "maxLocalEcmp", "maxLocalEcmp", 63080, PropCategory.REGULAR)
