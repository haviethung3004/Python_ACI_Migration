...
# ##################################################
class SiteOfOriginDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.SiteOfOriginDef")

    meta.moClassName = "bgpSiteOfOriginDef"
    meta.rnFormat = "soo"
    meta.category = MoCategory.REGULAR
    meta.label = "Site of Origin Profile Definition"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65365, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sooPKey", "sooPKey", 65274, PropCategory.REGULAR)
    prop.label = "Soo Policy DN"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("sooPKey", prop)
