...
class DomAf(Mo):
    ...
    prop = PropMeta("str", "allocLblAll", "allocLblAll", 56501, PropCategory.REGULAR)
    prop.label = "Allocate label for all prefixes in AF"
    ...
    meta.props.add("allocLblAll", prop)

    prop = PropMeta("str", "allocLblRtMap", "allocLblRtMap", 56502, PropCategory.REGULAR)
    prop.label = "Allocate label route-map"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("allocLblRtMap", prop)
    ...
    prop = PropMeta("str", "maxLocalEcmp", "maxLocalEcmp", 62974, PropCategory.REGULAR)
    prop.label = "Max Local ECMP for redistribute Rotes"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("maxLocalEcmp", prop)
