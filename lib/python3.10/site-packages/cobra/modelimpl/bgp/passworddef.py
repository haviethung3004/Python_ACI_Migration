...
# ##################################################
class PasswordDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.PasswordDef")

    meta.moClassName = "bgpPasswordDef"
    meta.rnFormat = "passwordDef"
    meta.category = MoCategory.REGULAR
    meta.label = "Encrypted BGP Peer Password"
    ...
    prop = PropMeta("str", "password", "password", 65272, PropCategory.REGULAR)
    prop.label = "Encrypted BGP Peer Password"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
