...
class RtSummPol(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.RtSubnetToRtSummPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.rtsum.RtSubnetToRtSumm")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtSubnetToRtSummPol", "rtfvSubnetToRtSummPol-"))
    ...
    prop = PropMeta("str", "addrTCtrl", "addrTCtrl", 65886, PropCategory.REGULAR)
