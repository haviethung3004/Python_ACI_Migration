...
# ##################################################
class SiteOfOriginP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.SiteOfOriginP")

    meta.moClassName = "bgpSiteOfOriginP"
    meta.rnFormat = "soo"
    meta.category = MoCategory.REGULAR
    meta.label = "Site of Origin Profile"
    meta.writeAccessMask = 0x1041
    ...
    meta.superClasses.add("cobra.model.bgp.ASiteOfOriginP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 62979, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 65273, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62980, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62978, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "soo", "soo", 62977, PropCategory.REGULAR)
    prop.label = "Site of Origin"
    prop.isConfig = True
    prop.isAdmin = True
