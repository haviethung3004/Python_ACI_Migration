...
class PeerDef(Mo):
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.SiteOfOriginDef", "soo"))
    ...
    prop._addConstant("conflicting-soo-value", "peer-soo-value-conflicts-with-pod/msite/fabric-soo", 2)
    ...
    prop._addConstant("af-label-ucast", "af-labeled-unicast", 4)
    ...
    prop = PropMeta("str", "capability", "capability", 68049, PropCategory.REGULAR)
    prop.label = "Capability"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("none", "peer-capability-none", 0)
    prop._addConstant("receive-add-path", "receive-additional-paths", 1)
    ...
    prop = PropMeta("str", "connectivityType", "connectivityType", 64558, PropCategory.REGULAR)
    prop.label = "Type of network reachable via this Peer"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "tenant"
    prop._addConstant("multipod", "multipod-network-reachable-via-this-peer", 2)
    prop._addConstant("multisite", "multisite-network-reachable-via-this-peer", 4)
    prop._addConstant("tenant", "tenant-network-reachable-via-this-peer", 1)
    meta.props.add("connectivityType", prop)
    ...
    prop._addConstant("segment-routing-disable", "disable-segment-routing-(not-advertise-prefix-sid)", 128)
    ...
    prop = PropMeta("str", "ctrlExt", "ctrlExt", 62451, PropCategory.REGULAR)
    prop.label = "Peer AF Controls Ext"
    prop.isConfig = True
    prop.isAdmin = True
    prop._addConstant("send-domain-path", "send-domain-path", 1)
    meta.props.add("ctrlExt", prop)
