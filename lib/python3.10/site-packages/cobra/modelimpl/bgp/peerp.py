...
class PeerP(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.SiteOfOriginP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.SiteOfOriginP", "soo"))
    ...
    prop = PropMeta("str", "connectivityType", "connectivityType", 64557, PropCategory.REGULAR)
