...
# ##################################################
class DataPlaneIfDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.DataPlaneIfDef")

    meta.moClassName = "bgpDataPlaneIfDef"
    meta.rnFormat = "dptepdef"
    meta.category = MoCategory.REGULAR
    meta.label = "Data plane address"
    ...
    prop = PropMeta("str", "addr", "addr", 56475, PropCategory.REGULAR)
