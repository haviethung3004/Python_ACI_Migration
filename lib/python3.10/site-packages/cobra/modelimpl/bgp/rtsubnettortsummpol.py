...
# ##################################################
class RtSubnetToRtSummPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.bgp.RtSubnetToRtSummPol", "cobra.model.fv.RtSummSubnet")

    meta.moClassName = "bgpRtSubnetToRtSummPol"
    meta.rnFormat = "rtfvSubnetToRtSummPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 65502, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19162
    prop.defaultValueStr = "fvRtSummSubnet"
    prop._addConstant("fvRtSummSubnet", None, 19162)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65501, PropCategory.REGULAR)
