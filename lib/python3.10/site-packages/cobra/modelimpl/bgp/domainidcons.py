...
# ##################################################
class DomainIdCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.bgp.DomainIdCons")

    meta.moClassName = "bgpDomainIdCons"
    ...
    meta.parentClasses.add("cobra.model.bgp.DomainIdAllocator")
    ...
    prop = PropMeta("str", "consDn", "consDn", 62455, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
