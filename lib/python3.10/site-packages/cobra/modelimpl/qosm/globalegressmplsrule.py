...
# ##################################################
class GlobalEgressMplsRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qosm.GlobalEgressMplsRule")

    meta.moClassName = "qosmGlobalEgressMplsRule"
    meta.rnFormat = "GblEgrMpls-f-%(from)s-t-%(to)s-dot1p-%(markDot1P)s-dscp-%(markDscp)s-exp-%(markExp)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Global MPLS DSCP QoS Classification Rule"
    ...
    prop = PropMeta("str", "from", "from", 56479, PropCategory.REGULAR)
    prop.label = "From"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDot1P", "markDot1P", 56569, PropCategory.REGULAR)
    prop.label = "DOT1P"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDscp", "markDscp", 57380, PropCategory.REGULAR)
    prop.label = "DSCP"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markExp", "markExp", 56570, PropCategory.REGULAR)
    prop.label = "Exp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("2", "2", 2)
    prop._addConstant("3", "3", 3)
    prop._addConstant("4", "4", 4)
    prop._addConstant("5", "5", 5)
    prop._addConstant("6", "6", 6)
    prop._addConstant("7", "7", 7)
    prop._addConstant("unspecified", "unspecified", 8)
    meta.props.add("markExp", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59752, PropCategory.REGULAR)
    ...
    prop._addConstant("microburst-unsupported-hw", "microburst-feature-unsupported-on-hardware", 5)
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("unsupported-hw", "feature-unsupported-on-hardware", 4)
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 56678, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosm:GlobalEgressMplsRuledescr_failed_flag", None, 4)
    prop._addConstant("qosm:GlobalEgressMplsRulefrom_failed_flag", None, 512)
    prop._addConstant("qosm:GlobalEgressMplsRulelcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("qosm:GlobalEgressMplsRulemarkDot1P_failed_flag", None, 8)
    prop._addConstant("qosm:GlobalEgressMplsRulemarkDscp_failed_flag", None, 16)
    prop._addConstant("qosm:GlobalEgressMplsRulemarkExp_failed_flag", None, 32)
    prop._addConstant("qosm:GlobalEgressMplsRulemodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("qosm:GlobalEgressMplsRulemonPolDn_failed_flag", None, 1024)
    prop._addConstant("qosm:GlobalEgressMplsRulenameAlias_failed_flag", None, 2)
    prop._addConstant("qosm:GlobalEgressMplsRulename_failed_flag", None, 1)
    prop._addConstant("qosm:GlobalEgressMplsRuleqosGrp_failed_flag", None, 256)
    prop._addConstant("qosm:GlobalEgressMplsRuleto_failed_flag", None, 16384)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 56680, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 56679, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "to", "to", 56480, PropCategory.REGULAR)
    prop.label = "To"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "markExp"))

    def __init__(self, parentMoOrDn, from_, to, markDot1P, markDscp, markExp, markDirty=True, **creationProps):
        namingVals = [from_, to, markDot1P, markDscp, markExp]
