...
class IfClass(Mo):
    ...
    prop = PropMeta("str", "TxBufferDropBytesCount", "TxBufferDropBytesCount", 67825, PropCategory.REGULAR)
    prop.label = "Egress Buffer drop bytes count"
    prop.isOper = True
    meta.props.add("TxBufferDropBytesCount", prop)

    prop = PropMeta("str", "TxBufferDropPacketsCount", "TxBufferDropPacketsCount", 67824, PropCategory.REGULAR)
    prop.label = "Egress Buffer drop packets count"
    prop.isOper = True
    meta.props.add("TxBufferDropPacketsCount", prop)
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosm:IfClassmonPolDn_failed_flag", None, 2048)
