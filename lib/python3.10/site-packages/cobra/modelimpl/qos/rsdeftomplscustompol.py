...
# ##################################################
class RsDefToMplsCustomPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.qos.RsDefToMplsCustomPol", "cobra.model.qos.MplsCustomPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsDefToMplsCustomPol"
    meta.rnFormat = "rsDefToMplsCustomPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58958, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58957, PropCategory.REGULAR)
