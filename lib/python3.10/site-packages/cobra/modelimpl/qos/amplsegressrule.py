...
# ##################################################
class AMplsEgressRule(Mo):
    meta = ClassMeta("cobra.model.qos.AMplsEgressRule")

    meta.isAbstract = True
    meta.moClassName = "qosAMplsEgressRule"


    meta.moClassName = "qosAMplsEgressRule"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Dscp to Exp Mapping Policy"
