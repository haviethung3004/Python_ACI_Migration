...
# ##################################################
class RsDefToMplsEgressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.qos.RsDefToMplsEgressRule", "cobra.model.qos.MplsEgressRule")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsDefToMplsEgressRule"
    meta.rnFormat = "rsDefToMplsEgressRule"
    ...
    meta.parentClasses.add("cobra.model.qos.MplsEgressRuleDef")

    meta.superClasses.add("cobra.model.reln.To")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rsDefToMplsEgressRule', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 57147, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16817
    prop.defaultValueStr = "qosMplsEgressRule"
    prop._addConstant("qosMplsEgressRule", None, 16817)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 57146, PropCategory.REGULAR)
