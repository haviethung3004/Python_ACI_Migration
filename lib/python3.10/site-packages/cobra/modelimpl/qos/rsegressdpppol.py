...
# ##################################################
class RsEgressDppPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.qos.RsEgressDppPol", "cobra.model.qos.DppPol")
    meta.targetNameProps["name"] = "tnQosDppPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "qosRsEgressDppPol"
    meta.rnFormat = "rsegressDppPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Policing policy that need to enforced in egress direction"
    ...
    meta.rnPrefixes = [
        ('rsegressDppPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61928, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61929, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61923, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 61914, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosDppPolName", "tnQosDppPolName", 62343, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
