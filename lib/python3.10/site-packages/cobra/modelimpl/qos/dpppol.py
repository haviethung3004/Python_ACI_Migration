...
class DppPol(Mo):
    ...
    meta.childClasses.add("cobra.model.qos.RtEgressDppPol")
    meta.childClasses.add("cobra.model.qos.RtEgressQosDppPol")
    meta.childClasses.add("cobra.model.qos.RtIngressDppPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtIngressDppPol", "rtingressDppPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtEgressDppPol", "rtegressDppPol-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26896, PropCategory.REGULAR)
