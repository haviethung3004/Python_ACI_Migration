...
# ##################################################
class RtLNodePMplsCustQosPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtLNodePMplsCustQosPol", "cobra.model.l3ext.LNodeP")

    meta.moClassName = "qosRtLNodePMplsCustQosPol"
    meta.rnFormat = "rtl3extLNodePMplsCustQosPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtl3extLNodePMplsCustQosPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 58956, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58955, PropCategory.REGULAR)
