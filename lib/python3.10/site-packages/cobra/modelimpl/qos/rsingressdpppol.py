...
# ##################################################
class RsIngressDppPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.qos.RsIngressDppPol", "cobra.model.qos.DppPol")
    meta.targetNameProps["name"] = "tnQosDppPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "qosRsIngressDppPol"
    meta.rnFormat = "rsingressDppPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Policing policy that need to enforced in ingress direction"
    meta.writeAccessMask = 0x81
    meta.readAccessMask = 0x80081
    ...
    meta.rnPrefixes = [
        ('rsingressDppPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61926, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61927, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61922, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 61918, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnQosDppPolName", "tnQosDppPolName", 62344, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
