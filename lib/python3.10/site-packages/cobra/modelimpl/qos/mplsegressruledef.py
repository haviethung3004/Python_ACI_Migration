...
# ##################################################
class MplsEgressRuleDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.MplsEgressRuleDef")

    meta.moClassName = "qosMplsEgressRuleDef"
    meta.rnFormat = "dscpToExp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Dscp to Exp Mapping Policy Definition"
    ...
    meta.childClasses.add("cobra.model.qos.RsDefToMplsEgressRule")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsDefToMplsEgressRule", "rsDefToMplsEgressRule"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.qos.MplsCustomPolDef")
    ...
    prop = PropMeta("str", "from", "from", 57131, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "name", "name", 57135, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "to", "to", 57132, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
