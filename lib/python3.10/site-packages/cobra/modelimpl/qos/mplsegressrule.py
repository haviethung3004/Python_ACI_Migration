...
# ##################################################
class MplsEgressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.MplsEgressRule")

    meta.moClassName = "qosMplsEgressRule"
    meta.rnFormat = "dscpToExp-%(from)s-%(to)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Mpls Dscp to Exp Mapping Policy"
    ...
    meta.childClasses.add("cobra.model.qos.RtDefToMplsEgressRule")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtDefToMplsEgressRule", "rtDefToMplsEgressRule"))
    ...
    meta.superClasses.add("cobra.model.qos.MplsMarking")
    meta.superClasses.add("cobra.model.qos.AMplsEgressRule")
    ...
    prop = PropMeta("str", "annotation", "annotation", 57154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "from", "from", 57134, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "targetExp", "targetExp", 57130, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 8)]
    ...
    prop._addConstant("unspecified", "unspecified", 8)
    meta.props.add("targetExp", prop)

    prop = PropMeta("str", "to", "to", 57133, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
