...
# ##################################################
class MplsIngressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.MplsIngressRule")

    meta.moClassName = "qosMplsIngressRule"
    meta.rnFormat = "exp-%(from)s-%(to)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Mpls to Priority Mapping Policy"
    ...
    meta.childClasses.add("cobra.model.qos.RtDefToMplsIngressRule")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtDefToMplsIngressRule", "rtDefToMplsIngressRule"))
    ...
    meta.superClasses.add("cobra.model.qos.AMplsIngressRule")
    ...
    prop = PropMeta("str", "annotation", "annotation", 57152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "from", "from", 57137, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prio", "prio", 57129, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 9)]
    ...
    prop = PropMeta("str", "to", "to", 57136, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
