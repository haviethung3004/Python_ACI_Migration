...
# ##################################################
class RtDefToMplsCustomPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtDefToMplsCustomPol", "cobra.model.qos.MplsCustomPolDef")

    meta.moClassName = "qosRtDefToMplsCustomPol"
    meta.rnFormat = "rtDefToMplsCustomPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58959, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17471
    prop.defaultValueStr = "qosMplsCustomPolDef"
