...
# ##################################################
class RtDefToMplsIngressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtDefToMplsIngressRule", "cobra.model.qos.MplsIngressRuleDef")

    meta.moClassName = "qosRtDefToMplsIngressRule"
    meta.rnFormat = "rtDefToMplsIngressRule"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57145, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16810
    prop.defaultValueStr = "qosMplsIngressRuleDef"
