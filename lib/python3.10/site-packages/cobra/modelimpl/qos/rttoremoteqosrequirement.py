...
# ##################################################
class RtToRemoteQosRequirement(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtToRemoteQosRequirement", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "qosRtToRemoteQosRequirement"
    meta.rnFormat = "rtfvToRemoteQosRequirement-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfvToRemoteQosRequirement-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 61912, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 61911, PropCategory.REGULAR)
