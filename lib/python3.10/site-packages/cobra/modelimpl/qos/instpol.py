...
class InstPol(Mo):
    ...
    prop = PropMeta("str", "uburstSpineQueues", "uburstSpineQueues", 60995, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "uburstTorQueues", "uburstTorQueues", 60994, PropCategory.REGULAR)
