...
# ##################################################
class RtQosRequirement(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtQosRequirement", "cobra.model.fv.AEPg")

    meta.moClassName = "qosRtQosRequirement"
    meta.rnFormat = "rtfvQosRequirement-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 61944, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 61943, PropCategory.REGULAR)
