...
class Requirement(Mo):
    ...
    meta = ClassMeta("cobra.model.qos.Requirement")

    meta.moClassName = "qosRequirement"
    meta.rnFormat = "qosreq-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Collection of Qos rules that need to be enforced"
    meta.writeAccessMask = 0x81
    meta.readAccessMask = 0x80681
    ...
    meta.childClasses.add("cobra.model.qos.EpDscpMarking")
    meta.childClasses.add("cobra.model.qos.RsEgressDppPol")
    meta.childClasses.add("cobra.model.qos.RsIngressDppPol")
    meta.childClasses.add("cobra.model.qos.RtQosRequirement")
    meta.childClasses.add("cobra.model.qos.RtToRemoteQosRequirement")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtToRemoteQosRequirement", "rtfvToRemoteQosRequirement-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RtQosRequirement", "rtfvQosRequirement-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsIngressDppPol", "rsingressDppPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsEgressDppPol", "rsegressDppPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.EpDscpMarking", "dscp_marking"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 61924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "egressDppPolDn", "egressDppPolDn", 61906, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("egressDppPolDn", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ingressDppPolDn", "ingressDppPolDn", 61907, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ingressDppPolDn", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61921, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 61908, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
