...
# ##################################################
class RsDefToMplsIngressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.qos.RsDefToMplsIngressRule", "cobra.model.qos.MplsIngressRule")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "qosRsDefToMplsIngressRule"
    meta.rnFormat = "rsDefToMplsIngressRule"
    ...
    meta.parentClasses.add("cobra.model.qos.MplsIngressRuleDef")

    meta.superClasses.add("cobra.model.reln.To")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rsDefToMplsIngressRule', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 57144, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16813
    prop.defaultValueStr = "qosMplsIngressRule"
    prop._addConstant("qosMplsIngressRule", None, 16813)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 57143, PropCategory.REGULAR)
