...
# ##################################################
class RtDefToMplsEgressRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.qos.RtDefToMplsEgressRule", "cobra.model.qos.MplsEgressRuleDef")

    meta.moClassName = "qosRtDefToMplsEgressRule"
    meta.rnFormat = "rtDefToMplsEgressRule"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57148, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16814
    prop.defaultValueStr = "qosMplsEgressRuleDef"
