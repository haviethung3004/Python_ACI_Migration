...
# ##################################################
class EpDscpMarking(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.EpDscpMarking")

    meta.moClassName = "qosEpDscpMarking"
    meta.rnFormat = "dscp_marking"
    meta.category = MoCategory.REGULAR
    meta.label = "Dscp marking of endpoint egress traffic"
    ...
    prop = PropMeta("str", "annotation", "annotation", 61948, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61949, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mark", "mark", 61939, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 63)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61980, PropCategory.REGULAR)
