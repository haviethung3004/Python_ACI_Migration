...
# ##################################################
class MplsCustomPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.MplsCustomPolDef")

    meta.moClassName = "qosMplsCustomPolDef"
    meta.rnFormat = "qosmplscustom-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Mpls Custom QOS Policy Definition"
    ...
    meta.childClasses.add("cobra.model.qos.MplsEgressRuleDef")
    meta.childClasses.add("cobra.model.qos.MplsIngressRuleDef")
    meta.childClasses.add("cobra.model.qos.RsDefToMplsCustomPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsDefToMplsCustomPol", "rsDefToMplsCustomPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.MplsEgressRuleDef", "dscpToExp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.MplsIngressRuleDef", "exp-"))
    ...
    prop = PropMeta("str", "name", "name", 58952, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
