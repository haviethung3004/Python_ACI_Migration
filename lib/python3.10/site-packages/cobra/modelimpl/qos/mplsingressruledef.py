...
# ##################################################
class MplsIngressRuleDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qos.MplsIngressRuleDef")

    meta.moClassName = "qosMplsIngressRuleDef"
    meta.rnFormat = "exp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Exp Class to Priority Mapping Policy Definition"
    ...
    meta.childClasses.add("cobra.model.qos.RsDefToMplsIngressRule")

    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RsDefToMplsIngressRule", "rsDefToMplsIngressRule"))
    ...
    prop = PropMeta("str", "from", "from", 57127, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 8)]
    ...
    prop = PropMeta("str", "name", "name", 57138, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "to", "to", 57128, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 8)]
