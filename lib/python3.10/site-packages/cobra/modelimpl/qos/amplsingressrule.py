...
# ##################################################
class AMplsIngressRule(Mo):
    meta = ClassMeta("cobra.model.qos.AMplsIngressRule")

    meta.isAbstract = True
    meta.moClassName = "qosAMplsIngressRule"


    meta.moClassName = "qosAMplsIngressRule"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction of Exp Class to Priority Mapping Policy"
