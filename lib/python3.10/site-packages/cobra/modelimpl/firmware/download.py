...
class Download(Mo):
    ...
    prop = PropMeta("str", "imageType", "imageType", 65277, PropCategory.REGULAR)
    prop.label = "Image Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("ciscoDockerApp", "ciscodockerapp", 3)
    prop._addConstant("controllerPatch", "controllerpatch", 2)
    prop._addConstant("dockerApp", "dockerapp", 4)
    prop._addConstant("switchPatch", "switchpatch", 1)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("imageType", prop)
