...
class Firmware(Mo):
    ...
    meta.childClasses.add("cobra.model.firmware.FirmwareFault")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.firmware.FirmwareFault", "firmwarefault"))
    ...
    prop = PropMeta("str", "bitInfo", "bitInfo", 68628, PropCategory.REGULAR)
    prop.label = "Bit Info"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "NA"
    prop._addConstant("32", "32bit", 1)
    prop._addConstant("64", "64bit", 2)
    prop._addConstant("NA", "notapplicable", 0)
    meta.props.add("bitInfo", prop)
    ...
    prop = PropMeta("str", "origFileName", "origFileName", 70538, PropCategory.REGULAR)
    prop.label = "Original File Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("origFileName", prop)
    ...
    prop = PropMeta("str", "restartType", "restartType", 67945, PropCategory.REGULAR)
    prop.label = "Restart Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "NA"
    prop._addConstant("NA", "notapplicable", 0)
    prop._addConstant("reload", "reload", 2)
    prop._addConstant("restart", "restart", 1)
    meta.props.add("restartType", prop)
    ...
    prop = PropMeta("str", "syncComplete", "syncComplete", 67629, PropCategory.REGULAR)
    prop.label = "Sync Complete"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("syncComplete", prop)
    ...
    prop._addConstant("cApicPatch", "capicpatch", 9)
    prop._addConstant("catalog", "catalog", 2)
    prop._addConstant("ciscoDockerApp", "ciscodockerapp", 10)
    prop._addConstant("config", "config", 5)
    prop._addConstant("controller", "controller", 0)
    prop._addConstant("controllerPatch", "controllerpatch", 8)
    prop._addConstant("dockerApp", "dockerapp", 11)
    prop._addConstant("plugin", "plugin", 3)
    prop._addConstant("pluginPackage", "pluginpackage", 4)
    prop._addConstant("switch", "switch", 1)
    prop._addConstant("switchPatch", "switchpatch", 7)
