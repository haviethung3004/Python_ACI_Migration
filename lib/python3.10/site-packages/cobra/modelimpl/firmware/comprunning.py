...
class CompRunning(Mo):
    ...
    prop = PropMeta("str", "epldUpgSt", "epldUpgSt", 61194, PropCategory.REGULAR)
    prop.label = "Auto Epld Upgrade Status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("upg-done", "auto-epld-upgrade-done", 1)
    prop._addConstant("upg-failed", "auto-epld-upgrade-failed", 2)
    prop._addConstant("upg-not-req", "upgrade-not-required", 0)
    meta.props.add("epldUpgSt", prop)
