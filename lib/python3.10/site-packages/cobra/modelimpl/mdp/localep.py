...
class LocalEp(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.LocalEp")

    meta.moClassName = "mdpLocalEp"
    meta.rnFormat = "mdpLocalEp-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Mdp Local Endpoint"
    ...
    prop = PropMeta("str", "addr", "addr", 57393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 57394, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fvIpDn", "fvIpDn", 62637, PropCategory.REGULAR)
    prop.label = "DN of associated fvIp"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("fvIpDn", prop)
