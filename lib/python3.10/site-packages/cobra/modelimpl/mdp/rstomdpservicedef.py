...
# ##################################################
class RsToMdpServiceDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.mdp.RsToMdpServiceDef", "cobra.model.mdp.ServiceDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mdpRsToMdpServiceDef"
    meta.rnFormat = "rstoMdpServiceDef"
    ...
    meta.rnPrefixes = [
        ('rstoMdpServiceDef', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 58998, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 58993, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16818
    prop.defaultValueStr = "mdpServiceDef"
    prop._addConstant("mdpServiceDef", None, 16818)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58992, PropCategory.REGULAR)
