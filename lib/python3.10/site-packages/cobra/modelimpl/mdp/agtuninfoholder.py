...
# ##################################################
class AgTunInfoHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mdp.AgTunInfoHolder")

    meta.moClassName = "mdpAgTunInfoHolder"
    meta.rnFormat = "agtun-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Aggregated Tunnel Stats Holder"
    ...
    prop = PropMeta("str", "addr", "addr", 59055, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59181, PropCategory.REGULAR)
