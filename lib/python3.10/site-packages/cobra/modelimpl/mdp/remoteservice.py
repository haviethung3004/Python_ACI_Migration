...
# ##################################################
class RemoteService(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mdp.RemoteService")

    meta.moClassName = "mdpRemoteService"
    meta.rnFormat = "mdprsrv"
    meta.category = MoCategory.REGULAR
    meta.label = "Multi-Domain Imported Service"
    meta.writeAccessMask = 0x121
    meta.readAccessMask = 0x121
    ...
    meta.superClasses.add("cobra.model.mdp.AService")
    ...
    prop = PropMeta("str", "annotation", "annotation", 57929, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "consumerScope", "consumerScope", 60938, PropCategory.REGULAR)
    prop.label = "Consumer Scope"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = "epg,context"
    prop.defaultValueStr = "epg,context"
    prop._addConstant("context", "vrf", 2)
    prop._addConstant("epg", "epg", 1)
    meta.props.add("consumerScope", prop)
    ...
    prop = PropMeta("str", "domainId", "domainId", 61791, PropCategory.REGULAR)
    prop.label = "Remote Domain Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57930, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "service", "service", 61886, PropCategory.REGULAR)
    prop.label = "Remote Service Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "tenant", "tenant", 61790, PropCategory.REGULAR)
    prop.label = "Remote Tenant Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
