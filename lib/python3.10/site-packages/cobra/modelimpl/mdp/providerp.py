...
class ProviderP(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.ProviderP")

    meta.moClassName = "mdpProviderP"
    meta.rnFormat = "provider-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Multi-Domain Provider Profile"
    meta.writeAccessMask = 0x25
    meta.readAccessMask = 0x81665
    ...
    meta.childClasses.add("cobra.model.fv.MdpConfigIssues")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.mdp.LeafP")
    meta.childClasses.add("cobra.model.mdp.RtOutToMdpProvP")
    meta.childClasses.add("cobra.model.mdp.SpineP")
    meta.childClasses.add("cobra.model.mdp.TypeInfoHolder")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.RtOutToMdpProvP", "rtl3extOutToMdpProvP-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.MdpConfigIssues", "mdpcfgissues"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.SpineP", "spine-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.LeafP", "leaf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.TypeInfoHolder", "ty-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 56665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "description", "description", 56551, PropCategory.REGULAR)
    prop.label = "Multi Domain Profile Description"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56666, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56630, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 56549, PropCategory.REGULAR)
