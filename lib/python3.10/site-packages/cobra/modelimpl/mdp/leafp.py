...
class LeafP(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.LeafP")

    meta.moClassName = "mdpLeafP"
    meta.rnFormat = "leaf-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Multi-Domain Leaf Profile"
    ...
    meta.superClasses.add("cobra.model.mdp.ANodeP")

    meta.rnPrefixes = [
        ('leaf-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56668, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 56558, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59177, PropCategory.REGULAR)
