...
# ##################################################
class DestGrpInfoHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mdp.DestGrpInfoHolder")

    meta.moClassName = "mdpDestGrpInfoHolder"
    meta.rnFormat = "dg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Destination Group Stats Holder"
    ...
    meta.childClasses.add("cobra.model.mdp.AgTunInfoHolder")
    meta.childClasses.add("cobra.model.mdp.TunInfoHolder")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.AgTunInfoHolder", "agtun-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.TunInfoHolder", "tun-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59179, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 59056, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
