...
class SpineP(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.SpineP")

    meta.moClassName = "mdpSpineP"
    meta.rnFormat = "spine-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Multi-Domain Spine Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 56669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56670, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 56568, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
