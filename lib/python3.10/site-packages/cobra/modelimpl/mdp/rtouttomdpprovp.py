...
# ##################################################
class RtOutToMdpProvP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mdp.RtOutToMdpProvP", "cobra.model.l3ext.Out")

    meta.moClassName = "mdpRtOutToMdpProvP"
    meta.rnFormat = "rtl3extOutToMdpProvP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56590, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56589, PropCategory.REGULAR)
