...
# ##################################################
class LocalTenant(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mdp.LocalTenant")

    meta.moClassName = "mdpLocalTenant"
    meta.rnFormat = "mdpLocalTenant"
    meta.category = MoCategory.REGULAR
    meta.label = "Local Multi-Domain Tenant"
    ...
    meta.rnPrefixes = [
        ('mdpLocalTenant', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56692, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56693, PropCategory.REGULAR)
