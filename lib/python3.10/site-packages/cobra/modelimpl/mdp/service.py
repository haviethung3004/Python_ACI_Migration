...
class Service(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.Service")

    meta.moClassName = "mdpService"
    meta.rnFormat = "mdpsrv"
    meta.category = MoCategory.REGULAR
    meta.label = "Multi-Domain Exported Service"
    meta.writeAccessMask = 0x121
    meta.readAccessMask = 0x125
    ...
    meta.childClasses.add("cobra.model.mdp.L4L7Vip")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mdp.L4L7Vip", "l4l7vip-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 57164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "consumeMode", "consumeMode", 61197, PropCategory.REGULAR)
    prop.label = "Consume Mode for this MDP Service"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "auto"
    prop._addConstant("auto", "auto", 1)
    prop._addConstant("manual", "manual", 2)
    meta.props.add("consumeMode", prop)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57165, PropCategory.REGULAR)
