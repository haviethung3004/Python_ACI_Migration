...
class LeafPDef(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.LeafPDef")

    meta.moClassName = "mdpLeafPDef"
    meta.rnFormat = "leafp-%(nodeId)s"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 56554, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
