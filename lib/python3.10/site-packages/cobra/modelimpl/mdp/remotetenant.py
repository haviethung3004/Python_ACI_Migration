...
# ##################################################
class RemoteTenant(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mdp.RemoteTenant")

    meta.moClassName = "mdpRemoteTenant"
    meta.rnFormat = "mdpRemoteTenant"
    meta.category = MoCategory.REGULAR
    meta.label = "Remote Multi-Domain Tenant"
    ...
    meta.superClasses.add("cobra.model.mdp.ATenant")
    meta.superClasses.add("cobra.model.pol.Comp")
    meta.superClasses.add("cobra.model.naming.NamedObject")

    meta.rnPrefixes = [
        ('mdpRemoteTenant', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56694, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "domainId", "domainId", 61789, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56695, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenant", "tenant", 61788, PropCategory.REGULAR)
