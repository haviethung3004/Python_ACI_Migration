...
# ##################################################
class RsTenantInfoDefToMdpPolDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.mdp.RsTenantInfoDefToMdpPolDefCont", "cobra.model.mdp.PolDefCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mdpRsTenantInfoDefToMdpPolDefCont"
    meta.rnFormat = "rsTenantInfoDefToMdpPolDefCont"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Container of multi-domain policies (resolved)"
    ...
    meta.rnPrefixes = [
        ('rsTenantInfoDefToMdpPolDefCont', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56653, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56654, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69883, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56612, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16598
    prop.defaultValueStr = "mdpPolDefCont"
    prop._addConstant("mdpPolDefCont", None, 16598)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56611, PropCategory.REGULAR)
