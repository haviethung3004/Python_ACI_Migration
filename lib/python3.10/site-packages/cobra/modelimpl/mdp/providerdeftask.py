...
# ##################################################
class ProviderDefTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mdp.ProviderDefTask")

    meta.moClassName = "mdpProviderDefTask"
    meta.rnFormat = "mdpProviderDefTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 56556, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 3722)
