...
# ##################################################
class RsRemoteCtxDefToMultiDomCtxDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.mdp.RsRemoteCtxDefToMultiDomCtxDef", "cobra.model.mdp.MultiDomCtxDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "mdpRsRemoteCtxDefToMultiDomCtxDef"
    meta.rnFormat = "rsremoteCtxDefToMultiDomCtxDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MDP Domain Remote Ctx reference"
    ...
    meta.rnPrefixes = [
        ('rsremoteCtxDefToMultiDomCtxDef', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56655, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56656, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56616, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16607
    prop.defaultValueStr = "mdpMultiDomCtxDef"
    prop._addConstant("mdpMultiDomCtxDef", None, 16607)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56615, PropCategory.REGULAR)
