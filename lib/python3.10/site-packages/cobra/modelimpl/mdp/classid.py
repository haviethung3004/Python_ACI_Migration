...
class ClassId(Mo):
    ...
    meta = ClassMeta("cobra.model.mdp.ClassId")

    meta.moClassName = "mdpClassId"
    meta.rnFormat = "mdpClassId"
    meta.category = MoCategory.REGULAR
    meta.label = "Global Class ID allocated for this EPG by MSC"
    ...
    meta.superClasses.add("cobra.model.mdp.AClassId")

    meta.rnPrefixes = [
        ('mdpClassId', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56671, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "epStream", "epStream", 61535, PropCategory.REGULAR)
    prop.label = "Control EP stream for this EPg to MDC"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("epStream", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56672, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 56553, PropCategory.REGULAR)
    prop.label = "Domain level pcTag allocated by MDC"
    prop.isConfig = True
    prop.isAdmin = True
