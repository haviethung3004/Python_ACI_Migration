...
# ##################################################
class RogueExpMac(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l2.RogueExpMac")

    meta.moClassName = "l2RogueExpMac"
    meta.rnFormat = "rogueexpmac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "MAC address for Rogue Exception List"
    ...
    prop = PropMeta("str", "mac", "mac", 63949, PropCategory.REGULAR)
    prop.label = "MAC"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "operSt", "operSt", 63950, PropCategory.REGULAR)
