...
class FcAggrIf(Mo):
    ...
    prop._addConstant("l2:FcAggrIfmodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("vfc-bind-ethernet-not-fcoe-capable", "fcoe-functionality-is-not-supported-on-bound-ethernet-interface", 7)
