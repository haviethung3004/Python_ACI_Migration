...
class BD(Mo):
    ...
    meta.childClasses.add("cobra.model.l2.RemoteSite")
    meta.childClasses.add("cobra.model.l2.RogueExpMac")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RogueExpMac", "rogueexpmac-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.EpScanInfo", "epsScanInfo"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l2.RemoteSite", "remoteSite-"))
    ...
    prop._addConstant("ArpBdSrcMacMcastAct", "arp-bd-src-mac-mcast-action", 1024)
    ...
    prop._addConstant("service-bd-route-disable", "disable-routing-on-service-bd", 2048)
    ...
    prop = PropMeta("str", "serviceEnabled", "serviceEnabled", 62802, PropCategory.REGULAR)
    prop.label = "serviceEnable"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    ...
    prop = PropMeta("str", "servicepcTag", "servicepcTag", 62801, PropCategory.REGULAR)
    prop.label = "service PC Tag"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
