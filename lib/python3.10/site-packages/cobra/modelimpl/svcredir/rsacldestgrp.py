...
# ##################################################
class RsAclDestGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.svcredir.RsAclDestGrp", "cobra.model.svcredir.DestGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "svcredirRsAclDestGrp"
    meta.rnFormat = "rsaclDestGrp"
    ...
    prop = PropMeta("str", "id", "id", 68820, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "tCl", "tCl", 68822, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68821, PropCategory.REGULAR)
