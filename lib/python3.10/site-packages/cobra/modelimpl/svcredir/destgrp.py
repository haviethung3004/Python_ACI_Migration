...
class DestGrp(Mo):
    ...
    meta.childClasses.add("cobra.model.svcredir.RtAclDestGrp")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.svcredir.RtAclDestGrp", "rtaclDestGrp-"))
    ...
    prop = PropMeta("str", "actrlCfgFailedBmp", "actrlCfgFailedBmp", 62796, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("svcredir:DestGrpactrlRuleExists_failed_flag", None, 8)
    prop._addConstant("svcredir:DestGrpctrl_failed_flag", None, 64)
    prop._addConstant("svcredir:DestGrpdestType_failed_flag", None, 128)
    prop._addConstant("svcredir:DestGrpflags_failed_flag", None, 256)
    prop._addConstant("svcredir:DestGrphashProfOption_failed_flag", None, 512)
    prop._addConstant("svcredir:DestGrpid_failed_flag", None, 1024)
    prop._addConstant("svcredir:DestGrplcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("svcredir:DestGrplocationPBREnabled_failed_flag", None, 4096)
    prop._addConstant("svcredir:DestGrpmodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("svcredir:DestGrpmonPolDn_failed_flag", None, 8192)
    prop._addConstant("svcredir:DestGrpnextDestGrpDn_failed_flag", None, 16384)
    prop._addConstant("svcredir:DestGrppeerDestGrpDn_failed_flag", None, 131072)
    prop._addConstant("svcredir:DestGrpredirPolKey_failed_flag", None, 262144)
    prop._addConstant("svcredir:DestGrpresilientHashEnabled_failed_flag", None, 524288)
    prop._addConstant("svcredir:DestGrpsortByName_failed_flag", None, 1048576)
    prop._addConstant("svcredir:DestGrpthresholdDownAction_failed_flag", None, 16777216)
    prop._addConstant("svcredir:DestGrpthresholdEnabled_failed_flag", None, 33554432)
    prop._addConstant("svcredir:DestGrpthresholdHigh_failed_flag", None, 67108864)
    prop._addConstant("svcredir:DestGrpthresholdLow_failed_flag", None, 134217728)
    prop._addConstant("svcredir:DestGrptrackingEnabled_failed_flag", None, 268435456)
    meta.props.add("actrlCfgFailedBmp", prop)

    prop = PropMeta("str", "actrlCfgFailedTs", "actrlCfgFailedTs", 62798, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("actrlCfgFailedTs", prop)

    prop = PropMeta("str", "actrlCfgState", "actrlCfgState", 62797, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("actrlCfgState", prop)

    prop = PropMeta("str", "actrlRuleExists", "actrlRuleExists", 63818, PropCategory.REGULAR)
    prop.label = "actrlRule Exists"
    ...
    meta.props.add("actrlRuleExists", prop)

    prop = PropMeta("str", "actrlRulePrimaryVrfVnid", "actrlRulePrimaryVrfVnid", 62794, PropCategory.REGULAR)
    prop.label = "actrlRule VRF (Primary)"
    prop.isOper = True
    meta.props.add("actrlRulePrimaryVrfVnid", prop)

    prop = PropMeta("str", "actrlRuleSecondaryVrfVnid", "actrlRuleSecondaryVrfVnid", 62795, PropCategory.REGULAR)
    prop.label = "actrlRule VRF (Secondary)"
    prop.isOper = True
    meta.props.add("actrlRuleSecondaryVrfVnid", prop)
    ...
    prop = PropMeta("str", "flags", "flags", 56107, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "undefined"
    prop._addConstant("activeActive", "active-active-mode", 2)
    prop._addConstant("smac_rw", "source-mac-rewrite-flag", 1)
    prop._addConstant("undefined", "undefined-value", 0)
    ...
    prop = PropMeta("str", "isRulePresent", "isRulePresent", 63870, PropCategory.REGULAR)
    prop.label = "Is rule present for this destgroup"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("isRulePresent", prop)
