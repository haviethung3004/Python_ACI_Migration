...
# ##################################################
class RtToAclRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.svcredir.RtToAclRule", "cobra.model.actrl.ARule")

    meta.moClassName = "svcredirRtToAclRule"
    meta.rnFormat = "rtactrlToAclRule-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68819, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68818, PropCategory.REGULAR)
