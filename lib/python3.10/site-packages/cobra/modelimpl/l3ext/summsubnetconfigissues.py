...
class SummSubnetConfigIssues(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.SummSubnetConfigIssues")

    meta.moClassName = "l3extSummSubnetConfigIssues"
    ...
    meta.superClasses.add("cobra.model.l3ext.AConfIssues")
    ...
    prop = PropMeta("str", "configQual", "configQual", 67880, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 67888, PropCategory.REGULAR)
