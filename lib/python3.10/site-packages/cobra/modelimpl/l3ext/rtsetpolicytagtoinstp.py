...
# ##################################################
class RtSetPolicyTagToInstP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtSetPolicyTagToInstP", "cobra.model.rtctrl.SetPolicyTag")

    meta.moClassName = "l3extRtSetPolicyTagToInstP"
    meta.rnFormat = "rtrtctrlSetPolicyTagToInstP-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtrtctrlSetPolicyTagToInstP-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65391, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19119
    prop.defaultValueStr = "rtctrlSetPolicyTag"
    prop._addConstant("rtctrlSetPolicyTag", None, 19119)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65390, PropCategory.REGULAR)
