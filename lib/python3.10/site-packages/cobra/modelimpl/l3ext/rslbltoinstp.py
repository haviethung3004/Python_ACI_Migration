...
# ##################################################
class RsLblToInstP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsLblToInstP", "cobra.model.l3ext.InstP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsLblToInstP"
    meta.rnFormat = "rslblToInstP-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 57359, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57360, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57356, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57346, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 57345, PropCategory.REGULAR)
