...
# ##################################################
class FloatingIpCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.FloatingIpCont")

    meta.moClassName = "l3extFloatingIpCont"
    meta.rnFormat = "floatingipcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Floating IP address container definition"
