...
# ##################################################
class RsOutToMdpProvP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsOutToMdpProvP", "cobra.model.mdp.ProviderP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsOutToMdpProvP"
    meta.rnFormat = "rsoutToMdpProvP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "L3 Out Multi-domain Policy"
    ...
    meta.rnPrefixes = [
        ('rsoutToMdpProvP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56637, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56621, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56588, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16628
    prop.defaultValueStr = "mdpProviderP"
    prop._addConstant("mdpProviderP", None, 16628)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56587, PropCategory.REGULAR)
