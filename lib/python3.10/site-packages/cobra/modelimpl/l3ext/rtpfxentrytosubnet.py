...
# ##################################################
class RtPfxEntryToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtPfxEntryToSubnet", "cobra.model.actrl.PfxEntry")

    meta.moClassName = "l3extRtPfxEntryToSubnet"
    meta.rnFormat = "rtactrlPfxEntryToSubnet-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63451, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2470
    prop.defaultValueStr = "actrlPfxEntry"
    prop._addConstant("actrlPfxEntry", None, 2470)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63450, PropCategory.REGULAR)
