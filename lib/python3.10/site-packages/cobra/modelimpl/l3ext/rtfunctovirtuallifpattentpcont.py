...
# ##################################################
class RtFuncToVirtualLIfPAttEntPCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtFuncToVirtualLIfPAttEntPCont", "cobra.model.infra.AFunc")

    meta.moClassName = "l3extRtFuncToVirtualLIfPAttEntPCont"
    meta.rnFormat = "rtinfraFuncToVirtualLIfPAttEntPCont-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "None"
    meta.writeAccessMask = 0x21
    meta.readAccessMask = 0x4021
    ...
    meta.rnPrefixes = [
        ('rtinfraFuncToVirtualLIfPAttEntPCont-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 58357, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58356, PropCategory.REGULAR)
