...
# ##################################################
class MplsVpnLabelCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.MplsVpnLabelCons")

    meta.moClassName = "l3extMplsVpnLabelCons"
    ...
    meta.parentClasses.add("cobra.model.l3ext.MplsVpnLabelAllocator")
    ...
    prop = PropMeta("str", "consDn", "consDn", 57051, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
