...
# ##################################################
class RsLblToProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsLblToProfile", "cobra.model.rtctrl.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsLblToProfile"
    meta.rnFormat = "rslblToProfile-[%(tDn)s]-%(direction)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 57357, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "direction", "direction", 57349, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57358, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 57350, PropCategory.REGULAR)
