...
# ##################################################
class RogueExceptionMacGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.RogueExceptionMacGroup")

    meta.moClassName = "l3extRogueExceptionMacGroup"
    meta.rnFormat = "rmacg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract rogue exception mac group"
    ...
    meta.childClasses.add("cobra.model.l3ext.RogueExceptionMac")
    meta.childClasses.add("cobra.model.l3ext.RtPathToRogueExceptMacGroup")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtPathToRogueExceptMacGroup", "rtpathToRogueExceptMacGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RogueExceptionMac", "rmac-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.fv.Tenant")

    meta.superClasses.add("cobra.model.l3ext.ARogueExceptionMacGroup")
    ...
    prop = PropMeta("str", "annotation", "annotation", 69155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69156, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 69145, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
