...
# ##################################################
class RsPathToRogueExceptMacGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsPathToRogueExceptMacGroup", "cobra.model.l3ext.RogueExceptionMacGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsPathToRogueExceptMacGroup"
    meta.rnFormat = "rsPathToRogueExceptMacGroup"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Rogue Exception MAC Group"
    ...
    meta.rnPrefixes = [
        ('rsPathToRogueExceptMacGroup', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69159, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69160, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69152, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69148, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20164
    prop.defaultValueStr = "l3extRogueExceptionMacGroup"
    prop._addConstant("l3extRogueExceptionMacGroup", None, 20164)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69147, PropCategory.REGULAR)
