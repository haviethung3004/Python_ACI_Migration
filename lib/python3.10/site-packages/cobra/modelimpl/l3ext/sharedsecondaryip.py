...
# ##################################################
class SharedSecondaryIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.SharedSecondaryIp")

    meta.moClassName = "l3extSharedSecondaryIp"
    meta.rnFormat = "sharedip-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Shared secondary IP"
    ...
    prop = PropMeta("str", "addr", "addr", 60589, PropCategory.REGULAR)
