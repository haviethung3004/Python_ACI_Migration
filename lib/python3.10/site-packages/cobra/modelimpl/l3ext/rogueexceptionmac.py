...
# ##################################################
class RogueExceptionMac(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.RogueExceptionMac")

    meta.moClassName = "l3extRogueExceptionMac"
    meta.rnFormat = "rmac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Rogue Exception Mac"
    ...
    meta.superClasses.add("cobra.model.l3ext.ARogueExceptionMac")

    meta.rnPrefixes = [
        ('rmac-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 69143, PropCategory.REGULAR)
    prop.label = "Rogoue Exception Mac Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
