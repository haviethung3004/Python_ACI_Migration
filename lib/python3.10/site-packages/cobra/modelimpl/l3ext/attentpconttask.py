...
# ##################################################
class AttEntPContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.AttEntPContTask")

    meta.moClassName = "l3extAttEntPContTask"
    meta.rnFormat = "l3extAttEntPContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 58349, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CreateRsFuncToVirtualLIfPAttEntPCont", "creatersfunctovirtuallifpattentpcont", 3828)
