...
# ##################################################
class MplsVpnLabelAllocator(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.MplsVpnLabelAllocator")

    meta.moClassName = "l3extMplsVpnLabelAllocator"
    meta.rnFormat = "mplslabel"
    meta.category = MoCategory.REGULAR
    meta.label = "MPLS VPN Label"
    ...
    meta.childClasses.add("cobra.model.l3ext.MplsVpnLabelCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.MplsVpnLabelCons", "cons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Delegate", "fd-"))

    meta.parentClasses.add("cobra.model.fv.Ctx")

    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.l3ext.AVpnLabelAllocator")
    ...
    prop = PropMeta("str", "labelPolDn", "labelPolDn", 57050, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("labelPolDn", prop)
    ...
    prop = PropMeta("str", "vpnLabel", "vpnLabel", 57049, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("vpnLabel", prop)
