...
# ##################################################
class FloatingPhyNodeDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.FloatingPhyNodeDef")

    meta.moClassName = "l3extFloatingPhyNodeDef"
    meta.rnFormat = "floatingphynodedef"
    meta.category = MoCategory.REGULAR
    meta.label = "Floating Node Def Mo for phyDom"
