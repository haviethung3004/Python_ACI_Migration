...
# ##################################################
class RsBdProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsBdProfile", "cobra.model.l3ext.BdProfile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsBdProfile"
    meta.rnFormat = "rsbdProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "External Bridge Group Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 60965, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 60966, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 60960, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 60956, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18075
    prop.defaultValueStr = "l3extBdProfile"
    prop._addConstant("l3extBdProfile", None, 18075)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 60955, PropCategory.REGULAR)
