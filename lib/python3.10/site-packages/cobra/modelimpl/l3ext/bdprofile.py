...
class BdProfile(Mo):
    ...
    meta = ClassMeta("cobra.model.l3ext.BdProfile")

    meta.moClassName = "l3extBdProfile"
    meta.rnFormat = "bdprofile-%(name)s"
    ...
    meta.childClasses.add("cobra.model.l3ext.RtBdProfile")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtBdProfile", "rtbdProfile-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 60961, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 60962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 60990, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 60951, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
