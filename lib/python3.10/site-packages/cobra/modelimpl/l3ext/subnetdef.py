...
class SubnetDef(Mo):
    ...
    meta.childClasses.add("cobra.model.l3ext.RtPfxEntryToSubnet")
    meta.childClasses.add("cobra.model.l3ext.SummSubnetConfigIssues")
    meta.childClasses.add("cobra.model.ospf.RtSummPolDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtPfxEntryToSubnet", "rtactrlPfxEntryToSubnet-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.SummSubnetConfigIssues", "sumcfgissues"))
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 65849, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "subnetKey", "subnetKey", 65850, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("subnetKey", prop)
