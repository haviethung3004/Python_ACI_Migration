...
# ##################################################
class RsLNodePMplsCustQosPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsLNodePMplsCustQosPol", "cobra.model.qos.MplsCustomPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3extRsLNodePMplsCustQosPol"
    meta.rnFormat = "rslNodePMplsCustQosPol"
    ...
    meta.rnPrefixes = [
        ('rslNodePMplsCustQosPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 58961, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58962, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 58960, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 58954, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17470
    prop.defaultValueStr = "qosMplsCustomPol"
    prop._addConstant("qosMplsCustomPol", None, 17470)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58953, PropCategory.REGULAR)
