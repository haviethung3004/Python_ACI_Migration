...
class InstP(Mo):
    ...
    meta.writeAccessMask = 0x21
    meta.readAccessMask = 0x19f73f
    ...
    meta.childClasses.add("cobra.model.l3ext.RtLblToInstP")
    meta.childClasses.add("cobra.model.l3ext.RtSetPolicyTagToInstP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtSetPolicyTagToInstP", "rtrtctrlSetPolicyTagToInstP-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RtLblToInstP", "rtlblToInstP-"))
    ...
    prop = PropMeta("str", "pcEnfPref", "pcEnfPref", 62963, PropCategory.REGULAR)
