...
class ProvLblDef(Mo):
    ...
    meta.childClasses.add("cobra.model.l3ext.ProvLblItem")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.ProvLblItem", "item"))
    ...
    prop = PropMeta("str", "usedFor", "usedFor", 57048, PropCategory.REGULAR)
    prop.label = "Provider Label Usage"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
