...
class LNodeP(Mo):
    ...
    meta.childClasses.add("cobra.model.bfd.MhNodeP")
    ...
    meta.childClasses.add("cobra.model.l3ext.RsLNodePMplsCustQosPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsLNodePMplsCustQosPol", "rslNodePMplsCustQosPol"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.MhNodeP", "bfdMhNodeP"))
