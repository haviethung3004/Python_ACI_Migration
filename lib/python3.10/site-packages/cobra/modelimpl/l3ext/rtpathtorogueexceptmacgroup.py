...
# ##################################################
class RtPathToRogueExceptMacGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.l3ext.RtPathToRogueExceptMacGroup", "cobra.model.l3ext.RogueExceptMacP")

    meta.moClassName = "l3extRtPathToRogueExceptMacGroup"
    meta.rnFormat = "rtpathToRogueExceptMacGroup-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtpathToRogueExceptMacGroup-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 69150, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20166
    prop.defaultValueStr = "l3extRogueExceptMacP"
    prop._addConstant("l3extRogueExceptMacP", None, 20166)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69149, PropCategory.REGULAR)
