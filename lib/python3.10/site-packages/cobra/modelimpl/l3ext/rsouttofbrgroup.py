...
# ##################################################
class RsOutToFBRGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3ext.RsOutToFBRGroup", "cobra.model.fv.FBRGroup")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3extRsOutToFBRGroup"
    meta.rnFormat = "rsoutToFBRGroup-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fallback Route Group"
    ...
    meta.rnPrefixes = [
        ('rsoutToFBRGroup-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65395, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65396, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65392, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65385, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19108
    prop.defaultValueStr = "fvFBRGroup"
    prop._addConstant("fvFBRGroup", None, 19108)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65384, PropCategory.REGULAR)
