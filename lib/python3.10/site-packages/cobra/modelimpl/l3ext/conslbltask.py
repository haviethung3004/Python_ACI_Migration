...
# ##################################################
class ConsLblTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.ConsLblTask")

    meta.moClassName = "l3extConsLblTask"
    meta.rnFormat = "l3extConsLblTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 57928, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("EpP", "epp", 3815)
