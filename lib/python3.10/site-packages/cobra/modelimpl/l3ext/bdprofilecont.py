...
# ##################################################
class BdProfileCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3ext.BdProfileCont")

    meta.moClassName = "l3extBdProfileCont"
    meta.rnFormat = "bdprofilecont"
    ...
    meta.childClasses.add("cobra.model.l3ext.RsBdProfile")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsBdProfile", "rsbdProfile"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 60963, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 60964, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 60959, PropCategory.REGULAR)
