...
class LIfP(Mo):
    ...
    meta.childClasses.add("cobra.model.bfd.MhIfP")
    ...
    meta.childClasses.add("cobra.model.mpls.IfP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.MhIfP", "bfdMhIfP"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.IfP", "mplsIfP"))
