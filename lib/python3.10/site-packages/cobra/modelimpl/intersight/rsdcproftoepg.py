...
# ##################################################
class RsDcProfToEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.intersight.RsDcProfToEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcProfToEpg"
    meta.rnFormat = "rsdcProfToEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Connectivity via in-band or out-of-band epg"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68075, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68076, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68071, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68070, PropCategory.REGULAR)
