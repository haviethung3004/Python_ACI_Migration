...
# ##################################################
class RsDcToInbEpP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.intersight.RsDcToInbEpP", "cobra.model.fv.InBEpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcToInbEpP"
    meta.rnFormat = "rsdcToInbEpP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "relationship to in-band epp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67520, PropCategory.REGULAR)
