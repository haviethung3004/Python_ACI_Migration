...
class RsDcToEpP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.intersight.RsDcToEpP", "cobra.model.fv.AMgmtEpP")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcToEpP"
    meta.rnFormat = "rsdcToEpP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "relationship to in-band or out-of-band epp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67883, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1939
    prop.defaultValueStr = "fvAMgmtEpP"
    ...
    prop = PropMeta("str", "tDn", "tDn", 67882, PropCategory.REGULAR)
