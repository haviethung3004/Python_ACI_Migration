...
# ##################################################
class RsDcToL3Dom(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.intersight.RsDcToL3Dom", "cobra.model.l3.Dom")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcToL3Dom"
    meta.rnFormat = "rsdcToL3Dom"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67526, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 67533, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
