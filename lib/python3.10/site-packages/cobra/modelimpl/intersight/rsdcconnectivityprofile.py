...
# ##################################################
class RsDcConnectivityProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.intersight.RsDcConnectivityProfile", "cobra.model.intersight.SwitchConnectivityProfile")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcConnectivityProfile"
    meta.rnFormat = "rsdcConnectivityProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to connectivity profile"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68068, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19921
    prop.defaultValueStr = "intersightSwitchConnectivityProfile"
    prop._addConstant("intersightSwitchConnectivityProfile", None, 19921)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68067, PropCategory.REGULAR)
