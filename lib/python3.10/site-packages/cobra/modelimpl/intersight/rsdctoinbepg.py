...
# ##################################################
class RsDcToInbEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.intersight.RsDcToInbEpg", "cobra.model.mgmt.InB")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcToInbEpg"
    meta.rnFormat = "rsdcToInbEpg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Connectivity via in-band"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67524, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67523, PropCategory.REGULAR)
