...
class RsDcToEpg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.intersight.RsDcToEpg", "cobra.model.fv.ATg")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcToEpg"
    meta.rnFormat = "rsdcToEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67886, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67885, PropCategory.REGULAR)
