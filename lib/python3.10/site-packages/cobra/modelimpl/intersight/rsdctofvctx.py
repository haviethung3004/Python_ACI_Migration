...
# ##################################################
class RsDcToFvCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.intersight.RsDcToFvCtx", "cobra.model.fv.CtxDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "intersightRsDcToFvCtx"
    meta.rnFormat = "rsdcToFvCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "relation to fv ctx of the in-band or out-of-band epg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67518, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67517, PropCategory.REGULAR)
