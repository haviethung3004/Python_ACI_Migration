...
class UpgJob(Mo):
    ...
    prop = PropMeta("str", "smuOperation", "smuOperation", 68836, PropCategory.REGULAR)
    prop.label = "SMU operation type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "smuInstall"
    prop._addConstant("smuInstall", "smu-add-and-activate/commit", 0)
    prop._addConstant("smuUninstall", "smu-uninstall", 1)
    meta.props.add("smuOperation", prop)

    prop = PropMeta("str", "smuOperationFlags", "smuOperationFlags", 63692, PropCategory.REGULAR)
    prop.label = "SMU Operation Flags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "smuReloadImmediate"
    prop._addConstant("patchHotSmu", "indicates-a-hot-smu", 2)
    prop._addConstant("smuReloadImmediate", "immediate-reload-of-the-smuoperation", 0)
    prop._addConstant("smuReloadSkip", "skip-reloading-node-after-smuoperation", 1)
    meta.props.add("smuOperationFlags", prop)
    ...
    prop = PropMeta("str", "suppBit", "suppBit", 69893, PropCategory.REGULAR)
    prop.label = "Supported Bit"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("32", "32", 1)
    prop._addConstant("64", "64", 2)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("suppBit", prop)

    prop = PropMeta("str", "targetFileName", "targetFileName", 69894, PropCategory.REGULAR)
    prop.label = "Target FileName"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("targetFileName", prop)
    ...
    prop._addConstant("postupgradepending", "pending-postupgrade-callback(s)-execution", 12)
    prop._addConstant("scheduled", "scheduled", 0)
    prop._addConstant("sendsuccesspending", "send-success-status-is-pending", 11)
