...
class MaintP(Mo):
    ...
    prop = PropMeta("str", "isModifyByUpgrade", "isModifyByUpgrade", 68892, PropCategory.REGULAR)
    prop.label = "Modify by Upgrade flow"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("isModifyByUpgrade", prop)
    ...
    prop = PropMeta("str", "smuOperation", "smuOperation", 63340, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "smuOperationFlags", "smuOperationFlags", 63392, PropCategory.REGULAR)
