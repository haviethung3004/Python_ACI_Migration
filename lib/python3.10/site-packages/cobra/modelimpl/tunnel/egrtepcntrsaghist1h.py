...
# ##################################################
class EgrTepCntrsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist1h", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist1h"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59059, PropCategory.REGULAR)
