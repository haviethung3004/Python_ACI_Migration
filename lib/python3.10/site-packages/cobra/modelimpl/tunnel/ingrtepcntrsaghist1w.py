...
# ##################################################
class IngrTepCntrsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist1w", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist1w"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59070, PropCategory.REGULAR)
