...
# ##################################################
class IngrTepCntrsAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg1mo", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg1mo"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg1mo', False),
    ]
