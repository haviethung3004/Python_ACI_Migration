...
# ##################################################
class IngrTepCntrsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist15min", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist15min"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.tunnel.IngrTepCntrsAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59065, PropCategory.REGULAR)
