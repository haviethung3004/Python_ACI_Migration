...
# ##################################################
class EgrTepCntrsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist5min", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist5min"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDtunnelEgrTepCntrsAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59064, PropCategory.REGULAR)
