...
# ##################################################
class EgrTepCntrsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist15min", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist15min"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.tunnel.EgrTepCntrsAgHist")

    meta.rnPrefixes = [
        ('HDtunnelEgrTepCntrsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59057, PropCategory.REGULAR)
