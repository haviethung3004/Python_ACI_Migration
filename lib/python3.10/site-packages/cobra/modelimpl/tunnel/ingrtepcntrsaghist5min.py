...
# ##################################################
class IngrTepCntrsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist5min", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist5min"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrsAg5min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59072, PropCategory.REGULAR)
