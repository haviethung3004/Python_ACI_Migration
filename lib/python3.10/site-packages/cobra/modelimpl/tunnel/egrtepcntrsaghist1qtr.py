...
# ##################################################
class EgrTepCntrsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist1qtr", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist1qtr"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDtunnelEgrTepCntrsAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59061, PropCategory.REGULAR)
