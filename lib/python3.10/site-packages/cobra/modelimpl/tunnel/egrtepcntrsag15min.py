...
# ##################################################
class EgrTepCntrsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAg15min", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAg15min"
    meta.rnFormat = "CDtunnelEgrTepCntrsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Egress TEP Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.tunnel.EgrTepCntrsAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDtunnelEgrTepCntrsAg15min', False),
    ]
