...
# ##################################################
class EgrTepCntrsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAg5min", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAg5min"
    meta.rnFormat = "CDtunnelEgrTepCntrsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Egress TEP Counters stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDtunnelEgrTepCntrsAg5min', False),
    ]
