...
# ##################################################
class IngrTepCntrsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist1h", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist1h"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59067, PropCategory.REGULAR)
