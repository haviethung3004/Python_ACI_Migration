...
# ##################################################
class IngrTepCntrsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist1qtr", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist1qtr"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrsAg1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59069, PropCategory.REGULAR)
