...
# ##################################################
class IngrTepCntrsAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg1h", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg1h"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 1 hour"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg1h', False),
    ]
