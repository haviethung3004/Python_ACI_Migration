...
# ##################################################
class IngrTepCntrsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist1year", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist1year"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59071, PropCategory.REGULAR)
