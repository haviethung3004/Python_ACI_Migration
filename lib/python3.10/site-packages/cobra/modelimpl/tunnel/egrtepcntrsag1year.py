...
# ##################################################
class EgrTepCntrsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAg1year", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAg1year"
    meta.rnFormat = "CDtunnelEgrTepCntrsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Egress TEP Counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDtunnelEgrTepCntrsAg1year', False),
    ]
