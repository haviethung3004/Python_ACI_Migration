...
# ##################################################
class IngrTepCntrsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist1mo", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist1mo"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 1 month"
    ...
    meta.rnPrefixes = [
        ('HDtunnelIngrTepCntrsAg1mo-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59068, PropCategory.REGULAR)
