...
# ##################################################
class IngrTepCntrsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg15min", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg15min"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.tunnel.IngrTepCntrsAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg15min', False),
    ]
