...
# ##################################################
class EgrTepCntrsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist1w", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist1w"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59062, PropCategory.REGULAR)
