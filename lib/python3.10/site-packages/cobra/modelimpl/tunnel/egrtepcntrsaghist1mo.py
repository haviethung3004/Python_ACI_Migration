...
# ##################################################
class EgrTepCntrsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist1mo", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist1mo"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59060, PropCategory.REGULAR)
