...
# ##################################################
class EgrTepCntrsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist1year", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist1year"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDtunnelEgrTepCntrsAg1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59063, PropCategory.REGULAR)
