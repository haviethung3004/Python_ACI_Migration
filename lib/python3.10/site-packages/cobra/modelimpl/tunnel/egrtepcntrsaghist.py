...
# ##################################################
class EgrTepCntrsAgHist(Mo):
    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist"


    meta.moClassName = "tunnelEgrTepCntrsAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats"
    ...
    prop = PropMeta("str", "dropBytesCum", "dropBytesCum", 59080, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Drop Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesCum", prop)

    prop = PropMeta("str", "dropBytesPer", "dropBytesPer", 59081, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Drop Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesPer", prop)

    prop = PropMeta("str", "dropBytesRate", "dropBytesRate", 59085, PropCategory.IMPLICIT_RATE)
    prop.label = "Drop Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRate", prop)

    prop = PropMeta("str", "dropBytesSpct", "dropBytesSpct", 59082, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Drop Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesSpct", prop)

    prop = PropMeta("str", "dropBytesThr", "dropBytesThr", 59083, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropBytesTr", "dropBytesTr", 59084, PropCategory.IMPLICIT_TREND)
    prop.label = "Drop Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesTr", prop)

    prop = PropMeta("str", "dropPktsCum", "dropPktsCum", 59093, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Drop Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsCum", prop)

    prop = PropMeta("str", "dropPktsPer", "dropPktsPer", 59094, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Drop Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsPer", prop)

    prop = PropMeta("str", "dropPktsRate", "dropPktsRate", 59098, PropCategory.IMPLICIT_RATE)
    prop.label = "Drop Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsRate", prop)

    prop = PropMeta("str", "dropPktsSpct", "dropPktsSpct", 59095, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Drop Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsSpct", prop)

    prop = PropMeta("str", "dropPktsThr", "dropPktsThr", 59096, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropPktsTr", "dropPktsTr", 59097, PropCategory.IMPLICIT_TREND)
    prop.label = "Drop Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsTr", prop)

    prop = PropMeta("str", "fwdBytesCum", "fwdBytesCum", 59106, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Forwarded Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesCum", prop)

    prop = PropMeta("str", "fwdBytesPer", "fwdBytesPer", 59107, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Forwarded Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesPer", prop)

    prop = PropMeta("str", "fwdBytesRate", "fwdBytesRate", 59111, PropCategory.IMPLICIT_RATE)
    prop.label = "Forwarded Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesRate", prop)

    prop = PropMeta("str", "fwdBytesSpct", "fwdBytesSpct", 59108, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Forwarded Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesSpct", prop)

    prop = PropMeta("str", "fwdBytesThr", "fwdBytesThr", 59109, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fwdBytesTr", "fwdBytesTr", 59110, PropCategory.IMPLICIT_TREND)
    prop.label = "Forwarded Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesTr", prop)

    prop = PropMeta("str", "fwdPktsCum", "fwdPktsCum", 59119, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Forwarded Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsCum", prop)

    prop = PropMeta("str", "fwdPktsPer", "fwdPktsPer", 59120, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Forwarded Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsPer", prop)

    prop = PropMeta("str", "fwdPktsRate", "fwdPktsRate", 59124, PropCategory.IMPLICIT_RATE)
    prop.label = "Forwarded Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsRate", prop)

    prop = PropMeta("str", "fwdPktsSpct", "fwdPktsSpct", 59121, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Forwarded Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsSpct", prop)

    prop = PropMeta("str", "fwdPktsThr", "fwdPktsThr", 59122, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fwdPktsTr", "fwdPktsTr", 59123, PropCategory.IMPLICIT_TREND)
