...
# ##################################################
class IngrTepCntrsAg1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg1w", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg1w"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 1 week"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg1w', False),
    ]
