...
class If(Mo):
    ...
    meta.writeAccessMask = 0x4805
    meta.readAccessMask = 0x86815
    ...
    prop = PropMeta("str", "isSiteAwarePcEnfEnabled", "isSiteAwarePcEnfEnabled", 69698, PropCategory.REGULAR)
    prop.label = "Site aware policy enforcement is enabled for vrf"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("isSiteAwarePcEnfEnabled", prop)
    ...
    prop = PropMeta("str", "siteId", "siteId", 69164, PropCategory.REGULAR)
    prop.label = "Site Id"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 1000)]
    ...
    prop._addConstant("tunnel:IfisSiteAwarePcEnfEnabled_failed_flag", None, 1024)
    prop._addConstant("tunnel:IfkeepAlvIntvl_failed_flag", None, 2048)
    prop._addConstant("tunnel:IfkeepAlvRetries_failed_flag", None, 4096)
    prop._addConstant("tunnel:IflcC_failed_flag", None, 8192)
    prop._addConstant("tunnel:IflcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("tunnel:Ifmac_failed_flag", None, 16384)
    prop._addConstant("tunnel:IfmodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("tunnel:IfmonPolDn_failed_flag", None, 32768)
    prop._addConstant("tunnel:Ifname_failed_flag", None, 1)
    prop._addConstant("tunnel:IfsiteId_failed_flag", None, 262144)
    prop._addConstant("tunnel:Ifsrc_failed_flag", None, 524288)
    prop._addConstant("tunnel:IftLayer_failed_flag", None, 1048576)
    prop._addConstant("tunnel:IftType_failed_flag", None, 2097152)
    prop._addConstant("tunnel:Iftype_failed_flag", None, 33554432)
    prop._addConstant("tunnel:IfunderlayVrfName_failed_flag", None, 67108864)
    prop._addConstant("tunnel:Ifv6Src_failed_flag", None, 134217728)
    prop._addConstant("tunnel:IfvrfName_failed_flag", None, 268435456)
