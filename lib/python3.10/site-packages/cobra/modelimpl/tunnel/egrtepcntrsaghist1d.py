...
# ##################################################
class EgrTepCntrsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.EgrTepCntrsAgHist1d", "Egress TEP Counters")
    ...
    meta.moClassName = "tunnelEgrTepCntrsAgHist1d"
    meta.rnFormat = "HDtunnelEgrTepCntrsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Egress TEP Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59058, PropCategory.REGULAR)
