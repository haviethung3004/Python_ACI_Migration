...
# ##################################################
class IngrTepCntrsAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg1qtr", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg1qtr"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg1qtr', False),
    ]
