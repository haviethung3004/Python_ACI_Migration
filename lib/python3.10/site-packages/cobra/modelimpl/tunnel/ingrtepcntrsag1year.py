...
# ##################################################
class IngrTepCntrsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg1year", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg1year"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg1year', False),
    ]
