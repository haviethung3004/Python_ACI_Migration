...
# ##################################################
class IngrTepCntrsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAgHist1d", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAgHist1d"
    meta.rnFormat = "HDtunnelIngrTepCntrsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Ingress TEP Counters stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59066, PropCategory.REGULAR)
