...
# ##################################################
class IngrTepCntrsAg5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg5min", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg5min"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg5min', False),
    ]
