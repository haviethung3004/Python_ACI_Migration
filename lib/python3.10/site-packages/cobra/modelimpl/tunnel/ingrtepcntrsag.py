...
# ##################################################
class IngrTepCntrsAg(Mo):
    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg"


    meta.moClassName = "tunnelIngrTepCntrsAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats"
    ...
    prop = PropMeta("str", "dropBytesCum", "dropBytesCum", 59125, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Drop Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesCum", prop)

    prop = PropMeta("str", "dropBytesPer", "dropBytesPer", 59126, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Drop Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesPer", prop)

    prop = PropMeta("str", "dropBytesRate", "dropBytesRate", 59131, PropCategory.IMPLICIT_RATE)
    prop.label = "Drop Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesRate", prop)

    prop = PropMeta("str", "dropBytesSpct", "dropBytesSpct", 59127, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Drop Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesSpct", prop)

    prop = PropMeta("str", "dropBytesThr", "dropBytesThr", 59128, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropBytesTr", "dropBytesTr", 59130, PropCategory.IMPLICIT_TREND)
    prop.label = "Drop Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesTr", prop)

    prop = PropMeta("str", "dropBytesTrBase", "dropBytesTrBase", 59129, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Drop Bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBytesTrBase", prop)

    prop = PropMeta("str", "dropPktsCum", "dropPktsCum", 59138, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Drop Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsCum", prop)

    prop = PropMeta("str", "dropPktsPer", "dropPktsPer", 59139, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Drop Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsPer", prop)

    prop = PropMeta("str", "dropPktsRate", "dropPktsRate", 59144, PropCategory.IMPLICIT_RATE)
    prop.label = "Drop Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsRate", prop)

    prop = PropMeta("str", "dropPktsSpct", "dropPktsSpct", 59140, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Drop Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsSpct", prop)

    prop = PropMeta("str", "dropPktsThr", "dropPktsThr", 59141, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropPktsTr", "dropPktsTr", 59143, PropCategory.IMPLICIT_TREND)
    prop.label = "Drop Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsTr", prop)

    prop = PropMeta("str", "dropPktsTrBase", "dropPktsTrBase", 59142, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Drop Packets trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPktsTrBase", prop)

    prop = PropMeta("str", "fwdBytesCum", "fwdBytesCum", 59151, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Forwarded Bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesCum", prop)

    prop = PropMeta("str", "fwdBytesPer", "fwdBytesPer", 59152, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Forwarded Bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesPer", prop)

    prop = PropMeta("str", "fwdBytesRate", "fwdBytesRate", 59157, PropCategory.IMPLICIT_RATE)
    prop.label = "Forwarded Bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesRate", prop)

    prop = PropMeta("str", "fwdBytesSpct", "fwdBytesSpct", 59153, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Forwarded Bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesSpct", prop)

    prop = PropMeta("str", "fwdBytesThr", "fwdBytesThr", 59154, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fwdBytesTr", "fwdBytesTr", 59156, PropCategory.IMPLICIT_TREND)
    prop.label = "Forwarded Bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesTr", prop)

    prop = PropMeta("str", "fwdBytesTrBase", "fwdBytesTrBase", 59155, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Forwarded Bytes trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdBytesTrBase", prop)

    prop = PropMeta("str", "fwdPktsCum", "fwdPktsCum", 59164, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "Forwarded Packets cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsCum", prop)

    prop = PropMeta("str", "fwdPktsPer", "fwdPktsPer", 59165, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "Forwarded Packets periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsPer", prop)

    prop = PropMeta("str", "fwdPktsRate", "fwdPktsRate", 59170, PropCategory.IMPLICIT_RATE)
    prop.label = "Forwarded Packets rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsRate", prop)

    prop = PropMeta("str", "fwdPktsSpct", "fwdPktsSpct", 59166, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Forwarded Packets suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsSpct", prop)

    prop = PropMeta("str", "fwdPktsThr", "fwdPktsThr", 59167, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "fwdPktsTr", "fwdPktsTr", 59169, PropCategory.IMPLICIT_TREND)
    prop.label = "Forwarded Packets trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("fwdPktsTr", prop)

    prop = PropMeta("str", "fwdPktsTrBase", "fwdPktsTrBase", 59168, PropCategory.IMPLICIT_TREND_BASE)
