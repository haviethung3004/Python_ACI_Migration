...
# ##################################################
class IngrTepCntrsAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.tunnel.IngrTepCntrsAg1d", "Ingress TEP Counters")
    ...
    meta.moClassName = "tunnelIngrTepCntrsAg1d"
    meta.rnFormat = "CDtunnelIngrTepCntrsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated Ingress TEP Counters stats in 1 day"
    ...
    meta.rnPrefixes = [
        ('CDtunnelIngrTepCntrsAg1d', False),
    ]
