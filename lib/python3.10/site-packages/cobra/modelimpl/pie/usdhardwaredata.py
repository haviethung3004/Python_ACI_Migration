...
# ##################################################
class UsdHardwareData(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pie.UsdHardwareData")

    meta.moClassName = "pieUsdHardwareData"
    meta.rnFormat = "hardware_data"
    meta.category = MoCategory.REGULAR
    meta.label = "USD Hardware data for the given usd port"
    ...
    prop = PropMeta("str", "adminState", "adminState", 64149, PropCategory.REGULAR)
    prop.label = "Admin state value for the given USD port"
    prop.isOper = True
    meta.props.add("adminState", prop)

    prop = PropMeta("str", "bkMap", "bkMap", 64157, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "duplex", "duplex", 64153, PropCategory.REGULAR)
    prop.label = "Hardware duplex value for the given USD port"
    prop.isOper = True
    meta.props.add("duplex", prop)

    prop = PropMeta("str", "eventId", "eventId", 64167, PropCategory.REGULAR)
    prop.label = "Event id as received from PIE"
    prop.isOper = True
    meta.props.add("eventId", prop)

    prop = PropMeta("str", "fec", "fec", 64156, PropCategory.REGULAR)
    prop.label = "Operating fec value for the given USD port"
    prop.isOper = True
    meta.props.add("fec", prop)

    prop = PropMeta("str", "glctPresent", "glctPresent", 64161, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "hwPortPresent", "hwPortPresent", 64165, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ipg", "ipg", 64158, PropCategory.REGULAR)
    prop.label = "Operating ipg value for the given USD port"
    prop.isOper = True
    meta.props.add("ipg", prop)

    prop = PropMeta("str", "loopback", "loopback", 64152, PropCategory.REGULAR)
    prop.label = "Hardware loopback value for the given USD port"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    ...
    prop = PropMeta("str", "mdix", "mdix", 64154, PropCategory.REGULAR)
    prop.label = "Hardware mdix value for the given USD port"
    prop.isOper = True
    ...
    prop = PropMeta("str", "mtuValue", "mtuValue", 64151, PropCategory.REGULAR)
    prop.label = "Hardware MTU value for the given USD port"
    prop.isOper = True
    meta.props.add("mtuValue", prop)

    prop = PropMeta("str", "operState", "operState", 64150, PropCategory.REGULAR)
    prop.label = "Oper state value for the given USD port"
    prop.isOper = True
    meta.props.add("operState", prop)

    prop = PropMeta("str", "phyPort", "phyPort", 64163, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prbs", "prbs", 64159, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "purged", "purged", 64164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "qsaPresent", "qsaPresent", 64162, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "speed", "speed", 64155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "timestamp", "timestamp", 64166, PropCategory.REGULAR)
    prop.label = "Time stamp for the link event"
    prop.isOper = True
    meta.props.add("timestamp", prop)

    prop = PropMeta("str", "xcvrPresent", "xcvrPresent", 64160, PropCategory.REGULAR)
