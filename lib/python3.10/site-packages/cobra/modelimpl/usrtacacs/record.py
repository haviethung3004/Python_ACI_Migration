...
class Record(Mo):
    ...
    meta = ClassMeta("cobra.model.usrtacacs.Record")

    meta.moClassName = "usrtacacsRecord"
    meta.rnFormat = "usrtacacs"
    meta.category = MoCategory.REGULAR
    meta.label = "User TACACS+ Record"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68674, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68675, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "message", "message", 68668, PropCategory.REGULAR)
    prop.label = "TACACS+ Message"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "severity", "severity", 68667, PropCategory.REGULAR)
