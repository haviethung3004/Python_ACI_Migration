...
class IfP(Mo):
    ...
    meta = ClassMeta("cobra.model.mpls.IfP")

    meta.moClassName = "mplsIfP"
    meta.rnFormat = "mplsIfP"
    meta.category = MoCategory.REGULAR
    meta.label = "Interface config"
    ...
    meta.childClasses.add("cobra.model.mpls.RsIfPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.RsIfPol", "rsIfPol"))
    ...
    meta.superClasses.add("cobra.model.mpls.AIfP")

    meta.rnPrefixes = [
        ('mplsIfP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56755, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56756, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56749, PropCategory.REGULAR)
