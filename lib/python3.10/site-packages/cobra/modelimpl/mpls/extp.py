...
class ExtP(Mo):
    ...
    meta = ClassMeta("cobra.model.mpls.ExtP")

    meta.moClassName = "mplsExtP"
    meta.rnFormat = "mplsextp"
    ...
    meta.childClasses.add("cobra.model.mpls.RsLabelPol")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.RsLabelPol", "rsLabelPol"))
    ...
    meta.superClasses.add("cobra.model.mpls.AExtP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 56751, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56752, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56747, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 56726, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "mpls"
    prop.defaultValueStr = "mpls"
