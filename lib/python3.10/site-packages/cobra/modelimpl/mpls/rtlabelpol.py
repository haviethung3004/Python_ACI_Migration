...
class RtLabelPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mpls.RtLabelPol", "cobra.model.mpls.ExtP")

    meta.moClassName = "mplsRtLabelPol"
    meta.rnFormat = "rtlabelPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56742, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16649
    prop.defaultValueStr = "mplsExtP"
    prop._addConstant("mplsExtP", None, 16649)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56741, PropCategory.REGULAR)
