...
# ##################################################
class NodeSidPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mpls.NodeSidPDef")

    meta.moClassName = "mplsNodeSidPDef"
    meta.rnFormat = "nodesidpdef-%(sidoffset)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Node Sid Profile Definition"
    ...
    meta.parentClasses.add("cobra.model.l3ext.LoopBackIfPDef")
    ...
    prop = PropMeta("str", "sidoffset", "sidoffset", 56738, PropCategory.REGULAR)
