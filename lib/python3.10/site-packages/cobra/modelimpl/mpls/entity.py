...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.mpls.Entity")

    meta.moClassName = "mplsEntity"
    meta.rnFormat = "mpls"
    meta.category = MoCategory.REGULAR
    meta.label = "MPLS Entity"
    ...
    meta.childClasses.add("cobra.model.mpls.LabelRange")

    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.LabelRange", "labelrange"))
