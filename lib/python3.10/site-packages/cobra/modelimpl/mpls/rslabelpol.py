...
class RsLabelPol(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.mpls.RsLabelPol", "cobra.model.mpls.LabelPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mplsRsLabelPol"
    meta.rnFormat = "rsLabelPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Mpls LabelPol Relation"
    ...
    prop = PropMeta("str", "annotation", "annotation", 56753, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56754, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56748, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56740, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16660
    prop.defaultValueStr = "mplsLabelPol"
    prop._addConstant("mplsLabelPol", None, 16660)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56739, PropCategory.REGULAR)
