...
class IfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.mpls.IfPol")

    meta.moClassName = "mplsIfPol"
    meta.rnFormat = "mplsifpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Mpls Interface Policy"
    ...
    meta.childClasses.add("cobra.model.mpls.RtIfPol")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.RtIfPol", "rtifPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 56759, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56760, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 56735, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
