...
class RtIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.mpls.RtIfPol", "cobra.model.mpls.IfP")

    meta.moClassName = "mplsRtIfPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56746, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16654
    prop.defaultValueStr = "mplsIfP"
    prop._addConstant("mplsIfP", None, 16654)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56745, PropCategory.REGULAR)
