...
class RsIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.mpls.RsIfPol", "cobra.model.mpls.IfPol")
    meta.targetNameProps["name"] = "tnMplsIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "mplsRsIfPol"
    meta.rnFormat = "rsIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Mpls IfPol Relation"
    ...
    prop = PropMeta("str", "annotation", "annotation", 56757, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56758, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56750, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56744, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16657
    prop.defaultValueStr = "mplsIfPol"
    ...
    prop = PropMeta("str", "tnMplsIfPolName", "tnMplsIfPolName", 56743, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnMplsIfPolName", prop)
