...
class VaInfo(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.VaInfo")

    meta.moClassName = "vmmVaInfo"
    meta.rnFormat = "va-%(nodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Virtual Attach Info"
    ...
    meta.parentClasses.add("cobra.model.vmm.VaPodInfo")
    ...
    prop = PropMeta("str", "address", "address", 55822, PropCategory.REGULAR)
    prop.label = "IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("address", prop)

    prop = PropMeta("str", "attachedAgents", "attachedAgents", 55825, PropCategory.REGULAR)
    prop.label = "Attached Agent Count"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("attachedAgents", prop)
    ...
    prop = PropMeta("str", "fabricSt", "fabricSt", 55823, PropCategory.REGULAR)
    ...
    prop._addConstant("maintenance", "maintenance", 9)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 55824, PropCategory.REGULAR)
