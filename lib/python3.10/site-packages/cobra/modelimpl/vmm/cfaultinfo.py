...
# ##################################################
class CFaultInfo(Mo):
    meta = ClassMeta("cobra.model.vmm.CFaultInfo")

    meta.isAbstract = True
    meta.moClassName = "vmmCFaultInfo"


    meta.moClassName = "vmmCFaultInfo"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Class to collect cluster fault"
    ...
    meta.concreteSubClasses.add("cobra.model.vmm.ClusterFaultInfo")
    ...
    prop = PropMeta("str", "faultCode", "faultCode", 62996, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
