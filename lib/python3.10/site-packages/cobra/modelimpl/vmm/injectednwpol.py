...
# ##################################################
class InjectedNwPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.InjectedNwPol")

    meta.moClassName = "vmmInjectedNwPol"
    meta.rnFormat = "nwpol-[%(name)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Injected Network Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 57094, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "egress", "egress", 57923, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.regex = ['[a-zA-Z0-9\\[\\]\\{\\}\\:\\*\\,\\/\\.]+']
    meta.props.add("egress", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57095, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ingress", "ingress", 57922, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.regex = ['[a-zA-Z0-9\\[\\]\\{\\}\\:\\*\\,\\/\\.]+']
    meta.props.add("ingress", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57090, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 57085, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
