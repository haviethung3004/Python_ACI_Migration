...
class CtrlrP(Mo):
    ...
    meta.childClasses.add("cobra.model.vmm.ClusterCtrlrP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.ClusterCtrlrP", "clusterctrlr-"))
    ...
    prop = PropMeta("str", "aosVersion", "aosVersion", 70045, PropCategory.REGULAR)
    ...
    prop._addConstant("invalid-cluster-ctrlr", "there-are-config-issues-on-cluster-ctrlr.", 4096)
    ...
    prop._addConstant("missing-cluster-ctrlr", "nutanix-domain-should-have-a-valid-cluster-controller-association.", 2048)
