...
# ##################################################
class ClusterCtrlrP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.ClusterCtrlrP")

    meta.moClassName = "vmmClusterCtrlrP"
    meta.rnFormat = "clusterctrlr-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "VMM Cluster Controller"
    ...
    meta.childClasses.add("cobra.model.vmm.RsClusterAcc")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.RsClusterAcc", "rsclusterAcc"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 69830, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69831, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69824, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 69800, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
