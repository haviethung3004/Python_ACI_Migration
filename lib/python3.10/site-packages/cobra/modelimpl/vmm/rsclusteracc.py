...
# ##################################################
class RsClusterAcc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vmm.RsClusterAcc", "cobra.model.vmm.UsrAccP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vmmRsClusterAcc"
    meta.rnFormat = "rsclusterAcc"
    ...
    prop = PropMeta("str", "annotation", "annotation", 69832, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69833, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69825, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69809, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69808, PropCategory.REGULAR)
