...
class EpPD(Mo):
    ...
    meta.childClasses.add("cobra.model.vmm.AddrMgmtPolCont")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vmm.AddrMgmtPolCont", "ipampolcont"))
