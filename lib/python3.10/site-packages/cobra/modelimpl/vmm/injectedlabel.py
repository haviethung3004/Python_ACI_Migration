...
# ##################################################
class InjectedLabel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.InjectedLabel")

    meta.moClassName = "vmmInjectedLabel"
    meta.rnFormat = "key-[%(name)s]-val-%(value)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Injected Label"
    ...
    prop = PropMeta("str", "annotation", "annotation", 57096, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57097, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57091, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 57074, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 57075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, name, value, markDirty=True, **creationProps):
        namingVals = [name, value]
