...
class AddrMgmtPolCont(Mo):
    ...
    meta = ClassMeta("cobra.model.vmm.AddrMgmtPolCont")

    meta.moClassName = "vmmAddrMgmtPolCont"
    ...
    prop = PropMeta("str", "addrMgmtPoolDn", "addrMgmtPoolDn", 69764, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ipamDhcpOverride", "ipamDhcpOverride", 69763, PropCategory.REGULAR)
    prop.label = "DHCP server address override"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipamDhcpOverride", prop)

    prop = PropMeta("str", "ipamEnabled", "ipamEnabled", 69761, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ipamGateway", "ipamGateway", 69762, PropCategory.REGULAR)
