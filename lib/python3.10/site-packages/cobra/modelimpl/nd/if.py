...
class If(Mo):
    ...
    prop = PropMeta("str", "nudRetryBase", "nudRetryBase", 60975, PropCategory.REGULAR)
    prop.label = "Neighbor Unreachability Detection Retry Base"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 3)]
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("nudRetryBase", prop)

    prop = PropMeta("str", "nudRetryInterval", "nudRetryInterval", 60976, PropCategory.REGULAR)
    prop.label = "Neighbor Unreachability Detection Retry Interval"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1000, 10000)]
    prop.defaultValue = 1000
    prop.defaultValueStr = "1000"
    meta.props.add("nudRetryInterval", prop)

    prop = PropMeta("str", "nudRetryMaxAttempts", "nudRetryMaxAttempts", 60977, PropCategory.REGULAR)
    prop.label = "Neighbor Unreachability Detection Retry Maximum Attempts"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 10)]
    prop.defaultValue = 3
    prop.defaultValueStr = "3"
    meta.props.add("nudRetryMaxAttempts", prop)
