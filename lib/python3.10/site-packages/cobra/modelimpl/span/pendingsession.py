...
# ##################################################
class PendingSession(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.span.PendingSession")

    meta.moClassName = "spanPendingSession"
    meta.rnFormat = "sess-[%(rsDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Pending unconstrcucted sessions"
    ...
    prop = PropMeta("str", "rsDn", "rsDn", 63134, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("rsDn", prop)
    ...
    prop = PropMeta("str", "tries", "tries", 63205, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("tries", prop)

    meta.namingProps.append(getattr(meta.props, "rsDn"))
    getattr(meta.props, "rsDn").needDelimiter = True

    def __init__(self, parentMoOrDn, rsDn, markDirty=True, **creationProps):
        namingVals = [rsDn]
