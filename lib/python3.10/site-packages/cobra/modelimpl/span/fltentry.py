...
class FltEntry(Mo):
    ...
    meta.childClasses.add("cobra.model.span.Extended")

    meta.childNamesAndRnPrefix.append(("cobra.model.span.Extended", "extended-"))
    ...
    prop._addConstant("span:FltEntrymodTs_failed_flag", None, 1152921504606846976)
