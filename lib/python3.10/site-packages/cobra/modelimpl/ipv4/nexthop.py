...
class Nexthop(Mo):
    ...
    prop._addConstant("disable-dp-learn", "data-plane-learn-is-disabled-for-subnet", 32)
    prop._addConstant("dst-unreachable", "destination-unreachable", 4)
    prop._addConstant("local-subnet", "local-subnet-route", 16)
    prop._addConstant("pervasive", "pervasive-route", 1)
    prop._addConstant("security-policy-incomplete", "security-policy-is-incomplete-for-subnet", 64)
    ...
    prop._addConstant("ipv4:NexthopmodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("no-nh", "no-nexthop", 23)
    prop._addConstant("no-nh-ep-cfg", "nexthop-ep-reachability-not-configured", 27)
    prop._addConstant("proxy-tunnel-down", "spine-proxy-tunnel-down", 26)
    prop._addConstant("rnh-not-resolved", "recursive-nexthop-not-resolved", 18)
    prop._addConstant("rnh-unresolved", "rnh-unresolved", 25)
    prop._addConstant("route-exists", "route-exists-with-no-or-different-pin-number", 17)
    prop._addConstant("rt-exists", "route-exists", 24)
    prop._addConstant("rt-unreachable", "route-unreachable", 2)
    prop._addConstant("track-id-invalid", "track-id-is-invalid", 28)
    prop._addConstant("track-state-down", "tracking-state-is-down", 30)
    prop._addConstant("track-state-invalid", "tracking-state-is-invalid", 29)
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("up", "up", 1)
    prop._addConstant("vrf-down", "vrf-down", 21)
    prop._addConstant("vrf-err", "invalid-vrf-error", 22)
