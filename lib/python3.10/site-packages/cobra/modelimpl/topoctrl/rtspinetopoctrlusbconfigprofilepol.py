...
# ##################################################
class RtSpineTopoctrlUsbConfigProfilePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.topoctrl.RtSpineTopoctrlUsbConfigProfilePol", "cobra.model.infra.SpineAccNodePGrp")

    meta.moClassName = "topoctrlRtSpineTopoctrlUsbConfigProfilePol"
    meta.rnFormat = "rtinfraSpineTopoctrlUsbConfigProfilePol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraSpineTopoctrlUsbConfigProfilePol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 64581, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 64580, PropCategory.REGULAR)
