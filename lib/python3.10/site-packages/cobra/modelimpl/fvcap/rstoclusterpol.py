...
# ##################################################
class RsToClusterPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fvcap.RsToClusterPol", "cobra.model.infra.ClusterPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvcapRsToClusterPol"
    meta.rnFormat = "rsToClusterPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67631, PropCategory.REGULAR)
