...
class Inst(Mo):
    ...
    prop = PropMeta("str", "gracePeriod", "gracePeriod", 63906, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxLimitReached", "maxLimitReached", 65465, PropCategory.REGULAR)
    prop.label = "Reached maximum supported logical port limit"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mcpMode", "mcpMode", 63905, PropCategory.REGULAR)
    prop.label = "Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
