...
# ##################################################
class RtProxyServer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.proxy.RtProxyServer", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "proxyRtProxyServer"
    meta.rnFormat = "rtaaaProxyServer-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67553, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67552, PropCategory.REGULAR)
