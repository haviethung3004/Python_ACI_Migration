...
# ##################################################
class APodFilter(Mo):
    meta = ClassMeta("cobra.model.hostprot.APodFilter")

    meta.isAbstract = True
    meta.moClassName = "hostprotAPodFilter"


    meta.moClassName = "hostprotAPodFilter"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Endpoint Label"
    ...
    prop = PropMeta("str", "key", "key", 68387, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "operator", "operator", 68389, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
