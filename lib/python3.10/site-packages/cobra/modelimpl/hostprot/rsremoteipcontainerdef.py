...
# ##################################################
class RsRemoteIpContainerDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hostprot.RsRemoteIpContainerDef", "cobra.model.hostprot.RemoteIpContainer")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hostprotRsRemoteIpContainerDef"
    meta.rnFormat = "rsremoteIpContainerDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68413, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68412, PropCategory.REGULAR)
