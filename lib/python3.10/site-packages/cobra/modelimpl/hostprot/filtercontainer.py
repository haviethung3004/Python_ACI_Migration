...
# ##################################################
class FilterContainer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hostprot.FilterContainer")

    meta.moClassName = "hostprotFilterContainer"
    meta.rnFormat = "filterContainer"
    meta.category = MoCategory.REGULAR
    meta.label = "Remote Ip filter Container"
    ...
    meta.childClasses.add("cobra.model.hostprot.PodFilter")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hostprot.PodFilter", "podfilter-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 68431, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68432, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68419, PropCategory.REGULAR)
