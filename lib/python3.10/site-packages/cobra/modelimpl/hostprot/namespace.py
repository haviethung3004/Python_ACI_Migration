...
class Namespace(Mo):
    ...
    meta = ClassMeta("cobra.model.hostprot.Namespace")

    meta.moClassName = "hostprotNamespace"
    meta.rnFormat = "ns-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Openshift k8s namespace"
    ...
    meta.childClasses.add("cobra.model.hostprot.RemoteIpContainer")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hostprot.RemoteIpContainer", "remoteipcont"))
    ...
    meta.superClasses.add("cobra.model.hostprot.ANamespace")
    ...
    prop = PropMeta("str", "annotation", "annotation", 68429, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68430, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68417, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 68394, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
