...
# ##################################################
class RtRemoteIpContainer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hostprot.RtRemoteIpContainer", "cobra.model.hostprot.Rule")

    meta.moClassName = "hostprotRtRemoteIpContainer"
    meta.rnFormat = "rtremoteIpContainer-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68411, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9843
    prop.defaultValueStr = "hostprotRule"
    prop._addConstant("hostprotRule", None, 9843)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68410, PropCategory.REGULAR)
