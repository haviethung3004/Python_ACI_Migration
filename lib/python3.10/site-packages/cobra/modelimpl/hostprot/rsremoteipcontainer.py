...
# ##################################################
class RsRemoteIpContainer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hostprot.RsRemoteIpContainer", "cobra.model.hostprot.RemoteIpContainer")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hostprotRsRemoteIpContainer"
    meta.rnFormat = "rsremoteIpContainer-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsremoteIpContainer-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 68423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68424, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68409, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19991
    prop.defaultValueStr = "hostprotRemoteIpContainer"
    prop._addConstant("hostprotRemoteIpContainer", None, 19991)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68408, PropCategory.REGULAR)
