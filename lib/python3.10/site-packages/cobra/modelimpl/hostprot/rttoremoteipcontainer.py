...
# ##################################################
class RtToRemoteIpContainer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hostprot.RtToRemoteIpContainer", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "hostprotRtToRemoteIpContainer"
    meta.rnFormat = "rtfvToRemoteIpContainer-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68406, PropCategory.REGULAR)
