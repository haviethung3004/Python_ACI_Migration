...
# ##################################################
class NamespaceDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hostprot.NamespaceDef")

    meta.moClassName = "hostprotNamespaceDef"
    meta.rnFormat = "nsdef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Protection Domain remote ip container"
    ...
    meta.childClasses.add("cobra.model.hostprot.RemoteIpContainerDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hostprot.RemoteIpContainerDef", "remoteipcont"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68418, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 68395, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
