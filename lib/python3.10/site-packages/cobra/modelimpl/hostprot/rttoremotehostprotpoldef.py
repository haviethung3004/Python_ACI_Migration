...
# ##################################################
class RtToRemoteHostprotPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hostprot.RtToRemoteHostprotPolDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "hostprotRtToRemoteHostprotPolDef"
    meta.rnFormat = "rtfvToRemoteHostprotPolDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfvToRemoteHostprotPolDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 68403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68402, PropCategory.REGULAR)
