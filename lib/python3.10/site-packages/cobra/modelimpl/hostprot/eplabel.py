...
class EpLabel(Mo):
    ...
    meta = ClassMeta("cobra.model.hostprot.EpLabel")

    meta.moClassName = "hostprotEpLabel"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68435, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68436, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "key", "key", 68390, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 68391, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
