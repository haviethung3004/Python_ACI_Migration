...
# ##################################################
class RtRemoteIpContainerDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hostprot.RtRemoteIpContainerDef", "cobra.model.hostprot.RuleDef")

    meta.moClassName = "hostprotRtRemoteIpContainerDef"
    meta.rnFormat = "rtremoteIpContainerDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68415, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9844
    prop.defaultValueStr = "hostprotRuleDef"
    prop._addConstant("hostprotRuleDef", None, 9844)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68414, PropCategory.REGULAR)
