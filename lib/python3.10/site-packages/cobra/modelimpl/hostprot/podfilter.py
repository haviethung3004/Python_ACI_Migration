...
class PodFilter(Mo):
    ...
    meta = ClassMeta("cobra.model.hostprot.PodFilter")

    meta.moClassName = "hostprotPodFilter"
    meta.rnFormat = "podfilter-%(key)s-%(operator)s"
    ...
    meta.superClasses.add("cobra.model.hostprot.APodFilter")
    ...
    prop = PropMeta("str", "annotation", "annotation", 68433, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68434, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "key", "key", 68397, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68421, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operator", "operator", 68396, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("doesnotexists", "doesnotexists", 4)
    prop._addConstant("exists", "exists", 3)
    prop._addConstant("in", "in", 1)
    prop._addConstant("notin", "notin", 2)
    ...
    prop = PropMeta("str", "values", "values", 68388, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("values", prop)

    meta.namingProps.append(getattr(meta.props, "key"))
    meta.namingProps.append(getattr(meta.props, "operator"))
    ...
    def __init__(self, parentMoOrDn, key, operator, markDirty=True, **creationProps):
        namingVals = [key, operator]
