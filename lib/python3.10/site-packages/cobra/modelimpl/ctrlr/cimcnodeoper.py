...
# ##################################################
class CimcNodeOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ctrlr.CimcNodeOper")

    meta.moClassName = "ctrlrCimcNodeOper"
    meta.rnFormat = "cimcnodeoper"
    meta.category = MoCategory.REGULAR
    meta.label = "CimcNode Oper"
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 62283, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "mac", "mac", 62282, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 62281, PropCategory.REGULAR)
