...
# ##################################################
class RtCtrlrInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.ctrlr.RtCtrlrInst", "cobra.model.aaa.SecRelnHolder")

    meta.moClassName = "ctrlrRtCtrlrInst"
    meta.rnFormat = "rtaaaCtrlrInst-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63218, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63217, PropCategory.REGULAR)
