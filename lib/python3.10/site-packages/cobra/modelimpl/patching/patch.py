...
class Patch(Mo):
    ...
    meta = ClassMeta("cobra.model.patching.Patch")

    meta.moClassName = "patchingPatch"
    meta.rnFormat = "patch-%(patchFileName)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Patch"
    meta.writeAccessMask = 0x4801
    meta.readAccessMask = 0x4801
    ...
    prop = PropMeta("str", "cfgAction", "cfgAction", 63349, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63356, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 63351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 63352, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operationFlags", "operationFlags", 63393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "patchFileName", "patchFileName", 63345, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "patchTriggerTime", "patchTriggerTime", 63346, PropCategory.REGULAR)
    prop.label = "Patch Trigger Time"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("patchTriggerTime", prop)

    prop = PropMeta("str", "patchType", "patchType", 63350, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "patchingCfgFailedBmp", "patchingCfgFailedBmp", 63360, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("patching:PatchcfgAction_failed_flag", None, 1)
    prop._addConstant("patching:PatchlcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("patching:PatchmodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("patching:PatchmonPolDn_failed_flag", None, 2)
    prop._addConstant("patching:PatchoperationFlags_failed_flag", None, 16)
    prop._addConstant("patching:PatchpatchFileName_failed_flag", None, 32)
    prop._addConstant("patching:PatchpatchTriggerTime_failed_flag", None, 64)
    meta.props.add("patchingCfgFailedBmp", prop)

    prop = PropMeta("str", "patchingCfgFailedTs", "patchingCfgFailedTs", 63362, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("patchingCfgFailedTs", prop)

    prop = PropMeta("str", "patchingCfgState", "patchingCfgState", 63361, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("patchingCfgState", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "patchFileName"))

    def __init__(self, parentMoOrDn, patchFileName, markDirty=True, **creationProps):
        namingVals = [patchFileName]
