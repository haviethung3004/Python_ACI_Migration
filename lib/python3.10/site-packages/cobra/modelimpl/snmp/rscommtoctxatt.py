...
class RsCommToCtxAtt(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 64924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 64925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 15614, PropCategory.REGULAR)
