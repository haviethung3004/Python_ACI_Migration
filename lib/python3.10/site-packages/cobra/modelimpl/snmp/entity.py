...
class Entity(Mo):
    ...
    meta.childClasses.add("cobra.model.snmp.ServerShutdown")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.snmp.ServerShutdown", "servershutdown"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 64920, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 64921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operErr", "operErr", 64861, PropCategory.REGULAR)
