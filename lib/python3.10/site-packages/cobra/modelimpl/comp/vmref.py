...
class VmRef(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.VmRef")

    meta.moClassName = "compVmRef"
    meta.rnFormat = "VmRef-%(vmOid)s"
    ...
    prop = PropMeta("str", "verifyCount", "verifyCount", 65450, PropCategory.REGULAR)
    prop.label = "How many we have to tried to verify VM"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("verifyCount", prop)

    prop = PropMeta("str", "vmOid", "vmOid", 65449, PropCategory.REGULAR)
    prop.label = "Vm Oid"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
