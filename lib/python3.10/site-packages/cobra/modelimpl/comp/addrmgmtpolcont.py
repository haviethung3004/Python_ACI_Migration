...
# ##################################################
class AddrMgmtPolCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.AddrMgmtPolCont")

    meta.moClassName = "compAddrMgmtPolCont"
    meta.rnFormat = "ipampolcont"
    meta.category = MoCategory.REGULAR
    meta.label = "VM address management policy container"
    ...
    meta.childClasses.add("cobra.model.comp.AddrMgmtPool")
    meta.childClasses.add("cobra.model.comp.RsFvAddrMgmtPool")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsFvAddrMgmtPool", "rsFvAddrMgmtPool"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.AddrMgmtPool", "ipampool"))
    ...
    prop = PropMeta("str", "addrMgmtPoolDn", "addrMgmtPoolDn", 69779, PropCategory.REGULAR)
    prop.label = "Reference to Address Management Policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("addrMgmtPoolDn", prop)
    ...
    prop = PropMeta("str", "ipamDhcpOverride", "ipamDhcpOverride", 69778, PropCategory.REGULAR)
    prop.label = "DHCP server address override"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipamDhcpOverride", prop)

    prop = PropMeta("str", "ipamEnabled", "ipamEnabled", 69776, PropCategory.REGULAR)
    prop.label = "Enable IP Adress Management for the EPG"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("ipamEnabled", prop)

    prop = PropMeta("str", "ipamGateway", "ipamGateway", 69777, PropCategory.REGULAR)
    prop.label = "Gateway address assigned to VMs when using IPAM"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipamGateway", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69826, PropCategory.REGULAR)
