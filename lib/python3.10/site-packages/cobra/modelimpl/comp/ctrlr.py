...
class Ctrlr(Mo):
    ...
    meta.childClasses.add("cobra.model.comp.ClusterCtrlrCont")
    meta.childClasses.add("cobra.model.comp.ClusterInfo")
    meta.childClasses.add("cobra.model.comp.ClusterNodeCont")
    ...
    meta.childClasses.add("cobra.model.comp.HvAdjTaskCont")
    ...
    meta.childClasses.add("cobra.model.comp.NodeCont")
    ...
    meta.childClasses.add("cobra.model.comp.RtHvNicToCtrlr")
    ...
    meta.childClasses.add("cobra.model.comp.VmInfoCont")
    ...
    meta.childClasses.add("cobra.model.hvs.SecurityPolCont")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHvNicToCtrlr", "rtfvHvNicToCtrlr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ClusterCtrlrCont", "clusterctrlrcont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ClusterNodeCont", "clusterNodeCont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvAdjTaskCont", "hvAdjTaskCont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.VmInfoCont", "vmInfoCont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.SecurityPolCont", "secpolcont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.NodeCont", "nodeCont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ClusterInfo", "cluster"))
    ...
    prop = PropMeta("str", "aosVersion", "aosVersion", 70044, PropCategory.REGULAR)
    prop.label = "AOS Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unknown"
    prop._addConstant("6.5", "aos-version-6.5", 1)
    prop._addConstant("6.6", "aos-version-6.6", 2)
    prop._addConstant("unknown", "aos-version-unknown", 0)
    meta.props.add("aosVersion", prop)
    ...
    prop = PropMeta("str", "credKey", "credKey", 70062, PropCategory.REGULAR)
    prop.label = "Cred Key"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("credKey", prop)
    ...
    prop = PropMeta("str", "customSwitchName", "customSwitchName", 69765, PropCategory.REGULAR)
    prop.label = "Custom vSwitch Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("customSwitchName", prop)
    ...
    prop._addConstant("epg-pol-enforce-nsx-unsupported", "intra-epg-isolation-is-not-supported-for-nsx-domains", 549755813888)
    ...
    prop._addConstant("missing-infra-pg-vlan", "infrastructure-vlan-needs-to-be-configured-for-infra-pg.-please-enable-under-aep.", 1099511627776)
    ...
    prop._addConstant("vswitch-create-not-supported", "vswitch-creation-is-not-supported-on-aos-version-less-than-6.6.-please-recreate-the-domain-and-populate-custom-switch-name-with-a-switch-created-in-nutanix.", 2199023255552)
    ...
    prop._addConstant("8.0", "dvs-version-8.0", 7)
    prop._addConstant("not-applicable", "not-applicable", 8)
    ...
    prop._addConstant("nsx", "nsx", 8)
    prop._addConstant("nutanix_pc", "nutanix-prism-central", 11)
    prop._addConstant("nutanix_pe", "nutanix-prism-element", 10)
    prop._addConstant("openshift", "openshift", 7)
    prop._addConstant("ovs", "open-vswitch", 3)
    prop._addConstant("rancher", "rancher-rke", 9)
    ...
    prop._addConstant("nsx", "nsx", 10)
    prop._addConstant("nutanix", "nutanix", 11)
