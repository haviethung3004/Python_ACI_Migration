...
# ##################################################
class WebhookInfoTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.WebhookInfoTask")

    meta.moClassName = "compWebhookInfoTask"
    meta.rnFormat = "compWebhookInfoTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 69849, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SendWebhookUpdate", "sendwebhookupdate", 4479)
