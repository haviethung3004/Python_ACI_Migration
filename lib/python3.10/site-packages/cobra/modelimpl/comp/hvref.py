...
class HvRef(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.HvRef")

    meta.moClassName = "compHvRef"
    meta.rnFormat = "hvRef-%(hvOid)s"
    ...
    prop = PropMeta("str", "adjStartTs", "adjStartTs", 63817, PropCategory.REGULAR)
    prop.label = "Starting timestamp of the adjacency check"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "never"
    prop._addConstant("never", "never", 0)
    meta.props.add("adjStartTs", prop)
    ...
    prop = PropMeta("str", "hvOid", "hvOid", 63816, PropCategory.REGULAR)
    prop.label = "OID of the referenced compHv"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.range = [(1, 512)]
    meta.props.add("hvOid", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "hvOid"))

    def __init__(self, parentMoOrDn, hvOid, markDirty=True, **creationProps):
        namingVals = [hvOid]
