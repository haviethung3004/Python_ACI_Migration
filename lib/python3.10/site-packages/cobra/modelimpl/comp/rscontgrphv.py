...
# ##################################################
class RsContGrpHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsContGrpHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsContGrpHv"
    meta.rnFormat = "rscontGrpHv"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Compute Node"
    ...
    prop = PropMeta("str", "tCl", "tCl", 59574, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 59573, PropCategory.REGULAR)
