...
class Locale(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Locale")

    meta.moClassName = "compLocale"
    ...
    meta.childClasses.add("cobra.model.comp.HvNicCont")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvNicCont", "hvnic-"))

    meta.parentClasses.add("cobra.model.comp.NodeCont")
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 39278, PropCategory.REGULAR)
