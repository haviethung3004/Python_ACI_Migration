...
# ##################################################
class ClusterCtrlrCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ClusterCtrlrCont")

    meta.moClassName = "compClusterCtrlrCont"
    meta.rnFormat = "clusterctrlrcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster Ctrlr Setting"
    ...
    meta.childClasses.add("cobra.model.comp.ClusterCtrlr")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ClusterCtrlr", "clusterctrlr-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69850, PropCategory.REGULAR)
