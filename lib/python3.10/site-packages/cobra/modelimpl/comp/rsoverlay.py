...
class RsOverlay(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsOverlay", "cobra.model.hcloud.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsOverlay"
    meta.rnFormat = "rsoverlay"
    ...
    prop = PropMeta("str", "tCl", "tCl", 57087, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 57086, PropCategory.REGULAR)
