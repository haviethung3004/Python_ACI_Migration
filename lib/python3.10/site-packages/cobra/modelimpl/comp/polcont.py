...
class PolCont(Mo):
    ...
    prop = PropMeta("str", "IssueFlags", "IssueFlags", 63902, PropCategory.REGULAR)
    prop.label = "IssueFlags"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("none", "none", 0)
    prop._addConstant("pending-modify-uplinks", "modify-number-of-uplinks-triggered-before-controller-is-online.-marking-issueflags-pending-and-waiting-for-controller-to-come-online.", 1)
    meta.props.add("IssueFlags", prop)
