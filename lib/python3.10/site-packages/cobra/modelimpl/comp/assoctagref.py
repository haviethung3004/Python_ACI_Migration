...
# ##################################################
class AssocTagRef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.AssocTagRef")

    meta.moClassName = "compAssocTagRef"
    meta.rnFormat = "assoctagref-[%(assocTagDn)s]"
    ...
    prop = PropMeta("str", "assocTagDn", "assocTagDn", 63371, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("assocTagDn", prop)

    prop = PropMeta("str", "category", "category", 63372, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 63375, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tag", "tag", 63373, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "vmName", "vmName", 63374, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    meta.namingProps.append(getattr(meta.props, "assocTagDn"))
    getattr(meta.props, "assocTagDn").needDelimiter = True

    def __init__(self, parentMoOrDn, assocTagDn, markDirty=True, **creationProps):
        namingVals = [assocTagDn]
