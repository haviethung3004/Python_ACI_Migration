...
class TagusedBy(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.TagusedBy")

    meta.moClassName = "compTagusedBy"
    meta.rnFormat = "tagusedby-[%(srcDn)s]"
    ...
    meta.parentClasses.add("cobra.model.comp.Taguse")
    ...
    prop = PropMeta("str", "isESg", "isESg", 63377, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "srcDn", "srcDn", 63376, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
