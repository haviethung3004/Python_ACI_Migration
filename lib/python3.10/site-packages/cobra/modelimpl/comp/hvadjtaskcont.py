...
# ##################################################
class HvAdjTaskCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvAdjTaskCont")

    meta.moClassName = "compHvAdjTaskCont"
    meta.rnFormat = "hvAdjTaskCont"
    ...
    meta.childClasses.add("cobra.model.comp.HvRef")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.HvRef", "hvRef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63820, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "workerTaskSt", "workerTaskSt", 63815, PropCategory.REGULAR)
    prop.label = "Worker task state"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    meta.props.add("workerTaskSt", prop)
