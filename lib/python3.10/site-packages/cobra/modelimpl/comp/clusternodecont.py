...
# ##################################################
class ClusterNodeCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ClusterNodeCont")

    meta.moClassName = "compClusterNodeCont"
    meta.rnFormat = "clusterNodeCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Node Cluster Container"
    ...
    meta.childClasses.add("cobra.model.comp.ClusterNode")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ClusterNode", "clusternode-"))
    ...
    prop = PropMeta("str", "virtualIp", "virtualIp", 62533, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
