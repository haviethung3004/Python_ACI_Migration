...
class RsTagOwner(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.comp.RsTagOwner", "cobra.model.comp.EpPD")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsTagOwner"
    meta.rnFormat = "rstagOwner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 69805, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69804, PropCategory.REGULAR)
