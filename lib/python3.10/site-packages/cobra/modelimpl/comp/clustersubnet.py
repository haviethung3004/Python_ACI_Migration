...
# ##################################################
class ClusterSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ClusterSubnet")

    meta.moClassName = "compClusterSubnet"
    meta.rnFormat = "cidr-%(cidr)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster Subnet"
    ...
    meta.parentClasses.add("cobra.model.comp.ClusterInfo")
    ...
    prop = PropMeta("str", "availabilityZone", "availabilityZone", 57068, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "cidr", "cidr", 57067, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
