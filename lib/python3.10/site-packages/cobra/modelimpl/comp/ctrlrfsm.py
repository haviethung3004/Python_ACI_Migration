...
class CtrlrFsm(Mo):
    ...
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:nsx", "ifc:vmmmgr:compctrlradd:nsx", 4096)
    prop._addConstant("ifc:vmmmgr:CompCtrlrAdd:nutanix", "ifc:vmmmgr:compctrlradd:nutanix", 8192)
    ...
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:nsx", "ifc:vmmmgr:compctrlrremove:nsx", 4096)
    prop._addConstant("ifc:vmmmgr:CompCtrlrRemove:nutanix", "ifc:vmmmgr:compctrlrremove:nutanix", 8192)
