...
class RtTagOwner(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.comp.RtTagOwner", "cobra.model.comp.Tag")

    meta.moClassName = "compRtTagOwner"
    meta.rnFormat = "rttagOwner-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 69807, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69806, PropCategory.REGULAR)
