...
# ##################################################
class RsFvAddrMgmtPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsFvAddrMgmtPool", "cobra.model.fv.AddrMgmtPool")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsFvAddrMgmtPool"
    meta.rnFormat = "rsFvAddrMgmtPool"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Address Management Pool"
    ...
    meta.rnPrefixes = [
        ('rsFvAddrMgmtPool', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69836, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69837, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69827, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69813, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20278
    prop.defaultValueStr = "fvAddrMgmtPool"
    prop._addConstant("fvAddrMgmtPool", None, 20278)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69812, PropCategory.REGULAR)
