...
# ##################################################
class RsLocaleToHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsLocaleToHv", "cobra.model.comp.Hv")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsLocaleToHv"
    meta.rnFormat = "rslocaleToHv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39289, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39288, PropCategory.REGULAR)
