...
# ##################################################
class ClusterCtrlrTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ClusterCtrlrTask")

    meta.moClassName = "compClusterCtrlrTask"
    meta.rnFormat = "compClusterCtrlrTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 70039, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateClusterInfo", "updateclusterinfo", 4488)
