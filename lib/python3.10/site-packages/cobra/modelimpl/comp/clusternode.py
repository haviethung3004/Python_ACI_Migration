...
# ##################################################
class ClusterNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ClusterNode")

    meta.moClassName = "compClusterNode"
    meta.rnFormat = "clusternode-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster Node"
    ...
    meta.parentClasses.add("cobra.model.comp.ClusterNodeCont")
    ...
    prop = PropMeta("str", "ip", "ip", 62534, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "oid", "oid", 62535, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
