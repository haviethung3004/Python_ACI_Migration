...
class Hv(Mo):
    ...
    meta.childClasses.add("cobra.model.comp.RsOverlayTunnel")
    meta.childClasses.add("cobra.model.comp.RsPhys")
    meta.childClasses.add("cobra.model.comp.RtCompHv")
    meta.childClasses.add("cobra.model.comp.RtContGrpHv")
    ...
    meta.childClasses.add("cobra.model.comp.RtLocaleToHv")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsOverlayTunnel", "rsoverlayTunnel-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtLocaleToHv", "rtlocaleToHv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsNestedInVm", "rsnestedInVm"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtContGrpHv", "rtcontGrpHv-"))
    ...
    prop = PropMeta("str", "mgmtIp", "mgmtIp", 57917, PropCategory.REGULAR)
