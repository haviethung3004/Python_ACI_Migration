...
class VNic(Mo):
    ...
    meta.childClasses.add("cobra.model.comp.AssocTagRef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.AssocTagRef", "assoctagref-"))
    ...
    prop = PropMeta("str", "vmName", "vmName", 61971, PropCategory.REGULAR)
    prop.label = "VM Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
