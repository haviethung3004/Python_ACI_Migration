...
# ##################################################
class RtContGrpHv(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.comp.RtContGrpHv", "cobra.model.comp.ContGrp")

    meta.moClassName = "compRtContGrpHv"
    meta.rnFormat = "rtcontGrpHv-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 59576, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 59575, PropCategory.REGULAR)
