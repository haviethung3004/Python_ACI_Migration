...
# ##################################################
class RsLocaleToVm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsLocaleToVm", "cobra.model.comp.Vm")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "compRsLocaleToVm"
    meta.rnFormat = "rslocaleToVm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39293, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39292, PropCategory.REGULAR)
