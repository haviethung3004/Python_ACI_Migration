...
class Label(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Label")

    meta.moClassName = "compLabel"
    ...
    prop = PropMeta("str", "name", "name", 57055, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 57056, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
