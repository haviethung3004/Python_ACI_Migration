...
class EpPD(Mo):
    ...
    meta.childClasses.add("cobra.model.comp.AddrMgmtPolCont")
    ...
    meta.childClasses.add("cobra.model.comp.RtSecurityPol")
    meta.childClasses.add("cobra.model.comp.RtTagOwner")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtSecurityPol", "rthvsSecurityPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.L3ExtTracker", "l3exttracker-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.AddrMgmtPolCont", "ipampolcont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsLocalEpCP", "rslocalEpCP"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtTagOwner", "rttagOwner-"))
    ...
    prop = PropMeta("str", "apiMode", "apiMode", 69168, PropCategory.REGULAR)
    prop.label = "NSX-T API mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "mgmt"
    prop._addConstant("mgmt", "management-api-mode", 0)
    prop._addConstant("policy", "policy-api-mode", 1)
    meta.props.add("apiMode", prop)
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 63087, PropCategory.REGULAR)
    prop.label = "CTX DN"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop.label = "Deployment Immediacy"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operFlags", "operFlags", 63809, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("add-del-secpol-task-pending", "whether-an-add-or-delete-security-policy-task-is-pending-to-be-executed", 2)
    prop._addConstant("add-del-task-pending", "whether-an-add-or-delete-extpol-task-is-pending-to-be-executed", 1)
    prop._addConstant("ipam-sync-pending", "whether-a-newly-created-eppd-is-waiting-for-ipam-relation-to-be-resolved", 4)
    prop._addConstant("none", "none", 0)
    meta.props.add("operFlags", prop)
    ...
    prop.label = "Resolution Immediacy"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "lazy"
