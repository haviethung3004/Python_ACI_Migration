...
class ContGrp(Mo):
    ...
    meta.childClasses.add("cobra.model.comp.Label")
    meta.childClasses.add("cobra.model.comp.RsContGrpDepl")
    meta.childClasses.add("cobra.model.comp.RsContGrpHv")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsContGrpHv", "rscontGrpHv"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Label", "key-"))
    ...
    prop = PropMeta("str", "encap", "encap", 57059, PropCategory.REGULAR)
    prop.label = "Encap"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "interfaceName", "interfaceName", 57057, PropCategory.REGULAR)
    prop.label = "IF Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "mac", "mac", 57058, PropCategory.REGULAR)
    prop.label = "MAC"
    prop.isImplicit = True
    prop.isAdmin = True
