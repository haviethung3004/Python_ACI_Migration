...
class NodeCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.NodeCont")

    meta.moClassName = "compNodeCont"
    meta.rnFormat = "nodeCont"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric Node Container"
    ...
    meta.childClasses.add("cobra.model.comp.Locale")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.Locale", "node-"))
