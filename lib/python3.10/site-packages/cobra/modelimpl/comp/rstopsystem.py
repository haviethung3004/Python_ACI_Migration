...
# ##################################################
class RsTopSystem(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsTopSystem", "cobra.model.comp.System")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "compRsTopSystem"
    meta.rnFormat = "rstopSystem"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to copy of topSystem in vmmmgr"
    ...
    prop = PropMeta("str", "tCl", "tCl", 70069, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20314
    prop.defaultValueStr = "compSystem"
    prop._addConstant("compSystem", None, 20314)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 70068, PropCategory.REGULAR)
