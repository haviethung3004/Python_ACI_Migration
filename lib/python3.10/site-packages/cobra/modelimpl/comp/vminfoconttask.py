...
# ##################################################
class VmInfoContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.VmInfoContTask")

    meta.moClassName = "compVmInfoContTask"
    meta.rnFormat = "compVmInfoContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 65451, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("VerifyVmsInfo", "verifyvmsinfo", 4267)
