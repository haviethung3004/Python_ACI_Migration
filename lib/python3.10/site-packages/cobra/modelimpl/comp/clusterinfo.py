...
# ##################################################
class ClusterInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.ClusterInfo")

    meta.moClassName = "compClusterInfo"
    meta.rnFormat = "cluster"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster Info"
    ...
    meta.childClasses.add("cobra.model.comp.ClusterSubnet")
    meta.childClasses.add("cobra.model.comp.RsOverlay")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsOverlay", "rsoverlay"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.ClusterSubnet", "cidr-"))
    ...
    prop = PropMeta("str", "accountName", "accountName", 57061, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "operState", "operState", 57065, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "provider", "provider", 57064, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "type", "type", 57063, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "uniqueId", "uniqueId", 59196, PropCategory.REGULAR)
    prop.label = "Unique Id when ClusterInfo was created"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("uniqueId", prop)

    prop = PropMeta("str", "version", "version", 57062, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
