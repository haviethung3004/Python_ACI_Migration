...
# ##################################################
class RsOverlayTunnel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.comp.RsOverlayTunnel", "cobra.model.hctunn.If")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "compRsOverlayTunnel"
    meta.rnFormat = "rsoverlayTunnel-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Overlay Tunnel to cloud routers"
    ...
    prop = PropMeta("str", "tCl", "tCl", 59570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 59569, PropCategory.REGULAR)
