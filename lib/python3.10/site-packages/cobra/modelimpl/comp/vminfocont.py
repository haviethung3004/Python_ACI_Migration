...
class VmInfoCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.VmInfoCont")

    meta.moClassName = "compVmInfoCont"
    meta.rnFormat = "vmInfoCont"
    meta.category = MoCategory.REGULAR
    meta.label = "VM Info Container"
    ...
    meta.childClasses.add("cobra.model.comp.VmRef")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.fault.Inst")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.VmRef", "VmRef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65452, PropCategory.REGULAR)
