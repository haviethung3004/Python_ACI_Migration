...
# ##################################################
class HvAdjTaskContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.HvAdjTaskContTask")

    meta.moClassName = "compHvAdjTaskContTask"
    meta.rnFormat = "compHvAdjTaskContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 63819, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("GetBulkHvAdj", "getbulkhvadj", 4187)
