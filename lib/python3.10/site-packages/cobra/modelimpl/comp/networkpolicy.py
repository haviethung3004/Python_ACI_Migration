...
# ##################################################
class NetworkPolicy(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.comp.NetworkPolicy")

    meta.moClassName = "compNetworkPolicy"
    meta.rnFormat = "nwpol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Network Policy"
    ...
    prop = PropMeta("str", "egress", "egress", 57916, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ingress", "ingress", 57915, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.regex = ['[a-zA-Z0-9\\[\\]\\{\\}\\:\\*\\,\\/\\.]+']
    ...
    prop = PropMeta("str", "name", "name", 57084, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
