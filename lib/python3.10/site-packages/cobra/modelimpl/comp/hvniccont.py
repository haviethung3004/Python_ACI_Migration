...
class HvNicCont(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.HvNicCont")

    meta.moClassName = "compHvNicCont"
    meta.rnFormat = "hvnic-[%(hvNicDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "HvNic Container"
    ...
    meta.childClasses.add("cobra.model.comp.RsLocaleToHv")
    meta.childClasses.add("cobra.model.comp.RsLocaleToVm")
    meta.childClasses.add("cobra.model.comp.RtHvNicToLocale")

    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHvNicToLocale", "rthvNicToLocale"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsLocaleToHv", "rslocaleToHv-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsLocaleToVm", "rslocaleToVm-"))

    meta.parentClasses.add("cobra.model.comp.Locale")
    ...
    prop = PropMeta("str", "hvNicDn", "hvNicDn", 39279, PropCategory.REGULAR)
    prop.label = "HvNic Dn"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("hvNicDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "hvNicDn"))
    getattr(meta.props, "hvNicDn").needDelimiter = True

    def __init__(self, parentMoOrDn, hvNicDn, markDirty=True, **creationProps):
        namingVals = [hvNicDn]
