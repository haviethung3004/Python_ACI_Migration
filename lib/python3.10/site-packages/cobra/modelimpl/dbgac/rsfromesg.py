...
class RsFromEsg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.dbgac.RsFromEsg", "cobra.model.fv.ESg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsFromEsg"
    meta.rnFormat = "rsfromEsg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Source ESG Relation for Atomic Counter Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 62830, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62831, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62828, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62820, PropCategory.REGULAR)
