...
# ##################################################
class RsToEsgForEpgToEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.dbgac.RsToEsgForEpgToEpg", "cobra.model.fv.ESg")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "dbgacRsToEsgForEpgToEpg"
    meta.rnFormat = "rstoEsgForEpgToEpg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_GLOBAL
    meta.label = "Destination ESG Relation for Atomic Counter Policy"
    ...
    meta.rnPrefixes = [
        ('rstoEsgForEpgToEpg-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 62832, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62833, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62829, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62825, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16474
    prop.defaultValueStr = "fvESg"
    prop._addConstant("fvESg", None, 16474)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62824, PropCategory.REGULAR)
