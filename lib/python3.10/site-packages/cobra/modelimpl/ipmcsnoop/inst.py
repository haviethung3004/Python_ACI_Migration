...
class Inst(Mo):
    ...
    prop = PropMeta("str", "disableChksum", "disableChksum", 68835, PropCategory.REGULAR)
    prop.label = "To disable igmp snoop checksum check"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("disableChksum", prop)

    prop = PropMeta("str", "disableTimers", "disableTimers", 68834, PropCategory.REGULAR)
    prop.label = "To disable igmp snoop timers"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("disableTimers", prop)
    ...
    prop = PropMeta("str", "v3ReportSup", "v3ReportSup", 63401, PropCategory.REGULAR)
    prop.label = "Configure v3 report suppression"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("v3ReportSup", prop)
