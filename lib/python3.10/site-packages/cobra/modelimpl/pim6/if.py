...
class If(Mo):
    ...
    prop = PropMeta("str", "recvFilterRtMap", "recvFilterRtMap", 56166, PropCategory.REGULAR)
    prop.label = "Recv Filter Policy"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("recvFilterRtMap", prop)
    ...
    prop = PropMeta("str", "sourceFilterRtMap", "sourceFilterRtMap", 56165, PropCategory.REGULAR)
    prop.label = "Source Filter Policy"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("sourceFilterRtMap", prop)
