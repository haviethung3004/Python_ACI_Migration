...
# ##################################################
class RsToProxyIgnoreHost(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToProxyIgnoreHost", "cobra.model.proxy.IgnoreHost")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToProxyIgnoreHost"
    meta.rnFormat = "rstoProxyIgnoreHost"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67875, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18600
    prop.defaultValueStr = "proxyIgnoreHost"
    prop._addConstant("proxyIgnoreHost", None, 18600)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 67874, PropCategory.REGULAR)
