...
# ##################################################
class RsToStaticRouteDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToStaticRouteDef", "cobra.model.mgmt.StaticRouteDef")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToStaticRouteDef"
    meta.rnFormat = "rstoStaticRouteDef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62296, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18389
    prop.defaultValueStr = "mgmtStaticRouteDef"
    prop._addConstant("mgmtStaticRouteDef", None, 18389)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62295, PropCategory.REGULAR)
