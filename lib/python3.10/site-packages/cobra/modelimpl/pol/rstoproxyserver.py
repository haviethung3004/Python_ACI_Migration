...
# ##################################################
class RsToProxyServer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToProxyServer", "cobra.model.proxy.Server")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToProxyServer"
    meta.rnFormat = "rstoProxyServer"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67878, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18599
    prop.defaultValueStr = "proxyServer"
    prop._addConstant("proxyServer", None, 18599)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 67877, PropCategory.REGULAR)
