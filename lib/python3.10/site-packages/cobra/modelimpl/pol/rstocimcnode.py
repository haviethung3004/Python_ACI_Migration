...
# ##################################################
class RsToCimcNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToCimcNode", "cobra.model.ctrlr.CimcNode")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToCimcNode"
    meta.rnFormat = "rstoCimcNode"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62293, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18384
    prop.defaultValueStr = "ctrlrCimcNode"
    prop._addConstant("ctrlrCimcNode", None, 18384)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62292, PropCategory.REGULAR)
