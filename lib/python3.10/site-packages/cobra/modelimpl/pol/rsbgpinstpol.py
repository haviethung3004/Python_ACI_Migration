...
# ##################################################
class RsBgpInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsBgpInstPol", "cobra.model.bgp.InstPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsBgpInstPol"
    meta.rnFormat = "rsbgpInstPol"
    ...
    prop = PropMeta("str", "tCl", "tCl", 64374, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 64373, PropCategory.REGULAR)
