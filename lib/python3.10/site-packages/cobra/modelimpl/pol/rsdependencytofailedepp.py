...
class RsDependencyToFailedEpP(Mo):
    ...
    prop._addConstant("dhcp-provider-is-not-reachable", "dhcp-provider-not-present-in-associated-epg/bd-subnet", 134217728)
    ...
    prop._addConstant("l3out-config-conflict", "operational-interface-parameters-cannot-be-different-(e.g.-mtu,-mac,-svi-autostate,-qos-priority,-qos-custom-policy)-from-different-deployments-under-a-context", 4398046511104)
    ...
    prop._addConstant("ospf-role-conflict", "ospf-cannot-be-supporting-protocol-for-bgp-in-one-l3-outside-and-main-protocol-for-another-on-same-node-for-given-context(vrf)", 549755813888)
    ...
    prop = PropMeta("str", "resolvedExtendedConfigQual", "resolvedExtendedConfigQual", 69910, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop._addConstant("FBR-route-not-present", "fbr-member-added-without-fbr-route", 2)
    prop._addConstant("bgp-dom-policy-not-present", "bgp-dom-policy-should-be-present-when-bgp-peer-is-created", 4)
    prop._addConstant("loopback-interface-id-pool-exhaustion", "loopback-interface-id-allocation-failed", 8)
    prop._addConstant("multipodDirect-portState-mismatch", "fault-is-raised-when-lldp-oper-state-of-the-interface-mismatches-multipod-direct-link-configuration", 1)
    meta.props.add("resolvedExtendedConfigQual", prop)
    ...
    prop = PropMeta("str", "unresolvedExtendedConfigQual", "unresolvedExtendedConfigQual", 69911, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("loopback-interface-id-pool-exhaustion", "loopback-interface-id-allocation-failed", 8)
    prop._addConstant("multipodDirect-portState-mismatch", "fault-is-raised-when-lldp-oper-state-of-the-interface-mismatches-multipod-direct-link-configuration", 1)
    meta.props.add("unresolvedExtendedConfigQual", prop)
