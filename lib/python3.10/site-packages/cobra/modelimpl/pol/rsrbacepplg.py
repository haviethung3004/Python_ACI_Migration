...
# ##################################################
class RsRbacEpPlg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsRbacEpPlg", "cobra.model.aaa.RbacEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "polRsRbacEpPlg"
    meta.rnFormat = "rsRbacEpPlg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58458, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58457, PropCategory.REGULAR)
