...
# ##################################################
class RsToStaticRouteDefOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.pol.RsToStaticRouteDefOper", "cobra.model.mgmt.StaticRouteDefOper")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "polRsToStaticRouteDefOper"
    meta.rnFormat = "rstoStaticRouteDefOper"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62750, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18390
    prop.defaultValueStr = "mgmtStaticRouteDefOper"
    prop._addConstant("mgmtStaticRouteDefOper", None, 18390)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62749, PropCategory.REGULAR)
