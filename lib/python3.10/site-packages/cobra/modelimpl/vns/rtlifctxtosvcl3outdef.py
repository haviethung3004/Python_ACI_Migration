...
# ##################################################
class RtLIfCtxToSvcL3OutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLIfCtxToSvcL3OutDef", "cobra.model.vns.LIfCtx")

    meta.moClassName = "vnsRtLIfCtxToSvcL3OutDef"
    meta.rnFormat = "rtLIfCtxToSvcL3OutDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62920, PropCategory.REGULAR)
