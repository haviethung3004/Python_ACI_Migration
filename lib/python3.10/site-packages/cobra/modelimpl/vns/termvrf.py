...
class TermVrf(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.TermVrf")

    meta.moClassName = "vnsTermVrf"
    meta.rnFormat = "ctx-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Terminal VRF Info"
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 61005, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61451, PropCategory.REGULAR)
