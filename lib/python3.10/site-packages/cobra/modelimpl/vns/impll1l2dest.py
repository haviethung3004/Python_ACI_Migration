...
# ##################################################
class ImplL1L2Dest(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.ImplL1L2Dest")

    meta.moClassName = "vnsImplL1L2Dest"
    meta.rnFormat = "implL1L2Dest-[%(ip)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59051, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59052, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ip", "ip", 59049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59050, PropCategory.REGULAR)
