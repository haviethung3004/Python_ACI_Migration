...
class SvcL3Cont(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.SvcL3Cont")

    meta.moClassName = "vnsSvcL3Cont"
    meta.rnFormat = "svcL3Cont"
    ...
    meta.childClasses.add("cobra.model.vns.SvcL3OutDef")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.SvcL3OutDef", "svcL3OutDef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62935, PropCategory.REGULAR)
