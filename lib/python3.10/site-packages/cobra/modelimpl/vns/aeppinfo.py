...
class AEPpInfo(Mo):
    ...
    meta.childClasses.add("cobra.model.vns.CIfInfo")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.CIfInfo", "cIfDn-"))
    ...
    prop = PropMeta("str", "useSharedNs", "useSharedNs", 59713, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("useSharedNs", prop)
