...
# ##################################################
class RsLIfCtxToSvcL3OutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToSvcL3OutDef", "cobra.model.vns.SvcL3OutDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfCtxToSvcL3OutDef"
    meta.rnFormat = "rsLIfCtxToSvcL3OutDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to vns:SvcL3OutDef"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62934, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62919, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18537
    prop.defaultValueStr = "vnsSvcL3OutDef"
    prop._addConstant("unspecified", "unspecified", 0)
    prop._addConstant("vnsSvcL3OutDef", None, 18537)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62918, PropCategory.REGULAR)
