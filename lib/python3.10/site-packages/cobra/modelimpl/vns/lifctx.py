...
class LIfCtx(Mo):
    ...
    meta.childClasses.add("cobra.model.vns.RsLIfCtxToRemoteSvcRedirectPol")
    meta.childClasses.add("cobra.model.vns.RsLIfCtxToSvcEPgPol")
    meta.childClasses.add("cobra.model.vns.RsLIfCtxToSvcL3OutDef")
    meta.childClasses.add("cobra.model.vns.RsLIfCtxToSvcRedirectPol")
    meta.childClasses.add("cobra.model.vns.RtMatchLIfCtx")
    meta.childClasses.add("cobra.model.vns.SvcVip")

    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLIfCtxToRemoteSvcRedirectPol", "rsLIfCtxToRemoteSvcRedirectPol-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLIfCtxToSvcRedirectPol", "rsLIfCtxToSvcRedirectPol"))
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLIfCtxToSvcL3OutDef", "rsLIfCtxToSvcL3OutDef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RtMatchLIfCtx", "rtfvMatchLIfCtx-"))
    ...
    prop = PropMeta("str", "acl", "acl", 69500, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 65646, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "permitHandoff", "permitHandoff", 69178, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("permitHandoff", prop)
    ...
    prop = PropMeta("str", "ruleType", "ruleType", 69177, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
