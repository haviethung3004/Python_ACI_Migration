...
# ##################################################
class RtMatchLIfCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtMatchLIfCtx", "cobra.model.fv.LIfCtxSelector")

    meta.moClassName = "vnsRtMatchLIfCtx"
    meta.rnFormat = "rtfvMatchLIfCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Endpoint Security Group LIfCtx Selector"
    ...
    prop = PropMeta("str", "tCl", "tCl", 64357, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18838
    prop.defaultValueStr = "fvLIfCtxSelector"
    prop._addConstant("fvLIfCtxSelector", None, 18838)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 64356, PropCategory.REGULAR)
