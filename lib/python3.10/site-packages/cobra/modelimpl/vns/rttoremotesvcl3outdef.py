...
# ##################################################
class RtToRemoteSvcL3OutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtToRemoteSvcL3OutDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "vnsRtToRemoteSvcL3OutDef"
    meta.rnFormat = "rtfvToRemoteSvcL3OutDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62917, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62916, PropCategory.REGULAR)
