...
class AbsFuncConn(Mo):
    ...
    prop = PropMeta("str", "connType", "connType", 61006, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("dnat", "dnat", 3)
    prop._addConstant("none", "none", 0)
    prop._addConstant("redir", "redir", 1)
    prop._addConstant("snat", "snat", 2)
    prop._addConstant("snat_dnat", "snat_dnat", 4)
    ...
    prop = PropMeta("str", "deviceLIfName", "deviceLIfName", 59197, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("deviceLIfName", prop)
