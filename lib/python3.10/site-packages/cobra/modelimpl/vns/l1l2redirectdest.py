...
class L1L2RedirectDest(Mo):
    ...
    meta.childClasses.add("cobra.model.vns.ImplL1L2Dest")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.ImplL1L2Dest", "implL1L2Dest-"))
    ...
    prop = PropMeta("str", "implName", "implName", 57397, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("implName", prop)
    ...
    prop = PropMeta("str", "podId", "podId", 58453, PropCategory.REGULAR)
    prop.label = "Pod Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
    ...
    prop = PropMeta("str", "weight", "weight", 65528, PropCategory.REGULAR)
    prop.label = "Weight"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 10)]
