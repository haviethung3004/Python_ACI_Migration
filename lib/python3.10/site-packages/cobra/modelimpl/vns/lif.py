...
class LIf(Mo):
    ...
    meta.childClasses.add("cobra.model.vns.RsLIfDomP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsLIfDomP", "rsLIfDomP"))
    ...
    prop = PropMeta("str", "lagPolicyName", "lagPolicyName", 59809, PropCategory.REGULAR)
