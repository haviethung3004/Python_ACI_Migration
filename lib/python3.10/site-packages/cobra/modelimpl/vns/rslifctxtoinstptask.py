...
# ##################################################
class RsLIfCtxToInstPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.RsLIfCtxToInstPTask")

    meta.moClassName = "vnsRsLIfCtxToInstPTask"
    meta.rnFormat = "vnsRsLIfCtxToInstPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 62912, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdateSvcL3Def", "updatesvcl3def", 4113)
