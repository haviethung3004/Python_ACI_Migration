...
class AbsGraph(Mo):
    ...
    prop = PropMeta("str", "svcRuleType", "svcRuleType", 61436, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "vrf"
    prop._addConstant("epg", "epg", 0)
    prop._addConstant("subnet", "subnet", 1)
    prop._addConstant("vrf", "vrf", 2)
    meta.props.add("svcRuleType", prop)
    ...
    prop._addConstant("NDO_IMPLICIT_TEMPLATE", "ndo_implicit_template", 23)
