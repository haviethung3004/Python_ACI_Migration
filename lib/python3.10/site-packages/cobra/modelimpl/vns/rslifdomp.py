...
class RsLIfDomP(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.vns.RsLIfDomP", "cobra.model.phys.DomP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsLIfDomP"
    meta.rnFormat = "rsLIfDomP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf to a Vlan Namespace Instance Profile"
    ...
    prop = PropMeta("str", "annotation", "annotation", 60664, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 60665, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 60663, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 60660, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60659, PropCategory.REGULAR)
