...
# ##################################################
class TermVrfTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.TermVrfTask")

    meta.moClassName = "vnsTermVrfTask"
    meta.rnFormat = "vnsTermVrfTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 61437, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SvcFltUpd", "svcfltupd", 3983)
