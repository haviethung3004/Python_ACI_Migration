...
# ##################################################
class RtLIfCtxToRemoteSvcRedirectPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.vns.RtLIfCtxToRemoteSvcRedirectPol", "cobra.model.vns.LIfCtx")

    meta.moClassName = "vnsRtLIfCtxToRemoteSvcRedirectPol"
    meta.rnFormat = "rtLIfCtxToRemoteSvcRedirectPol-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtLIfCtxToRemoteSvcRedirectPol-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 68852, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68851, PropCategory.REGULAR)
