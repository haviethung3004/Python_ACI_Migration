...
class VmmConfigFile(Mo):
    ...
    prop._addConstant("usePassword", "password", 0)
    prop._addConstant("useSshKeyContents", "ssh-public/private-key-files", 1)
    ...
    prop.label = "SSH Private Key Content"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.label = "SSH Public Key Content"
    prop.isConfig = True
    prop.isAdmin = True
