...
# ##################################################
class RsLIfCtxToRemoteSvcRedirectPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsLIfCtxToRemoteSvcRedirectPol", "cobra.model.vns.SvcRedirectPol")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "vnsRsLIfCtxToRemoteSvcRedirectPol"
    meta.rnFormat = "rsLIfCtxToRemoteSvcRedirectPol-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from LIf Context to Remote Service Redirect Policy"
    ...
    meta.rnPrefixes = [
        ('rsLIfCtxToRemoteSvcRedirectPol-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 68854, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68855, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "siteId", "siteId", 68848, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 1000)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 68850, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68849, PropCategory.REGULAR)
