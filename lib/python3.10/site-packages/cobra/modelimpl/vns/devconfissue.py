...
class DevConfIssue(Mo):
    ...
    prop._addConstant("invalid-SvcBD-Mac", "invalid-service-bd-mac", 158)
    ...
    prop._addConstant("invalid-cif-encap", "invalid-cif-encap", 159)
    ...
    prop._addConstant("l3Out-pbr-fault", "l3out-pbr-fault", 160)
    ...
    prop._addConstant("lifctx-should-have-same-esg", "invalid--all-the-lifctx-in-the-same-device-using-same-bd-should-have-same-esg-set.-use-the-same-esg-and-retrigger-the-graph", 161)
