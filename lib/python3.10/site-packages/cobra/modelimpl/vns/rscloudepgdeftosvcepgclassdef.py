...
# ##################################################
class RsCloudEPgDefToSvcEPgClassDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.vns.RsCloudEPgDefToSvcEPgClassDef", "cobra.model.cloud.SvcEPgClassDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "vnsRsCloudEPgDefToSvcEPgClassDef"
    meta.rnFormat = "rsCloudEPgDefToSvcEPgClassDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "cloud service EPg details"
    ...
    meta.rnPrefixes = [
        ('rsCloudEPgDefToSvcEPgClassDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 58359, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17267
    prop.defaultValueStr = "cloudSvcEPgClassDef"
    prop._addConstant("cloudSvcEPgClassDef", None, 17267)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58358, PropCategory.REGULAR)
