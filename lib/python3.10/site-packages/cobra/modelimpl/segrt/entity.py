...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.segrt.Entity")

    meta.moClassName = "segrtEntity"
    meta.rnFormat = "segrt"
    meta.category = MoCategory.REGULAR
    meta.label = "Segment-routing Entity"
    ...
    meta.childClasses.add("cobra.model.segrt.Inst")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.segrt.Inst", "inst"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 56645, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56646, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56622, PropCategory.REGULAR)
