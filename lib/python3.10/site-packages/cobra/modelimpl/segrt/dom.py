...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.segrt.Dom")

    meta.moClassName = "segrtDom"
    ...
    meta.childClasses.add("cobra.model.segrt.DomAf")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.segrt.DomAf", "af-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 56641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56642, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 56581, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
