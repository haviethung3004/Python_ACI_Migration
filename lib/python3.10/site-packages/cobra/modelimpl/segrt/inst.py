...
class Inst(Mo):
    ...
    meta = ClassMeta("cobra.model.segrt.Inst")

    meta.moClassName = "segrtInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Object to hold per Segment-routing instance information"
    ...
    meta.childClasses.add("cobra.model.segrt.Mpls")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.segrt.Mpls", "mpls"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56623, PropCategory.REGULAR)
