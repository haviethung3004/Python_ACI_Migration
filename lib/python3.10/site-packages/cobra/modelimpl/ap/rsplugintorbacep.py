...
# ##################################################
class RsPluginToRbacEp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ap.RsPluginToRbacEp", "cobra.model.aaa.RbacEp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "apRsPluginToRbacEp"
    meta.rnFormat = "rsPluginToRbacEp"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58462, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58461, PropCategory.REGULAR)
