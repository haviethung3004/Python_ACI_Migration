...
class Inst(Mo):
    ...
    prop = PropMeta("str", "md5CACert", "md5CACert", 67965, PropCategory.REGULAR)
    prop.label = "MD5 of SSL CACert"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 128)]
    prop.regex = ['[a-zA-Z0-9\\!#$%()*,-./:;@ _{|}~?&+]+']
    meta.props.add("md5CACert", prop)
    ...
    prop._addConstant("link-aggregation", "port-link-aggregation", 8192)
    prop._addConstant("max-framesize", "port-maximum-frame-size", 2048)
    prop._addConstant("mgmt-addr", "management-address", 16)
    prop._addConstant("model-number", "model-number", 128)
    prop._addConstant("port-desc", "port-description", 1)
    prop._addConstant("port-vlan", "port-vlan", 32)
    prop._addConstant("software-version", "software-version", 256)
    ...
    prop._addConstant("vlan-name", "port-vlan-name", 4096)
