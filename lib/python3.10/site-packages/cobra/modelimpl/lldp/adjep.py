...
class AdjEp(Mo):
    ...
    prop = PropMeta("str", "linkAgg", "linkAgg", 68741, PropCategory.REGULAR)
    prop.label = "Port Link Aggregation(Cap,status,id)"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("linkAgg", prop)

    prop = PropMeta("str", "maxFramesize", "maxFramesize", 68739, PropCategory.REGULAR)
    prop.label = "Port Max Frame size(MTU)"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("maxFramesize", prop)
    ...
    prop = PropMeta("str", "modelNumber", "modelNumber", 69195, PropCategory.REGULAR)
    prop.label = "Model Number"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("modelNumber", prop)
    ...
    prop = PropMeta("str", "swVersion", "swVersion", 69196, PropCategory.REGULAR)
    prop.label = "Software Version"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("swVersion", prop)
    ...
    prop = PropMeta("str", "vlanName", "vlanName", 68740, PropCategory.REGULAR)
    prop.label = "Port Vlan Name (ID:Name)"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("vlanName", prop)
