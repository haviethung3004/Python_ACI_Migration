...
class If(Mo):
    ...
    prop = PropMeta("str", "portDCBXPVer", "portDCBXPVer", 68778, PropCategory.REGULAR)
    prop.label = "DCBXP Version"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "CEE"
    prop._addConstant("CEE", "cee", 2)
    prop._addConstant("IEEE", "ieee-802.1", 3)
    meta.props.add("portDCBXPVer", prop)

    prop = PropMeta("str", "portDCBXPVerFexInvalid", "portDCBXPVerFexInvalid", 70034, PropCategory.REGULAR)
    prop.label = "Port DCBXP Version for Fex port is Invalid"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", 0)
    prop._addConstant("yes", "yes", 1)
    meta.props.add("portDCBXPVerFexInvalid", prop)

    prop = PropMeta("str", "portDCBXSt", "portDCBXSt", 68777, PropCategory.REGULAR)
    prop.label = "Port DBCX enabled status"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("portDCBXSt", prop)
