...
class InstAf(Mo):
    ...
    meta.childClasses.add("cobra.model.bfd.MhKaP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.MhKaP", "mhka"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 69649, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69650, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startupIntvl", "startupIntvl", 65524, PropCategory.REGULAR)
    prop.label = "Startup timer Interval"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 60)]
    prop.defaultValue = 10
    prop.defaultValueStr = "10"
    meta.props.add("startupIntvl", prop)
