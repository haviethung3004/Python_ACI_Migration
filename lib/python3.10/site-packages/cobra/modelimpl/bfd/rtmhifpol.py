...
class RtMhIfPol(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.bfd.RtMhIfPol", "cobra.model.bfd.MhIfP")

    meta.moClassName = "bfdRtMhIfPol"
    meta.rnFormat = "rtmhIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56035, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16452
    prop.defaultValueStr = "bfdMhIfP"
    prop._addConstant("bfdMhIfP", None, 16452)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56034, PropCategory.REGULAR)
