...
class MhIfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MhIfPol")

    meta.moClassName = "bfdMhIfPol"
    meta.rnFormat = "bfdMhIfPol-%(name)s"
    ...
    meta.childClasses.add("cobra.model.bfd.RtMhIfPol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RtMhIfPol", "rtmhIfPol-"))
    ...
    meta.superClasses.add("cobra.model.bfd.AMhIfPol")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 56002, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 56044, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "detectMult", "detectMult", 56001, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56045, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minRxIntvl", "minRxIntvl", 56000, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minTxIntvl", "minTxIntvl", 55999, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 56031, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
