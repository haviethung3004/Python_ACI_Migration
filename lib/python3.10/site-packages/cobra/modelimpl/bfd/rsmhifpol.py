...
class RsMhIfPol(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.bfd.RsMhIfPol", "cobra.model.bfd.MhIfPol")
    meta.targetNameProps["name"] = "tnBfdMhIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "bfdRsMhIfPol"
    meta.rnFormat = "rsMhIfPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 56048, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56037, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56033, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16451
    prop.defaultValueStr = "bfdMhIfPol"
    ...
    prop = PropMeta("str", "tnBfdMhIfPolName", "tnBfdMhIfPolName", 56032, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdMhIfPolName", prop)
