...
class SessStats(Mo):
    ...
    prop.label = "Down Count is the number of times session has gone into down state"
    prop.isOper = True
    ...
    prop.label = "Packets Average Receive Interval, which is the average interval between received packets"
    prop.isOper = True
    ...
    prop.label = "Packets Average Transmit Interval, which is average interval between transmitted packets"
    prop.isOper = True
    ...
    prop.label = "Up Count is the number of times session has gone into up state"
    prop.isOper = True
