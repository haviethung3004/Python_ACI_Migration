...
class PeerV(Mo):
    ...
    prop = PropMeta("str", "CBit", "CBit", 57476, PropCategory.REGULAR)
    prop.label = "CBit Flag In Last Packet"
    prop.isOper = True
    prop.defaultValue = 2
    prop.defaultValueStr = "disabled"
    prop._addConstant("disabled", "control-plane-dependent", 2)
    prop._addConstant("enabled", "control-plane-independent", 1)
    meta.props.add("CBit", prop)
    ...
    prop.label = "Diagnostic Code in Last Packet"
    prop.isOper = True
    ...
    prop.label = "Minimum Echo Interval in Last Packet"
    prop.isOper = True
    prop.range = [(50, 999)]
    ...
    prop.label = "Minimum Rx Interval in Last Packet"
    prop.isOper = True
    prop.range = [(50, 999)]
    prop.defaultValue = 50
    prop.defaultValueStr = "50"
    ...
    prop.label = "Minimum Tx Interval in Last Packet"
    prop.isOper = True
    prop.range = [(50, 999)]
    prop.defaultValue = 50
    prop.defaultValueStr = "50"
