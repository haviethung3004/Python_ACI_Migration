...
class Sess(Mo):
    ...
    prop.label = "Asynchronous mode Source Port"
    prop.isOper = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    prop.label = "Active value of Authentication Type"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop.label = "Protocol Diagnostic code"
    prop.isOper = True
    ...
    prop.label = "Local Session Identifier of the BFD session"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.label = "Echo mode Source Port"
    prop.isOper = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    ...
    prop._addConstant("cbit", "cbit", 16)
    ...
    prop.label = "Interface ID associated with the BFD session"
    prop.isOper = True
    meta.props.add("ifId", prop)

    prop = PropMeta("str", "iod", "iod", 17008, PropCategory.REGULAR)
    prop.label = "Interface ordinal associated with the BFD session"
    prop.isOper = True
    ...
    prop.label = "Last Diagnostic code"
    prop.isOper = True
    prop._addConstant("admin-down", "administratively-down", 7)
    prop._addConstant("concat-path-down", "concatenated-path-down", 6)
    prop._addConstant("detect-timeout", "control-detection-time-expired", 1)
    ...
    prop.label = "Transition Time. Last time when protocol state changed"
    prop.isOper = True
    ...
    prop.label = "Remote Session Identifier of the BFD session"
    prop.isOper = True
    ...
    prop = PropMeta("str", "sessionDown", "sessionDown", 68027, PropCategory.REGULAR)
    prop.label = "Flag to indicate that BFD session is down"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", 0)
    prop._addConstant("yes", "yes", 1)
    meta.props.add("sessionDown", prop)

    prop = PropMeta("str", "sessionType", "sessionType", 56015, PropCategory.REGULAR)
    prop.label = "BFD session type - single or multi hop"
    prop.isOper = True
    prop.defaultValue = 1
    prop.defaultValueStr = "singlehop"
    prop._addConstant("ietf-bfd", "ietf-bfd-session", 3)
    prop._addConstant("multihop", "multi-hop-bfd-session", 2)
    prop._addConstant("singlehop", "single-hop-bfd-session", 1)
    meta.props.add("sessionType", prop)
