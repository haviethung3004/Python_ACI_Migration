...
class MhIfP(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MhIfP")

    meta.moClassName = "bfdMhIfP"
    meta.rnFormat = "bfdMhIfP"
    ...
    meta.childClasses.add("cobra.model.bfd.RsMhIfPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RsMhIfPol", "rsMhIfPol"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 56046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56047, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56036, PropCategory.REGULAR)
