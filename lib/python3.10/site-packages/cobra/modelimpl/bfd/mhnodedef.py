...
class MhNodeDef(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MhNodeDef")

    meta.moClassName = "bfdMhNodeDef"
    meta.rnFormat = "bfdMhNodeDef"
    meta.category = MoCategory.REGULAR
    meta.label = "Node Profile Definition"
    ...
    meta.superClasses.add("cobra.model.bfd.AMhNodeDef")

    meta.rnPrefixes = [
        ('bfdMhNodeDef', False),
    ]

    prop = PropMeta("str", "adminSt", "adminSt", 57411, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "detectMult", "detectMult", 57410, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minRxIntvl", "minRxIntvl", 57409, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minTxIntvl", "minTxIntvl", 57408, PropCategory.REGULAR)
