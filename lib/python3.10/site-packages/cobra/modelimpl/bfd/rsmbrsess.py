...
class RsMbrSess(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 69637, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69638, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69636, PropCategory.REGULAR)
