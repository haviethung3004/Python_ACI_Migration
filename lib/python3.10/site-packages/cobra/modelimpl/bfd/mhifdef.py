...
class MhIfDef(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MhIfDef")

    meta.moClassName = "bfdMhIfDef"
    meta.rnFormat = "bfdMhIfDef"
    ...
    meta.superClasses.add("cobra.model.bfd.AMhIfDef")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 56007, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "detectMult", "detectMult", 56006, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minRxIntvl", "minRxIntvl", 56005, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minTxIntvl", "minTxIntvl", 56004, PropCategory.REGULAR)
