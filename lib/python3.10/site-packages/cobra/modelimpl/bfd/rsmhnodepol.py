...
# ##################################################
class RsMhNodePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.bfd.RsMhNodePol", "cobra.model.bfd.MhNodePol")
    meta.targetNameProps["name"] = "tnBfdMhNodePolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "bfdRsMhNodePol"
    meta.rnFormat = "rsMhNodePol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Node Policy"
    meta.writeAccessMask = 0x61
    ...
    prop = PropMeta("str", "annotation", "annotation", 57439, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57440, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57428, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57424, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16907
    prop.defaultValueStr = "bfdMhNodePol"
    ...
    prop = PropMeta("str", "tnBfdMhNodePolName", "tnBfdMhNodePolName", 57423, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdMhNodePolName", prop)
