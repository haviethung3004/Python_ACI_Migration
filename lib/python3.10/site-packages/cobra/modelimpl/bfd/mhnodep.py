...
class MhNodeP(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MhNodeP")

    meta.moClassName = "bfdMhNodeP"
    meta.rnFormat = "bfdMhNodeP"
    meta.category = MoCategory.REGULAR
    meta.label = "Node Profile"
    ...
    meta.childClasses.add("cobra.model.bfd.RsMhNodePol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RsMhNodePol", "rsMhNodePol"))
    ...
    meta.superClasses.add("cobra.model.bfd.ANodeP")

    meta.rnPrefixes = [
        ('bfdMhNodeP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 57437, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57438, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "key", "key", 57406, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "keyId", "keyId", 57407, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57427, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 57405, PropCategory.REGULAR)
