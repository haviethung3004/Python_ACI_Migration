...
class MhNodePol(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MhNodePol")

    meta.moClassName = "bfdMhNodePol"
    meta.rnFormat = "bfdMhNodePol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "BFD Multihop Node Policy"
    ...
    meta.childClasses.add("cobra.model.bfd.RtMhNodePol")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.RtMhNodePol", "rtmhNodePol-"))
    ...
    meta.superClasses.add("cobra.model.bfd.AMhNodePol")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 57404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 57435, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "detectMult", "detectMult", 57403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57436, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minRxIntvl", "minRxIntvl", 57402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "minTxIntvl", "minTxIntvl", 57401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 57414, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
