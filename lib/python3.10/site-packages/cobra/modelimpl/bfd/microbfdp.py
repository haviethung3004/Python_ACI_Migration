...
class MicroBfdP(Mo):
    ...
    meta = ClassMeta("cobra.model.bfd.MicroBfdP")

    meta.moClassName = "bfdMicroBfdP"
    meta.rnFormat = "microBfdP"
    meta.category = MoCategory.REGULAR
    meta.label = "Micro BFD Configuration"
    meta.writeAccessMask = 0x61
    meta.readAccessMask = 0x80061
    ...
    meta.superClasses.add("cobra.model.bfd.AMicroBfdP")
    ...
    prop = PropMeta("str", "adminState", "adminState", 64383, PropCategory.REGULAR)
    prop.label = "MicroBfd"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 64387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dst", "dst", 64384, PropCategory.REGULAR)
    prop.label = "Micro BFD Destination Address"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("dst", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 64388, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 64386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "stTm", "stTm", 64385, PropCategory.REGULAR)
    prop.label = "Micro BFD Start Timer"
    prop.isConfig = True
    prop.isAdmin = True
