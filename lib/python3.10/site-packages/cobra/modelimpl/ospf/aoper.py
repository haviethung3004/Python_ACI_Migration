...
# ##################################################
class AOper(Mo):
    meta = ClassMeta("cobra.model.ospf.AOper")

    meta.isAbstract = True
    meta.moClassName = "ospfAOper"


    meta.moClassName = "ospfAOper"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF Instance Operational Data"
    ...
    meta.concreteSubClasses.add("cobra.model.ospf.InstOper")
    meta.concreteSubClasses.add("cobra.model.ospf.OperMultiPodDirect")
