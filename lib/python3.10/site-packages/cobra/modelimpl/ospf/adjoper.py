...
class AdjOper(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.AdjOper")

    meta.moClassName = "ospfAdjOper"
    meta.rnFormat = "adjOper-%(id)s"
    ...
    meta.childClasses.add("cobra.model.ospf.AdjStatsOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.AdjStatsOper", "adjstatsOper"))
    ...
    prop = PropMeta("str", "id", "id", 68468, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68469, PropCategory.REGULAR)
