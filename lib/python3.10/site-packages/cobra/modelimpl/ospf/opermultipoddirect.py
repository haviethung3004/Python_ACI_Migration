...
# ##################################################
class OperMultiPodDirect(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ospf.OperMultiPodDirect")

    meta.moClassName = "ospfOperMultiPodDirect"
    meta.rnFormat = "operMpodDirect"
    ...
    meta.superClasses.add("cobra.model.ospf.AOper")

    meta.rnPrefixes = [
        ('operMpodDirect', False),
    ]
    ...
    prop = PropMeta("str", "memAlert", "memAlert", 67791, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operErr", "operErr", 67792, PropCategory.REGULAR)
