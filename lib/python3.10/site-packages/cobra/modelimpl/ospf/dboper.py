...
class DbOper(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.DbOper")

    meta.moClassName = "ospfDbOper"
    meta.rnFormat = "dbOper-%(type)s"
    ...
    meta.childClasses.add("cobra.model.ospf.RouteOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.RouteOper", "rtOper-"))

    meta.parentClasses.add("cobra.model.ospf.AreaOper")
    ...
    prop = PropMeta("str", "type", "type", 68461, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
