...
class If(Mo):
    ...
    meta.childClasses.add("cobra.model.ospf.AdjOper")
    meta.childClasses.add("cobra.model.ospf.AuthP")
    meta.childClasses.add("cobra.model.ospf.Db")
    meta.childClasses.add("cobra.model.ospf.IfOper")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.AdjOper", "adjOper-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.IfOper", "ifOper"))
