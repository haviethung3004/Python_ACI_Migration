...
class Inst(Mo):
    ...
    meta.childClasses.add("cobra.model.ospf.InstOper")
    meta.childClasses.add("cobra.model.ospf.OperMultiPodDirect")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.OperMultiPodDirect", "operMpodDirect"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.InstOper", "instOper"))
