...
class IfOper(Mo):
    ...
    meta = ClassMeta("cobra.model.ospf.IfOper")

    meta.moClassName = "ospfIfOper"
    meta.rnFormat = "ifOper"
    meta.category = MoCategory.REGULAR
    meta.label = "OSPF MultiPodDirect Instance Operational Data"
    ...
    meta.childClasses.add("cobra.model.ospf.DbOper")
    meta.childClasses.add("cobra.model.ospf.IfStatsOper")
    meta.childClasses.add("cobra.model.ospf.TrafficStatsOper")

    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.TrafficStatsOper", "trafficstatsOper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.IfStatsOper", "ifstatsOper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ospf.DbOper", "dbOper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Inst", "fault-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))

    meta.parentClasses.add("cobra.model.ospf.If")

    meta.superClasses.add("cobra.model.ospf.AIfOper")

    meta.rnPrefixes = [
        ('ifOper', False),
    ]

    prop = PropMeta("str", "addr", "addr", 68380, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isOper = True
    meta.props.add("addr", prop)

    prop = PropMeta("str", "bdr", "bdr", 68382, PropCategory.REGULAR)
    prop.label = "BDR Ip Address"
    prop.isOper = True
    meta.props.add("bdr", prop)

    prop = PropMeta("str", "bdrId", "bdrId", 68384, PropCategory.REGULAR)
    prop.label = "BDR Id"
    prop.isOper = True
    ...
    prop = PropMeta("str", "dr", "dr", 68381, PropCategory.REGULAR)
    prop.label = "DR Ip Address"
    prop.isOper = True
    meta.props.add("dr", prop)

    prop = PropMeta("str", "drId", "drId", 68383, PropCategory.REGULAR)
    prop.label = "DR Id"
    prop.isOper = True
    meta.props.add("drId", prop)

    prop = PropMeta("str", "failStQual", "failStQual", 68377, PropCategory.REGULAR)
    ...
    prop._addConstant("rtrid-conflict", "router-id-conflict-config-error", 128)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("failStQual", prop)

    prop = PropMeta("str", "flags", "flags", 68379, PropCategory.REGULAR)
    prop.label = "Flags"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    ...
    prop = PropMeta("str", "lsaCksumSum", "lsaCksumSum", 68385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68470, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operCost", "operCost", 68386, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 68375, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "p2pOperSt", "p2pOperSt", 68376, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 68378, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
