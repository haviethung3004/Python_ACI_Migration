...
# ##################################################
class RsIfDefToHsrpIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hsrp.RsIfDefToHsrpIf", "cobra.model.hsrp.If")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hsrpRsIfDefToHsrpIf"
    meta.rnFormat = "rsIfDefToHsrpIf"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67839, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 8375
    prop.defaultValueStr = "hsrpIf"
    prop._addConstant("hsrpIf", None, 8375)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 67838, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 67842, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
