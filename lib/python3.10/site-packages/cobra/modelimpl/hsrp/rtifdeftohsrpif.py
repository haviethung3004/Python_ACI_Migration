...
# ##################################################
class RtIfDefToHsrpIf(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hsrp.RtIfDefToHsrpIf", "cobra.model.hsrp.IfDef")

    meta.moClassName = "hsrpRtIfDefToHsrpIf"
    meta.rnFormat = "rtifDefToHsrpIf-[%(tDn)s]"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 67843, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 67841, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9192
    prop.defaultValueStr = "hsrpIfDef"
    prop._addConstant("hsrpIfDef", None, 9192)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 67840, PropCategory.REGULAR)
