...
# ##################################################
class RsToTenantTagsHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fcpr.RsToTenantTagsHolder", "cobra.model.fv.TenantTagsHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fcprRsToTenantTagsHolder"
    meta.rnFormat = "rstoTenantTagsHolder-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fcpr.EsgTagsManager")
    ...
    prop = PropMeta("str", "tCl", "tCl", 63386, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18591
    prop.defaultValueStr = "fvTenantTagsHolder"
    prop._addConstant("fvTenantTagsHolder", None, 18591)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63385, PropCategory.REGULAR)
