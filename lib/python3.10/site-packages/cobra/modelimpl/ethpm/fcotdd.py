...
class FcotDD(Mo):
    ...
    prop = PropMeta("str", "distIn100mFor9uOM3", "distIn100mFor9uOM3", 67796, PropCategory.REGULAR)
    prop.label = "Distance"
    prop.isOper = True
    meta.props.add("distIn100mFor9uOM3", prop)

    prop = PropMeta("str", "distIn10mFor50uOM2", "distIn10mFor50uOM2", 67797, PropCategory.REGULAR)
    prop.label = "Distance"
    prop.isOper = True
    meta.props.add("distIn10mFor50uOM2", prop)

    prop = PropMeta("str", "distIn1mForCuOM4", "distIn1mForCuOM4", 67795, PropCategory.REGULAR)
    prop.label = "Distance"
    prop.isOper = True
    meta.props.add("distIn1mForCuOM4", prop)

    prop = PropMeta("str", "distIn1mForCuOM5", "distIn1mForCuOM5", 67794, PropCategory.REGULAR)
    prop.label = "Distance"
    prop.isOper = True
    meta.props.add("distIn1mForCuOM5", prop)

    prop = PropMeta("str", "distInKmFor9u", "distInKmFor9u", 67793, PropCategory.REGULAR)
    prop.label = "Distance"
    prop.isOper = True
