...
# ##################################################
class SvccoreStatusInstanceTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.dbgexp.SvccoreStatusInstanceTask")

    meta.moClassName = "dbgexpSvccoreStatusInstanceTask"
    meta.rnFormat = "dbgexpSvccoreStatusInstanceTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('dbgexpSvccoreStatusInstanceTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 69757, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportCoreLocation", "reportcorelocation", 4467)
    prop._addConstant("ReportCoreLocationOnApic", "reportcorelocationonapic", 4466)
