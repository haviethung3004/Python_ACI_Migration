...
class RsTsSrc(Mo):
    ...
    prop = PropMeta("str", "nodeStatus", "nodeStatus", 68917, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "commissioned"
    prop._addConstant("commissioned", "commissioned", 0)
    prop._addConstant("decommissioned", "decommissioned", 1)
    meta.props.add("nodeStatus", prop)
