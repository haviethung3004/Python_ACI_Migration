...
# ##################################################
class RsTSOnDScheduler(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.dbgexp.RsTSOnDScheduler", "cobra.model.trig.SchedP")
    meta.targetNameProps["name"] = "tnTrigSchedPName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "dbgexpRsTSOnDScheduler"
    meta.rnFormat = "rsTSOnDScheduler"
    ...
    meta.rnPrefixes = [
        ('rsTSOnDScheduler', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 59760, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59761, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59758, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 59755, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTrigSchedPName", "tnTrigSchedPName", 59754, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
