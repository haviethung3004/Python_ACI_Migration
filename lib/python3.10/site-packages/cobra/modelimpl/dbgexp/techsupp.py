...
class TechSupP(Mo):
    ...
    meta.childClasses.add("cobra.model.dbgexp.RtApplTechSupPSched")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dbgexp.RtApplTechSupPSched", "rtfabricApplTechSupPSched-"))
    ...
    prop = PropMeta("str", "exportToIntersight", "exportToIntersight", 67575, PropCategory.REGULAR)
    prop.label = "Export to Intersight"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("exportToIntersight", prop)
