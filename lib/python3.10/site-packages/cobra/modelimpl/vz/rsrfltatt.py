...
class RsRFltAtt(Mo):
    ...
    prop._addConstant("permit_handoff", "permit-handoff", 4096)
    prop._addConstant("permit_override", "permit-override", 1024)
    prop._addConstant("punt_to_learn", "punt-the-packet-for-learn", 2048)
    ...
    prop = PropMeta("str", "azNetworkSecurityGroupRule", "azNetworkSecurityGroupRule", 61470, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 128)]
    meta.props.add("azNetworkSecurityGroupRule", prop)
    ...
    prop = PropMeta("str", "cloudSecurityGroupRuleAction", "cloudSecurityGroupRuleAction", 62964, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "InstallForFromEPg"
    prop._addConstant("InstallForFromEPg", "install-the-rule-in-security-group-for-fromepg", 0)
    prop._addConstant("InstallForToEPg", "install-the-rule-in-security-group-for-toepg", 1)
    meta.props.add("cloudSecurityGroupRuleAction", prop)
    ...
    prop = PropMeta("str", "msiteSvcAction", "msiteSvcAction", 69180, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("acl", "acl", 4)
    prop._addConstant("none", "none", 0)
    prop._addConstant("permit-handoff", "permit-handoff", 2)
    prop._addConstant("rule-type", "rule-type", 1)
    meta.props.add("msiteSvcAction", prop)
