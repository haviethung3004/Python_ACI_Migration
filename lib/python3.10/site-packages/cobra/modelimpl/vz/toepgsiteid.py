...
# ##################################################
class ToEPgSiteId(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.ToEPgSiteId")

    meta.moClassName = "vzToEPgSiteId"
    meta.rnFormat = "siteid-%(siteId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Identify Site ID for a ToEPg"
    ...
    prop = PropMeta("str", "siteId", "siteId", 68916, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
