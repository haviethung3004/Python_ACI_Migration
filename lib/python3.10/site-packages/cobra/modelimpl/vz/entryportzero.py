...
# ##################################################
class EntryPortZero(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vz.EntryPortZero")

    meta.moClassName = "vzEntryPortZero"
    meta.rnFormat = "epz-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Filter Port Zero Entry"
    meta.writeAccessMask = 0x101
    meta.readAccessMask = 0x80101
    ...
    meta.superClasses.add("cobra.model.vz.AFiltPZEntry")
    ...
    prop = PropMeta("str", "accessPrivilege", "accessPrivilege", 69522, PropCategory.REGULAR)
    prop.label = "access privilege for modifying the mo"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "USER"
    prop._addConstant("SYSTEM", "created-by-the-system", 1)
    prop._addConstant("USER", "created-by-the-user", 0)
    meta.props.add("accessPrivilege", prop)

    prop = PropMeta("str", "annotation", "annotation", 69526, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "applyToFrag", "applyToFrag", 69519, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "direction", "direction", 69515, PropCategory.REGULAR)
    prop.label = "Port Zero direction"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "both"
    prop._addConstant("both", "direction-both", 0)
    prop._addConstant("destination", "direction-destination", 2)
    prop._addConstant("source", "direction-source", 1)
    ...
    prop = PropMeta("str", "etherT", "etherT", 69517, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69527, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "matchDscp", "matchDscp", 69521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69525, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 69523, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "prot", "prot", 69516, PropCategory.REGULAR)
    prop.label = "Protocol"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 6
    ...
    prop = PropMeta("str", "stateful", "stateful", 69520, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop = PropMeta("str", "tcpRules", "tcpRules", 69518, PropCategory.REGULAR)
