...
class ConsDef(Mo):
    ...
    meta.childClasses.add("cobra.model.fv.RemoteIdDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RemoteIdDef", "sitedef-"))
    ...
    prop = PropMeta("str", "bgpDomainId", "bgpDomainId", 62976, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "isCifLblIntersEmpty", "isCifLblIntersEmpty", 60647, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("isCifLblIntersEmpty", prop)
