...
class ZRFabIfPol(Mo):
    ...
    meta = ClassMeta("cobra.model.xcvr.ZRFabIfPol")

    meta.moClassName = "xcvrZRFabIfPol"
    meta.rnFormat = "zrfab-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "ZR-S Policy"
    meta.writeAccessMask = 0x1001
    meta.readAccessMask = 0x87801
    ...
    meta.childClasses.add("cobra.model.xcvr.RtOpticsFabIfPol")
    meta.childClasses.add("cobra.model.xcvr.RtXcvrOpticsFabIfPolCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.xcvr.RtXcvrOpticsFabIfPolCons", "rtl1XcvrOpticsFabIfPolCons-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.xcvr.RtOpticsFabIfPol", "rtfabricOpticsFabIfPol-"))
    ...
    meta.superClasses.add("cobra.model.xcvr.OpticsFabIfPol")
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 68146, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "annotation", "annotation", 68186, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cdMax", "cdMax", 68152, PropCategory.REGULAR)
    prop.label = "Chromatic Dispersion Maximum"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(-2400, 2400)]
    prop.defaultValue = 2400
    prop.defaultValueStr = "2400"
    meta.props.add("cdMax", prop)

    prop = PropMeta("str", "cdMin", "cdMin", 68153, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dacRate", "dacRate", 68149, PropCategory.REGULAR)
    prop.label = "DAC Rate"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "1x1"
    ...
    prop = PropMeta("str", "dwdmCarrier", "dwdmCarrier", 68155, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68187, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fecMode", "fecMode", 68150, PropCategory.REGULAR)
    prop.label = "FEC Mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "cFEC"
    prop._addConstant("cFEC", "cfec", 1)
    meta.props.add("fecMode", prop)

    prop = PropMeta("str", "frequency100MHz", "frequency100MHz", 68156, PropCategory.REGULAR)
    prop.label = "100MHz Frequency"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1911500, 1961000)]
    prop.defaultValue = 1931000
    prop.defaultValueStr = "1931000"
    meta.props.add("frequency100MHz", prop)

    prop = PropMeta("str", "frequency50GHz", "frequency50GHz", 68157, PropCategory.REGULAR)
    prop.label = "50GHz Frequency"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(19115, 19610)]
    prop.defaultValue = 19310
    prop.defaultValueStr = "19310"
    meta.props.add("frequency50GHz", prop)

    prop = PropMeta("str", "ituChannel50GHz", "ituChannel50GHz", 68158, PropCategory.REGULAR)
    prop.label = "50GHz ITU Channel"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 100)]
    prop.defaultValue = 61
    prop.defaultValueStr = "61"
    ...
    prop = PropMeta("str", "modulation", "modulation", 68151, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68182, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "muxponder", "muxponder", 68148, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 68175, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "transmitPower", "transmitPower", 68154, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "wavelength50GHz", "wavelength50GHz", 68159, PropCategory.REGULAR)
    prop.label = "50GHz Wavelength"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1528773, 1568362)]
    prop.defaultValue = 1552524
    prop.defaultValueStr = "1552524"
