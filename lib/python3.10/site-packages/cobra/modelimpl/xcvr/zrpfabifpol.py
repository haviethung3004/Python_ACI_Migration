...
# ##################################################
class ZRPFabIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.xcvr.ZRPFabIfPol")

    meta.moClassName = "xcvrZRPFabIfPol"
    meta.rnFormat = "zrpfab-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "ZRP-S Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68188, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cdMax", "cdMax", 68166, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cdMin", "cdMin", 68167, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dacRate", "dacRate", 68163, PropCategory.REGULAR)
    prop.label = "DAC Rate"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "dwdmCarrier", "dwdmCarrier", 68169, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68189, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fecMode", "fecMode", 68164, PropCategory.REGULAR)
    prop.label = "FEC Mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "frequency100MHz", "frequency100MHz", 68170, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "frequency50GHz", "frequency50GHz", 68171, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ituChannel50GHz", "ituChannel50GHz", 68172, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "modulation", "modulation", 68165, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68183, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "muxponder", "muxponder", 68162, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 68176, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "transmitPower", "transmitPower", 68168, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "wavelength50GHz", "wavelength50GHz", 68173, PropCategory.REGULAR)
