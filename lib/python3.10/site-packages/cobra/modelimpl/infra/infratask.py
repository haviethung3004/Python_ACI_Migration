...
class InfraTask(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.InfraTask")

    meta.moClassName = "infraInfraTask"
    meta.rnFormat = "infraInfraTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5647, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CleanUpBundleConfig", "cleanupbundleconfig", 4444)
    prop._addConstant("CleanUpEmptyProfile", "cleanupemptyprofile", 4423)
