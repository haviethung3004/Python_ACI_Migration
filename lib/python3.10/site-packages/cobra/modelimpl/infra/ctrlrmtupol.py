...
# ##################################################
class CtrlrMtuPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.CtrlrMtuPol")

    meta.moClassName = "infraCtrlrMtuPol"
    meta.rnFormat = "mtu"
    meta.category = MoCategory.REGULAR
    meta.label = "Ctrlr MTU Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 70140, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "enable", "enable", 70139, PropCategory.REGULAR)
    prop.label = "enable above MTU"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 70141, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mtu", "mtu", 70138, PropCategory.REGULAR)
    prop.label = "MTU Size for apic infra and inband interface"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(576, 9216)]
