...
# ##################################################
class RsSpineTopoctrlUsbConfigProfilePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSpineTopoctrlUsbConfigProfilePol", "cobra.model.topoctrl.UsbConfigProfilePol")
    meta.targetNameProps["name"] = "tnTopoctrlUsbConfigProfilePolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSpineTopoctrlUsbConfigProfilePol"
    meta.rnFormat = "rsspineTopoctrlUsbConfigProfilePol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "USB Config Policy"
    meta.writeAccessMask = 0x14001
    ...
    meta.rnPrefixes = [
        ('rsspineTopoctrlUsbConfigProfilePol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 64586, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 64587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 64582, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 64579, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18910
    prop.defaultValueStr = "topoctrlUsbConfigProfilePol"
    ...
    prop = PropMeta("str", "tnTopoctrlUsbConfigProfilePolName", "tnTopoctrlUsbConfigProfilePolName", 64578, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnTopoctrlUsbConfigProfilePolName", prop)
