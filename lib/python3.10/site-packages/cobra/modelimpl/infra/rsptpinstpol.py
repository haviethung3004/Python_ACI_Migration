...
# ##################################################
class RsPtpInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsPtpInstPol", "cobra.model.ptp.InstPol")
    meta.targetNameProps["name"] = "tnPtpInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsPtpInstPol"
    meta.rnFormat = "rsptpInstPol"
    ...
    prop = PropMeta("str", "annotation", "annotation", 63502, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63503, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63501, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 63498, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18675
    prop.defaultValueStr = "ptpInstPol"
    ...
    prop = PropMeta("str", "tnPtpInstPolName", "tnPtpInstPolName", 63497, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnPtpInstPolName", prop)
