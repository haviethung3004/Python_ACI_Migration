...
# ##################################################
class RsBfdMhIpv4InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsBfdMhIpv4InstPol", "cobra.model.bfd.MhIpv4InstPol")
    meta.targetNameProps["name"] = "tnBfdMhIpv4InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsBfdMhIpv4InstPol"
    meta.rnFormat = "rsbfdMhIpv4InstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MH BFD Ipv4 Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rsbfdMhIpv4InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 57441, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57442, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57429, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57416, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16904
    prop.defaultValueStr = "bfdMhIpv4InstPol"
    ...
    prop = PropMeta("str", "tnBfdMhIpv4InstPolName", "tnBfdMhIpv4InstPolName", 57415, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdMhIpv4InstPolName", prop)
