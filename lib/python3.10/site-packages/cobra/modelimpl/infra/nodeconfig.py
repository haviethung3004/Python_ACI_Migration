...
class NodeConfig(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.NodeConfig")

    meta.moClassName = "infraNodeConfig"
    ...
    prop = PropMeta("str", "annotation", "annotation", 65893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "assocGrp", "assocGrp", 65892, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65894, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "node", "node", 65891, PropCategory.REGULAR)
    prop.label = "Node"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
