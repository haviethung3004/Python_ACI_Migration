...
# ##################################################
class RsConnectivityProfileOptFc(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsConnectivityProfileOptFc", "cobra.model.infra.FcAccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsConnectivityProfileOptFc"
    meta.rnFormat = "rsconnectivityProfileOptFc"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Access Policy Group Optimized"
    ...
    meta.rnPrefixes = [
        ('rsconnectivityProfileOptFc', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 68055, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68054, PropCategory.REGULAR)
