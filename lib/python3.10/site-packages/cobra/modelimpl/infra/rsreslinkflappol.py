...
# ##################################################
class RsResLinkFlapPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsResLinkFlapPol", "cobra.model.fabric.LinkFlapPol")
    meta.targetNameProps["name"] = "tnFabricLinkFlapPolName"
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "infraRsResLinkFlapPol"
    meta.rnFormat = "rsresLinkFlapPol"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57469, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57461, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFabricLinkFlapPolName", "tnFabricLinkFlapPolName", 57460, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
