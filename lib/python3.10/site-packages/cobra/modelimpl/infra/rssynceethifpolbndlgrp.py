...
# ##################################################
class RsSynceEthIfPolBndlGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSynceEthIfPolBndlGrp", "cobra.model.synce.EthIfPol")
    meta.targetNameProps["name"] = "tnSynceEthIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSynceEthIfPolBndlGrp"
    meta.rnFormat = "rssynceEthIfPolBndlGrp"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Bundled Group to syncE Interface Policy"
    ...
    meta.rnPrefixes = [
        ('rssynceEthIfPolBndlGrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65521, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65522, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65520, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65517, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18579
    prop.defaultValueStr = "synceEthIfPol"
    ...
    prop = PropMeta("str", "tnSynceEthIfPolName", "tnSynceEthIfPolName", 65516, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnSynceEthIfPolName", prop)
