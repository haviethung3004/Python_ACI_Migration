...
# ##################################################
class RsLeafTopoctrlUsbConfigProfilePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsLeafTopoctrlUsbConfigProfilePol", "cobra.model.topoctrl.UsbConfigProfilePol")
    meta.targetNameProps["name"] = "tnTopoctrlUsbConfigProfilePolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsLeafTopoctrlUsbConfigProfilePol"
    meta.rnFormat = "rsleafTopoctrlUsbConfigProfilePol"
    ...
    meta.rnPrefixes = [
        ('rsleafTopoctrlUsbConfigProfilePol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 64588, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 64589, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 64583, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 64575, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnTopoctrlUsbConfigProfilePolName", "tnTopoctrlUsbConfigProfilePolName", 64574, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
