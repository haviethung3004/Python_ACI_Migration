...
# ##################################################
class RsBfdMhIpv6InstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsBfdMhIpv6InstPol", "cobra.model.bfd.MhIpv6InstPol")
    meta.targetNameProps["name"] = "tnBfdMhIpv6InstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsBfdMhIpv6InstPol"
    meta.rnFormat = "rsbfdMhIpv6InstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MH BFD Ipv6 Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rsbfdMhIpv6InstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 57443, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57444, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 57430, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 57420, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16905
    prop.defaultValueStr = "bfdMhIpv6InstPol"
    ...
    prop = PropMeta("str", "tnBfdMhIpv6InstPolName", "tnBfdMhIpv6InstPolName", 57419, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnBfdMhIpv6InstPolName", prop)
