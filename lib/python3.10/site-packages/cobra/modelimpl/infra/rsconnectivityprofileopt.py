...
# ##################################################
class RsConnectivityProfileOpt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsConnectivityProfileOpt", "cobra.model.infra.AccGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsConnectivityProfileOpt"
    meta.rnFormat = "rsconnectivityProfileOpt"
    ...
    meta.rnPrefixes = [
        ('rsconnectivityProfileOpt', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65475, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65474, PropCategory.REGULAR)
