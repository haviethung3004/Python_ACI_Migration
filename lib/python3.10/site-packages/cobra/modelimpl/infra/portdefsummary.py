...
# ##################################################
class PortDefSummary(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.PortDefSummary")

    meta.moClassName = "infraPortDefSummary"
    meta.rnFormat = "card-%(card)s-port-%(port)s-sub-%(subPort)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Port Def Summary Configuration"
    ...
    meta.parentClasses.add("cobra.model.infra.SummaryDefCont")

    meta.superClasses.add("cobra.model.fabric.APortDefSummary")
    ...
    prop = PropMeta("str", "card", "card", 69479, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descriptionPC", "descriptionPC", 70869, PropCategory.REGULAR)
    prop.label = "Description from Port Channel"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("descriptionPC", prop)
    ...
    prop = PropMeta("str", "fex", "fex", 69464, PropCategory.REGULAR)
    prop.label = "Fex Id"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 199)]
    ...
    prop = PropMeta("str", "mode", "mode", 69463, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "port", "port", 69480, PropCategory.REGULAR)
    prop.label = "Port Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "subPort", "subPort", 69481, PropCategory.REGULAR)
