...
# ##################################################
class RsSynceEthIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSynceEthIfPol", "cobra.model.synce.EthIfPol")
    meta.targetNameProps["name"] = "tnSynceEthIfPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSynceEthIfPol"
    meta.rnFormat = "rssynceEthIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to syncE Interface Policy"
    ...
    meta.rnPrefixes = [
        ('rssynceEthIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 63068, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63069, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63064, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 63060, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnSynceEthIfPolName", "tnSynceEthIfPolName", 63059, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
