...
# ##################################################
class RsFuncToVirtualLIfPAttEntPContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.RsFuncToVirtualLIfPAttEntPContTask")

    meta.moClassName = "infraRsFuncToVirtualLIfPAttEntPContTask"
    meta.rnFormat = "infraRsFuncToVirtualLIfPAttEntPContTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('infraRsFuncToVirtualLIfPAttEntPContTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 58348, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ReportNodesToVirtualLIfP", "reportnodestovirtuallifp", 3825)
