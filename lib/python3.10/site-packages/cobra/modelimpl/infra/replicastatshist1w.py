...
class ReplicaStatsHist1w(Mo):
    ...
    prop = PropMeta("str", "doerTAvg", "doerTAvg", 63326, PropCategory.IMPLICIT_AVG)
    prop.label = "liveliness of doer average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("doerTAvg", prop)

    prop = PropMeta("str", "doerTMax", "doerTMax", 63325, PropCategory.IMPLICIT_MAX)
    prop.label = "liveliness of doer maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("doerTMax", prop)

    prop = PropMeta("str", "doerTMin", "doerTMin", 63324, PropCategory.IMPLICIT_MIN)
    prop.label = "liveliness of doer minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("doerTMin", prop)

    prop = PropMeta("str", "doerTSpct", "doerTSpct", 63327, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "liveliness of doer suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("doerTSpct", prop)

    prop = PropMeta("str", "doerTThr", "doerTThr", 63328, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "doerTTr", "doerTTr", 63329, PropCategory.IMPLICIT_TREND)
