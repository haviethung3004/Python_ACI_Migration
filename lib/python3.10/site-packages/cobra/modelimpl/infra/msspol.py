...
class MssPol(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.MssPol")

    meta.moClassName = "infraMssPol"
    meta.rnFormat = "mssp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "TCP MSS Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 69498, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69499, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mssIPv4", "mssIPv4", 69492, PropCategory.REGULAR)
    prop.label = "MSS IPv4"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(688, 9104)]
    ...
    prop = PropMeta("str", "mssIPv6", "mssIPv6", 69493, PropCategory.REGULAR)
    prop.label = "MSS IPv6"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(668, 9084)]
    ...
    prop = PropMeta("str", "mssP", "mssP", 69491, PropCategory.REGULAR)
    prop.label = "MSS Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 69497, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
