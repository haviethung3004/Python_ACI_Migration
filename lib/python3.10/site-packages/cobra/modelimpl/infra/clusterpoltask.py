...
# ##################################################
class ClusterPolTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.ClusterPolTask")

    meta.moClassName = "infraClusterPolTask"
    meta.rnFormat = "infraClusterPolTask-%(id)s"
    meta.category = MoCategory.TASK
    meta.label = "None"
    meta.writeAccessMask = 0x1
    meta.readAccessMask = 0x8001
    ...
    prop = PropMeta("str", "id", "id", 67512, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("DisableShrink", "disableshrink", 4436)
    prop._addConstant("none", "none", 0)
    prop._addConstant("updateFabricNodeContraints", "updatefabricnodecontraints", 4326)
