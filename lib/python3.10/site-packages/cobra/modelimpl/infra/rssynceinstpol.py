...
# ##################################################
class RsSynceInstPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsSynceInstPol", "cobra.model.synce.InstPol")
    meta.targetNameProps["name"] = "tnSynceInstPolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSynceInstPol"
    meta.rnFormat = "rssynceInstPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "syncE Node Policy"
    ...
    meta.rnPrefixes = [
        ('rssynceInstPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 63066, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63067, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63063, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 63056, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18576
    prop.defaultValueStr = "synceInstPol"
    ...
    prop = PropMeta("str", "tnSynceInstPolName", "tnSynceInstPolName", 63055, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnSynceInstPolName", prop)
