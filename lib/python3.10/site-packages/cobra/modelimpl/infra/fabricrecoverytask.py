...
# ##################################################
class FabricRecoveryTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.FabricRecoveryTask")

    meta.moClassName = "infraFabricRecoveryTask"
    meta.rnFormat = "infraFabricRecoveryTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 63201, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("updateAdrelay", "updateadrelay", 4138)
