...
# ##################################################
class RsFuncToVirtualLIfPAttEntPCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsFuncToVirtualLIfPAttEntPCont", "cobra.model.l3ext.AttEntPCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsFuncToVirtualLIfPAttEntPCont"
    meta.rnFormat = "rsfuncToVirtualLIfPAttEntPCont-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VirtualLIfPs Using Function"
    ...
    meta.rnPrefixes = [
        ('rsfuncToVirtualLIfPAttEntPCont-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 58404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 58389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 58355, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17268
    prop.defaultValueStr = "l3extAttEntPCont"
    prop._addConstant("l3extAttEntPCont", None, 17268)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58354, PropCategory.REGULAR)
