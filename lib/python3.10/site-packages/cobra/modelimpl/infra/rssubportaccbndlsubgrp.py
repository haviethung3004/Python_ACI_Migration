...
# ##################################################
class RsSubPortAccBndlSubgrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsSubPortAccBndlSubgrp", "cobra.model.infra.AccBndlSubgrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsSubPortAccBndlSubgrp"
    meta.rnFormat = "rssubPortAccBndlSubgrp"
    ...
    meta.rnPrefixes = [
        ('rssubPortAccBndlSubgrp', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 67735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 67736, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 67734, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 67731, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67730, PropCategory.REGULAR)
