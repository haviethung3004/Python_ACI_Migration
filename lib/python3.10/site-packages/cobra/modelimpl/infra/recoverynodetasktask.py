...
# ##################################################
class RecoveryNodeTaskTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.RecoveryNodeTaskTask")

    meta.moClassName = "infraRecoveryNodeTaskTask"
    meta.rnFormat = "infraRecoveryNodeTaskTask-%(id)s"
    ...
    meta.rnPrefixes = [
        ('infraRecoveryNodeTaskTask-', True),
    ]
    ...
    prop = PropMeta("str", "id", "id", 63446, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("trigger", "trigger", 4153)
