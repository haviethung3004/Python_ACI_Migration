...
class SummaryContTask(Mo):
    ...
    meta = ClassMeta("cobra.model.infra.SummaryContTask")

    meta.moClassName = "infraSummaryContTask"
    meta.rnFormat = "infraSummaryContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 65940, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PortNodeConfigRecreate", "portnodeconfigrecreate", 4317)
