...
# ##################################################
class RsToInterfacePolProfileOpt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsToInterfacePolProfileOpt", "cobra.model.infra.AccPortP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "infraRsToInterfacePolProfileOpt"
    meta.rnFormat = "rstoInterfacePolProfileOpt-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoInterfacePolProfileOpt-', True),
    ]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69541, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69537, PropCategory.REGULAR)
