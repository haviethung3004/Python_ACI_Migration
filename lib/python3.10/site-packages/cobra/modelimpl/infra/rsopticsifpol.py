...
# ##################################################
class RsOpticsIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.infra.RsOpticsIfPol", "cobra.model.xcvr.OpticsIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsOpticsIfPol"
    meta.rnFormat = "rsOpticsIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Interface Optics Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68120, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68121, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68115, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68112, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19925
    prop.defaultValueStr = "xcvrOpticsIfPol"
    ...
    prop = PropMeta("str", "tDn", "tDn", 68111, PropCategory.REGULAR)
