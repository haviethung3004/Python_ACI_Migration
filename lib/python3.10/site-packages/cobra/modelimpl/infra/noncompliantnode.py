...
# ##################################################
class NonCompliantNode(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.infra.NonCompliantNode")

    meta.moClassName = "infraNonCompliantNode"
    meta.rnFormat = "noncompliantnode-%(serialNum)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cluster Element"
    meta.writeAccessMask = 0x2001
    meta.readAccessMask = 0x12019
    ...
    meta.rnPrefixes = [
        ('noncompliantnode-', True),
    ]

    prop = PropMeta("str", "NodeAddr", "NodeAddr", 70270, PropCategory.REGULAR)
    prop.label = "Node IP Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("NodeAddr", prop)
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 70268, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 70273, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 70274, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 70272, PropCategory.REGULAR)
    prop.label = "Monitoring policy"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 70267, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 70271, PropCategory.REGULAR)
    prop.label = "node Id"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "serialNum", "serialNum", 70269, PropCategory.REGULAR)
    prop.label = "Node Serial Number"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    meta.namingProps.append(getattr(meta.props, "serialNum"))

    def __init__(self, parentMoOrDn, serialNum, markDirty=True, **creationProps):
        namingVals = [serialNum]
