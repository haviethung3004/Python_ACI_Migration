...
class HostCfg(Mo):
    ...
    meta.childClasses.add("cobra.model.infra.RsConnectivityProfileOpt")
    meta.childClasses.add("cobra.model.infra.RsConnectivityProfileOptFc")
    meta.childClasses.add("cobra.model.infra.RsConnectivitySpProfile")

    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsConnectivityProfileOptFc", "rsconnectivityProfileOptFc"))
    meta.childNamesAndRnPrefix.append(("cobra.model.infra.RsConnectivityProfileOpt", "rsconnectivityProfileOpt"))
