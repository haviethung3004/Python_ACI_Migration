...
class Entity(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 69439, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69440, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operErr", "operErr", 69410, PropCategory.REGULAR)
