...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.infrasec.Entity")

    meta.moClassName = "infrasecEntity"
    meta.rnFormat = "infrasec"
    meta.category = MoCategory.REGULAR
    meta.label = "infrasec Entity"
    ...
    meta.childClasses.add("cobra.model.infrasec.Policy")

    meta.childNamesAndRnPrefix.append(("cobra.model.infrasec.Policy", "policy-"))
