...
class RtLIfDomP(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.phys.RtLIfDomP", "cobra.model.vns.LIf")

    meta.moClassName = "physRtLIfDomP"
    meta.rnFormat = "rtvnsLIfDomP-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Logical Interface"
    meta.writeAccessMask = 0x631
    meta.readAccessMask = 0x184633
    ...
    prop = PropMeta("str", "tCl", "tCl", 60662, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60661, PropCategory.REGULAR)
