...
class DomP(Mo):
    ...
    meta.writeAccessMask = 0x631
    meta.readAccessMask = 0x117633
    ...
    meta.childClasses.add("cobra.model.phys.RtLIfDomP")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.phys.RtLIfDomP", "rtvnsLIfDomP-"))
