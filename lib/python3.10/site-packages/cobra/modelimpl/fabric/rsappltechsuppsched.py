...
# ##################################################
class RsApplTechSupPSched(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fabric.RsApplTechSupPSched", "cobra.model.dbgexp.TechSupP")
    meta.targetNameProps["name"] = "tnDbgexpTechSupPName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsApplTechSupPSched"
    meta.rnFormat = "rsapplTechSupPSched-%(tnDbgexpTechSupPName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Tech Support Policy"
    meta.writeAccessMask = 0x3801
    meta.readAccessMask = 0x3801
    ...
    meta.rnPrefixes = [
        ('rsapplTechSupPSched-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 56427, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56428, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56426, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56423, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDbgexpTechSupPName", "tnDbgexpTechSupPName", 56422, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "tnDbgexpTechSupPName"))

    # Deployment Meta
    meta.deploymentQuery = True
    meta.deploymentType = "Ancestor"

    def __init__(self, parentMoOrDn, tnDbgexpTechSupPName, markDirty=True, **creationProps):
        namingVals = [tnDbgexpTechSupPName]
