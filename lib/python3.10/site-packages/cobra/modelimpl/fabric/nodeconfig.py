...
class NodeConfig(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.NodeConfig")

    meta.moClassName = "fabricNodeConfig"
    meta.rnFormat = "nodeconfnode-%(node)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 67572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "assocGrp", "assocGrp", 67569, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 67573, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "node", "node", 67568, PropCategory.REGULAR)
    prop.label = "Node"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
