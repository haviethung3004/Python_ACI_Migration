...
# ##################################################
class SummaryContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.SummaryContTask")

    meta.moClassName = "fabricSummaryContTask"
    meta.rnFormat = "fabricSummaryContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 67617, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("PortNodeConfigRecreate", "portnodeconfigrecreate", 4335)
