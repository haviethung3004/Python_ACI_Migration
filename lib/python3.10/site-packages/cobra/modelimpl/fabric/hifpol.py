...
class HIfPol(Mo):
    ...
    prop = PropMeta("str", "creator", "creator", 66806, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "emiRetrain", "emiRetrain", 65443, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portPhyMediaType", "portPhyMediaType", 62780, PropCategory.REGULAR)
