...
class InstTask(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.InstTask")

    meta.moClassName = "fabricInstTask"
    meta.rnFormat = "fabricInstTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 5644, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("CleanUpEmptyProfile", "cleanupemptyprofile", 4424)
