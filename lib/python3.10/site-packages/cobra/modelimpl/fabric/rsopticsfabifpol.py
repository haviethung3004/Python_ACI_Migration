...
# ##################################################
class RsOpticsFabIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsOpticsFabIfPol", "cobra.model.xcvr.OpticsFabIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fabricRsOpticsFabIfPol"
    meta.rnFormat = "rsOpticsFabIfPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Fabric Interface Optics Policy"
    ...
    meta.rnPrefixes = [
        ('rsOpticsFabIfPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 68184, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68185, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68181, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68178, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19935
    prop.defaultValueStr = "xcvrOpticsFabIfPol"
    ...
    prop = PropMeta("str", "tDn", "tDn", 68177, PropCategory.REGULAR)
