...
class Node(Mo):
    ...
    meta.childClasses.add("cobra.model.fabric.RtNodeFabricExpAtt")
    meta.childClasses.add("cobra.model.fabric.RtNodeFabricImpAtt")
    meta.childClasses.add("cobra.model.fabric.RtNodeL3OutAtt")
    meta.childClasses.add("cobra.model.fabric.RtNodeLocation")
    meta.childClasses.add("cobra.model.fabric.RtNodeRtSummAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.RtNodeFabricExpAtt", "rtfvNodeFabricExpAtt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.RtNodeFabricImpAtt", "rtfvNodeFabricImpAtt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.RtNodeRtSummAtt", "rtfvNodeRtSummAtt-"))
