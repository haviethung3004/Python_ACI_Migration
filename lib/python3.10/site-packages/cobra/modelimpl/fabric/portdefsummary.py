...
class PortDefSummary(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.PortDefSummary")

    meta.moClassName = "fabricPortDefSummary"
    ...
    meta.parentClasses.add("cobra.model.fabric.SummaryDefCont")
    ...
    prop = PropMeta("str", "card", "card", 69476, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mode", "mode", 69474, PropCategory.REGULAR)
    prop.label = "Port Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unknown"
    prop._addConstant("leaf", "leaf-individual", 1)
    prop._addConstant("spine", "spine-individual", 2)
    ...
    prop = PropMeta("str", "port", "port", 69477, PropCategory.REGULAR)
    prop.label = "Port Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "subPort", "subPort", 69478, PropCategory.REGULAR)
