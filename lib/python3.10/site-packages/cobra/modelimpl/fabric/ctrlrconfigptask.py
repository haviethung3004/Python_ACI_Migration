...
# ##################################################
class CtrlrConfigPTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fabric.CtrlrConfigPTask")

    meta.moClassName = "fabricCtrlrConfigPTask"
    meta.rnFormat = "fabricCtrlrConfigPTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 63202, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("UpdatePodConnPDef", "updatepodconnpdef", 4137)
