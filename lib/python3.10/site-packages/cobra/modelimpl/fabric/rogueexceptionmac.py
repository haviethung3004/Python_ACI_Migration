...
class RogueExceptionMac(Mo):
    ...
    meta = ClassMeta("cobra.model.fabric.RogueExceptionMac")

    meta.moClassName = "fabricRogueExceptionMac"
    meta.rnFormat = "rgexpmac-%(mac)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68672, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 68662, PropCategory.REGULAR)
    prop.label = "Exception Mac"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
