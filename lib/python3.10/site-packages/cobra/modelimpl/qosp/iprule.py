...
class IpRule(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosp:IpRuleaddr_failed_flag", None, 512)
    ...
    prop._addConstant("qosp:IpRulemarkExp_failed_flag", None, 32)
    prop._addConstant("qosp:IpRulemodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("qosp:IpRulenameAlias_failed_flag", None, 2)
    prop._addConstant("qosp:IpRulename_failed_flag", None, 1)
    prop._addConstant("qosp:IpRuleqosGrp_failed_flag", None, 256)
