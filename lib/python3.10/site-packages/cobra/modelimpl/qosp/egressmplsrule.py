...
# ##################################################
class EgressMplsRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.qosp.EgressMplsRule")

    meta.moClassName = "qospEgressMplsRule"
    meta.rnFormat = "EgrMpls-f-%(from)s-t-%(to)s-grp-%(qosGrp)s-dot1p-%(markDot1P)s-exp-%(markExp)s"
    meta.category = MoCategory.REGULAR
    meta.label = "MPLS DSCP QoS Classification Rule"
    meta.writeAccessMask = 0x20001
    meta.readAccessMask = 0x24001
    ...
    meta.childClasses.add("cobra.model.qosp.RtEgressMplsRuleAtt")

    meta.childNamesAndRnPrefix.append(("cobra.model.qosp.RtEgressMplsRuleAtt", "rtl3EgressMplsRuleAtt-"))
    ...
    prop = PropMeta("str", "from", "from", 56484, PropCategory.REGULAR)
    prop.label = "From"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markDot1P", "markDot1P", 56575, PropCategory.REGULAR)
    prop.label = "DOT1P"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "markExp", "markExp", 56576, PropCategory.REGULAR)
    prop.label = "Exp"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "qosGrp", "qosGrp", 56577, PropCategory.REGULAR)
    prop.label = "Group ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "qosmCfgFailedBmp", "qosmCfgFailedBmp", 56684, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosp:EgressMplsRuledescr_failed_flag", None, 4)
    prop._addConstant("qosp:EgressMplsRulefrom_failed_flag", None, 512)
    prop._addConstant("qosp:EgressMplsRulelcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("qosp:EgressMplsRulemarkDot1P_failed_flag", None, 8)
    prop._addConstant("qosp:EgressMplsRulemarkDscp_failed_flag", None, 16)
    prop._addConstant("qosp:EgressMplsRulemarkExp_failed_flag", None, 32)
    prop._addConstant("qosp:EgressMplsRulemodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("qosp:EgressMplsRulenameAlias_failed_flag", None, 2)
    prop._addConstant("qosp:EgressMplsRulename_failed_flag", None, 1)
    prop._addConstant("qosp:EgressMplsRuleqosGrp_failed_flag", None, 256)
    prop._addConstant("qosp:EgressMplsRuleto_failed_flag", None, 8192)
    meta.props.add("qosmCfgFailedBmp", prop)

    prop = PropMeta("str", "qosmCfgFailedTs", "qosmCfgFailedTs", 56686, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("qosmCfgFailedTs", prop)

    prop = PropMeta("str", "qosmCfgState", "qosmCfgState", 56685, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "to", "to", 56485, PropCategory.REGULAR)
    prop.label = "To"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, from_, to, qosGrp, markDot1P, markExp, markDirty=True, **creationProps):
        namingVals = [from_, to, qosGrp, markDot1P, markExp]
