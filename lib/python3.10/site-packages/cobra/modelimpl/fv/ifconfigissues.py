...
# ##################################################
class IfConfigIssues(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.IfConfigIssues")

    meta.moClassName = "fvIfConfigIssues"
    meta.rnFormat = "ifcfgissues-%(type)s"
    ...
    prop = PropMeta("str", "configQual", "configQual", 62006, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-applicable"
    prop._addConstant("ce-netflow-policy-conflict", "ce-netflow-policy-conflict", 8)
    prop._addConstant("ipv4-netflow-policy-conflict", "ipv4-netflow-policy-conflict", 2)
    prop._addConstant("ipv6-netflow-policy-conflict", "ipv6-netflow-policy-conflict", 4)
    ...
    prop = PropMeta("str", "debugMessage", "debugMessage", 62007, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62009, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 62008, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    prop.defaultValue = 0
    prop.defaultValueStr = "common"
    prop._addConstant("common", "common-configuration-issues", 0)
    prop._addConstant("netflow", "netflow-configuration-issues", 1)
