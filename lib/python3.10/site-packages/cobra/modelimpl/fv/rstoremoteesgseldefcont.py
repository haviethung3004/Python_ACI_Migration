...
# ##################################################
class RsToRemoteESgSelDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteESgSelDefCont", "cobra.model.fv.ESgSelDefCont")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToRemoteESgSelDefCont"
    meta.rnFormat = "rstoRemoteESgSelDefCont"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56085, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16471
    prop.defaultValueStr = "fvESgSelDefCont"
    prop._addConstant("fvESgSelDefCont", None, 16471)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56084, PropCategory.REGULAR)
