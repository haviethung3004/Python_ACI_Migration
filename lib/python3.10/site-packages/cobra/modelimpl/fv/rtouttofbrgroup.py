...
# ##################################################
class RtOutToFBRGroup(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtOutToFBRGroup", "cobra.model.l3ext.Out")

    meta.moClassName = "fvRtOutToFBRGroup"
    meta.rnFormat = "rtl3extOutToFBRGroup-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 65387, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65386, PropCategory.REGULAR)
