...
# ##################################################
class RsToRemoteIpContainer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteIpContainer", "cobra.model.hostprot.RemoteIpContainer")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteIpContainer"
    meta.rnFormat = "rstoRemoteIpContainer-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68404, PropCategory.REGULAR)
