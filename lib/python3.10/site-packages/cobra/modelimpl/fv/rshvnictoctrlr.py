...
# ##################################################
class RsHvNicToCtrlr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsHvNicToCtrlr", "cobra.model.comp.Ctrlr")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsHvNicToCtrlr"
    meta.rnFormat = "rshvNicToCtrlr-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 39285, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 39284, PropCategory.REGULAR)
