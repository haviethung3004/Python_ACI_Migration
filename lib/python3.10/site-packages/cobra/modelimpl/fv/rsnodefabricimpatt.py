...
# ##################################################
class RsNodeFabricImpAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsNodeFabricImpAtt", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsNodeFabricImpAtt"
    meta.rnFormat = "rsnodeFabricImpAtt-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsnodeFabricImpAtt-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65571, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65550, PropCategory.REGULAR)
