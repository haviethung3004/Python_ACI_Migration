...
# ##################################################
class RtFromAssocPolToExpRt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFromAssocPolToExpRt", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtFromAssocPolToExpRt"
    meta.rnFormat = "rtfromAssocPolToExpRt-[%(tDn)s]"
    ...
    meta.parentClasses.add("cobra.model.fv.FabricExpRtctrlDef")

    meta.superClasses.add("cobra.model.reln.From")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rtfromAssocPolToExpRt-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65723, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65722, PropCategory.REGULAR)
