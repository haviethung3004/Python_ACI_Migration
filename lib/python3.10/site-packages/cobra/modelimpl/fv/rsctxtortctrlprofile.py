...
# ##################################################
class RsCtxToRtctrlProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsCtxToRtctrlProfile", "cobra.model.rtctrl.Profile")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsCtxToRtctrlProfile"
    meta.rnFormat = "rsctxToRtctrlProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relationship to Route Control Profile"
    ...
    meta.rnPrefixes = [
        ('rsctxToRtctrlProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 60601, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 60602, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 60600, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 60598, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60597, PropCategory.REGULAR)
