...
# ##################################################
class RtFvAddrMgmtPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFvAddrMgmtPool", "cobra.model.comp.AddrMgmtPolCont")

    meta.moClassName = "fvRtFvAddrMgmtPool"
    meta.rnFormat = "rtcompFvAddrMgmtPool-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 69815, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20265
    prop.defaultValueStr = "compAddrMgmtPolCont"
    prop._addConstant("compAddrMgmtPolCont", None, 20265)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69814, PropCategory.REGULAR)
