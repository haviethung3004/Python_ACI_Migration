...
# ##################################################
class RtToRemoteESgHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteESgHolder", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteESgHolder"
    meta.rnFormat = "rttoRemoteESgHolder-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 60646, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 60645, PropCategory.REGULAR)
