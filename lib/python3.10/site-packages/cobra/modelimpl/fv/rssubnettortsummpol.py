...
# ##################################################
class RsSubnetToRtSummPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsSubnetToRtSummPol", "cobra.model.bgp.RtSummPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsSubnetToRtSummPol"
    meta.rnFormat = "rsSubnetToRtSummPol"
    ...
    meta.rnPrefixes = [
        ('rsSubnetToRtSummPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65514, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65507, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65500, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 7688
    prop.defaultValueStr = "bgpRtSummPol"
    prop._addConstant("bgpRtSummPol", None, 7688)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65499, PropCategory.REGULAR)
