...
# ##################################################
class RtExtCtxProfileToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtExtCtxProfileToCtx", "cobra.model.cloud.ExtCtxProfile")

    meta.moClassName = "fvRtExtCtxProfileToCtx"
    meta.rnFormat = "rtcloudExtCtxProfileToCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "External Cloud Context Profile"
    ...
    meta.rnPrefixes = [
        ('rtcloudExtCtxProfileToCtx-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 62058, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18296
    prop.defaultValueStr = "cloudExtCtxProfile"
    prop._addConstant("cloudExtCtxProfile", None, 18296)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62057, PropCategory.REGULAR)
