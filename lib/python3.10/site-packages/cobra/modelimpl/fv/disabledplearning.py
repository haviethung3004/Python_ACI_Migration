...
# ##################################################
class DisableDPLearning(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.DisableDPLearning")

    meta.moClassName = "fvDisableDPLearning"
    meta.rnFormat = "dsblDPLearn"
    meta.category = MoCategory.REGULAR
    meta.label = "Disable Ip Dataplane Learning for EPG Host, /32 or /128"
    meta.writeAccessMask = 0x5
    meta.readAccessMask = 0x80005
    ...
    prop = PropMeta("str", "annotation", "annotation", 62847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62848, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62846, PropCategory.REGULAR)
