...
# ##################################################
class RsToRemoteLocalSiteBdDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteLocalSiteBdDef", "cobra.model.fv.LocalBdDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteLocalSiteBdDef"
    meta.rnFormat = "rstoRemoteLocalSiteBdDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Local BD Definition"
    ...
    prop = PropMeta("str", "tCl", "tCl", 69743, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9510
    prop.defaultValueStr = "fvLocalBdDef"
    prop._addConstant("fvLocalBdDef", None, 9510)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69742, PropCategory.REGULAR)
