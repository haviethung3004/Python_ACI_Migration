...
# ##################################################
class RsImportFromFabricProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsImportFromFabricProfile", "cobra.model.rtctrl.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsImportFromFabricProfile"
    meta.rnFormat = "rsimportFromFabricProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Import Route Profile"
    ...
    meta.rnPrefixes = [
        ('rsimportFromFabricProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65573, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65565, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65546, PropCategory.REGULAR)
