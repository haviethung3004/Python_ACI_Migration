...
# ##################################################
class RsToRemoteLeakRouteFromToCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteLeakRouteFromToCont", "cobra.model.leak.RouteFromToCont")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteLeakRouteFromToCont"
    meta.rnFormat = "rstoRemoteLeakRouteFromToCont-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteLeakRouteFromToCont-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65268, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17491
    prop.defaultValueStr = "leakRouteFromToCont"
    prop._addConstant("leakRouteFromToCont", None, 17491)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65267, PropCategory.REGULAR)
