...
class SvcBD(Mo):
    ...
    prop._addConstant("l3-mcast-is-enabled-on-vrf-where-bd-has-ip-learn-disable", "l3-mcast-is-enabled-on-vrf-where-bd-has-ip-learn-disable", 4)
    ...
    prop = PropMeta("str", "serviceBdRoutingDisable", "serviceBdRoutingDisable", 70465, PropCategory.REGULAR)
    prop.label = "Disable Routing on service BD"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("serviceBdRoutingDisable", prop)
