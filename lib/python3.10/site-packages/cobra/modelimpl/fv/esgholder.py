...
class ESgHolder(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.ESgHolder")

    meta.moClassName = "fvESgHolder"
    meta.rnFormat = "esghold-[%(ctxDn)s]"
    ...
    meta.childClasses.add("cobra.model.fv.RtToRemoteESgHolder")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToRemoteESgHolder", "rttoRemoteESgHolder-"))
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 60639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "missingContent", "missingContent", 60641, PropCategory.REGULAR)
