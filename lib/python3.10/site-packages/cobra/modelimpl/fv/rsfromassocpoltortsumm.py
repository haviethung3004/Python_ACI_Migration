...
# ##################################################
class RsFromAssocPolToRtSumm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsFromAssocPolToRtSumm", "cobra.model.fv.CtxRtSummPolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsFromAssocPolToRtSumm"
    meta.rnFormat = "rsfromAssocPolToRtSumm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 65492, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19160
    prop.defaultValueStr = "fvCtxRtSummPolDef"
    prop._addConstant("fvCtxRtSummPolDef", None, 19160)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65491, PropCategory.REGULAR)
