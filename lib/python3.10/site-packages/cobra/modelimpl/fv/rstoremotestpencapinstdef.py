...
# ##################################################
class RsToRemoteStpEncapInstDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteStpEncapInstDef", "cobra.model.stp.EncapInstDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteStpEncapInstDef"
    meta.rnFormat = "rstoRemoteStpEncapInstDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteStpEncapInstDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65471, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65470, PropCategory.REGULAR)
