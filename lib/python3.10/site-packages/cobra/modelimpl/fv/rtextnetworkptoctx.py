...
# ##################################################
class RtExtNetworkPToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtExtNetworkPToCtx", "cobra.model.cloud.ExtNetworkP")

    meta.moClassName = "fvRtExtNetworkPToCtx"
    meta.rnFormat = "rtcloudExtNetworkPToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63756, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 14409
    prop.defaultValueStr = "cloudExtNetworkP"
    prop._addConstant("cloudExtNetworkP", None, 14409)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63755, PropCategory.REGULAR)
