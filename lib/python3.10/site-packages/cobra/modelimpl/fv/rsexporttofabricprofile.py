...
# ##################################################
class RsExportToFabricProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsExportToFabricProfile", "cobra.model.rtctrl.Profile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsExportToFabricProfile"
    meta.rnFormat = "rsexportToFabricProfile"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Export Route Profile"
    ...
    meta.rnPrefixes = [
        ('rsexportToFabricProfile', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65578, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65579, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65567, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65555, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65554, PropCategory.REGULAR)
