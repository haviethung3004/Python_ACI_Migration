...
class RtDcToEpg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtDcToEpg", "cobra.model.intersight.DeviceConnectorInst")

    meta.moClassName = "fvRtDcToEpg"
    meta.rnFormat = "rtdcToEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67887, PropCategory.REGULAR)
