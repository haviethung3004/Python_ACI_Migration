...
# ##################################################
class RsHvNicToLocale(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsHvNicToLocale", "cobra.model.comp.HvNicCont")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "fvRsHvNicToLocale"
    meta.rnFormat = "rshvNicToLocale"
    ...
    meta.parentClasses.add("cobra.model.fv.HvNic")

    meta.superClasses.add("cobra.model.reln.To")
    meta.superClasses.add("cobra.model.reln.Inst")

    meta.rnPrefixes = [
        ('rshvNicToLocale', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 39369, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 11943
    prop.defaultValueStr = "compHvNicCont"
    prop._addConstant("compHvNicCont", None, 11943)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 39368, PropCategory.REGULAR)
