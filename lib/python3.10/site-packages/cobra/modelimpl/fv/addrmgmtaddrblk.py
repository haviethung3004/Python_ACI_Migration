...
class AddrMgmtAddrBlk(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.AddrMgmtAddrBlk")

    meta.moClassName = "fvAddrMgmtAddrBlk"
    ...
    prop = PropMeta("str", "annotation", "annotation", 69846, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69847, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "from", "from", 69795, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "to", "to", 69796, PropCategory.REGULAR)
