...
# ##################################################
class EpVmmMacTagDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.EpVmmMacTagDef")

    meta.moClassName = "fvEpVmmMacTagDef"
    meta.rnFormat = "epvmmmactagdef-%(mac)s-[%(epgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "VMM Mac Endpoint"
    ...
    meta.childClasses.add("cobra.model.tag.DerivedTag")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.AssocESgTagSel", "assocesgtagsel"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.DerivedTag", "derivedtagKey-"))
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 63146, PropCategory.REGULAR)
    prop.label = "EPG DN"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "mac", "mac", 63144, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63151, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "vmName", "vmName", 63145, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    def __init__(self, parentMoOrDn, mac, epgDn, markDirty=True, **creationProps):
        namingVals = [mac, epgDn]
