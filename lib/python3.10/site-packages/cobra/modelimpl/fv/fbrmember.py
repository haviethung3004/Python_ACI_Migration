...
class FBRMember(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.FBRMember")

    meta.moClassName = "fvFBRMember"
    meta.rnFormat = "nexthop-[%(rnhAddr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "FBR Member"
    ...
    meta.superClasses.add("cobra.model.fv.AFBRMember")
    ...
    prop = PropMeta("str", "annotation", "annotation", 65401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65402, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rnhAddr", "rnhAddr", 65380, PropCategory.REGULAR)
    prop.label = "Fallback Router Member Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("rnhAddr", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "rnhAddr"))
    getattr(meta.props, "rnhAddr").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, rnhAddr, markDirty=True, **creationProps):
        namingVals = [rnhAddr]
