...
# ##################################################
class RsToRemoteRemoteSiteBdDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteRemoteSiteBdDef", "cobra.model.fv.RemoteBdDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteRemoteSiteBdDef"
    meta.rnFormat = "rstoRemoteRemoteSiteBdDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Remote BD Definition"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteRemoteSiteBdDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 69747, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9511
    prop.defaultValueStr = "fvRemoteBdDef"
    prop._addConstant("fvRemoteBdDef", None, 9511)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69746, PropCategory.REGULAR)
