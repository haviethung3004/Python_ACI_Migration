...
# ##################################################
class TenantTagsHolderTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.TenantTagsHolderTask")

    meta.moClassName = "fvTenantTagsHolderTask"
    meta.rnFormat = "fvTenantTagsHolderTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 63129, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("ESgTagsUpdate", "esgtagsupdate", 4131)
