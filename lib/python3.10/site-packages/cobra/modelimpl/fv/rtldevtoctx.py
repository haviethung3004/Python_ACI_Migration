...
# ##################################################
class RtLDevToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtLDevToCtx", "cobra.model.cloud.LDev")

    meta.moClassName = "fvRtLDevToCtx"
    meta.rnFormat = "rtcloudLDevToCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Cloud L4-L7 Device"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58381, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17260
    prop.defaultValueStr = "cloudLDev"
    prop._addConstant("cloudLDev", None, 17260)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58380, PropCategory.REGULAR)
