...
# ##################################################
class RtToEpIpTag(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpIpTag", "cobra.model.fv.Ip")

    meta.moClassName = "fvRtToEpIpTag"
    meta.rnFormat = "rttoEpIpTag-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63421, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63420, PropCategory.REGULAR)
