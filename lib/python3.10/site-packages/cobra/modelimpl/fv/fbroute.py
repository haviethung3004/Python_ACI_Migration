...
class FBRoute(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.FBRoute")

    meta.moClassName = "fvFBRoute"
    meta.rnFormat = "pfx-[%(fbrPrefix)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Fallback Route"
    ...
    meta.superClasses.add("cobra.model.fv.AFBRoute")
    ...
    prop = PropMeta("str", "annotation", "annotation", 65399, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65400, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fbrPrefix", "fbrPrefix", 65382, PropCategory.REGULAR)
    prop.label = "Fallback Route Address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("fbrPrefix", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "fbrPrefix"))
    getattr(meta.props, "fbrPrefix").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, fbrPrefix, markDirty=True, **creationProps):
        namingVals = [fbrPrefix]
