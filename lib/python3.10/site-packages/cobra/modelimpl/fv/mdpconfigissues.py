...
# ##################################################
class MdpConfigIssues(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.MdpConfigIssues")

    meta.moClassName = "fvMdpConfigIssues"
    meta.rnFormat = "mdpcfgissues"
    meta.category = MoCategory.REGULAR
    meta.label = "Mdp Configuration Issues"
    ...
    prop = PropMeta("str", "configQual", "configQual", 63689, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "not-applicable"
    prop._addConstant("external-routable-pool-exhaustion", "no-more-external-tep-address-available", 1)
    ...
    prop = PropMeta("str", "debugMessage", "debugMessage", 63690, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
