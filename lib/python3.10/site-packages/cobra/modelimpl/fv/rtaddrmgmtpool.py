...
# ##################################################
class RtAddrMgmtPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtAddrMgmtPool", "cobra.model.fv.AEPgAddrMgmtPoolAtt")

    meta.moClassName = "fvRtAddrMgmtPool"
    meta.rnFormat = "rtaddrMgmtPool-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 69823, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20275
    prop.defaultValueStr = "fvAEPgAddrMgmtPoolAtt"
    prop._addConstant("fvAEPgAddrMgmtPoolAtt", None, 20275)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69822, PropCategory.REGULAR)
