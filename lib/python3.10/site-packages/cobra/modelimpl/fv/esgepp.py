...
class ESgEpP(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.ESgEpP")

    meta.moClassName = "fvESgEpP"
    meta.rnFormat = "sec-[%(epgPKey)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Security EPg Resolved"
    ...
    meta.childClasses.add("cobra.model.fv.RsToRemoteESgSelDefCont")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteESgSelDefCont", "rstoRemoteESgSelDefCont"))
    ...
    prop = PropMeta("str", "epgPKey", "epgPKey", 56082, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56096, PropCategory.REGULAR)
