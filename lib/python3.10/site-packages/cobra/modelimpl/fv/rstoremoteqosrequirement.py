...
# ##################################################
class RsToRemoteQosRequirement(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteQosRequirement", "cobra.model.qos.Requirement")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteQosRequirement"
    meta.rnFormat = "rstoRemoteQosRequirement-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 61910, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 61909, PropCategory.REGULAR)
