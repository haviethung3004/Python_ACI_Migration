...
class RtFromEsg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtFromEsg", "cobra.model.dbgac.FromEpgCmn")

    meta.moClassName = "fvRtFromEsg"
    meta.rnFormat = "rtdbgacFromEsg-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62823, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62822, PropCategory.REGULAR)
