...
# ##################################################
class AssocESgTagSel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.AssocESgTagSel")

    meta.moClassName = "fvAssocESgTagSel"
    meta.rnFormat = "assocesgtagsel"
    meta.category = MoCategory.REGULAR
    meta.label = "Associated ESg TagSelector"
    ...
    prop = PropMeta("str", "esgDn", "esgDn", 63119, PropCategory.REGULAR)
    prop.label = "Associated fvESg DN"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tagSelectorDn", "tagSelectorDn", 63099, PropCategory.REGULAR)
    prop.label = "Associated fvTagSelector DN"
    prop.isImplicit = True
    prop.isAdmin = True
