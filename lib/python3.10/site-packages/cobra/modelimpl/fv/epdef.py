...
class EpDef(Mo):
    ...
    prop = PropMeta("str", "baseEpgDn", "baseEpgDn", 59794, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("baseEpgDn", prop)

    prop = PropMeta("str", "bdDn", "bdDn", 62695, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "contName", "contName", 68842, PropCategory.REGULAR)
    prop.label = "Endpoint Name"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "epUpSeqNum", "epUpSeqNum", 67828, PropCategory.REGULAR)
    prop.label = "EP Update Sequence Number"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("epUpSeqNum", prop)

    prop = PropMeta("str", "esgUsegDn", "esgUsegDn", 59795, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("esgUsegDn", prop)

    prop = PropMeta("str", "fabricPathDn", "fabricPathDn", 62696, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop._addConstant("control-ep", "control-ep", 2251799813685248)
    ...
    prop._addConstant("lrn-dis", "lrn-dis-ep", 1125899906842624)
    ...
    prop._addConstant("ptp", "ptp-ep", 562949953421312)
    ...
    prop = PropMeta("str", "hostingServer", "hostingServer", 68843, PropCategory.REGULAR)
    prop.label = "Hypervisor/Container Host hosting the Endpoint"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("hostingServer", prop)
    ...
    prop = PropMeta("str", "reportingControllerName", "reportingControllerName", 68844, PropCategory.REGULAR)
    prop.label = "Orchestrator reporting the Endpoint"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("reportingControllerName", prop)
    ...
    prop = PropMeta("str", "vrfDn", "vrfDn", 62694, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
