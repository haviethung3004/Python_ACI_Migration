...
# ##################################################
class NwIssuesExtended(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.NwIssuesExtended")

    meta.moClassName = "fvNwIssuesExtended"
    meta.rnFormat = "nwissuesext"
    ...
    prop = PropMeta("str", "configQual", "configQual", 63127, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63130, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tempConfigQual", "tempConfigQual", 63128, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
