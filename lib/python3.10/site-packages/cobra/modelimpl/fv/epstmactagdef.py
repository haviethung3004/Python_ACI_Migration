...
# ##################################################
class EpStMacTagDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.EpStMacTagDef")

    meta.moClassName = "fvEpStMacTagDef"
    meta.rnFormat = "epstmactagdef-[%(stCEpDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Static Mac Endpoint"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "stCEpDn", "stCEpDn", 63093, PropCategory.REGULAR)
    prop.label = "Static CEp DN"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("stCEpDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "stCEpDn"))
    getattr(meta.props, "stCEpDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, stCEpDn, markDirty=True, **creationProps):
        namingVals = [stCEpDn]
