...
# ##################################################
class RsToRemoteHostprotPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteHostprotPolDef", "cobra.model.hostprot.PolDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteHostprotPolDef"
    meta.rnFormat = "rstoRemoteHostprotPolDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68401, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68400, PropCategory.REGULAR)
