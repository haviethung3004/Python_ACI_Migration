...
class RogueExceptionMac(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.RogueExceptionMac")

    meta.moClassName = "fvRogueExceptionMac"
    ...
    meta.superClasses.add("cobra.model.fv.ARogueExceptionMac")
    ...
    prop = PropMeta("str", "annotation", "annotation", 63883, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63884, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 63881, PropCategory.REGULAR)
