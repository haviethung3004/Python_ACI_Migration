...
# ##################################################
class RsToRemoteESgHolder(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteESgHolder", "cobra.model.fv.ESgHolder")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteESgHolder"
    meta.rnFormat = "rstoRemoteESgHolder-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ESg Holder for the CTX"
    ...
    prop = PropMeta("str", "tCl", "tCl", 60644, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17975
    prop.defaultValueStr = "fvESgHolder"
    prop._addConstant("fvESgHolder", None, 17975)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 60643, PropCategory.REGULAR)
