...
class IfConn(Mo):
    ...
    meta.childClasses.add("cobra.model.bfd.MhIfDef")
    meta.childClasses.add("cobra.model.bfd.MicroBfdDef")
    ...
    meta.childClasses.add("cobra.model.fv.IfConfigIssues")
    ...
    meta.childClasses.add("cobra.model.l3ext.FloatingIpCont")
    meta.childClasses.add("cobra.model.l3ext.ForwarderAddrDef")
    meta.childClasses.add("cobra.model.l3ext.IpDef")
    meta.childClasses.add("cobra.model.l3ext.RogueExceptMacPDef")
    meta.childClasses.add("cobra.model.l3ext.SharedSecondaryIpContDef")
    meta.childClasses.add("cobra.model.l3ext.VmmDomTracker")
    meta.childClasses.add("cobra.model.mgmt.IpDef")
    meta.childClasses.add("cobra.model.mpls.IfDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.FloatingIpCont", "floatingipcont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IfConfigIssues", "ifcfgissues-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.SharedSecondaryIpContDef", "sharedipcont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.netflow.MonitorPolHolder", "monitorpolh-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.MicroBfdDef", "microBfdDef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bfd.MhIfDef", "bfdMhIfDef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.IfDef", "mplsifdef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RogueExceptMacPDef", "rmacpdef"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.VmmDomTracker", "dom-"))
    ...
    prop = PropMeta("str", "configurationMode", "configurationMode", 68796, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("configurationMode", prop)
    ...
    prop = PropMeta("str", "isMultiPodDirect", "isMultiPodDirect", 62992, PropCategory.REGULAR)
    prop.label = "MultiPod Direct Link"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
