...
class Ip(Mo):
    ...
    meta.childClasses.add("cobra.model.fv.RsToEpIpTag")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToEpIpTag", "rstoEpIpTag"))
    ...
    prop = PropMeta("str", "baseEpgDn", "baseEpgDn", 59796, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("baseEpgDn", prop)

    prop = PropMeta("str", "bdDn", "bdDn", 62701, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "encap", "encap", 69737, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("encap", prop)

    prop = PropMeta("str", "esgUsegDn", "esgUsegDn", 59797, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "fabricPathDn", "fabricPathDn", 62702, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrfDn", "vrfDn", 62700, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
