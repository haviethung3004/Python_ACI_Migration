...
# ##################################################
class AddrMgmtPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.AddrMgmtPool")

    meta.moClassName = "fvAddrMgmtPool"
    meta.rnFormat = "ipampool-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Address Management Pool"
    ...
    meta.childClasses.add("cobra.model.fv.AddrMgmtAddrBlk")
    meta.childClasses.add("cobra.model.fv.RtAddrMgmtPool")
    meta.childClasses.add("cobra.model.fv.RtFvAddrMgmtPool")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtFvAddrMgmtPool", "rtcompFvAddrMgmtPool-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtAddrMgmtPool", "rtaddrMgmtPool-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.AddrMgmtAddrBlk", "fromaddr-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 69844, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69845, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 69797, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
