...
class EpP(Mo):
    ...
    meta.childClasses.add("cobra.model.qos.RequirementHolder")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.qos.RequirementHolder", "qosrequirementh"))
