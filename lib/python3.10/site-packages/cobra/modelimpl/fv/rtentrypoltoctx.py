...
# ##################################################
class RtEntryPolToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtEntryPolToCtx", "cobra.model.pim.InterVRFEntryPol")

    meta.moClassName = "fvRtEntryPolToCtx"
    meta.rnFormat = "rtpimEntryPolToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67549, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12379
    prop.defaultValueStr = "pimInterVRFEntryPol"
    prop._addConstant("pimInterVRFEntryPol", None, 12379)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 67548, PropCategory.REGULAR)
