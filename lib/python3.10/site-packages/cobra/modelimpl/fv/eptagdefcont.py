...
# ##################################################
class EpTagDefCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.EpTagDefCont")

    meta.moClassName = "fvEpTagDefCont"
    meta.rnFormat = "eptagdefcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Container for Object of type AEpTag Def"
    ...
    meta.childClasses.add("cobra.model.fv.EpStMacTagDef")
    meta.childClasses.add("cobra.model.fv.EpSubnetTagDef")
    meta.childClasses.add("cobra.model.fv.EpVmmMacTagDef")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.EpVmmMacTagDef", "epvmmmactagdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.EpStMacTagDef", "epstmactagdef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.EpSubnetTagDef", "epsubtagdef-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63104, PropCategory.REGULAR)
