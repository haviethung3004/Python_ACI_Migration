...
# ##################################################
class RtIpESgEpPAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtIpESgEpPAtt", "cobra.model.l3.SecIpCktEp")

    meta.moClassName = "fvRtIpESgEpPAtt"
    meta.rnFormat = "rtl3IpESgEpPAtt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56095, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16478
    prop.defaultValueStr = "l3SecIpCktEp"
    prop._addConstant("l3SecIpCktEp", None, 16478)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56094, PropCategory.REGULAR)
