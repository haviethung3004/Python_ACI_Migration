...
class RsDomAtt(Mo):
    ...
    meta.childClasses.add("cobra.model.fv.AEPgAddrMgmtPoolAtt")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.AEPgAddrMgmtPoolAtt", "epgipampoolatt"))
    ...
    prop = PropMeta("str", "apiMode", "apiMode", 69172, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "ipamDhcpOverride", "ipamDhcpOverride", 69801, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("ipamDhcpOverride", prop)

    prop = PropMeta("str", "ipamEnabled", "ipamEnabled", 69802, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ipamGateway", "ipamGateway", 69803, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
