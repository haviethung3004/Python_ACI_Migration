...
class EpMacTag(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpMacTag")

    meta.moClassName = "fvEpMacTag"
    meta.rnFormat = "epmactag-%(mac)s-[%(bdName)s]"
    ...
    meta.childClasses.add("cobra.model.fv.AssocESgTagSel")
    meta.childClasses.add("cobra.model.fv.RsEpTagBd")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.AssocESgTagSel", "assocesgtagsel"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsEpTagBd", "rsepTagBd"))
    ...
    meta.superClasses.add("cobra.model.fv.AEpTag")
    ...
    prop = PropMeta("str", "annotation", "annotation", 62887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bdName", "bdName", 62867, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctxName", "ctxName", 63214, PropCategory.REGULAR)
    prop.label = "VRF name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62888, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mac", "mac", 62866, PropCategory.REGULAR)
    prop.label = "Endpoint MAC address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62881, PropCategory.REGULAR)
    ...
    getattr(meta.props, "bdName").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, mac, bdName, markDirty=True, **creationProps):
        namingVals = [mac, bdName]
