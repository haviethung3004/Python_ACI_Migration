...
class RtScope(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtScope", "cobra.model.fv.ESg")

    meta.moClassName = "fvRtScope"
    meta.rnFormat = "rtscope-[%(tDn)s]"
    ...
    meta.superClasses.add("cobra.model.fv.RtScopeFrom")
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 58452, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56090, PropCategory.REGULAR)
