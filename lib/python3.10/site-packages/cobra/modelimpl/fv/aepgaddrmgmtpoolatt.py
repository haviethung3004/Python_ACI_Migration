...
# ##################################################
class AEPgAddrMgmtPoolAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.AEPgAddrMgmtPoolAtt")

    meta.moClassName = "fvAEPgAddrMgmtPoolAtt"
    meta.rnFormat = "epgipampoolatt"
    meta.category = MoCategory.REGULAR
    meta.label = "Application EPG IP Address Management Policy"
    ...
    meta.childClasses.add("cobra.model.fv.RsAddrMgmtPool")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsAddrMgmtPool", "rsAddrMgmtPool"))
    ...
    meta.rnPrefixes = [
        ('epgipampoolatt', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69840, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69828, PropCategory.REGULAR)
