...
# ##################################################
class RsToEpIpTag(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToEpIpTag", "cobra.model.fv.EpIpTag")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToEpIpTag"
    meta.rnFormat = "rstoEpIpTag"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63419, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18584
    prop.defaultValueStr = "fvEpIpTag"
    prop._addConstant("fvEpIpTag", None, 18584)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63418, PropCategory.REGULAR)
