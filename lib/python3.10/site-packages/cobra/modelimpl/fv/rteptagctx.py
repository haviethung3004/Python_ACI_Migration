...
class RtEpTagCtx(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtEpTagCtx", "cobra.model.fv.AEpTag")

    meta.moClassName = "fvRtEpTagCtx"
    meta.rnFormat = "rtepTagCtx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "EpTag associated to the VRF"
    meta.writeAccessMask = 0x5
    meta.readAccessMask = 0x18976d
    ...
    prop = PropMeta("str", "tCl", "tCl", 62874, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18525
    prop.defaultValueStr = "fvAEpTag"
    ...
    prop = PropMeta("str", "tDn", "tDn", 62873, PropCategory.REGULAR)
