...
class RtEpTagBd(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtEpTagBd", "cobra.model.fv.EpMacTag")

    meta.moClassName = "fvRtEpTagBd"
    meta.rnFormat = "rtepTagBd-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "EpTag associated to the Bridge Domain"
    meta.writeAccessMask = 0x5
    meta.readAccessMask = 0x184f6d
    ...
    prop = PropMeta("str", "tCl", "tCl", 62878, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18528
    prop.defaultValueStr = "fvEpMacTag"
    prop._addConstant("fvEpMacTag", None, 18528)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62877, PropCategory.REGULAR)
