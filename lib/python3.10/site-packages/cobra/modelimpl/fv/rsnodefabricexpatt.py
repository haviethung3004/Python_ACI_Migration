...
# ##################################################
class RsNodeFabricExpAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsNodeFabricExpAtt", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsNodeFabricExpAtt"
    meta.rnFormat = "rsnodeFabricExpAtt-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsnodeFabricExpAtt-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65576, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65577, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65559, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65558, PropCategory.REGULAR)
