...
# ##################################################
class RsToRemoteMdpProviderDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteMdpProviderDef", "cobra.model.mdp.ProviderDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteMdpProviderDef"
    meta.rnFormat = "rstoRemoteMdpProviderDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56592, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16600
    prop.defaultValueStr = "mdpProviderDef"
    prop._addConstant("mdpProviderDef", None, 16600)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56591, PropCategory.REGULAR)
