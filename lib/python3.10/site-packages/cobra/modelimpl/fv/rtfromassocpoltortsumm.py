...
# ##################################################
class RtFromAssocPolToRtSumm(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtFromAssocPolToRtSumm", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtFromAssocPolToRtSumm"
    meta.rnFormat = "rtfromAssocPolToRtSumm-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 65494, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65493, PropCategory.REGULAR)
