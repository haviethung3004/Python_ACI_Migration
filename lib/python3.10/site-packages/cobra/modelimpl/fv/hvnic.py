...
class HvNic(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.HvNic")

    meta.moClassName = "fvHvNic"
    meta.rnFormat = "nic-%(mac)s"
    ...
    meta.childClasses.add("cobra.model.fv.RsHvNicToCtrlr")
    meta.childClasses.add("cobra.model.fv.RsHvNicToLocale")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsHvNicToCtrlr", "rshvNicToCtrlr-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsHvNicToLocale", "rshvNicToLocale"))
    ...
    prop = PropMeta("str", "mac", "mac", 39277, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
