...
class RsMatchEPg(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fv.RsMatchEPg", "cobra.model.fv.EPg")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsMatchEPg"
    meta.rnFormat = "rsmatchEPg"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Match fvEPg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62745, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62744, PropCategory.REGULAR)
