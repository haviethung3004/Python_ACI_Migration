...
# ##################################################
class RsToEpMacTag(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToEpMacTag", "cobra.model.fv.ATp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsToEpMacTag"
    meta.rnFormat = "rstoEpMacTag"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63415, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2029
    prop.defaultValueStr = "fvATp"
    ...
    prop = PropMeta("str", "tDn", "tDn", 63414, PropCategory.REGULAR)
