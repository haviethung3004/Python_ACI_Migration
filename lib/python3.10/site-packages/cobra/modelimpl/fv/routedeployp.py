...
# ##################################################
class RouteDeployP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RouteDeployP")

    meta.moClassName = "fvRouteDeployP"
    meta.rnFormat = "routedeploy"
    meta.category = MoCategory.REGULAR
    meta.label = "Vrf Level Route Deployment Policy"
    ...
    meta.superClasses.add("cobra.model.fv.ARouteDeployP")
    ...
    prop = PropMeta("str", "annotation", "annotation", 68451, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68452, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68450, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "spineIntraVrf", "spineIntraVrf", 68449, PropCategory.REGULAR)
    prop.label = "Spine Intra Vrf Route deployment type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "contract"
    prop._addConstant("automatic", "automatic", 1)
    prop._addConstant("contract", "contract", 2)
    meta.props.add("spineIntraVrf", prop)
