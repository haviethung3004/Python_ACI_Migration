...
# ##################################################
class RemoteIdDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.RemoteIdDef")

    meta.moClassName = "fvRemoteIdDef"
    meta.rnFormat = "sitedef-%(siteId)s"
    ...
    prop = PropMeta("str", "siteId", "siteId", 68914, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
