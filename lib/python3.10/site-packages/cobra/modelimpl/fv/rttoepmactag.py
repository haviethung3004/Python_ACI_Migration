...
# ##################################################
class RtToEpMacTag(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToEpMacTag", "cobra.model.fv.CEp")

    meta.moClassName = "fvRtToEpMacTag"
    meta.rnFormat = "rttoEpMacTag-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63417, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63416, PropCategory.REGULAR)
