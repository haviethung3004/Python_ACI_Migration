...
# ##################################################
class RsFromAssocPolToExpRt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsFromAssocPolToExpRt", "cobra.model.fv.FabricExpRtctrlDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsFromAssocPolToExpRt"
    meta.rnFormat = "rsfromAssocPolToExpRt-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 65721, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19188
    prop.defaultValueStr = "fvFabricExpRtctrlDef"
    prop._addConstant("fvFabricExpRtctrlDef", None, 19188)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65720, PropCategory.REGULAR)
