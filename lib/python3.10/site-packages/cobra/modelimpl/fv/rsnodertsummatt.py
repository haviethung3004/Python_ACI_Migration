...
# ##################################################
class RsNodeRtSummAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsNodeRtSummAtt", "cobra.model.fabric.Node")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsNodeRtSummAtt"
    meta.rnFormat = "rsnodeRtSummAtt-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsnodeRtSummAtt-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65510, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65511, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65496, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65495, PropCategory.REGULAR)
