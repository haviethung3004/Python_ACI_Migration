...
class RsEpTagBd(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsEpTagBd", "cobra.model.fv.BD")
    meta.targetNameProps["name"] = "tnFvBDName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpTagBd"
    meta.rnFormat = "rsepTagBd"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Bridge Domain for the EpTag"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62882, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvBDName", "tnFvBDName", 62875, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
