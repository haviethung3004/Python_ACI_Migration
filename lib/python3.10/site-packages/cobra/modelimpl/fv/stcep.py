...
class StCEp(Mo):
    ...
    prop._addConstant("multiple-tag-selector-match", "tag(s)-matching-more-than-one-esg-tagselector.-endpoints-can-only-be-associated-to-a-single-esg-tagselector-via-tags.", 2)
    prop._addConstant("multiple-tag-selector-match-after-single-match", "tag(s)-are-now-matching-more-than-one-esg-tagselector.-the-original-match-is-still-active.-endpoints-can-only-be-associated-to-a-single-esg-tagselector-via-tags.", 4)
    prop._addConstant("none", "none", 0)
    prop._addConstant("path-not-present", "path-not-present", 1)
    meta.props.add("configIssues", prop)

    prop = PropMeta("str", "debugMessage", "debugMessage", 63131, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
