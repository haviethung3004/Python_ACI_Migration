...
# ##################################################
class ESgOOService(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.ESgOOService")

    meta.moClassName = "fvESgOOService"
    meta.rnFormat = "esgoos-[%(esgDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Out Of Service ESg"
    ...
    prop = PropMeta("str", "esgDn", "esgDn", 68837, PropCategory.REGULAR)
    prop.label = "ESg DN Reference"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
