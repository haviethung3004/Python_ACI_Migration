...
# ##################################################
class RtSvcEPgCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSvcEPgCtx", "cobra.model.cloud.ASvcEPg")

    meta.moClassName = "fvRtSvcEPgCtx"
    meta.rnFormat = "rtcloudSvcEPgCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58377, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58376, PropCategory.REGULAR)
