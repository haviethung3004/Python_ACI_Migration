...
# ##################################################
class RsMatchLIfCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsMatchLIfCtx", "cobra.model.vns.LIfCtx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsMatchLIfCtx"
    meta.rnFormat = "rsmatchLIfCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Match vnsLIfCtx"
    ...
    prop = PropMeta("str", "tCl", "tCl", 64355, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 64354, PropCategory.REGULAR)
