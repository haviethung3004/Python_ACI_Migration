...
# ##################################################
class RsAddrMgmtPool(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsAddrMgmtPool", "cobra.model.fv.AddrMgmtPool")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsAddrMgmtPool"
    meta.rnFormat = "rsAddrMgmtPool"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Address Management Policy"
    ...
    meta.rnPrefixes = [
        ('rsAddrMgmtPool', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69842, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69843, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69829, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69821, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69820, PropCategory.REGULAR)
