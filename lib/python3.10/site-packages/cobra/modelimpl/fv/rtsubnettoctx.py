...
# ##################################################
class RtSubnetToCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtSubnetToCtx", "cobra.model.cloud.Subnet")

    meta.moClassName = "fvRtSubnetToCtx"
    meta.rnFormat = "rtcloudSubnetToCtx-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62002, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62001, PropCategory.REGULAR)
