...
class RsScope(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsScope", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsScope"
    meta.rnFormat = "rsscope"
    ...
    prop = PropMeta("str", "annotation", "annotation", 56103, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56104, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 56098, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 56089, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 56088, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
