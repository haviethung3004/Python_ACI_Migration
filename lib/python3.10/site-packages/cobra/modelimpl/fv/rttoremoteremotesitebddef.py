...
# ##################################################
class RtToRemoteRemoteSiteBdDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteRemoteSiteBdDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteRemoteSiteBdDef"
    meta.rnFormat = "rttoRemoteRemoteSiteBdDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rttoRemoteRemoteSiteBdDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 69749, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69748, PropCategory.REGULAR)
