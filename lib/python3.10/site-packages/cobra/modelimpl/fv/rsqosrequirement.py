...
# ##################################################
class RsQosRequirement(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.fv.RsQosRequirement", "cobra.model.qos.Requirement")
    meta.targetNameProps["name"] = "tnQosRequirementName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsQosRequirement"
    meta.rnFormat = "rsqosRequirement"
    ...
    meta.rnPrefixes = [
        ('rsqosRequirement', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61946, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61947, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 61945, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 61942, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18272
    prop.defaultValueStr = "qosRequirement"
    ...
    prop = PropMeta("str", "tnQosRequirementName", "tnQosRequirementName", 61941, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnQosRequirementName", prop)
