...
# ##################################################
class RtToRemoteLocalSiteBdDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtToRemoteLocalSiteBdDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "fvRtToRemoteLocalSiteBdDef"
    meta.rnFormat = "rttoRemoteLocalSiteBdDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 69745, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69744, PropCategory.REGULAR)
