...
class RsEpTagCtx(Mo):
    ...
    meta = NamedSourceRelationMeta("cobra.model.fv.RsEpTagCtx", "cobra.model.fv.Ctx")
    meta.targetNameProps["name"] = "tnFvCtxName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fvRsEpTagCtx"
    meta.rnFormat = "rsepTagCtx"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VRF for the EpTag"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62872, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnFvCtxName", "tnFvCtxName", 62871, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
