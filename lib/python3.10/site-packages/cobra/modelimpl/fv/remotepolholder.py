...
class RemotePolHolder(Mo):
    ...
    meta.childClasses.add("cobra.model.fv.RsFromAssocPolToExpRt")
    meta.childClasses.add("cobra.model.fv.RsFromAssocPolToIntraImpRt")
    meta.childClasses.add("cobra.model.fv.RsFromAssocPolToRtSumm")
    ...
    meta.childClasses.add("cobra.model.fv.RsToRemoteESgHolder")
    meta.childClasses.add("cobra.model.fv.RsToRemoteFabricExtConnPDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteHealthGrp")
    meta.childClasses.add("cobra.model.fv.RsToRemoteHostprotPolDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteIpContainer")
    meta.childClasses.add("cobra.model.fv.RsToRemoteIpslaPol")
    meta.childClasses.add("cobra.model.fv.RsToRemoteKeyChainPolDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteLeakRouteFromToCont")
    meta.childClasses.add("cobra.model.fv.RsToRemoteLocalSiteBdDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteLocalSiteCtxDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteMdpProviderDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteMdpTenantInfoDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsToRemoteQosRequirement")
    ...
    meta.childClasses.add("cobra.model.fv.RsToRemoteRemoteSiteBdDef")
    ...
    meta.childClasses.add("cobra.model.fv.RsToRemoteStpEncapInstDef")
    meta.childClasses.add("cobra.model.fv.RsToRemoteSvcL3OutDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteLeakRouteFromToCont", "rstoRemoteLeakRouteFromToCont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteCloudsecKeyDefCont", "rstoRemoteCloudsecKeyDefCont-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsFromAssocPolToIntraImpRt", "rsfromAssocPolToIntraImpRt-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteFabricExtConnPDef", "rstoRemoteFabricExtConnPDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteMdpTenantInfoDef", "rstoRemoteMdpTenantInfoDef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteRemoteSiteBdDef", "rstoRemoteRemoteSiteBdDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteStpEncapInstDef", "rstoRemoteStpEncapInstDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteHostprotPolDef", "rstoRemoteHostprotPolDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteKeyChainPolDef", "rstoRemoteKeyChainPolDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteLocalSiteBdDef", "rstoRemoteLocalSiteBdDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteMdpProviderDef", "rstoRemoteMdpProviderDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteQosRequirement", "rstoRemoteQosRequirement-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsFromAssocPolToRtSumm", "rsfromAssocPolToRtSumm-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteQosDppPolDef", "rstoRemoteQosDppPolDef-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsFromAssocPolToExpRt", "rsfromAssocPolToExpRt-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteIpContainer", "rstoRemoteIpContainer-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteSvcL3OutDef", "rstoRemoteSvcL3OutDef-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RsToRemoteESgHolder", "rstoRemoteESgHolder-"))
