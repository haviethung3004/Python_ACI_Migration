...
# ##################################################
class RtDcProfToEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtDcProfToEpg", "cobra.model.intersight.SwitchConnectivityProfile")

    meta.moClassName = "fvRtDcProfToEpg"
    meta.rnFormat = "rtdcProfToEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68072, PropCategory.REGULAR)
