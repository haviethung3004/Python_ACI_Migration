...
# ##################################################
class RsToRemoteSvcL3OutDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteSvcL3OutDef", "cobra.model.vns.SvcL3OutDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteSvcL3OutDef"
    meta.rnFormat = "rstoRemoteSvcL3OutDef-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62915, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62914, PropCategory.REGULAR)
