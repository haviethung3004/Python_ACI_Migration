...
class BDDef(Mo):
    ...
    meta.childClasses.add("cobra.model.fv.RogueExceptionMacDef")
    ...
    meta.childClasses.add("cobra.model.pim.BDDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RogueExceptionMacDef", "rgexpmac-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.igmp.IfDef", "igmpIfDef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.pim.BDDef", "pimbdpdef"))
    ...
    prop = PropMeta("str", "enableRogueExceptMac", "enableRogueExceptMac", 68665, PropCategory.REGULAR)
    prop.label = "rogue exception mac wildcard support for bd"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("enableRogueExceptMac", prop)
    ...
    prop = PropMeta("str", "mcastARPDrop", "mcastARPDrop", 67535, PropCategory.REGULAR)
    prop.label = "BD rogue mcast ARP packet drop"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = True
    prop.defaultValueStr = "yes"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("mcastARPDrop", prop)
