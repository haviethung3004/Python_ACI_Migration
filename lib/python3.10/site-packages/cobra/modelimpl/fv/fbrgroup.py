...
class FBRGroup(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.FBRGroup")

    meta.moClassName = "fvFBRGroup"
    meta.rnFormat = "fbrg-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Context-level fallback route group"
    ...
    meta.childClasses.add("cobra.model.fv.FBRMember")
    meta.childClasses.add("cobra.model.fv.FBRoute")
    meta.childClasses.add("cobra.model.fv.RtOutToFBRGroup")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtOutToFBRGroup", "rtl3extOutToFBRGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.FBRMember", "nexthop-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Tag", "tagKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.FBRoute", "pfx-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 65397, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65398, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 65377, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
