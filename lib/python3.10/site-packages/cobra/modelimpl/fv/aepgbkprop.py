...
class AEPgBkProp(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.AEPgBkProp")

    meta.moClassName = "fvAEPgBkProp"
    meta.rnFormat = "aepgbkprop"
    meta.category = MoCategory.REGULAR
    meta.label = "AEPg pre migration parameters"
    ...
    prop = PropMeta("str", "pcEnfPref", "pcEnfPref", 65446, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prefGrMemb", "prefGrMemb", 65447, PropCategory.REGULAR)
