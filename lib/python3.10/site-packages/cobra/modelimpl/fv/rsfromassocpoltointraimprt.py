...
# ##################################################
class RsFromAssocPolToIntraImpRt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsFromAssocPolToIntraImpRt", "cobra.model.fv.IntraVrfFabricImpRtctrlDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsFromAssocPolToIntraImpRt"
    meta.rnFormat = "rsfromAssocPolToIntraImpRt-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rsfromAssocPolToIntraImpRt-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65543, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19181
    prop.defaultValueStr = "fvIntraVrfFabricImpRtctrlDef"
    prop._addConstant("fvIntraVrfFabricImpRtctrlDef", None, 19181)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65542, PropCategory.REGULAR)
