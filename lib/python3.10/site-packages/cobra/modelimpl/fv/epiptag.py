...
class EpIpTag(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.EpIpTag")

    meta.moClassName = "fvEpIpTag"
    meta.rnFormat = "epiptag-[%(ip)s]-%(ctxName)s"
    ...
    meta.childClasses.add("cobra.model.fv.RtToEpIpTag")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtToEpIpTag", "rttoEpIpTag-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 63107, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctxName", "ctxName", 63101, PropCategory.REGULAR)
    prop.label = "VRF name"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63108, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ip", "ip", 63090, PropCategory.REGULAR)
    prop.label = "Endpoint IP address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63103, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, ip, ctxName, markDirty=True, **creationProps):
        namingVals = [ip, ctxName]
