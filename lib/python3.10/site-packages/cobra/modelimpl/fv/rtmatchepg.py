...
class RtMatchEPg(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.fv.RtMatchEPg", "cobra.model.fv.EPgSelector")

    meta.moClassName = "fvRtMatchEPg"
    meta.rnFormat = "rtmatchEPg-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Endpoint Security Group EPg Selector"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62746, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18498
    prop.defaultValueStr = "fvEPgSelector"
    prop._addConstant("fvEPgSelector", None, 18498)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62896, PropCategory.REGULAR)
