...
# ##################################################
class EpSubnetTagDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fv.EpSubnetTagDef")

    meta.moClassName = "fvEpSubnetTagDef"
    meta.rnFormat = "epsubtagdef-[%(subnetDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63106, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "subnetDn", "subnetDn", 63094, PropCategory.REGULAR)
    prop.label = "Subnet DN"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("subnetDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "subnetDn"))
    getattr(meta.props, "subnetDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, subnetDn, markDirty=True, **creationProps):
        namingVals = [subnetDn]
