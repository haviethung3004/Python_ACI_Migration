...
# ##################################################
class RsToRemoteMdpTenantInfoDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsToRemoteMdpTenantInfoDef", "cobra.model.mdp.TenantInfoDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsToRemoteMdpTenantInfoDef"
    meta.rnFormat = "rstoRemoteMdpTenantInfoDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoRemoteMdpTenantInfoDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 56596, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56595, PropCategory.REGULAR)
