...
class PhysIf(Mo):
    ...
    prop._addConstant("cacert-mismatch", "ca-certificate-md5-mismatch", 4096)
    ...
    prop._addConstant("unapproved-serialnumber", "wired-to-a-node-whose-serial-number-doesnt-match-with-the-serial-number-in-the-fabric-node-vector", 512)
    prop._addConstant("undiscovered-peer", "wired-to-an-undiscovered-invalid-neighbor", 2048)
