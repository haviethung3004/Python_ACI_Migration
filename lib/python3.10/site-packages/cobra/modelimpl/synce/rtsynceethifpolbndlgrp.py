...
# ##################################################
class RtSynceEthIfPolBndlGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.synce.RtSynceEthIfPolBndlGrp", "cobra.model.infra.AAccBndlGrp")

    meta.moClassName = "synceRtSynceEthIfPolBndlGrp"
    meta.rnFormat = "rtinfraSynceEthIfPolBndlGrp-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtinfraSynceEthIfPolBndlGrp-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65519, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65518, PropCategory.REGULAR)
