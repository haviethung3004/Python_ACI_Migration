...
# ##################################################
class RtSynceEthIfPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.synce.RtSynceEthIfPol", "cobra.model.infra.AccPortGrp")

    meta.moClassName = "synceRtSynceEthIfPol"
    meta.rnFormat = "rtinfraSynceEthIfPol-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63062, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63061, PropCategory.REGULAR)
