...
class Entity(Mo):
    ...
    meta = ClassMeta("cobra.model.synce.Entity")

    meta.moClassName = "synceEntity"
    meta.rnFormat = "synce"
    meta.category = MoCategory.REGULAR
    meta.label = "syncE Entity"
    ...
    meta.childClasses.add("cobra.model.synce.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.synce.Inst", "inst"))
    ...
    meta.superClasses.add("cobra.model.l1.ProtEntity")
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63457, PropCategory.REGULAR)
