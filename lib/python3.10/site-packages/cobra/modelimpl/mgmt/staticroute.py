...
# ##################################################
class StaticRoute(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.mgmt.StaticRoute")

    meta.moClassName = "mgmtStaticRoute"
    meta.rnFormat = "staticroute-[%(prefix)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Route for OOB and Inband management"
    ...
    prop = PropMeta("str", "annotation", "annotation", 62304, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62305, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "prefix", "prefix", 62284, PropCategory.REGULAR)
