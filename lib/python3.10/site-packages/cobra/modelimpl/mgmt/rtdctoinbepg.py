...
# ##################################################
class RtDcToInbEpg(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.mgmt.RtDcToInbEpg", "cobra.model.intersight.DeviceConnectorInst")

    meta.moClassName = "mgmtRtDcToInbEpg"
    meta.rnFormat = "rtdcToInbEpg"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67525, PropCategory.REGULAR)
