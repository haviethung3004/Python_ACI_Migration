...
class RuleOper(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.RuleOper")

    meta.moClassName = "hcloudRuleOper"
    meta.rnFormat = "rruleoper-[%(ruleDn)s]"
    ...
    prop = PropMeta("str", "mergeLabel", "mergeLabel", 62314, PropCategory.REGULAR)
    prop.label = "MergeLabel that was processed for the rule"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("mergeLabel", prop)

    prop = PropMeta("str", "mergedRulesCount", "mergedRulesCount", 62315, PropCategory.REGULAR)
    prop.label = "Number of rules that have been merged together with this particular rule"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("mergedRulesCount", prop)
    ...
    prop = PropMeta("str", "ruleDn", "ruleDn", 62313, PropCategory.REGULAR)
    prop.label = "DN of the corresponding rule"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("ruleDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "ruleDn"))
    getattr(meta.props, "ruleDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, ruleDn, markDirty=True, **creationProps):
        namingVals = [ruleDn]
