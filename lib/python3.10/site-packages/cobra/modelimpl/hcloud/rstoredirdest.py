...
# ##################################################
class RsToRedirDest(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsToRedirDest", "cobra.model.hcloud.SvcRedirDest")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "hcloudRsToRedirDest"
    meta.rnFormat = "rstoRedirDest-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "vrf-to-redir-dest"
    ...
    meta.childClasses.add("cobra.model.hcloud.SvcRedirCons")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SvcRedirCons", "redircons-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 62421, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62422, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nextHop", "nextHop", 62416, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 62418, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18414
    prop.defaultValueStr = "hcloudSvcRedirDest"
    prop._addConstant("hcloudSvcRedirDest", None, 18414)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 62417, PropCategory.REGULAR)
