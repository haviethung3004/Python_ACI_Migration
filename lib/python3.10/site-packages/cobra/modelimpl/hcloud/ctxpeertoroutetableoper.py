...
# ##################################################
class CtxPeerToRouteTableOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CtxPeerToRouteTableOper")

    meta.moClassName = "hcloudCtxPeerToRouteTableOper"
    meta.rnFormat = "ctxpeertortoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Oper State of CtxPeer to RouteTable Association"
