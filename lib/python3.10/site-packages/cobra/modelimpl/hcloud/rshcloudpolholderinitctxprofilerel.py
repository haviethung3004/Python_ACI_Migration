...
# ##################################################
class RsHcloudPolHolderInitCtxProfileRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderInitCtxProfileRel", "cobra.model.hcloud.CtxProfile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderInitCtxProfileRel"
    meta.rnFormat = "rshcloudPolHolderInitCtxProfileRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Context Profile"
    ...
    meta.rnPrefixes = [
        ('rshcloudPolHolderInitCtxProfileRel', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 64486, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18731
    prop.defaultValueStr = "hcloudCtxProfile"
    prop._addConstant("hcloudCtxProfile", None, 18731)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 64485, PropCategory.REGULAR)
