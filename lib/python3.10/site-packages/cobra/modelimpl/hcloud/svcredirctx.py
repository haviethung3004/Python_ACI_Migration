...
# ##################################################
class SvcRedirCtx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SvcRedirCtx")

    meta.moClassName = "hcloudSvcRedirCtx"
    meta.rnFormat = "redirCtx-[%(ctxDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "destination for svc redirection."
    ...
    meta.childClasses.add("cobra.model.hcloud.RsToRedirDest")
    meta.childClasses.add("cobra.model.hcloud.SvcRedirCidrPfx")
    meta.childClasses.add("cobra.model.hcloud.SvcRedirDest")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsToRedirDest", "rstoRedirDest-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SvcRedirDest", "redirdst-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SvcRedirCidrPfx", "ctxpfx-"))
    ...
    prop = PropMeta("str", "ctxDn", "ctxDn", 62411, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
