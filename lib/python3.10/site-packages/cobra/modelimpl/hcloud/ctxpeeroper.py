...
# ##################################################
class CtxPeerOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CtxPeerOper")

    meta.moClassName = "hcloudCtxPeerOper"
    meta.rnFormat = "ctxpeeroper"
    ...
    prop = PropMeta("str", "peeringState", "peeringState", 60749, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("initiated", "initiated", 1)
    prop._addConstant("none", "none", 0)
    prop._addConstant("pending-acceptance", "pending-acceptance", 7)
    prop._addConstant("provisioning", "provisioning", 5)
    prop._addConstant("removed", "removed", 4)
    meta.props.add("peeringState", prop)

    prop = PropMeta("str", "provisioningState", "provisioningState", 63927, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("deleting", "deleting", 1)
    prop._addConstant("failed", "failed", 2)
    prop._addConstant("none", "none", 0)
    prop._addConstant("succeeded", "succeeded", 3)
    prop._addConstant("updating", "updating", 4)
    meta.props.add("provisioningState", prop)
    ...
    prop = PropMeta("str", "transitState", "transitState", 61075, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("allow-gw-transit", "allow-gateway-transit-(hub)", 1)
    prop._addConstant("none", "none", 0)
    prop._addConstant("use-remote-gw", "use-remote-gateways-(spoke)", 2)
    meta.props.add("transitState", prop)
