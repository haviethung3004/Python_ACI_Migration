...
# ##################################################
class HubCtxGroupOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.HubCtxGroupOper")

    meta.moClassName = "hcloudHubCtxGroupOper"
    meta.rnFormat = "hubctxgroupoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Oper State of Virtual WAN"
    ...
    prop = PropMeta("str", "provisioningState", "provisioningState", 65321, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
