...
# ##################################################
class RsHcloudPolHolderCtxProfileRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderCtxProfileRel", "cobra.model.hcloud.CtxProfile")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderCtxProfileRel"
    meta.rnFormat = "rshcloudPolHolderCtxProfileRel"
    ...
    meta.rnPrefixes = [
        ('rshcloudPolHolderCtxProfileRel', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 63762, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63761, PropCategory.REGULAR)
