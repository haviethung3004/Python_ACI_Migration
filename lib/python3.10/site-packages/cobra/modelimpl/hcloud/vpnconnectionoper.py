...
# ##################################################
class VpnConnectionOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.VpnConnectionOper")

    meta.moClassName = "hcloudVpnConnectionOper"
    meta.rnFormat = "vpnconnectionoper"
    ...
    meta.rnPrefixes = [
        ('vpnconnectionoper', False),
    ]

    prop = PropMeta("str", "attachmentId", "attachmentId", 65418, PropCategory.REGULAR)
    prop.label = "None"
