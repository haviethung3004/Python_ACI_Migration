...
class NginxTxId(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.NginxTxId")

    meta.moClassName = "hcloudNginxTxId"
    meta.rnFormat = "txid"
    meta.category = MoCategory.REGULAR
    meta.label = "nginx tx id"
    ...
    prop = PropMeta("str", "annotation", "annotation", 58330, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58331, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 57943, PropCategory.REGULAR)
    prop.label = "tx id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
