...
# ##################################################
class ARuleContractOper(Mo):
    meta = ClassMeta("cobra.model.hcloud.ARuleContractOper")

    meta.isAbstract = True
    meta.moClassName = "hcloudARuleContractOper"
    ...
    prop = PropMeta("str", "contractDn", "contractDn", 64440, PropCategory.REGULAR)
