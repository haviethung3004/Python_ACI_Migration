...
# ##################################################
class UserRouteTableEntryOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.UserRouteTableEntryOper")

    meta.moClassName = "hcloudUserRouteTableEntryOper"
    meta.rnFormat = "userrtentryoper-[%(destinationAddress)s]"
    ...
    prop = PropMeta("str", "destinationAddress", "destinationAddress", 67746, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "userOwner", "userOwner", 67747, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("userOwner", prop)
