...
# ##################################################
class InterHubCtxPeerOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.InterHubCtxPeerOper")

    meta.moClassName = "hcloudInterHubCtxPeerOper"
    meta.rnFormat = "interhubctxpeeroper"
