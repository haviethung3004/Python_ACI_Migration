...
# ##################################################
class RsHcloudPolHolderCsrRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderCsrRel", "cobra.model.hcloud.Csr")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderCsrRel"
    meta.rnFormat = "rshcloudPolHolderCsrRel"
    ...
    prop = PropMeta("str", "tCl", "tCl", 62381, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62380, PropCategory.REGULAR)
