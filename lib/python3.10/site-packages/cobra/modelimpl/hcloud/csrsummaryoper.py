...
class CsrSummaryOper(Mo):
    ...
    prop = PropMeta("str", "dataPathReady", "dataPathReady", 60676, PropCategory.REGULAR)
    prop.label = "reflects CSR ready with all the config"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("dataPathReady", prop)
