...
# ##################################################
class AwsTgwConnectTunnelInfo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.AwsTgwConnectTunnelInfo")

    meta.moClassName = "hcloudAwsTgwConnectTunnelInfo"
    meta.rnFormat = "connecttunnelinfo-[%(destInnerAddress)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "TGW Connect Tunnel Info"
    ...
    prop = PropMeta("str", "destInnerAddress", "destInnerAddress", 63564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tunnelID", "tunnelID", 63529, PropCategory.REGULAR)
    prop.label = "Tunnel ID"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("tunnelID", prop)

    meta.namingProps.append(getattr(meta.props, "destInnerAddress"))
    getattr(meta.props, "destInnerAddress").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, destInnerAddress, markDirty=True, **creationProps):
        namingVals = [destInnerAddress]
