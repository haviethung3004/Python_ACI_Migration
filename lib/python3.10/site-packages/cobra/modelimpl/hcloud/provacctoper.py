...
# ##################################################
class ProvAcctOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ProvAcctOper")

    meta.moClassName = "hcloudProvAcctOper"
    meta.rnFormat = "provacctoper"
    meta.category = MoCategory.REGULAR
    meta.label = "provider account oper state"
