...
class ZoneMappingOper(Mo):
    ...
    prop = PropMeta("str", "awsZoneInventoryDn", "awsZoneInventoryDn", 65716, PropCategory.REGULAR)
    prop.label = "DN of the hinventoryAvailZone"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("awsZoneInventoryDn", prop)
