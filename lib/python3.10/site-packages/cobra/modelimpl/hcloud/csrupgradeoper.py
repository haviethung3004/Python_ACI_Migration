...
# ##################################################
class CsrUpgradeOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CsrUpgradeOper")

    meta.moClassName = "hcloudCsrUpgradeOper"
    meta.rnFormat = "upgradeoper"
    ...
    meta.parentClasses.add("cobra.model.hcloud.CsrHealth")
    ...
    prop = PropMeta("str", "upgradeTime", "upgradeTime", 63528, PropCategory.REGULAR)
    prop.label = "Time the CSR upgrade got triggered"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("upgradeTime", prop)
