...
# ##################################################
class SharedResourceToHubCtxAcceptOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SharedResourceToHubCtxAcceptOper")

    meta.moClassName = "hcloudSharedResourceToHubCtxAcceptOper"
    meta.rnFormat = "sharedresourcetohubctxacceptoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Oper State of SharedResource to HubCtx Accept Association"
    ...
    meta.rnPrefixes = [
        ('sharedresourcetohubctxacceptoper', False),
    ]
