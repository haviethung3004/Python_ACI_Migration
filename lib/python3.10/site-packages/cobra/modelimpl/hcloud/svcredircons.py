...
class SvcRedirCons(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.SvcRedirCons")

    meta.moClassName = "hcloudSvcRedirCons"
    meta.rnFormat = "redircons-[%(consDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "consumer of this redirect entry."
    ...
    prop = PropMeta("str", "consDn", "consDn", 62415, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
