...
# ##################################################
class BulkEgressRuleOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.BulkEgressRuleOper")

    meta.moClassName = "hcloudBulkEgressRuleOper"
    meta.rnFormat = "bulkegressoper"
