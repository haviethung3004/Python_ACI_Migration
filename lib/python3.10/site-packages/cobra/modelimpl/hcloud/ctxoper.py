...
class CtxOper(Mo):
    ...
    prop = PropMeta("str", "cloudDirectoryID", "cloudDirectoryID", 62028, PropCategory.REGULAR)
    prop.label = "cloudDirectoryID is the unique ID for each Active Directory Instance"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("cloudDirectoryID", prop)
    ...
    prop = PropMeta("str", "siteId", "siteId", 62088, PropCategory.REGULAR)
