...
# ##################################################
class SvcRedirCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SvcRedirCont")

    meta.moClassName = "hcloudSvcRedirCont"
    meta.rnFormat = "redircont"
    meta.category = MoCategory.REGULAR
    meta.label = "container for svc redirection."
    ...
    meta.childClasses.add("cobra.model.hcloud.SvcRedirCtx")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SvcRedirCtx", "redirCtx-"))
