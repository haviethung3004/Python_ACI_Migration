...
# ##################################################
class StorageAccountOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.StorageAccountOper")

    meta.moClassName = "hcloudStorageAccountOper"
    meta.rnFormat = "storageacctoper"
    ...
    meta.rnPrefixes = [
        ('storageacctoper', False),
    ]

    prop = PropMeta("str", "blobUrl", "blobUrl", 57954, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("blobUrl", prop)
