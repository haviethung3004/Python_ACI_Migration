...
# ##################################################
class EgressRuleContractOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.EgressRuleContractOper")

    meta.moClassName = "hcloudEgressRuleContractOper"
    meta.rnFormat = "egressrulecontractoper-[%(contractDn)s]"
    ...
    prop = PropMeta("str", "contractDn", "contractDn", 64476, PropCategory.REGULAR)
