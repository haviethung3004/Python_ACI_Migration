...
# ##################################################
class SharedResourceToHubCtxCreateOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SharedResourceToHubCtxCreateOper")

    meta.moClassName = "hcloudSharedResourceToHubCtxCreateOper"
    meta.rnFormat = "sharedresourcetohubctxcreateoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Oper State of SharedResource to HubCtx Create Association"
    ...
    meta.rnPrefixes = [
        ('sharedresourcetohubctxcreateoper', False),
    ]
