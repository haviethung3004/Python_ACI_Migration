...
# ##################################################
class ResolvedNames(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ResolvedNames")

    meta.moClassName = "hcloudResolvedNames"
    meta.rnFormat = "resolvednames"
    meta.category = MoCategory.REGULAR
    meta.label = "ResolvedNames"
    ...
    meta.childClasses.add("cobra.model.hcloud.ResourceName")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ResourceName", "rname-"))
