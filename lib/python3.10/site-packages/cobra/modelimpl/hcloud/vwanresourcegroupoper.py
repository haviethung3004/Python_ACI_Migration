...
# ##################################################
class VwanResourceGroupOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.VwanResourceGroupOper")

    meta.moClassName = "hcloudVwanResourceGroupOper"
    meta.rnFormat = "vwanrgoper-%(tenantName)s"
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 66008, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
