...
class FailedOper(Mo):
    ...
    meta.childClasses.add("cobra.model.hcextnw.TunnIfOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.AwsTgwConnectTunnelInfo")
    meta.childClasses.add("cobra.model.hcloud.AwsVpnTunnelInfo")
    meta.childClasses.add("cobra.model.hcloud.AzEventTaskError")
    meta.childClasses.add("cobra.model.hcloud.AzureInventoryTaskError")
    meta.childClasses.add("cobra.model.hcloud.BulkEgressRuleOper")
    meta.childClasses.add("cobra.model.hcloud.BulkIngressRuleOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.CloneFromRouteTableOper")
    meta.childClasses.add("cobra.model.hcloud.ConfigTaskError")
    meta.childClasses.add("cobra.model.hcloud.CsrSummaryOper")
    meta.childClasses.add("cobra.model.hcloud.CsrUpgradeOper")
    meta.childClasses.add("cobra.model.hcloud.CtError")
    meta.childClasses.add("cobra.model.hcloud.CtxConnectOper")
    meta.childClasses.add("cobra.model.hcloud.CtxConnectToRouteTableOper")
    meta.childClasses.add("cobra.model.hcloud.CtxOper")
    meta.childClasses.add("cobra.model.hcloud.CtxPeerOper")
    meta.childClasses.add("cobra.model.hcloud.CtxPeerRoutingOper")
    meta.childClasses.add("cobra.model.hcloud.CtxPeerToRouteTableOper")
    meta.childClasses.add("cobra.model.hcloud.CtxPeeringOper")
    meta.childClasses.add("cobra.model.hcloud.CtxProfileOper")
    meta.childClasses.add("cobra.model.hcloud.CweError")
    meta.childClasses.add("cobra.model.hcloud.DiscEpOper")
    meta.childClasses.add("cobra.model.hcloud.DiscVendorCInstOper")
    meta.childClasses.add("cobra.model.hcloud.DiskOper")
    meta.childClasses.add("cobra.model.hcloud.EgressRuleContractOper")
    meta.childClasses.add("cobra.model.hcloud.EgressRuleOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.GcpFlowLogOper")
    meta.childClasses.add("cobra.model.hcloud.GenericError")
    meta.childClasses.add("cobra.model.hcloud.HubCtxBgpPeerOper")
    meta.childClasses.add("cobra.model.hcloud.HubCtxGroupOper")
    meta.childClasses.add("cobra.model.hcloud.HubCtxOper")
    meta.childClasses.add("cobra.model.hcloud.IgwOper")
    meta.childClasses.add("cobra.model.hcloud.IngressRuleContractOper")
    meta.childClasses.add("cobra.model.hcloud.IngressRuleOper")
    meta.childClasses.add("cobra.model.hcloud.InstanceOper")
    meta.childClasses.add("cobra.model.hcloud.InterHubCtxPeerOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.PeerGwOper")
    meta.childClasses.add("cobra.model.hcloud.PrivateEndpointOper")
    meta.childClasses.add("cobra.model.hcloud.ProvAcctOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.RsEpToSecurityGroupError")
    meta.childClasses.add("cobra.model.hcloud.RsEpToSecurityGroupOper")
    meta.childClasses.add("cobra.model.hcloud.RsIgwToRTOper")
    meta.childClasses.add("cobra.model.hcloud.RsSubnetToRTOper")
    meta.childClasses.add("cobra.model.hcloud.RsTgToEndPointOper")
    meta.childClasses.add("cobra.model.hcloud.RsVpnConnToCgwOper")
    meta.childClasses.add("cobra.model.hcloud.RuleOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.SelectedEPOper")
    meta.childClasses.add("cobra.model.hcloud.SgEgressRuleOper")
    meta.childClasses.add("cobra.model.hcloud.SgIngressRuleOper")
    meta.childClasses.add("cobra.model.hcloud.SharedResourceToHubCtxAcceptOper")
    meta.childClasses.add("cobra.model.hcloud.SharedResourceToHubCtxCreateOper")
    meta.childClasses.add("cobra.model.hcloud.SqsError")
    meta.childClasses.add("cobra.model.hcloud.StorageAccountOper")
    ...
    meta.childClasses.add("cobra.model.hcloud.UserRouteTableEntryOper")
    meta.childClasses.add("cobra.model.hcloud.VendorInstOper")
    meta.childClasses.add("cobra.model.hcloud.VgwOper")
    meta.childClasses.add("cobra.model.hcloud.VpnConnectionOper")
    meta.childClasses.add("cobra.model.hcloud.VpnConnectionToRouteTableOper")
    meta.childClasses.add("cobra.model.hcloud.VrfOper")
    meta.childClasses.add("cobra.model.hcloud.VwanResourceGroupOper")
    meta.childClasses.add("cobra.model.hcloud.ZoneMappingOper")
    meta.childClasses.add("cobra.model.health.Inst")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SharedResourceToHubCtxAcceptOper", "sharedresourcetohubctxacceptoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SharedResourceToHubCtxCreateOper", "sharedresourcetohubctxcreateoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.IngressRuleContractOper", "ingressrulecontractoper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CloneFromRouteTableOper", "clonefromroutetableoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.EgressRuleContractOper", "egressrulecontractoper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.VpnConnectionToRouteTableOper", "vpnconnectiontortoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.InterHubCtxPeerOper", "interhubctxpeeroper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.AwsTgwConnectTunnelInfo", "connecttunnelinfo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxConnectToRouteTableOper", "ctxconnecttortoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxPeerRoutingOper", "ctxpeerroutingoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.HubCtxBgpPeerOper", "hubctxbgppeeroper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ListenerRulePriorityOper", "listenruleprioper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.VpnConnectionOper", "vpnconnectionoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.UserRouteTableEntryOper", "userrtentryoper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.BulkIngressRuleOper", "bulkingressoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CertificateOper", "certificateoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxPeerToRouteTableOper", "ctxpeertortoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxPeeringOper", "ctxpeeringoper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.HubCtxGroupOper", "hubctxgroupoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.StorageAccountOper", "storageacctoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.TargetGroupOper", "targetgroupoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.BulkEgressRuleOper", "bulkegressoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxConnectOper", "ctxconnectoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxProfileOper", "ctxprofileoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.VendorInstOper", "vendorinstoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.IpIngressRuleOper", "ipingressoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.PrivateEndpointOper", "privateepoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsIgwToRTOper", "rsigwtortoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.AzEventTaskError", "azevttaskerr"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ProvAcctOper", "provacctoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CsrUpgradeOper", "upgradeoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.CtxPeerOper", "ctxpeeroper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.FlowLogOper", "flowlogoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.IngressRuleOper", "ingressoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RouteTableEntryOper", "rtentryoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.VwanResourceGroupOper", "vwanrgoper-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcextnw.TunnIfOper", "tunnifoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.DiscEpOper", "discepoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.DiscVendorCInstOper", "dcinstoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.EgressRuleOper", "egressoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.HubCtxOper", "hubctxoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.PeerGwOper", "peergwoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RegionOper", "regionoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RuleOper", "rruleoper-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsEpToSecurityGroupError", "epsgerror"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SGRuleGroupOper", "operrules"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.SelectedEPOper", "selepoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsTgToEndPointOper", "tgepoper"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.VrfOper", "vrfoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.EndPointOper", "epoper"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.GcpFlowLogOper", "floper"))
