...
# ##################################################
class IngressRuleContractOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.IngressRuleContractOper")

    meta.moClassName = "hcloudIngressRuleContractOper"
    meta.rnFormat = "ingressrulecontractoper-[%(contractDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "arulecontractoper"
    ...
    meta.superClasses.add("cobra.model.hcloud.ARuleContractOper")
    meta.superClasses.add("cobra.model.pol.Obj")
    meta.superClasses.add("cobra.model.naming.NamedObject")
    meta.superClasses.add("cobra.model.hcloud.ASgRuleOper")

    meta.rnPrefixes = [
        ('ingressrulecontractoper-', True),
    ]
    ...
    prop = PropMeta("str", "contractDn", "contractDn", 64480, PropCategory.REGULAR)
    prop.label = "DN of the contract"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("contractDn", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "contractDn"))
    getattr(meta.props, "contractDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, contractDn, markDirty=True, **creationProps):
        namingVals = [contractDn]
