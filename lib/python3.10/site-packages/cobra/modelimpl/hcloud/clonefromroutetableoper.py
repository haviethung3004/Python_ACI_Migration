...
# ##################################################
class CloneFromRouteTableOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CloneFromRouteTableOper")

    meta.moClassName = "hcloudCloneFromRouteTableOper"
    meta.rnFormat = "clonefromroutetableoper"
    ...
    meta.parentClasses.add("cobra.model.hcloud.CloneFromRouteTable")
