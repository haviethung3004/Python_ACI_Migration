...
class InstanceOper(Mo):
    ...
    prop = PropMeta("str", "reconcileRequired", "reconcileRequired", 62835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("reconcileRequired", prop)
    ...
    prop = PropMeta("str", "version", "version", 62685, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
