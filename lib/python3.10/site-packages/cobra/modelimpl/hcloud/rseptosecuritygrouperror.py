...
# ##################################################
class RsEpToSecurityGroupError(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.RsEpToSecurityGroupError")

    meta.moClassName = "hcloudRsEpToSecurityGroupError"
    meta.rnFormat = "epsgerror"
