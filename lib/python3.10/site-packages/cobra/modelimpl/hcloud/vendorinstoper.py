...
# ##################################################
class VendorInstOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.VendorInstOper")

    meta.moClassName = "hcloudVendorInstOper"
    meta.rnFormat = "vendorinstoper"
