...
class NativeLBOper(Mo):
    ...
    prop = PropMeta("str", "healthStatus", "healthStatus", 62268, PropCategory.REGULAR)
    prop.label = "LB health status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("healthStatus", prop)

    prop = PropMeta("str", "healthStatusReason", "healthStatusReason", 62269, PropCategory.REGULAR)
    prop.label = "LB health status Reason"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
