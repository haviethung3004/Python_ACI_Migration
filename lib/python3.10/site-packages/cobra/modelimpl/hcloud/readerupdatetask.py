...
# ##################################################
class ReaderUpdateTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.ReaderUpdateTask")

    meta.moClassName = "hcloudReaderUpdateTask"
    meta.rnFormat = "hcloudReaderUpdateTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 57974, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SyncReader", "syncreader", 3820)
