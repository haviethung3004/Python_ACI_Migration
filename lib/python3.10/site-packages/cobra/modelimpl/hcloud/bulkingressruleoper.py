...
# ##################################################
class BulkIngressRuleOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.BulkIngressRuleOper")

    meta.moClassName = "hcloudBulkIngressRuleOper"
    meta.rnFormat = "bulkingressoper"
