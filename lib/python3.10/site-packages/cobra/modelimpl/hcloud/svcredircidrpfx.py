...
# ##################################################
class SvcRedirCidrPfx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.SvcRedirCidrPfx")

    meta.moClassName = "hcloudSvcRedirCidrPfx"
    meta.rnFormat = "ctxpfx-[%(prefix)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "cidr prefix."
    ...
    prop = PropMeta("str", "prefix", "prefix", 62413, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "region", "region", 62414, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
