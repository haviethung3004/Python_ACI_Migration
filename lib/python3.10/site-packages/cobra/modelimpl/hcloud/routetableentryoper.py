...
class RouteTableEntryOper(Mo):
    ...
    prop = PropMeta("str", "nextHopSvcEpState", "nextHopSvcEpState", 61792, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("nextHopSvcEpState", prop)

    prop = PropMeta("str", "nextHopSvcEpStateReason", "nextHopSvcEpStateReason", 61793, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("nextHopSvcEpStateReason", prop)
