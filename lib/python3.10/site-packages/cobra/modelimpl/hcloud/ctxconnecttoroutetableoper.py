...
# ##################################################
class CtxConnectToRouteTableOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CtxConnectToRouteTableOper")

    meta.moClassName = "hcloudCtxConnectToRouteTableOper"
    meta.rnFormat = "ctxconnecttortoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Oper State of CtxConnect to RouteTable Association"
