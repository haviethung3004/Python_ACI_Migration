...
# ##################################################
class RsHcloudPolHolderRelToNamingDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderRelToNamingDef", "cobra.model.hcloud.NamingDef")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderRelToNamingDef"
    meta.rnFormat = "rshcloudPolHolderRelToNamingDef"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Concrete Object for naming policy container for cloud resources"
    ...
    meta.rnPrefixes = [
        ('rshcloudPolHolderRelToNamingDef', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 61119, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18108
    prop.defaultValueStr = "hcloudNamingDef"
    prop._addConstant("hcloudNamingDef", None, 18108)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 61118, PropCategory.REGULAR)
