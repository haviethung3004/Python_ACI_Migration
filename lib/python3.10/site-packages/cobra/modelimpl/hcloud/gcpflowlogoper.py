...
# ##################################################
class GcpFlowLogOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.GcpFlowLogOper")

    meta.moClassName = "hcloudGcpFlowLogOper"
    meta.rnFormat = "floper"
    ...
    meta.parentClasses.add("cobra.model.hcloud.GcpFlowLogPol")
