...
# ##################################################
class VpnConnectionToRouteTableOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.VpnConnectionToRouteTableOper")

    meta.moClassName = "hcloudVpnConnectionToRouteTableOper"
    meta.rnFormat = "vpnconnectiontortoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Oper State of VPN Connection to RouteTable Association"
