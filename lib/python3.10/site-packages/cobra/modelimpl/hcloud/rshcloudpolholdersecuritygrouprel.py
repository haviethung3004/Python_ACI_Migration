...
# ##################################################
class RsHcloudPolHolderSecurityGroupRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderSecurityGroupRel", "cobra.model.hcloud.SecurityGroup")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderSecurityGroupRel"
    meta.rnFormat = "rshcloudPolHolderSecurityGroupRel"
    ...
    meta.rnPrefixes = [
        ('rshcloudPolHolderSecurityGroupRel', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 62385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 62384, PropCategory.REGULAR)
