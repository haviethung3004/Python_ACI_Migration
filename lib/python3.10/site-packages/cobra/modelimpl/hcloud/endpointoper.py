...
class EndPointOper(Mo):
    ...
    prop._addConstant("APIGw", "the-vip-of-a-cloud-api-gw-service-instance", 9)
    prop._addConstant("awsAlb", "network-interface-that-is-attached-to-an-aws-alb", 2)
    prop._addConstant("container", "network-interface-that-is-attached-to-a-container-running-on-a-cloud-platform", 5)
    ...
    prop._addConstant("lb", "network-interface-that-is-attached-to-load-balancer", 8)
    prop._addConstant("private-ep", "private-endpoint", 7)
    prop._addConstant("scaleset-vm", "network-interface-that-is-attached-to-an-azure-scaleset-vm", 4)
    prop._addConstant("tgw-attachment", "transit-gateway-network-interface", 6)
    prop._addConstant("vm", "network-interface-that-is-attached-to-an-azure-vm", 3)
    meta.props.add("epType", prop)

    prop = PropMeta("str", "instanceId", "instanceId", 63714, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("instanceId", prop)
    ...
    prop = PropMeta("str", "zone", "zone", 63715, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
