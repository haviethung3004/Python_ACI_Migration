...
class TargetGroupOper(Mo):
    ...
    prop = PropMeta("str", "healthStatus", "healthStatus", 62968, PropCategory.REGULAR)
    prop.label = "TG health status"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("healthStatus", prop)

    prop = PropMeta("str", "healthStatusReason", "healthStatusReason", 62969, PropCategory.REGULAR)
    prop.label = "TG health status Reason"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("healthStatusReason", prop)
