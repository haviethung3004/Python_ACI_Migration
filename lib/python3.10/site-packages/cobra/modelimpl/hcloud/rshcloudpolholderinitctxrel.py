...
# ##################################################
class RsHcloudPolHolderInitCtxRel(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsHcloudPolHolderInitCtxRel", "cobra.model.hcloud.Ctx")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsHcloudPolHolderInitCtxRel"
    meta.rnFormat = "rshcloudPolHolderInitCtxRel"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "VPC context"
    ...
    meta.rnPrefixes = [
        ('rshcloudPolHolderInitCtxRel', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 63931, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63930, PropCategory.REGULAR)
