...
# ##################################################
class CtxPeerRoutingOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hcloud.CtxPeerRoutingOper")

    meta.moClassName = "hcloudCtxPeerRoutingOper"
    meta.rnFormat = "ctxpeerroutingoper"
    ...
    meta.rnPrefixes = [
        ('ctxpeerroutingoper', False),
    ]

    prop = PropMeta("str", "associationDone", "associationDone", 66006, PropCategory.REGULAR)
    prop.label = "None"
    ...
    meta.props.add("associationDone", prop)
    ...
    prop = PropMeta("str", "propagationDone", "propagationDone", 66007, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    ...
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("propagationDone", prop)
