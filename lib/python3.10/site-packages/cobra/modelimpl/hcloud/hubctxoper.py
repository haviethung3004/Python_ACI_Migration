...
class HubCtxOper(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.HubCtxOper")

    meta.moClassName = "hcloudHubCtxOper"
    meta.rnFormat = "hubctxoper"
    ...
    meta.superClasses.add("cobra.model.hcloud.SharedOper")
    ...
    prop = PropMeta("str", "cloudResourceName", "cloudResourceName", 57217, PropCategory.REGULAR)
    prop.label = "Complete Resource Name of Cloud Provider"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("cloudResourceName", prop)
    ...
    prop = PropMeta("str", "interSiteDeviceDn", "interSiteDeviceDn", 60747, PropCategory.REGULAR)
    prop.label = "DN of the device providing Spoke to remote site connectivity"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("interSiteDeviceDn", prop)

    prop = PropMeta("str", "interSiteNextHop", "interSiteNextHop", 60746, PropCategory.REGULAR)
    prop.label = "Next hop to use for spoke to remote site connectivity"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("interSiteNextHop", prop)

    prop = PropMeta("str", "interVrfDeviceDn", "interVrfDeviceDn", 60745, PropCategory.REGULAR)
    prop.label = "DN of the device providing Spoke to spoke connectivity"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("interVrfDeviceDn", prop)

    prop = PropMeta("str", "interVrfNextHop", "interVrfNextHop", 60744, PropCategory.REGULAR)
    prop.label = "Next hop IP to use for spoke to spoke connectivity"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("interVrfNextHop", prop)
