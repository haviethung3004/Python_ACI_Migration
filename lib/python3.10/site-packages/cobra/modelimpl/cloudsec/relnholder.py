...
class RelnHolder(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.RelnHolder")

    meta.moClassName = "cloudsecRelnHolder"
    meta.rnFormat = "cid-%(id)s"
    ...
    meta.childClasses.add("cobra.model.cloudsec.RsIfPolRef")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloudsec.RsIfPolRef", "rsifPolRef"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 63640, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63641, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "id", "id", 63634, PropCategory.REGULAR)
    prop.label = "Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
