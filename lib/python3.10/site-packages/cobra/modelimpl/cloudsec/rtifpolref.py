...
class RtIfPolRef(Mo):
    ...
    meta = TargetRelationMeta("cobra.model.cloudsec.RtIfPolRef", "cobra.model.cloudsec.RelnHolder")

    meta.moClassName = "cloudsecRtIfPolRef"
    meta.rnFormat = "rtifPolRef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_FROM_LOCAL
    meta.label = "Policy holder container"
    meta.writeAccessMask = 0x41
    meta.readAccessMask = 0x80041
    ...
    prop = PropMeta("str", "tCl", "tCl", 63639, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18712
    prop.defaultValueStr = "cloudsecRelnHolder"
    prop._addConstant("cloudsecRelnHolder", None, 18712)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63638, PropCategory.REGULAR)
