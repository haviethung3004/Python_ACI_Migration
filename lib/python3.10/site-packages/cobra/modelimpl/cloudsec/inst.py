...
class Inst(Mo):
    ...
    prop = PropMeta("str", "nodeControl", "nodeControl", 64390, PropCategory.REGULAR)
    prop.label = "Cloudsec Inst Node Control"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("ianaUdpPort", "enable-iana-assigned-dataplane-udp-port-usage", 1)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("nodeControl", prop)
