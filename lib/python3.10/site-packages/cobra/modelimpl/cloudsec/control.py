...
class Control(Mo):
    ...
    prop = PropMeta("str", "state", "state", 63654, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "NA"
    prop._addConstant("NA", "na", 0)
    prop._addConstant("disable-in-progress", "disabling", 1)
    ...
    prop = PropMeta("str", "udpPortCtrl", "udpPortCtrl", 64398, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unassigned"
    prop._addConstant("assigned", "iana-assigned-port", 1)
    prop._addConstant("unassigned", "unassigned-port", 0)
    meta.props.add("udpPortCtrl", prop)
