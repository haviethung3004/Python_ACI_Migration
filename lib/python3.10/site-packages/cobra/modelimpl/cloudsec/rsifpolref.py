...
class RsIfPolRef(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.cloudsec.RsIfPolRef", "cobra.model.cloudsec.IfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudsecRsIfPolRef"
    meta.rnFormat = "rsifPolRef"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63637, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 12289
    prop.defaultValueStr = "cloudsecIfPol"
    prop._addConstant("cloudsecIfPol", None, 12289)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63636, PropCategory.REGULAR)
