...
class Cont(Mo):
    ...
    meta.childClasses.add("cobra.model.action.GoreaderSubj")
    ...
    meta.childClasses.add("cobra.model.action.TftpdSubj")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.action.GoreaderSubj", "goreadersubj-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.action.TftpdSubj", "tftpdsubj-"))
