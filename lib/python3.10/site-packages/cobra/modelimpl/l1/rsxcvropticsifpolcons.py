...
# ##################################################
class RsXcvrOpticsIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsXcvrOpticsIfPolCons", "cobra.model.xcvr.OpticsIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsXcvrOpticsIfPolCons"
    meta.rnFormat = "rsxcvrOpticsIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Transceiver Optics Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 68142, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 68139, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68138, PropCategory.REGULAR)
