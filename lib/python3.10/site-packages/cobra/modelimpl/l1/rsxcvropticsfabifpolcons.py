...
# ##################################################
class RsXcvrOpticsFabIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsXcvrOpticsFabIfPolCons", "cobra.model.xcvr.OpticsFabIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsXcvrOpticsFabIfPolCons"
    meta.rnFormat = "rsxcvrOpticsFabIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Fabric Transceiver Optics Policy Attachment"
    ...
    meta.rnPrefixes = [
        ('rsxcvrOpticsFabIfPolCons', False),
    ]
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 68194, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 68191, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68190, PropCategory.REGULAR)
