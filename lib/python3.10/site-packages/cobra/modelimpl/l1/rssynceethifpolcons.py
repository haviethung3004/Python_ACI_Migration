...
# ##################################################
class RsSynceEthIfPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsSynceEthIfPolCons", "cobra.model.synce.EthIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsSynceEthIfPolCons"
    meta.rnFormat = "rssynceEthIfPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Synce Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 63074, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 63052, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63051, PropCategory.REGULAR)
