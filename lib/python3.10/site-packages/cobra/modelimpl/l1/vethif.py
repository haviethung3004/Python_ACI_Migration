...
class VethIf(Mo):
    ...
    prop._addConstant("The bind configuration already exists", "already-exists", 3)
    ...
    prop._addConstant("l1:VethIfmodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("bfd-establishment", "bfdestablishment", 207)
    ...
    prop._addConstant("err-disabled-link-flaps", "err-disabled-link-flaps", 204)
    ...
    prop._addConstant("hpo-blkd-by-macsec-sesns", "hpoblkdbymacsecsesns", 209)
    prop._addConstant("hpo-max-limit-exceeded", "hpomaxlimitexceeded", 208)
    prop._addConstant("hw-disabled", "hwdisabled", 93)
    prop._addConstant("hw-disabled-by-bkout", "hwdisabledbybkout", 205)
    prop._addConstant("hw-disbld-speed-mismatch", "hwdisabledbyspeedmismatch", 206)
    ...
    prop._addConstant("link-failure", "linkfailure", 20)
    prop._addConstant("link-flap-err", "linkflaperr", 17)
    prop._addConstant("link-not-connected", "linknotconnected", 211)
    ...
    prop._addConstant("mpls-platform-not-supported", "mplspfmnotsupp", 203)
    ...
    prop._addConstant("unsupported-xcvr", "unsupportedxcvr", 210)
