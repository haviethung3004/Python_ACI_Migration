...
class Memory(Mo):
    ...
    meta = ClassMeta("cobra.model.proc.Memory")

    meta.moClassName = "procMemory"
    meta.rnFormat = "procmem"
    meta.category = MoCategory.REGULAR
    meta.label = "LC/FM Memory Information"
    ...
    meta.childClasses.add("cobra.model.proc.MemUsage")

    meta.childNamesAndRnPrefix.append(("cobra.model.proc.MemUsage", "memusage-"))
    ...
    prop = PropMeta("str", "maxAlloc", "maxAlloc", 67714, PropCategory.REGULAR)
    prop.label = "Maximum Memory Allocated"
    prop.isOper = True
    meta.props.add("maxAlloc", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 67721, PropCategory.REGULAR)
