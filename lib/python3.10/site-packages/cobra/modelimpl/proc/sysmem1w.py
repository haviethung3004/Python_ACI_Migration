...
class SysMem1w(Mo):
    ...
    prop = PropMeta("str", "PercUsedMemoryAvg", "PercUsedMemoryAvg", 69986, PropCategory.IMPLICIT_AVG)
    prop.label = "Percentage of Memory Used average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemoryAvg", prop)

    prop = PropMeta("str", "PercUsedMemoryLast", "PercUsedMemoryLast", 69983, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "Percentage of Memory Used current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemoryLast", prop)

    prop = PropMeta("str", "PercUsedMemoryMax", "PercUsedMemoryMax", 69985, PropCategory.IMPLICIT_MAX)
    prop.label = "Percentage of Memory Used maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemoryMax", prop)

    prop = PropMeta("str", "PercUsedMemoryMin", "PercUsedMemoryMin", 69984, PropCategory.IMPLICIT_MIN)
    prop.label = "Percentage of Memory Used minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemoryMin", prop)

    prop = PropMeta("str", "PercUsedMemorySpct", "PercUsedMemorySpct", 69987, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "Percentage of Memory Used suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemorySpct", prop)

    prop = PropMeta("str", "PercUsedMemoryThr", "PercUsedMemoryThr", 69989, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "PercUsedMemoryTr", "PercUsedMemoryTr", 69991, PropCategory.IMPLICIT_TREND)
    prop.label = "Percentage of Memory Used trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemoryTr", prop)

    prop = PropMeta("str", "PercUsedMemoryTrBase", "PercUsedMemoryTrBase", 69990, PropCategory.IMPLICIT_TREND_BASE)
    prop.label = "Percentage of Memory Used trend baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("PercUsedMemoryTrBase", prop)

    prop = PropMeta("str", "PercUsedMemoryTtl", "PercUsedMemoryTtl", 69988, PropCategory.IMPLICIT_TOTAL)
