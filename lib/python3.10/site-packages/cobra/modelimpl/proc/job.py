...
class Job(Mo):
    ...
    meta = ClassMeta("cobra.model.proc.Job")

    meta.moClassName = "procJob"
    meta.rnFormat = "job-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 68064, PropCategory.REGULAR)
    prop.label = "Job ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68066, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "numTimesAppInfraFailed", "numTimesAppInfraFailed", 68065, PropCategory.REGULAR)
    prop.label = "Job app infra failure"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("numTimesAppInfraFailed", prop)
