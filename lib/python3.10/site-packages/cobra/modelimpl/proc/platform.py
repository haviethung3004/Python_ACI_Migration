...
class Platform(Mo):
    ...
    meta = ClassMeta("cobra.model.proc.Platform")

    meta.moClassName = "procPlatform"
    meta.rnFormat = "platform-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 68077, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68079, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "numUnexpectedLVs", "numUnexpectedLVs", 68078, PropCategory.REGULAR)
    prop.label = "num unexpected lvs"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("numUnexpectedLVs", prop)
