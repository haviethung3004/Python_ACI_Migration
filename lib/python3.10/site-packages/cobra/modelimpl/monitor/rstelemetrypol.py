...
# ##################################################
class RsTelemetryPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsTelemetryPol", "cobra.model.monitor.TelemetryPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "monitorRsTelemetryPol"
    meta.rnFormat = "rstelemetryPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to telemetry policy"
    ...
    meta.rnPrefixes = [
        ('rstelemetryPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 68587, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68588, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68553, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68533, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20051
    prop.defaultValueStr = "monitorTelemetryPol"
    prop._addConstant("monitorTelemetryPol", None, 20051)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68532, PropCategory.REGULAR)
