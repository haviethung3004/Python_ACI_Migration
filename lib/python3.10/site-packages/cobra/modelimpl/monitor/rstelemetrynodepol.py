...
# ##################################################
class RsTelemetryNodePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsTelemetryNodePol", "cobra.model.monitor.TelemetryNodePol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "monitorRsTelemetryNodePol"
    meta.rnFormat = "rstelemetryNodePol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to telemetry node policy"
    ...
    meta.rnPrefixes = [
        ('rstelemetryNodePol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 68591, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68592, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68555, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68537, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20052
    prop.defaultValueStr = "monitorTelemetryNodePol"
    prop._addConstant("monitorTelemetryNodePol", None, 20052)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68536, PropCategory.REGULAR)
