...
# ##################################################
class RsCfgToProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsCfgToProfile", "cobra.model.monitor.IntfP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "monitorRsCfgToProfile"
    meta.rnFormat = "rscfgToProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68517, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68516, PropCategory.REGULAR)
