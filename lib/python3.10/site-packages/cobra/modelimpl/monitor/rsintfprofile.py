...
# ##################################################
class RsIntfProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsIntfProfile", "cobra.model.monitor.IntfP")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "monitorRsIntfProfile"
    meta.rnFormat = "rsintfProfile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68563, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68521, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20037
    prop.defaultValueStr = "monitorIntfP"
    prop._addConstant("monitorIntfP", None, 20037)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68520, PropCategory.REGULAR)
