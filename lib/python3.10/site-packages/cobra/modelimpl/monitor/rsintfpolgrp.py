...
# ##################################################
class RsIntfPolGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsIntfPolGrp", "cobra.model.monitor.IntfPolGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "monitorRsIntfPolGrp"
    meta.rnFormat = "rsintfPolGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68575, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68576, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68529, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20045
    prop.defaultValueStr = "monitorIntfPolGrp"
    prop._addConstant("monitorIntfPolGrp", None, 20045)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68528, PropCategory.REGULAR)
