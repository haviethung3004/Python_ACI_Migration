...
# ##################################################
class RsCfgToNodePolGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsCfgToNodePolGrp", "cobra.model.monitor.NodePolGrp")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "monitorRsCfgToNodePolGrp"
    meta.rnFormat = "rscfgToNodePolGrp-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68513, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68512, PropCategory.REGULAR)
