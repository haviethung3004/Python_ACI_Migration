...
# ##################################################
class RsNodePolGrp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.monitor.RsNodePolGrp", "cobra.model.monitor.NodePolGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "monitorRsNodePolGrp"
    meta.rnFormat = "rsnodePolGrp"
    ...
    prop = PropMeta("str", "annotation", "annotation", 68567, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 68568, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 68548, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 68525, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20048
    prop.defaultValueStr = "monitorNodePolGrp"
    prop._addConstant("monitorNodePolGrp", None, 20048)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 68524, PropCategory.REGULAR)
