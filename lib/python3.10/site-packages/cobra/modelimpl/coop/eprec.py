...
class EpRec(Mo):
    ...
    prop = PropMeta("str", "remoteType", "remoteType", 63109, PropCategory.REGULAR)
    prop.label = "RemoteType"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "local"
    prop._addConstant("ext_src", "ext_src", 4)
    prop._addConstant("golf", "golf", 3)
    prop._addConstant("local", "local", 0)
    prop._addConstant("mpod", "mpod", 1)
    prop._addConstant("msite", "msite", 2)
    meta.props.add("remoteType", prop)
