...
class EpExcMac(Mo):
    ...
    meta = ClassMeta("cobra.model.coop.EpExcMac")

    meta.moClassName = "coopEpExcMac"
    meta.rnFormat = "mac-%(mac)s"
    meta.category = MoCategory.REGULAR
    meta.label = "EP's mac exempted from dampening"
    ...
    meta.parentClasses.add("cobra.model.coop.EpExcBD")
    ...
    prop = PropMeta("str", "mac", "mac", 64409, PropCategory.REGULAR)
    prop.label = "MAC"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
