...
class Dom(Mo):
    ...
    meta.childClasses.add("cobra.model.coop.EpExcList")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.coop.EpExcList", "epexclist"))
    ...
    prop = PropMeta("str", "haveThresholdsEPs", "haveThresholdsEPs", 64410, PropCategory.REGULAR)
    prop.label = "Current Thresholds EPs"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", 0)
    prop._addConstant("yes", "yes", 1)
    meta.props.add("haveThresholdsEPs", prop)
    ...
    prop = PropMeta("str", "lwepexceptionList", "lwepexceptionList", 65804, PropCategory.REGULAR)
    prop.label = "LW Ep exception list"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", 0)
    prop._addConstant("yes", "yes", 1)
    meta.props.add("lwepexceptionList", prop)

    prop = PropMeta("str", "lwepnormalList", "lwepnormalList", 65805, PropCategory.REGULAR)
    prop.label = "LW Ep normal list"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", 0)
    prop._addConstant("yes", "yes", 1)
    meta.props.add("lwepnormalList", prop)
    ...
    prop = PropMeta("str", "noOfThresholdEPs", "noOfThresholdEPs", 64419, PropCategory.REGULAR)
    prop.label = "No of Thresholds EPs"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "0"
    meta.props.add("noOfThresholdEPs", prop)

    prop = PropMeta("str", "operFlags", "operFlags", 59048, PropCategory.REGULAR)
    prop.label = "Operational State flags"
    prop.isOper = True
    prop._addConstant("sync-done", "is-initial-sync-done", 1)
    ...
    prop = PropMeta("str", "overloadState", "overloadState", 65413, PropCategory.REGULAR)
    prop.label = "IPN Overload State"
    prop.isOper = True
    prop.defaultValue = 1
    prop.defaultValueStr = "enabled"
    prop._addConstant("disabled", "disabled", 0)
    prop._addConstant("enabled", "enabled", 1)
    meta.props.add("overloadState", prop)
