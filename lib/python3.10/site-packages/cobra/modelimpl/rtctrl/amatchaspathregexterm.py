...
# ##################################################
class AMatchAsPathRegexTerm(Mo):
    meta = ClassMeta("cobra.model.rtctrl.AMatchAsPathRegexTerm")

    meta.isAbstract = True
    meta.moClassName = "rtctrlAMatchAsPathRegexTerm"


    meta.moClassName = "rtctrlAMatchAsPathRegexTerm"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstraction Match Rule Based on AS-Path Regular Expression"
