...
# ##################################################
class SetNhUnchanged(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.SetNhUnchanged")

    meta.moClassName = "rtctrlSetNhUnchanged"
    meta.rnFormat = "nhunchanged"
    meta.category = MoCategory.REGULAR
    meta.label = "Nexthop Unchanged Action"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetNhUnchanged")
    ...
    prop = PropMeta("str", "annotation", "annotation", 57924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 57918, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 12
    prop.defaultValueStr = "nh-unchanged"
