...
# ##################################################
class SetPolicyTagDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.SetPolicyTagDef")

    meta.moClassName = "rtctrlSetPolicyTagDef"
    meta.rnFormat = "ptag"
    ...
    prop = PropMeta("str", "policytag", "policytag", 65374, PropCategory.REGULAR)
    prop.label = "Policy Tag"
    prop.isImplicit = True
    prop.isAdmin = True
    prop._addConstant("any", "any", 0)
    meta.props.add("policytag", prop)
