...
# ##################################################
class SetPolicyTag(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.SetPolicyTag")

    meta.moClassName = "rtctrlSetPolicyTag"
    meta.rnFormat = "sptag"
    ...
    meta.childClasses.add("cobra.model.rtctrl.RsSetPolicyTagToInstP")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.rtctrl.RsSetPolicyTagToInstP", "rssetPolicyTagToInstP"))
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetPolicyTag")

    meta.rnPrefixes = [
        ('sptag', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65403, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65404, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65393, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 65373, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 14
    prop.defaultValueStr = "policy-tag"
    ...
    prop._addConstant("nh-unchanged", "nexthop-unchanged", 12)
    prop._addConstant("ospf-fwd-addr", "ospf-fowarding-address", 7)
    prop._addConstant("ospf-nssa", "ospf-nssa-area", 6)
    prop._addConstant("policy-tag", "policy-tag", 14)
    prop._addConstant("redist-multipath", "redistribute-multipath", 13)
