...
# ##################################################
class SetNhUnchangedDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.SetNhUnchangedDef")

    meta.moClassName = "rtctrlSetNhUnchangedDef"
    meta.rnFormat = "nhunchanged"
    meta.category = MoCategory.REGULAR
    meta.label = "Nexthop Unchanged Action Definition"
