...
# ##################################################
class SetRedistMultipath(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.SetRedistMultipath")

    meta.moClassName = "rtctrlSetRedistMultipath"
    meta.rnFormat = "redistmpath"
    meta.category = MoCategory.REGULAR
    meta.label = "Redistribute Multipath Action"
    ...
    meta.superClasses.add("cobra.model.rtctrl.ASetRedistMultipath")
    ...
    prop = PropMeta("str", "annotation", "annotation", 63082, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 63081, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 13
    prop.defaultValueStr = "redist-multipath"
