...
# ##################################################
class RsSetPolicyTagToInstP(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.rtctrl.RsSetPolicyTagToInstP", "cobra.model.l3ext.InstP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "rtctrlRsSetPolicyTagToInstP"
    meta.rnFormat = "rssetPolicyTagToInstP"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to External Network Instance Profile"
    ...
    meta.rnPrefixes = [
        ('rssetPolicyTagToInstP', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 65405, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 65406, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65394, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 65389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65388, PropCategory.REGULAR)
