...
# ##################################################
class MatchAsPathRegexTermDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.MatchAsPathRegexTermDef")

    meta.moClassName = "rtctrlMatchAsPathRegexTermDef"
    meta.rnFormat = "aspathrxtrm-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Match AS-Path Regular Expression Rule Definition"
    ...
    prop = PropMeta("str", "name", "name", 65907, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
