...
# ##################################################
class SetRedistMultipathDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.rtctrl.SetRedistMultipathDef")

    meta.moClassName = "rtctrlSetRedistMultipathDef"
    meta.rnFormat = "redistmpath"
    meta.category = MoCategory.REGULAR
    meta.label = "Redistribute Multipath Action Definition"
