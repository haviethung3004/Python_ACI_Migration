...
class Events(Mo):
    ...
    meta = ClassMeta("cobra.model.fte.Events")

    meta.moClassName = "fteEvents"
    meta.rnFormat = "events-%(name)s"
    ...
    meta.childClasses.add("cobra.model.fte.RtEventsAtt")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fte.RtEventsAtt", "rteventsAtt"))
    ...
    prop = PropMeta("str", "aclDrops", "aclDrops", 59605, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "aclSpan", "aclSpan", 61554, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "analyticsChangedBit", "analyticsChangedBit", 61539, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "analyticsChangedCount", "analyticsChangedCount", 59620, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "analyticsChangedLimit", "analyticsChangedLimit", 59619, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 59672, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "blackHole", "blackHole", 59608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "bufferDrops", "bufferDrops", 59606, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 59633, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dropFlowCount", "dropFlowCount", 59612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "eventExportMax", "eventExportMax", 59629, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "exportFlowBit", "exportFlowBit", 61536, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "exportFlowCount", "exportFlowCount", 59614, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "exportFlowLimit", "exportFlowLimit", 59613, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "firstPacketBit", "firstPacketBit", 61537, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "firstPacketCount", "firstPacketCount", 59616, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "firstPacketLimit", "firstPacketLimit", 59615, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "flowType", "flowType", 61557, PropCategory.REGULAR)
    prop.label = "flowType"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("flowType", prop)

    prop = PropMeta("str", "fwdDrops", "fwdDrops", 59607, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "groupDropEvents", "groupDropEvents", 59603, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "groupLatencyEvents", "groupLatencyEvents", 59604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latencyCount", "latencyCount", 59626, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latencyFlowCount", "latencyFlowCount", 59611, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latencyLimit", "latencyLimit", 59625, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latencyThreshold", "latencyThreshold", 59609, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "latencyThresholdUnit", "latencyThresholdUnit", 59610, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mousePacketBit", "mousePacketBit", 61538, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mousePacketCount", "mousePacketCount", 59618, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mousePacketLimit", "mousePacketLimit", 59617, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 59637, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "packetDisposition", "packetDisposition", 61544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionIdsDrop", "packetDispositionIdsDrop", 61547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionPolicingDrop", "packetDispositionPolicingDrop", 61546, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionPolicyApplied", "packetDispositionPolicyApplied", 61551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionPolicyCopy", "packetDispositionPolicyCopy", 61550, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionPolicyDrop", "packetDispositionPolicyDrop", 61548, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionPolicyRedirect", "packetDispositionPolicyRedirect", 61549, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetDispositionRpfPortSecFail", "packetDispositionRpfPortSecFail", 61545, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetLength", "packetLength", 61558, PropCategory.REGULAR)
    prop.label = "packetLength"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("packetLength", prop)

    prop = PropMeta("str", "packetValueMatchBit", "packetValueMatchBit", 61541, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetValueMatchCount", "packetValueMatchCount", 59624, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "packetValueMatchLimit", "packetValueMatchLimit", 59623, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pingOfDeath", "pingOfDeath", 61553, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "receiveWindowZero", "receiveWindowZero", 61552, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rttAckCount", "rttAckCount", 59628, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rttAckLimit", "rttAckLimit", 59627, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rttSampleAckBit", "rttSampleAckBit", 61543, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rttSampleSeqBit", "rttSampleSeqBit", 61542, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tableFullBit", "tableFullBit", 61540, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tableFullCount", "tableFullCount", 59622, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tableFullLimit", "tableFullLimit", 59621, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ttlMatchEnable", "ttlMatchEnable", 61555, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ttlMatchValue", "ttlMatchValue", 61556, PropCategory.REGULAR)
