...
# ##################################################
class RsEventsAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fte.RsEventsAtt", "cobra.model.fte.Events")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fteRsEventsAtt"
    meta.rnFormat = "rseventsAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attach FTE Events to FTE Monitor"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59681, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59659, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 59645, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17677
    prop.defaultValueStr = "fteEvents"
    prop._addConstant("fteEvents", None, 17677)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59644, PropCategory.REGULAR)
