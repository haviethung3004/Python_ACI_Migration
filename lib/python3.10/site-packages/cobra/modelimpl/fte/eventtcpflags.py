...
# ##################################################
class EventTcpFlags(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.fte.EventTcpFlags")

    meta.moClassName = "fteEventTcpFlags"
    meta.rnFormat = "eventTcpFlags-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Configure FTE Event Tcp Flags Information"
    ...
    prop = PropMeta("str", "annotation", "annotation", 61768, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 61752, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61769, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 61757, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tcpAckFlag", "tcpAckFlag", 61564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpCwrFlag", "tcpCwrFlag", 61567, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpEceFlag", "tcpEceFlag", 61566, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpFinFlag", "tcpFinFlag", 61560, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpFlagSet", "tcpFlagSet", 61559, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpNsFlag", "tcpNsFlag", 61568, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpPshFlag", "tcpPshFlag", 61563, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpRstFlag", "tcpRstFlag", 61562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpSynFlag", "tcpSynFlag", 61561, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tcpUrgFlag", "tcpUrgFlag", 61565, PropCategory.REGULAR)
