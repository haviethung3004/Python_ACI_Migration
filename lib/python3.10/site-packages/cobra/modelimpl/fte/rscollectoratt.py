...
class RsCollectorAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fte.RsCollectorAtt", "cobra.model.fte.Collector")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fteRsCollectorAtt"
    meta.rnFormat = "rscollectorAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Reference to FTE Collector"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59678, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59679, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 59642, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17675
    prop.defaultValueStr = "fteCollector"
    prop._addConstant("fteCollector", None, 17675)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59641, PropCategory.REGULAR)
