...
class Collector(Mo):
    ...
    meta = ClassMeta("cobra.model.fte.Collector")

    meta.moClassName = "fteCollector"
    meta.rnFormat = "collector-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Configure the FTE Collector Information"
    ...
    meta.childClasses.add("cobra.model.fte.RtCollectorAtt")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.fte.RtCollectorAtt", "rtcollectorAtt-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 59668, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "descr", "descr", 59632, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dscp", "dscp", 59583, PropCategory.REGULAR)
    prop.label = "Configure Collector Entity DSCP Value"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 63)]
    ...
    prop = PropMeta("str", "dstAddr", "dstAddr", 59581, PropCategory.REGULAR)
    prop.label = "Configure Collector Entity IP"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("dstAddr", prop)

    prop = PropMeta("str", "dstPort", "dstPort", 59582, PropCategory.REGULAR)
    prop.label = "Configure Collector Entity L4 Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59669, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 59636, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "srcAddr", "srcAddr", 59585, PropCategory.REGULAR)
    prop.label = "Configure Collector Entity Source IP Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "swExport", "swExport", 67898, PropCategory.REGULAR)
    prop.label = "Flag to indicate if user wants Software based record export or HW based"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrfName", "vrfName", 59580, PropCategory.REGULAR)
    prop.label = "Configure Collector Entity VRF"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
