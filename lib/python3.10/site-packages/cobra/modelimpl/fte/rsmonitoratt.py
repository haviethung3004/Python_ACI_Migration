...
class RsMonitorAtt(Mo):
    ...
    meta = SourceRelationMeta("cobra.model.fte.RsMonitorAtt", "cobra.model.fte.Monitor")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "fteRsMonitorAtt"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59684, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59685, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 59651, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17678
    prop.defaultValueStr = "fteMonitor"
    prop._addConstant("fteMonitor", None, 17678)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59650, PropCategory.REGULAR)
