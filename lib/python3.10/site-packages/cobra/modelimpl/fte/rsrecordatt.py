...
# ##################################################
class RsRecordAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fte.RsRecordAtt", "cobra.model.fte.Record")
    meta.cardinality = SourceRelationMeta.ONE_TO_M

    meta.moClassName = "fteRsRecordAtt"
    meta.rnFormat = "rsrecordAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Attach FTE Record to FTE Monitor"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59676, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59677, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 59657, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 59648, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17676
    prop.defaultValueStr = "fteRecord"
    prop._addConstant("fteRecord", None, 17676)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 59647, PropCategory.REGULAR)
