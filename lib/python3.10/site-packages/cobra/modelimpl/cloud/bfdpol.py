...
class BfdPol(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.BfdPol")

    meta.moClassName = "cloudBfdPol"
    meta.rnFormat = "bfdPol-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Tenant BFD Policy"
    ...
    prop = PropMeta("str", "annotation", "annotation", 67924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 67925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 67911, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
