...
# ##################################################
class StatsFilter(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.StatsFilter")

    meta.moClassName = "cloudStatsFilter"
    meta.rnFormat = "sfpeerip-[%(peerIP)s]-sfpeerport-%(peerPort)s-sfprotocol-%(protocol)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Filter Policy"
    ...
    meta.childClasses.add("cobra.model.cloud.RtToStatsFilter")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.RtToStatsFilter", "rttoStatsFilter-"))
    ...
    meta.superClasses.add("cobra.model.cloud.AAFilter")
    ...
    prop = PropMeta("str", "annotation", "annotation", 54684, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 54685, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "peerIP", "peerIP", 54665, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "peerPort", "peerPort", 54666, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "protocol", "protocol", 54667, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.namingProps.append(getattr(meta.props, "peerPort"))
    ...
    def __init__(self, parentMoOrDn, peerIP, peerPort, protocol, markDirty=True, **creationProps):
        namingVals = [peerIP, peerPort, protocol]
