...
# ##################################################
class RsLDevToMgmtPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsLDevToMgmtPol", "cobra.model.cloud.MgmtPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsLDevToMgmtPol"
    meta.rnFormat = "rsLDevToMgmtPol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Cloud LDev to Mgmt Policy"
    ...
    meta.rnPrefixes = [
        ('rsLDevToMgmtPol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 58450, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58451, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 58441, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 58437, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17283
    prop.defaultValueStr = "cloudMgmtPol"
    prop._addConstant("cloudMgmtPol", None, 17283)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58436, PropCategory.REGULAR)
