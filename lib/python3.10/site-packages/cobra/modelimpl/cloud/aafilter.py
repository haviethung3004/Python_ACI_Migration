...
# ##################################################
class AAFilter(Mo):
    meta = ClassMeta("cobra.model.cloud.AAFilter")

    meta.isAbstract = True
    meta.moClassName = "cloudAAFilter"
    ...
    prop = PropMeta("str", "peerIP", "peerIP", 54654, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("peerIP", prop)

    prop = PropMeta("str", "peerPort", "peerPort", 54655, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    ...
    prop = PropMeta("str", "protocol", "protocol", 54656, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 255)]
