...
# ##################################################
class RtToStatsFilter(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.cloud.RtToStatsFilter", "cobra.model.cloud.AwsFlowLogPol")

    meta.moClassName = "cloudRtToStatsFilter"
    meta.rnFormat = "rttoStatsFilter-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54680, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58320, PropCategory.REGULAR)
