...
class Credentials(Mo):
    ...
    prop = PropMeta("str", "clientId", "clientId", 63699, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "email", "email", 63700, PropCategory.REGULAR)
    prop.label = "Credentials email address"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "rsaPrivateKey", "rsaPrivateKey", 63698, PropCategory.REGULAR)
    prop.label = "RSA Private Key"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("rsaPrivateKey", prop)
