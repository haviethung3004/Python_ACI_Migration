...
# ##################################################
class RsLDevToComputePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.cloud.RsLDevToComputePol", "cobra.model.cloud.ComputePol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "cloudRsLDevToComputePol"
    meta.rnFormat = "rsLDevToComputePol"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation from Cloud LDev to Compute Instance Policy"
    ...
    meta.rnPrefixes = [
        ('rsLDevToComputePol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 58448, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 58449, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 58440, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 58433, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 17282
    prop.defaultValueStr = "cloudComputePol"
    prop._addConstant("cloudComputePol", None, 17282)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58432, PropCategory.REGULAR)
