...
class RtCtrlPolDef(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.RtCtrlPolDef")

    meta.moClassName = "cloudRtCtrlPolDef"
    meta.rnFormat = "cloudRtctrlPolDef-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Route Control Policies"
    ...
    prop = PropMeta("str", "direction", "direction", 60595, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "name", "name", 60596, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
