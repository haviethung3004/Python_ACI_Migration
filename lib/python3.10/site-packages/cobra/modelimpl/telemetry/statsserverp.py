...
class StatsServerP(Mo):
    ...
    meta.childClasses.add("cobra.model.telemetry.FastExporterStreamP")
    ...
    meta.childClasses.add("cobra.model.telemetry.SnCertDownloadStatus")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.telemetry.FastExporterStreamP", "fastexpstrm"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.telemetry.SnCertDownloadStatus", "sncertst"))
    ...
    prop = PropMeta("str", "transportType", "transportType", 65304, PropCategory.REGULAR)
    prop.label = "Destination transport type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "kafka"
    prop._addConstant("gRPC", "grpc", 2)
    prop._addConstant("kafka", "kafka", 1)
    meta.props.add("transportType", prop)
