...
# ##################################################
class FteEventTcpFlags(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.FteEventTcpFlags")

    meta.moClassName = "telemetryFteEventTcpFlags"
    meta.rnFormat = "fteeventstcpflags-%(name)s"
    ...
    meta.rnPrefixes = [
        ('fteeventstcpflags-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61784, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61785, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 61761, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
