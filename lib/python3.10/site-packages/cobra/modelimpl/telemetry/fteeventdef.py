...
# ##################################################
class FteEventDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.FteEventDef")

    meta.moClassName = "telemetryFteEventDef"
    meta.rnFormat = "fteeventdef-%(name)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 61776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61777, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 61759, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
