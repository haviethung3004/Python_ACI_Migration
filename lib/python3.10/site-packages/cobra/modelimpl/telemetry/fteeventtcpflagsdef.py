...
# ##################################################
class FteEventTcpFlagsDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.telemetry.FteEventTcpFlagsDef")

    meta.moClassName = "telemetryFteEventTcpFlagsDef"
    meta.rnFormat = "fteeventtcpflagsdef-%(name)s"
    ...
    meta.superClasses.add("cobra.model.telemetry.AFteEventsTcpFlags")
    meta.superClasses.add("cobra.model.naming.NamedObject")

    meta.rnPrefixes = [
        ('fteeventtcpflagsdef-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 61778, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 61779, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 61762, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
