...
class Dom(Mo):
    ...
    prop = PropMeta("str", "delayRestoreTmr", "delayRestoreTmr", 65872, PropCategory.REGULAR)
    prop.label = "Delay Restore Timer"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(120, 600)]
    prop.defaultValue = 120
    prop.defaultValueStr = "120"
    meta.props.add("delayRestoreTmr", prop)
    ...
    prop = PropMeta("str", "selfIniFabLinkFlapCnt", "selfIniFabLinkFlapCnt", 59834, PropCategory.REGULAR)
    prop.label = "Self-initiated Fabric Link Flap count"
    prop.isOper = True
    meta.props.add("selfIniFabLinkFlapCnt", prop)

    prop = PropMeta("str", "splitBrainTimerDuration", "splitBrainTimerDuration", 63441, PropCategory.REGULAR)
    prop.label = "Split-brain timer duration in sec"
    prop.isOper = True
    meta.props.add("splitBrainTimerDuration", prop)

    prop = PropMeta("str", "splitBrainTimerIsRun", "splitBrainTimerIsRun", 63439, PropCategory.REGULAR)
    prop.label = "Is split-brain timer running?"
    prop.isOper = True
    ...
    prop._addConstant("yes", "yes", True)
    meta.props.add("splitBrainTimerIsRun", prop)

    prop = PropMeta("str", "splitBrainTimerStartTime", "splitBrainTimerStartTime", 63440, PropCategory.REGULAR)
    prop.label = "When did split-brain timer start?"
    prop.isOper = True
    meta.props.add("splitBrainTimerStartTime", prop)
    ...
    prop = PropMeta("str", "tryRoleEstabTimerDuration", "tryRoleEstabTimerDuration", 63444, PropCategory.REGULAR)
    prop.label = "Try-role-establish timer duration in sec"
    prop.isOper = True
    meta.props.add("tryRoleEstabTimerDuration", prop)

    prop = PropMeta("str", "tryRoleEstabTimerIsRun", "tryRoleEstabTimerIsRun", 63442, PropCategory.REGULAR)
    prop.label = "Is try-role-establish timer running?"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("No", "no", True)
    ...
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("tryRoleEstabTimerIsRun", prop)

    prop = PropMeta("str", "tryRoleEstabTimerStartTime", "tryRoleEstabTimerStartTime", 63443, PropCategory.REGULAR)
    prop.label = "When did try-role-establish timer start?"
    prop.isOper = True
    meta.props.add("tryRoleEstabTimerStartTime", prop)
    ...
    prop._addConstant("vpc:DomdelayRestoreTmr_failed_flag", None, 64)
    prop._addConstant("vpc:Domid_failed_flag", None, 256)
    prop._addConstant("vpc:DomlcOwn_failed_flag", None, 9223372036854775808)
    prop._addConstant("vpc:DommodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("vpc:DommonPolDn_failed_flag", None, 16384)
    prop._addConstant("vpc:Domname_failed_flag", None, 1)
    prop._addConstant("vpc:DomorphanPortList_failed_flag", None, 262144)
    prop._addConstant("vpc:DompeerIp_failed_flag", None, 524288)
    prop._addConstant("vpc:DomrolePrio_failed_flag", None, 33554432)
    prop._addConstant("vpc:DomsysMac_failed_flag", None, 2147483648)
    prop._addConstant("vpc:DomsysPrio_failed_flag", None, 4294967296)
    prop._addConstant("vpc:DomvIpAnnounceDelay_failed_flag", None, 549755813888)
    prop._addConstant("vpc:DomvirtualIp_failed_flag", None, 1099511627776)
