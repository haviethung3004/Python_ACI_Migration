...
class If(Mo):
    ...
    meta.label = "Dot1x interface information"
    ...
    prop = PropMeta("str", "annotation", "annotation", 69531, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69532, PropCategory.REGULAR)
    ...
    prop.label = "APIC Dot1x Guest VLAN"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 4095)]
    prop.defaultValue = 0
    ...
    prop.label = "Dot1x host mode type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop.label = "Maximum re-authentication attempts before failing"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 10)]
    prop.defaultValue = 2
    ...
    prop.label = "Maximum retries to initiate authentication"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(2, 10)]
    prop.defaultValue = 2
    ...
    prop.label = "Dot1x timeout quiet period"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop.label = "Dot1x timeout rate limit period"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    prop.label = "Enable or disable reauthentication for this port"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop.label = "Dot1x timeout re-auth period"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop.label = "Dot1x timeout server timeout"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop.label = "Dot1x timeout supplicant timeout"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 30
    ...
    prop.label = "Dot1x timeout tx period"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    prop.defaultValue = 30
