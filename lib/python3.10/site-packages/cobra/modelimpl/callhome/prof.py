...
class Prof(Mo):
    ...
    prop = PropMeta("str", "pwd", "pwd", 62309, PropCategory.REGULAR)
    prop.label = "Password"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "secureSmtp", "secureSmtp", 62310, PropCategory.REGULAR)
    prop.label = "Secure SMTP"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("secureSmtp", prop)
    ...
    prop = PropMeta("str", "username", "username", 62308, PropCategory.REGULAR)
    prop.label = "Username"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
