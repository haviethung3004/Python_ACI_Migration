...
# ##################################################
class AVmmExporterPol(Mo):
    meta = ClassMeta("cobra.model.netflow.AVmmExporterPol")

    meta.isAbstract = True
    meta.moClassName = "netflowAVmmExporterPol"


    meta.moClassName = "netflowAVmmExporterPol"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Netflow VMM External Collector"
    ...
    prop = PropMeta("str", "dscp", "dscp", 59559, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ver", "ver", 59558, PropCategory.REGULAR)
    prop.label = "VMM Exporter NetFlow Version Format"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 3
