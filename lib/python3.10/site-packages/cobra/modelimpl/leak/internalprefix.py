...
# ##################################################
class InternalPrefix(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.leak.InternalPrefix")

    meta.moClassName = "leakInternalPrefix"
    meta.rnFormat = "leakintprefix-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Inter-VRF Leaked Internal Prefix"
    ...
    prop = PropMeta("str", "annotation", "annotation", 63795, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63796, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ip", "ip", 63748, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
