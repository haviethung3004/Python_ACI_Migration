...
# ##################################################
class ExternalPrefix(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.leak.ExternalPrefix")

    meta.moClassName = "leakExternalPrefix"
    meta.rnFormat = "leakextsubnet-[%(ip)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Inter-VRF Leaked External Prefix"
    ...
    meta.superClasses.add("cobra.model.leak.APrefix")
    ...
    prop = PropMeta("str", "annotation", "annotation", 57498, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "configIssues", "configIssues", 63735, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57499, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ge", "ge", 63736, PropCategory.REGULAR)
    prop.label = "Greater then"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 128)]
    prop.defaultValue = 0
    ...
    meta.props.add("ge", prop)

    prop = PropMeta("str", "ip", "ip", 57490, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "le", "le", 63737, PropCategory.REGULAR)
    prop.label = "Less than or equal"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 128)]
    prop.defaultValue = 0
