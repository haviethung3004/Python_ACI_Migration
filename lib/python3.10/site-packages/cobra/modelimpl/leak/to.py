...
class To(Mo):
    ...
    meta = ClassMeta("cobra.model.leak.To")

    meta.moClassName = "leakTo"
    meta.rnFormat = "to-[%(tenantName)s]-[%(ctxName)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Tenant and VRF destination for Inter-VRF Leaked Routes"
    ...
    prop = PropMeta("str", "annotation", "annotation", 57500, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctxName", "ctxName", 57485, PropCategory.REGULAR)
    prop.label = "Leak to VRF Name"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57501, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "scope", "scope", 59711, PropCategory.REGULAR)
    prop.label = "Override Subnet scope"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "targetVRFPresent", "targetVRFPresent", 59824, PropCategory.REGULAR)
    prop.label = "Target VRF is Present?"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.props.add("targetVRFPresent", prop)

    prop = PropMeta("str", "tenantName", "tenantName", 57484, PropCategory.REGULAR)
    prop.label = "Leak to Tenant Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    ...
    prop = PropMeta("str", "toCtxDn", "toCtxDn", 57486, PropCategory.REGULAR)
    prop.label = "VRF DN where to export the Routes"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("toCtxDn", prop)
    ...
    getattr(meta.props, "ctxName").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, tenantName, ctxName, markDirty=True, **creationProps):
        namingVals = [tenantName, ctxName]
