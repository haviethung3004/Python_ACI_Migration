...
# ##################################################
class RtRouteToLeakRouteIntPfx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.leak.RtRouteToLeakRouteIntPfx", "cobra.model.ip.Route")

    meta.moClassName = "leakRtRouteToLeakRouteIntPfx"
    meta.rnFormat = "rtipRouteToLeakRouteIntPfx-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtipRouteToLeakRouteIntPfx-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 58468, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 58467, PropCategory.REGULAR)
