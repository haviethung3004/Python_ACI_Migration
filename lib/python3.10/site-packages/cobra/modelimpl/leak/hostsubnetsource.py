...
# ##################################################
class HostSubnetSource(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.leak.HostSubnetSource")

    meta.moClassName = "leakHostSubnetSource"
    meta.rnFormat = "hostsubsrc"
    meta.category = MoCategory.REGULAR
    meta.label = "Host Subnet Def"
    ...
    prop = PropMeta("str", "bdDn", "bdDn", 62989, PropCategory.REGULAR)
    prop.label = "Bridge Domain DN of the leaked EPG host subnet"
    ...
    prop = PropMeta("str", "epgDn", "epgDn", 62990, PropCategory.REGULAR)
    prop.label = "EPG DN of the leaked EPG host subnet"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "type", "type", 62991, PropCategory.REGULAR)
    prop.label = "Type of the leaked EPG host subnet"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("epAnycast", "epanycast", 3)
    prop._addConstant("epReachability", "epreachability", 2)
    prop._addConstant("nlb", "nlb", 1)
