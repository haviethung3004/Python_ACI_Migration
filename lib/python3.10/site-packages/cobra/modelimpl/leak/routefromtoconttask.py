...
# ##################################################
class RouteFromToContTask(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.leak.RouteFromToContTask")

    meta.moClassName = "leakRouteFromToContTask"
    meta.rnFormat = "leakRouteFromToContTask-%(id)s"
    ...
    prop = PropMeta("str", "id", "id", 59036, PropCategory.REGULAR)
    prop.label = "ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop._addConstant("SendRouteFromToContToShard", "sendroutefromtoconttoshard", 3857)
