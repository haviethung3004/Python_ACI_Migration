...
# ##################################################
class RtToRemoteStpEncapInstDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.stp.RtToRemoteStpEncapInstDef", "cobra.model.fv.RemotePolHolder")

    meta.moClassName = "stpRtToRemoteStpEncapInstDef"
    meta.rnFormat = "rtfvToRemoteStpEncapInstDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtfvToRemoteStpEncapInstDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 65473, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 65472, PropCategory.REGULAR)
