...
# ##################################################
class RsRtAsPathAccAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.rtmap.RsRtAsPathAccAtt", "cobra.model.rtlist.Rule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "rtmapRsRtAsPathAccAtt"
    meta.rnFormat = "rsrtAsPathAccAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Access list Attachment"
    ...
    meta.parentClasses.add("cobra.model.rtmap.MatchAsPathAccessList")
    ...
    prop = PropMeta("str", "tCl", "tCl", 65899, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 19237
    prop.defaultValueStr = "rtlistRule"
    prop._addConstant("rtlistRule", None, 19237)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 65898, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tSKey", "tSKey", 65935, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
