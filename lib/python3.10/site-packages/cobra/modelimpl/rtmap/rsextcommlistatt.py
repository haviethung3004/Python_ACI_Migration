...
# ##################################################
class RsExtCommListAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.rtmap.RsExtCommListAtt", "cobra.model.rtextcom.Rule")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "rtmapRsExtCommListAtt"
    meta.rnFormat = "rsExtCommListAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Extended Community List Attachment"
    ...
    meta.parentClasses.add("cobra.model.rtmap.SetExtCommList")
    ...
    prop = PropMeta("str", "tCl", "tCl", 69135, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69134, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 69138, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
