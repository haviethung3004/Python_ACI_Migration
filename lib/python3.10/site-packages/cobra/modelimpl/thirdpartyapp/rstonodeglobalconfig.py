...
# ##################################################
class RsToNodeGlobalConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.thirdpartyapp.RsToNodeGlobalConfig", "cobra.model.thirdpartyapp.NodeGlobalConfig")
    meta.targetNameProps["name"] = "tnThirdpartyappNodeGlobalConfigName"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "thirdpartyappRsToNodeGlobalConfig"
    meta.rnFormat = "rstoNodeGlobalConfig-%(tnThirdpartyappNodeGlobalConfigName)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to Global Config Policy"
    ...
    meta.rnPrefixes = [
        ('rstoNodeGlobalConfig-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69603, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69604, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69586, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69578, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20215
    prop.defaultValueStr = "thirdpartyappNodeGlobalConfig"
    ...
    prop = PropMeta("str", "tnThirdpartyappNodeGlobalConfigName", "tnThirdpartyappNodeGlobalConfigName", 69577, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnThirdpartyappNodeGlobalConfigName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "tnThirdpartyappNodeGlobalConfigName"))
    ...
    def __init__(self, parentMoOrDn, tnThirdpartyappNodeGlobalConfigName, markDirty=True, **creationProps):
        namingVals = [tnThirdpartyappNodeGlobalConfigName]
