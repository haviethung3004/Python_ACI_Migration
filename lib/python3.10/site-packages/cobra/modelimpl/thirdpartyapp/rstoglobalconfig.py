...
# ##################################################
class RsToGlobalConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.thirdpartyapp.RsToGlobalConfig", "cobra.model.thirdpartyapp.AppGlobalConfig")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "thirdpartyappRsToGlobalConfig"
    meta.rnFormat = "rstoGlobalConfig-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rstoGlobalConfig-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 69607, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 69608, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69588, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 69582, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 20216
    prop.defaultValueStr = "thirdpartyappAppGlobalConfig"
    prop._addConstant("thirdpartyappAppGlobalConfig", None, 20216)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 69581, PropCategory.REGULAR)
