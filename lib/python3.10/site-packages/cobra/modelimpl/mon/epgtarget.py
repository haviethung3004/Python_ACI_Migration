...
class EPGTarget(Mo):
    ...
    meta.writeAccessMask = 0x80009
    meta.readAccessMask = 0x81009
    ...
    prop._addConstant("bfdMhIfP", "interface-profile-(bfd.mhifp)", 16452)
    prop._addConstant("bfdMhNodeP", "node-profile-(bfd.mhnodep)", 16909)
    prop._addConstant("bfdMicroBfdP", "micro-bfd-configuration-(bfd.microbfdp)", 18846)
    prop._addConstant("bfdRsIfPol", "interface-policy-(bfd.rsifpol)", 8229)
    prop._addConstant("bfdRsMhIfPol", "interface-policy-(bfd.rsmhifpol)", 16453)
    prop._addConstant("bfdRsMhNodePol", "node-policy-(bfd.rsmhnodepol)", 16910)
    ...
    prop._addConstant("bgpSiteOfOriginP", "site-of-origin-profile-(bgp.siteoforiginp)", 18553)
    ...
    prop._addConstant("cloudAwsProvider", "cloud-aws-provider-(cloud.awsprovider)", 14637)
    ...
    prop._addConstant("cloudCtxUnderlayP", "underlay-ctx-profile-(cloud.ctxunderlayp)", 17303)
    ...
    prop._addConstant("cloudExtCtxProfile", "external-cloud-context-profile-(cloud.extctxprofile)", 18296)
    ...
    prop._addConstant("cloudGatewayCidr", "cloud-gateway-cidr-(cloud.gatewaycidr)", 18681)
    prop._addConstant("cloudGatewayRouterLabel", "cloud-gateway-router-label-(cloud.gatewayrouterlabel)", 19142)
    prop._addConstant("cloudGatewayRouterP", "cloud-gateway-router-profile-(cloud.gatewayrouterp)", 16823)
    prop._addConstant("cloudGcpFlowLogPol", "gcp-flow-log-policy-(cloud.gcpflowlogpol)", 19262)
    ...
    prop._addConstant("cloudIpInfoHolder", "ip-stats-holder-(cloud.ipinfoholder)", 19555)
    ...
    prop._addConstant("cloudLDev", "cloud-l4-l7-device-(cloud.ldev)", 17260)
    prop._addConstant("cloudLDevDef", "cloud-ldev-resolved-data-(cloud.ldevdef)", 15160)
    prop._addConstant("cloudLIf", "cloud-l4-l7-logical-interface-(cloud.lif)", 17264)
    ...
    prop._addConstant("cloudPeZnInfoHolder", "peer-zone-stats-holder-(cloud.pezninfoholder)", 19730)
    ...
    prop._addConstant("cloudRsCtxProfileToAccessPolicy", "relation-to-the-access-policy-to-be-used-(cloud.rsctxprofiletoaccesspolicy)", 18763)
    prop._addConstant("cloudRsCtxProfileToGatewayRouterP", "attachment-to-cloud-gateway-routerp-(cloud.rsctxprofiletogatewayrouterp)", 16837)
    ...
    prop._addConstant("cloudRsCtxToGcpFlowLog", "relationship-to-flow-log-policy-(cloud.rsctxtogcpflowlog)", 19259)
    prop._addConstant("cloudRsExtCtxProfileToCtx", "attachment-to-fvctx-(cloud.rsextctxprofiletoctx)", 18297)
    prop._addConstant("cloudRsExtCtxProfileToRegion", "attachment-to-cloud-region-(cloud.rsextctxprofiletoregion)", 18299)
    prop._addConstant("cloudRsExtNetworkPToCtx", "attachment-to-fvctx-(cloud.rsextnetworkptoctx)", 18720)
    prop._addConstant("cloudRsExtNetworkPToRegion", "attachment-to-cloud-region-(cloud.rsextnetworkptoregion)", 18718)
    prop._addConstant("cloudRsGatewayRouterPToRegion", "attachment-to-cloud-regions-(cloud.rsgatewayrouterptoregion)", 18679)
    ...
    prop._addConstant("cloudRsLDevToComputePol", "relation-from-cloud-ldev-to-compute-instance-policy-(cloud.rsldevtocomputepol)", 17284)
    prop._addConstant("cloudRsLDevToCtx", "relation-from-cloud-ldev-to-cloud-ctx-(cloud.rsldevtoctx)", 17261)
    prop._addConstant("cloudRsLDevToMgmtPol", "relation-from-cloud-ldev-to-mgmt-policy-(cloud.rsldevtomgmtpol)", 17286)
    ...
    prop._addConstant("cloudRsListenerToVip", "relation-from-listener-to-frontend-ip-(cloud.rslistenertovip)", 19225)
    prop._addConstant("cloudRsProviderToAccessPolicy", "relation-to-the-access-policy-to-be-used-(cloud.rsprovidertoaccesspolicy)", 19093)
    prop._addConstant("cloudRsSubnetToAccessPolicy", "relation-to-the-access-policy-to-be-used-(cloud.rssubnettoaccesspolicy)", 19824)
    prop._addConstant("cloudRsSubnetToCtx", "overwrite-attachment-to-fvctx-(cloud.rssubnettoctx)", 18292)
    ...
    prop._addConstant("cloudRsToStatsFilter", "relationship-to-stats-filter-(cloud.rstostatsfilter)", 16097)
    prop._addConstant("cloudRsToTransitHubGwPol", "attachment-to-transit-hub-gateway-policy-(cloud.rstotransithubgwpol)", 16824)
    prop._addConstant("cloudRsToUnderlayCtxProfile", "underlay-ctxprofile-to-overlay-ctxprofile-(cloud.rstounderlayctxprofile)", 17304)
    ...
    prop._addConstant("cloudRtrInfoHolder", "gateway-stats-holder-(cloud.rtrinfoholder)", 17089)
    prop._addConstant("cloudRuleActionDef", "resolved-cloud-load-balancer-listener-rule-action-(cloud.ruleactiondef)", 15189)
    prop._addConstant("cloudSfInfoHolder", "stats-filter-info-holder-(cloud.sfinfoholder)", 16093)
    prop._addConstant("cloudSubnet", "cloud-subnet-(cloud.subnet)", 14606)
    prop._addConstant("cloudSubnetInfoHolder", "subnet-stats-holder-(cloud.subnetinfoholder)", 19553)
    prop._addConstant("cloudSvcEPg", "cloud-service-epg-(cloud.svcepg)", 18284)
    ...
    prop._addConstant("cloudVpcInfoHolder", "vpc-stats-holder-(cloud.vpcinfoholder)", 19552)
    prop._addConstant("cloudVpnIfP", "cloud-vgw-vpn-interface-profile-(cloud.vpnifp)", 14426)
    prop._addConstant("cloudVpnNetworkP", "vpn-network-profile-(cloud.vpnnetworkp)", 18899)
    prop._addConstant("cloudZnInfoHolder", "zone-stats-holder-(cloud.zninfoholder)", 19554)
    prop._addConstant("cloudZoneInfoHolder", "zone-stats-holder-(cloud.zoneinfoholder)", 17090)
    ...
    prop._addConstant("compVNic", "virtual-interface-(comp.vnic)", 1125)
    ...
    prop._addConstant("dbgacRsFromEsg", "source-esg-relation-for-atomic-counter-policy-(dbgac.rsfromesg)", 18513)
    ...
    prop._addConstant("dbgacRsToEsgForEpgToEpg", "destination-esg-relation-for-atomic-counter-policy-(dbgac.rstoesgforepgtoepg)", 18515)
    ...
    prop._addConstant("fvAEPgAddrMgmtPoolAtt", "application-epg-ip-address-management-policy-(fv.aepgaddrmgmtpoolatt)", 20275)
    ...
    prop._addConstant("fvAssocNodeDef", "fabric-node-id-(fv.assocnodedef)", 19174)
    prop._addConstant("fvAssocPolicyDef", "associated-routing-policy-(fv.assocpolicydef)", 19173)
    ...
    prop._addConstant("fvCtxRtSummPol", "vrf-level-route-summarization-policy-(fv.ctxrtsummpol)", 19157)
    ...
    prop._addConstant("fvESg", "endpoint-security-group-(fv.esg)", 16474)
    prop._addConstant("fvESgEpP", "security-epg-resolved-(fv.esgepp)", 16463)
    ...
    prop._addConstant("fvEpIpTag", "ip-endpoint-(fv.epiptag)", 18584)
    prop._addConstant("fvEpMacTag", "mac-endpoint-(fv.epmactag)", 18528)
    ...
    prop._addConstant("fvEpStMacTagDef", "static-mac-endpoint-(fv.epstmactagdef)", 18586)
    prop._addConstant("fvEpSubnetTagDef", "ip-subnet-(fv.epsubnettagdef)", 18587)
    prop._addConstant("fvEpTagDefCont", "container-for-object-of-type-aeptag-def-(fv.eptagdefcont)", 18585)
    prop._addConstant("fvEpTags", "endpoint-tags-container-(fv.eptags)", 18524)
    prop._addConstant("fvEpVmmMacTagDef", "vmm-mac-endpoint-(fv.epvmmmactagdef)", 18601)
    ...
    prop._addConstant("fvFBRGroupDef", "fbr-group-(fv.fbrgroupdef)", 19113)
    prop._addConstant("fvFabricExpRtctrlP", "vrf-level-fabric-export-rtctrl-policy-(fv.fabricexprtctrlp)", 19183)
    ...
    prop._addConstant("fvIfConfigIssues", "network-configuration-issues-(fv.ifconfigissues)", 18294)
    ...
    prop._addConstant("fvIntraVrfFabricImpRtctrlP", "vrf-level-fabric-import-rtctrl-policy-for-intra-vrf-(fv.intravrffabricimprtctrlp)", 19176)
    ...
    prop._addConstant("fvLabelInfoHolder", "mpls-label-(fv.labelinfoholder)", 17550)
    ...
    prop._addConstant("fvPhyNodeAtt", "epg-to-path-attachment-(fv.phynodeatt)", 18033)
    ...
    prop._addConstant("fvRouteDeployP", "vrf-level-route-deployment-policy-(fv.routedeployp)", 20014)
    prop._addConstant("fvRouteInfoHolder", "mpls-route-(fv.routeinfoholder)", 17549)
    ...
    prop._addConstant("fvRsAddrMgmtPool", "relation-to-address-management-policy-(fv.rsaddrmgmtpool)", 20276)
    ...
    prop._addConstant("fvRsCtxToCloudVrfRouteLeakPol", "relationship-to-cloud-route-leak-policy-(fv.rsctxtocloudvrfrouteleakpol)", 18741)
    ...
    prop._addConstant("fvRsCtxToRtctrlProfile", "relationship-to-route-control-profile-(fv.rsctxtortctrlprofile)", 17963)
    ...
    prop._addConstant("fvRsEpTagBd", "bridge-domain-for-the-eptag-(fv.rseptagbd)", 18529)
    prop._addConstant("fvRsEpTagCtx", "vrf-for-the-eptag-(fv.rseptagctx)", 18526)
    prop._addConstant("fvRsEppBgpCtxPol", "bgp-timers-policy-(fv.rseppbgpctxpol)", 1930)
    prop._addConstant("fvRsExportToFabricProfile", "export-route-profile-(fv.rsexporttofabricprofile)", 19186)
    prop._addConstant("fvRsIgmpsn", "igmp-snoop-policy-(fv.rsigmpsn)", 1875)
    prop._addConstant("fvRsImportFromFabricProfile", "import-route-profile-(fv.rsimportfromfabricprofile)", 19179)
    ...
    prop._addConstant("fvRsQosRequirement", "collection-of-qos-rules-that-need-to-be-enforced-(fv.rsqosrequirement)", 18279)
    prop._addConstant("fvRsScope", "private-network-(fv.rsscope)", 16475)
    ...
    prop._addConstant("fvRsSubnetToRtSummPol", "route-summarization-policy-(fv.rssubnettortsummpol)", 19163)
    ...
    prop._addConstant("fvRtSummSubnet", "route-summarization-subnet-(fv.rtsummsubnet)", 19162)
    ...
    prop._addConstant("hostprotFilterContainer", "remote-ip-filter-container-(hostprot.filtercontainer)", 19996)
    prop._addConstant("hostprotPodFilter", "endpoint-label-(hostprot.podfilter)", 19999)
    ...
    prop._addConstant("l3extAttEntPCont", "to-fix---l3ext.attentpcont", 17268)
    prop._addConstant("l3extAttNodeCont", "to-fix---l3ext.attnodecont", 18034)
    prop._addConstant("l3extBdProfile", "external-bridge-group-profile-(l3ext.bdprofile)", 18075)
    prop._addConstant("l3extBdProfileCont", "conntainer-of-rspath-relationships-(l3ext.bdprofilecont)", 18076)
    prop._addConstant("l3extConsLbl", "external-connectivity-consumer-label-(l3ext.conslbl)", 7246)
    prop._addConstant("l3extConsLblDef", "external-connectivity-consumer-label-definition-(l3ext.conslbldef)", 7629)
    ...
    prop._addConstant("l3extFloatingNode", "floating-node-(l3ext.floatingnode)", 17270)
    prop._addConstant("l3extFloatingNodeCont", "to-fix---l3ext.floatingnodecont", 17269)
    ...
    prop._addConstant("l3extRogueExceptMacP", "rogue-exception-mac-group-policy-(l3ext.rogueexceptmacp)", 20166)
    prop._addConstant("l3extRsArpIfPol", "arp-policy-(l3ext.rsarpifpol)", 15242)
    prop._addConstant("l3extRsBdProfile", "external-bridge-group-profile-(l3ext.rsbdprofile)", 18077)
    prop._addConstant("l3extRsDampeningPol", "l3-out-dampening-policy-(l3ext.rsdampeningpol)", 8043)
    prop._addConstant("l3extRsDynPathAtt", "floating-path-attributes-(l3ext.rsdynpathatt)", 15822)
    ...
    prop._addConstant("l3extRsLNodePMplsCustQosPol", "mpls-custom-qos-policy-(l3ext.rslnodepmplscustqospol)", 17468)
    prop._addConstant("l3extRsLblToInstP", "external-network-instance-profile-(l3ext.rslbltoinstp)", 16895)
    prop._addConstant("l3extRsLblToProfile", "route-control-profile-(l3ext.rslbltoprofile)", 16893)
    ...
    prop._addConstant("l3extRsOutToFBRGroup", "fallback-route-group-(l3ext.rsouttofbrgroup)", 19105)
    prop._addConstant("l3extRsOutToMdpProvP", "l3-out-multi-domain-policy-(l3ext.rsouttomdpprovp)", 16568)
    ...
    prop._addConstant("l3extRsPathToRogueExceptMacGroup", "rogue-exception-mac-group-(l3ext.rspathtorogueexceptmacgroup)", 20167)
    ...
    prop._addConstant("l3extRtdCtxCont", "routed-ctx-container-(l3ext.rtdctxcont)", 15455)
    prop._addConstant("l3extRtdCtxDef", "routed-ctx-definition-(l3ext.rtdctxdef)", 15456)
    ...
    prop._addConstant("l3extSharedSecondaryIpCont", "shared-secondary-ip-container-(l3ext.sharedsecondaryipcont)", 17959)
    ...
    prop._addConstant("leakInternalSubnet", "inter-vrf-leaked-subnet-(epg/bd-in-case-of-apic,-cloudsubnet/cloudcidr-in-case-of-capic)-(leak.internalsubnet)", 16930)
    prop._addConstant("leakRouteCont", "implicit-route-container-mo-used-to-keep-track-of-the-routes-to-be-leaked-in-the-vrf-(leak.routecont)", 16933)
    prop._addConstant("leakRouteIntPfx", "implicit-subnet-to-be-leaked-(leak.routeintpfx)", 16934)
    prop._addConstant("leakRoutes", "inter-vrf-leaked-routes-container-(leak.routes)", 16929)
    ...
    prop._addConstant("mplsExtP", "external-profile-(mpls.extp)", 16649)
    prop._addConstant("mplsIfP", "interface-config-(mpls.ifp)", 16654)
    prop._addConstant("mplsRsIfPol", "mpls-ifpol-relation-(mpls.rsifpol)", 16655)
    prop._addConstant("mplsRsLabelPol", "mpls-labelpol-relation-(mpls.rslabelpol)", 16650)
    ...
    prop._addConstant("pimBDDef", "pim-bridge-domain-level-policy-definition-(pim.bddef)", 16495)
    prop._addConstant("pimBDDestFilterDef", "destination-routemap-for-the-bd-filter-definition-(pim.bddestfilterdef)", 16501)
    prop._addConstant("pimBDDestFilterPol", "destination-routemap-for-the-bd-filter-policy-(pim.bddestfilterpol)", 16500)
    prop._addConstant("pimBDFilterDef", "pim-bd-filter-policy-definition-(pim.bdfilterdef)", 16497)
    prop._addConstant("pimBDFilterPol", "pim-bd-filter-policy-(pim.bdfilterpol)", 16496)
    prop._addConstant("pimBDP", "bd-level-pim-policy-(pim.bdp)", 16494)
    prop._addConstant("pimBDSrcFilterDef", "source-routemap-for-the-bd-filter-definition-(pim.bdsrcfilterdef)", 16499)
    prop._addConstant("pimBDSrcFilterPol", "source-routemap-for-the-bd-filter-policy-(pim.bdsrcfilterpol)", 16498)
    ...
    prop._addConstant("pimCSWEntry", "configured-stripe-winner-entry-(pim.cswentry)", 20064)
    prop._addConstant("pimCSWPol", "configured-stripe-winner-policy-(pim.cswpol)", 20062)
    ...
    prop._addConstant("qosEpDscpMarking", "dscp-marking-of-endpoint-egress-traffic-(qos.epdscpmarking)", 18281)
    prop._addConstant("qosRequirement", "collection-of-qos-rules-that-need-to-be-enforced-(qos.requirement)", 18272)
    prop._addConstant("qosRsEgressDppPol", "policing-policy-that-need-to-enforced-in-egress-direction-(qos.rsegressdpppol)", 18275)
    prop._addConstant("qosRsIngressDppPol", "policing-policy-that-need-to-enforced-in-ingress-direction-(qos.rsingressdpppol)", 18273)
    ...
    prop._addConstant("rtctrlAttrP", "action-rule-profile-(rtctrl.attrp)", 607)
    ...
    prop._addConstant("rtctrlRsSetPolicyTagToInstP", "relation-to-external-network-instance-profile-(rtctrl.rssetpolicytagtoinstp)", 19120)
    prop._addConstant("rtctrlScope", "route-context-scope-(rtctrl.scope)", 603)
    prop._addConstant("rtctrlSetPolicyTag", "to-fix---rtctrl.setpolicytag", 19119)
    ...
    prop._addConstant("vnsCIfDef", "cif-def-(vns.cifdef)", 16799)
    ...
    prop._addConstant("vnsImplL1L2Dest", "to-fix---vns.impll1l2dest", 17493)
    ...
    prop._addConstant("vnsRsLIfCtxToRemoteSvcRedirectPol", "relation-from-lif-context-to-remote-service-redirect-policy-(vns.rslifctxtoremotesvcredirectpol)", 20107)
    prop._addConstant("vnsRsLIfCtxToSvcEPgPol", "relation-from-lif-context-to-service-epg-profile-(vns.rslifctxtosvcepgpol)", 12987)
    prop._addConstant("vnsRsLIfCtxToSvcL3OutDef", "relation-from-lif-context-to-vns:svcl3outdef-(vns.rslifctxtosvcl3outdef)", 18534)
    ...
    prop._addConstant("vnsSvcL3Cont", "to-fix---vns.svcl3cont", 18536)
    prop._addConstant("vnsSvcL3OutDef", "to-fix---vns.svcl3outdef", 18537)
    ...
    prop._addConstant("vnsTermVrf", "terminal-vrf-info-(vns.termvrf)", 18092)
    ...
    prop._addConstant("vzEntryPortZero", "filter-port-zero-entry-(vz.entryportzero)", 20207)
