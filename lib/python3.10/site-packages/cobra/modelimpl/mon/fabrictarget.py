...
class FabricTarget(Mo):
    ...
    meta.writeAccessMask = 0x81001
    meta.readAccessMask = 0x83801
    ...
    prop._addConstant("aaaOauthEp", "default-oauth2-settings-(aaa.oauthep)", 18901)
    prop._addConstant("aaaOauthProvider", "oauth-2-provider-(aaa.oauthprovider)", 18902)
    ...
    prop._addConstant("actrlSiteScope", "access-control-scope-(actrl.sitescope)", 20101)
    ...
    prop._addConstant("analyticsHwTelemetry", "entity-for-all-hardware-telemetry-features-(analytics.hwtelemetry)", 17672)
    ...
    prop._addConstant("analyticsRsTargetToAcl", "target-to-acl-mo-(analytics.rstargettoacl)", 20057)
    prop._addConstant("apphostingAppConf", "configuration-required-for-app-hosting-(apphosting.appconf)", 19579)
    prop._addConstant("apphostingAppHosting", "top-entity-of-the-application-host-(apphosting.apphosting)", 19578)
    prop._addConstant("arpDom", "this-object-holds-per-arp-domain-(vrf)-information-(arp.dom)", 2556)
    ...
    prop._addConstant("bfdKaP", "keepalive-policy-information-is-held-in-this-object-(bfd.kap)", 5780)
    prop._addConstant("bfdMhAuthP", "authentication-policy-(bfd.mhauthp)", 16783)
    prop._addConstant("bfdMhIfAf", "multi-hop-interface-address-family-(bfd.mhifaf)", 16457)
    prop._addConstant("bfdMhKaP", "keepalive-policy-(bfd.mhkap)", 16458)
    prop._addConstant("bfdRsMbrSess", "port-channel-member-sessions-(bfd.rsmbrsess)", 5768)
    ...
    prop._addConstant("bgpDataPlaneIfP", "mdp-data-plane-address-(bgp.dataplaneifp)", 16563)
    prop._addConstant("bgpDom", "domain-(bgp.dom)", 2605)
    prop._addConstant("bgpDomainIdBase", "domain-id-base-(bgp.domainidbase)", 18431)
    ...
    prop._addConstant("bgpSiteOfOriginDef", "site-of-origin-profile-definition-(bgp.siteoforigindef)", 18554)
    ...
    prop._addConstant("cloudNaming", "naming-policy-container-for-cloud-resources-(cloud.naming)", 18106)
    ...
    prop._addConstant("cloudRsAccountToAccessPolicy", "relation-to-the-access-policy-to-be-used-(cloud.rsaccounttoaccesspolicy)", 18765)
    ...
    prop._addConstant("cloudRsDomPToAccessPolicy", "relation-to-the-access-policy-to-be-used-(cloud.rsdomptoaccesspolicy)", 19828)
    prop._addConstant("cloudRsLIfToCloudSubnet", "relation-from-cloud-ldev-to-cloud-subnet-(cloud.rsliftocloudsubnet)", 18065)
    prop._addConstant("cloudRsSvcEPgCtx", "relationship-to-the-fvctx-of-belonging-(cloud.rssvcepgctx)", 17265)
    ...
    prop._addConstant("coopDb", "database-(coop.db)", 2588)
    prop._addConstant("coopDom", "coop-domain-(coop.dom)", 2575)
    prop._addConstant("coopEntity", "coop-entity-(coop.entity)", 2598)
    prop._addConstant("coopEpDamp", "endpoint-dampen-status-(coop.epdamp)", 19231)
    ...
    prop._addConstant("datetimeRsNtpProvToNtpAuthKey2", "new-(n-to-m)-relation-to-datetime-authentication-key-(datetime.rsntpprovtontpauthkey2)", 18505)
    ...
    prop._addConstant("dbgexpRsTSOnDScheduler", "relation-to-techsupport-scheduler-policy-(dbgexp.rstsondscheduler)", 17705)
    ...
    prop._addConstant("dhcpNodeConvP", "fabric-node-standalone-to-aci-conversion-(dhcp.nodeconvp)", 18837)
    prop._addConstant("dhcpNodeConvPOper", "fabric-nodeconvp-oper-(dhcp.nodeconvpoper)", 19089)
    prop._addConstant("dhcpNodeGrp", "dhcp-node-group-(dhcp.nodegrp)", 1448)
    prop._addConstant("dhcpNodeIdentPOper", "fabric-node-member-oper-(dhcp.nodeidentpoper)", 18836)
    ...
    prop._addConstant("dot1xDUEp", "dot1x-aep-interface-(dot1x.duep)", 12247)
    prop._addConstant("dot1xEntity", "dot1x-entity-(dot1x.entity)", 10532)
    prop._addConstant("dot1xIf", "dot1x-interface-information-(dot1x.if)", 10535)
    ...
    prop._addConstant("eqptLEM", "the-line-card-information-(eqpt.lem)", 18780)
    ...
    prop._addConstant("eqptSpromCH", "chaiss-backplane-sprom-(eqpt.spromch)", 20175)
    ...
    prop._addConstant("fabricCtrlrConfigP", "fabric-controller-configuration-(fabric.ctrlrconfigp)", 17984)
    ...
    prop._addConstant("fabricRsApplTechSupPSched", "tech-support-policy-(fabric.rsappltechsuppsched)", 16554)
    ...
    prop._addConstant("fabricRsOpticsFabIfPol", "relation-to-fabric-interface-optics-policy-(fabric.rsopticsfabifpol)", 19933)
    ...
    prop._addConstant("fabricSummaryCont", "summary-configuration-container-(fabric.summarycont)", 19771)
    ...
    prop._addConstant("fcAllocEncapCont", "fibre-channel-encap-container-(fc.allocencapcont)", 8740)
    ...
    prop._addConstant("fteCollectorBucket", "flow-collector-bucket-entry-(fte.collectorbucket)", 18238)
    prop._addConstant("fteFte", "configure-flow-table-events-(fte.fte)", 17673)
    prop._addConstant("fteInst", "configure-fte-instance-(fte.inst)", 17674)
    prop._addConstant("fteMonitor", "configure-fte-monitor-information-(fte.monitor)", 17678)
    prop._addConstant("fteRsCollectorAtt", "reference-to-fte-collector-(fte.rscollectoratt)", 17681)
    prop._addConstant("fteRsEventsAtt", "attach-fte-events-to-fte-monitor-(fte.rseventsatt)", 17683)
    prop._addConstant("fteRsRecordAtt", "attach-fte-record-to-fte-monitor-(fte.rsrecordatt)", 17679)
    ...
    prop._addConstant("fvDisableDPLearning", "disable-ip-dataplane-learning-for-epg-host,-/32-or-/128-(fv.disabledplearning)", 18519)
    ...
    prop._addConstant("fvExtTepPoolDef", "tep-pool-definition-(fv.extteppooldef)", 11019)
    prop._addConstant("fvFabricExtConnPDef", "intrasite/intersite-profile-definition-(fv.fabricextconnpdef)", 7261)
    ...
    prop._addConstant("fvLocalBdDef", "local-bd-definition-(fv.localbddef)", 9510)
    prop._addConstant("fvLocalCtxDef", "local-vrf-definition-(fv.localctxdef)", 9508)
    prop._addConstant("fvLocalCtxPcTagDef", "local-vrf-pctag-(fv.localctxpctagdef)", 11022)
    prop._addConstant("fvLocalEPgDef", "local-epg-definition-(fv.localepgdef)", 9512)
    prop._addConstant("fvLocalInstPDef", "local-instance-policy-(fv.localinstpdef)", 10985)
    prop._addConstant("fvNodeDef", "node-definition-(fv.nodedef)", 7274)
    prop._addConstant("fvNwIssues", "network-configuration-issues-(fv.nwissues)", 2113)
    prop._addConstant("fvNwIssuesExtended", "network-configuration-issues-(fv.nwissuesextended)", 18595)
    prop._addConstant("fvOrchsInfo", "orchestrator-configuration-for-this-epg-(fv.orchsinfo)", 5566)
    prop._addConstant("fvPodConnPDef", "pod-dtep-ip-definition-(fv.podconnpdef)", 7264)
    prop._addConstant("fvPodDhcpServerInfo", "dhcp-server-info-of-the-current-pod-(fv.poddhcpserverinfo)", 12903)
    prop._addConstant("fvRInfoHolder", "rule-info-holder-(fv.rinfoholder)", 1896)
    prop._addConstant("fvRemoteBdDef", "remote-bd-definition-(fv.remotebddef)", 9511)
    prop._addConstant("fvRemoteCtxDef", "remote-vrf-definition-(fv.remotectxdef)", 9509)
    prop._addConstant("fvRemoteCtxPcTagDef", "remote-vrf-pctag-(fv.remotectxpctagdef)", 11023)
    prop._addConstant("fvRemoteEPgDef", "remote-epg-definition-(fv.remoteepgdef)", 9513)
    prop._addConstant("fvRemoteInstPDef", "remote-instance-policy-(fv.remoteinstpdef)", 10986)
    ...
    prop._addConstant("fvRtdEpPInfoCont", "routed-external-epp-information-container-(fv.rtdeppinfocont)", 6033)
    prop._addConstant("fvRtdEpPInfoHolder", "routed-external-epp-information-holder-(fv.rtdeppinfoholder)", 6034)
    prop._addConstant("fvSharedService", "alloc-pctag-from-shared-service-pool-(fv.sharedservice)", 5306)
    prop._addConstant("fvSite", "site-(fv.site)", 9504)
    prop._addConstant("fvSiteCont", "site-(fv.sitecont)", 9503)
    ...
    prop._addConstant("hostprotFilterContainerDef", "remote-ip-filter-container-(hostprot.filtercontainerdef)", 19997)
    prop._addConstant("hostprotNamespace", "openshift-k8s-namespace-(hostprot.namespace)", 19994)
    prop._addConstant("hostprotNamespaceDef", "host-protection-domain-remote-ip-container-(hostprot.namespacedef)", 19995)
    prop._addConstant("hostprotPodFilterDef", "endpoint-label-filter-(hostprot.podfilterdef)", 20000)
    ...
    prop._addConstant("hostprotRemoteIpContainer", "remote-ip-container-(hostprot.remoteipcontainer)", 19991)
    ...
    prop._addConstant("iaclLeafProfile", "copp-prefilter-leaf-level-policy-(iacl.leafprofile)", 10975)
    prop._addConstant("iaclSpineProfile", "copp-prefilter-spine-level-policy-(iacl.spineprofile)", 10976)
    ...
    prop._addConstant("infraAssocEncapInstDef", "assocociated-stpencapinstdef-(infra.assocencapinstdef)", 19149)
    ...
    prop._addConstant("infraClusterPol", "cluster-policy-(infra.clusterpol)", 4463)
    ...
    prop._addConstant("infraFailedAutoUpgrade", "failed-auto-upgrade-(infra.failedautoupgrade)", 19897)
    prop._addConstant("infraFailedClusterShrink", "failed-cluster-shrink-(infra.failedclustershrink)", 20098)
    ...
    prop._addConstant("infraNonCompliantNode", "cluster-element-(infra.noncompliantnode)", 20386)
    ...
    prop._addConstant("infraProvFloatingSvi", "floatign-l3out-provisioning-(infra.provfloatingsvi)", 18666)
    prop._addConstant("infraRecoveryNodeTask", "task-to-send-fabric-recovery-trigger-to-other-pod-and-remote-leaf-(infra.recoverynodetask)", 18667)
    ...
    prop._addConstant("infraRsBfdMhIpv4InstPol", "mh-bfd-ipv4-instance-policy-(infra.rsbfdmhipv4instpol)", 16914)
    prop._addConstant("infraRsBfdMhIpv6InstPol", "mh-bfd-ipv6-instance-policy-(infra.rsbfdmhipv6instpol)", 16916)
    ...
    prop._addConstant("infraRsFuncToVirtualLIfPAttEntPCont", "virtuallifps-using-function-(infra.rsfunctovirtuallifpattentpcont)", 17271)
    ...
    prop._addConstant("infraRsLeafTopoctrlUsbConfigProfilePol", "usb-config-policy-(infra.rsleaftopoctrlusbconfigprofilepol)", 18913)
    ...
    prop._addConstant("infraRsOpticsIfPol", "relation-to-interface-optics-policy-(infra.rsopticsifpol)", 19928)
    ...
    prop._addConstant("infraRsPtpInstPol", "ptp-node-policy-(infra.rsptpinstpol)", 18673)
    prop._addConstant("infraRsQosDppIfPol", "data-plane-policy-both-(infra.rsqosdppifpol)", 7766)
    prop._addConstant("infraRsQosEgressDppIfPol", "egress-data-plane-policy-(infra.rsqosegressdppifpol)", 7861)
    prop._addConstant("infraRsQosIngressDppIfPol", "ingress-data-plane-policy-(infra.rsqosingressdppifpol)", 7859)
    prop._addConstant("infraRsQosLlfcIfPol", "interface-link-level-flow-control-(infra.rsqosllfcifpol)", 18408)
    ...
    prop._addConstant("infraRsResLacpIfPol", "port-channel-member-policy-(infra.rsreslacpifpol)", 4425)
    ...
    prop._addConstant("infraRsSpineTopoctrlUsbConfigProfilePol", "usb-config-policy-(infra.rsspinetopoctrlusbconfigprofilepol)", 18911)
    ...
    prop._addConstant("infraRsSubPortAccBndlSubgrp", "access-bundle-sub-group-(infra.rssubportaccbndlsubgrp)", 19817)
    prop._addConstant("infraRsSynceEthIfPol", "relation-to-synce-interface-policy-(infra.rssynceethifpol)", 18572)
    prop._addConstant("infraRsSynceEthIfPolBndlGrp", "relation-from-bundled-group-to-synce-interface-policy-(infra.rssynceethifpolbndlgrp)", 19167)
    prop._addConstant("infraRsSynceInstPol", "synce-node-policy-(infra.rssynceinstpol)", 18570)
    ...
    prop._addConstant("infraRsToInterfacePolProfileOpt", "leaf-interface-profile-(infra.rstointerfacepolprofileopt)", 20209)
    ...
    prop._addConstant("infraSnNode", "serial-number-of-cluster-element-(infra.snnode)", 7627)
    ...
    prop._addConstant("infraStandbyApicDeleted", "delete-standby-apic-(infra.standbyapicdeleted)", 20126)
    prop._addConstant("infraStorage", "access-storage-(infra.storage)", 4450)
    prop._addConstant("infraSubPortBlk", "access-sub-port-block-(infra.subportblk)", 9125)
    prop._addConstant("infraSubsDfltPolicy", "default-policies-subscription-(infra.subsdfltpolicy)", 6884)
    prop._addConstant("infraSummaryCont", "summary-configuration-container-(infra.summarycont)", 19217)
    ...
    prop._addConstant("l3extFabricExtRoutingPDef", "fabric-external-routing-profile-definition-(l3ext.fabricextroutingpdef)", 7254)
    ...
    prop._addConstant("l3extSummSubnetConfigIssues", "summsubnet-configuration-issues-(l3ext.summsubnetconfigissues)", 19855)
    prop._addConstant("lacpIf", "lacp-interface-(lacp.if)", 2537)
    prop._addConstant("lacpIfPol", "port-channel-member-policy-(lacp.ifpol)", 154)
    ...
    prop._addConstant("lldpInvalidAciAdjEp", "invalid-aci-adjacency-(lldp.invalidaciadjep)", 18290)
    ...
    prop._addConstant("mdpAgTunInfoHolder", "aggregated-tunnel-stats-holder-(mdp.agtuninfoholder)", 17533)
    prop._addConstant("mdpConsumedServiceDef", "consumer-of-mdp-service-(resolved)-(mdp.consumedservicedef)", 17481)
    prop._addConstant("mdpDestGrpInfoHolder", "destination-group-stats-holder-(mdp.destgrpinfoholder)", 17531)
    prop._addConstant("mdpLeafP", "multi-domain-leaf-profile-(mdp.leafp)", 16630)
    prop._addConstant("mdpLocalDomP", "local-multi-domain-profile-(mdp.localdomp)", 16623)
    prop._addConstant("mdpPolCont", "container-of-multi-domain-profiles-and-policies-(mdp.polcont)", 16621)
    prop._addConstant("mdpPolDefCont", "container-of-multi-domain-policies-(resolved)-(mdp.poldefcont)", 16598)
    prop._addConstant("mdpProviderDef", "mdp-infrastructure-definition-(mdp.providerdef)", 16600)
    prop._addConstant("mdpProviderP", "multi-domain-provider-profile-(mdp.providerp)", 16628)
    prop._addConstant("mdpRemoteCtxDef", "mdp-domain-remote-ctx-definition-(mdp.remotectxdef)", 16613)
    prop._addConstant("mdpRsRemoteCtxDefToMultiDomCtxDef", "mdp-domain-remote-ctx-reference-(mdp.rsremotectxdeftomultidomctxdef)", 16614)
    prop._addConstant("mdpRsTenantInfoDefToMdpPolDefCont", "container-of-multi-domain-policies-(resolved)-(mdp.rstenantinfodeftomdppoldefcont)", 16610)
    prop._addConstant("mdpRsToMdpServiceDef", "mdp-service-def-(resolved)-(mdp.rstomdpservicedef)", 17482)
    prop._addConstant("mdpTenantDefCont", "multi-domain-tenant-definitions-container-(mdp.tenantdefcont)", 16608)
    prop._addConstant("mdpTenantInfoDef", "multi-domain-tenant-definition-(mdp.tenantinfodef)", 16609)
    prop._addConstant("mdpTunInfoHolder", "tunnel-stats-holder-(mdp.tuninfoholder)", 17532)
    prop._addConstant("mdpTypeInfoHolder", "type-stats-holder-(mdp.typeinfoholder)", 17530)
    ...
    prop._addConstant("monitorInst", "monitoring-instance-(monitor.inst)", 20023)
    prop._addConstant("monitorIntfP", "interface-profile-(monitor.intfp)", 20037)
    prop._addConstant("monitorIntfPolGrp", "access-node-configuration-(monitor.intfpolgrp)", 20045)
    prop._addConstant("monitorIntfS", "switch-association-(monitor.intfs)", 20038)
    prop._addConstant("monitorNodeCfg", "node-configuration-for-monitoring-(monitor.nodecfg)", 20025)
    prop._addConstant("monitorNodeCfgCont", "node-configuration-container-for-monitoring-(monitor.nodecfgcont)", 20024)
    prop._addConstant("monitorNodeP", "leaf-profile-(monitor.nodep)", 20030)
    prop._addConstant("monitorNodePolGrp", "access-node-configuration-(monitor.nodepolgrp)", 20048)
    prop._addConstant("monitorNodeS", "switch-association-(monitor.nodes)", 20033)
    prop._addConstant("monitorRsCfgToNodePolGrp", "access-node-configuration-(monitor.rscfgtonodepolgrp)", 20028)
    prop._addConstant("monitorRsCfgToProfile", "interface-profile-(monitor.rscfgtoprofile)", 20026)
    prop._addConstant("monitorRsIntfPolGrp", "access-access-group-(monitor.rsintfpolgrp)", 20039)
    prop._addConstant("monitorRsIntfProfile", "interface-profile-(monitor.rsintfprofile)", 20031)
    prop._addConstant("monitorRsNodePolGrp", "relation-to-node-policy-group-(monitor.rsnodepolgrp)", 20034)
    prop._addConstant("monitorRsTelemetryNodePol", "relation-to-telemetry-node-policy-(monitor.rstelemetrynodepol)", 20049)
    prop._addConstant("monitorRsTelemetryPol", "relation-to-telemetry-policy-(monitor.rstelemetrypol)", 20046)
    prop._addConstant("multidomainMultiDomainIps", "aci-anycast-ip-used-to-communicate-with-sda-domain-(multidomain.multidomainips)", 16584)
    ...
    prop._addConstant("opflexpAgentIDEpFaultInfo", "concrete-class-to-raise-faults-for-idep-issues-in-opflex-agent-(opflexp.agentidepfaultinfo)", 17732)
    prop._addConstant("opflexpAgentODevFaultInfo", "concrete-class-to-raise-faults-for-odev-issues-in-opflex-agent-(opflexp.agentodevfaultinfo)", 17731)
    ...
    prop._addConstant("ospfAdjOper", "ospf-multipoddirect-instance-operational-data-(ospf.adjoper)", 19982)
    prop._addConstant("ospfDom", "ospf-domain-(ospf.dom)", 2649)
    prop._addConstant("ospfDomOper", "ospf-multipoddirect-instance-operational-data-(ospf.domoper)", 20021)
    prop._addConstant("ospfEntity", "ospf-entity-(ospf.entity)", 2665)
    prop._addConstant("ospfIf", "ospf-interface-(ospf.if)", 2655)
    prop._addConstant("ospfIfOper", "ospf-multipoddirect-instance-operational-data-(ospf.ifoper)", 19986)
    prop._addConstant("ospfIfStats", "ifstats-(ospf.ifstats)", 2647)
    prop._addConstant("ospfInst", "ospf-instance-(ospf.inst)", 2666)
    prop._addConstant("ospfInstOper", "ospf-multipoddirect-instance-operational-data-(ospf.instoper)", 20020)
    prop._addConstant("ospfMaxLsaOpSt", "max-lsa-operational-state-qualifier-(ospf.maxlsaopst)", 20233)
    ...
    prop._addConstant("ospfv3MaxLsaOpSt", "max-lsa-operational-state-qualifier-(ospfv3.maxlsaopst)", 20234)
    prop._addConstant("ospfv3MaxLsaP", "max-lsa-(ospfv3.maxlsap)", 5924)
    prop._addConstant("patchingEntity", "patch-installer-entity-(patching.entity)", 18642)
    prop._addConstant("patchingInst", "patch-installer-instance-(patching.inst)", 18643)
    prop._addConstant("patchingPatch", "patch-(patching.patch)", 18645)
    ...
    prop._addConstant("pimInterVRF", "static-rp-policy-(pim.intervrf)", 12384)
    prop._addConstant("pimInterVRFP", "static-rp-policy-(pim.intervrfp)", 12383)
    ...
    prop._addConstant("polNdoProfile", "ndo-controller-profile-(pol.ndoprofile)", 20313)
    prop._addConstant("polResPolCont", "resolved-policy-container-(pol.respolcont)", 6030)
    ...
    prop._addConstant("procJob", "job-(proc.job)", 19918)
    prop._addConstant("procMemUsage", "system-process-information-(proc.memusage)", 19815)
    prop._addConstant("procMemory", "lc/fm-memory-information-(proc.memory)", 19814)
    prop._addConstant("procPlatform", "platform-(proc.platform)", 19924)
    ...
    prop._addConstant("ptpEntity", "ptp-entity-(ptp.entity)", 9052)
    prop._addConstant("ptpIf", "ptp-interface-(ptp.if)", 9051)
    prop._addConstant("ptpInst", "ptp-instance-(ptp.inst)", 9053)
    prop._addConstant("qosDppPol", "data-plane-policing-policy-(qos.dpppol)", 7681)
    prop._addConstant("qosmEntity", "qos-entity-(qosm.entity)", 2393)
    prop._addConstant("qosmGlobalEgressMplsRule", "global-mpls-dscp-qos-classification-rule-(qosm.globalegressmplsrule)", 16575)
    prop._addConstant("qosmGlobalIngressMplsRule", "global-ingress-mpls-qos-classification-rule-(qosm.globalingressmplsrule)", 16574)
    ...
    prop._addConstant("segrtEntity", "segment-routing-entity-(segrt.entity)", 16593)
    prop._addConstant("segrtInst", "object-to-hold-per-segment-routing-instance-information-(segrt.inst)", 16594)
    prop._addConstant("segrtMpls", "mpls-segment-routing-instance-block-(segrt.mpls)", 16595)
    prop._addConstant("segrtSrgb", "segment-routing-global-block-(segrt.srgb)", 16597)
    ...
    prop._addConstant("snmpCommSecP", "community-security-policy-(snmp.commsecp)", 2530)
    ...
    prop._addConstant("snmpRsCommToCtxAtt", "context-(snmp.rscommtoctxatt)", 4573)
    ...
    prop._addConstant("spanExtended", "acl-filter-entry-extended-(span.extended)", 19230)
    ...
    prop._addConstant("svcredirAclRule", "acl-redir-rule-(svcredir.aclrule)", 20102)
    ...
    prop._addConstant("svcredirDestmon", "redirect-destination-monitoring-(svcredir.destmon)", 10948)
    ...
    prop._addConstant("synceEntity", "synce-entity-(synce.entity)", 18562)
    prop._addConstant("synceEthIf", "synce-eth-interface-config-(synce.ethif)", 18565)
    prop._addConstant("synceEthIfPol", "synce-interface-policy-(synce.ethifpol)", 18579)
    prop._addConstant("synceInst", "synce-instance-(synce.inst)", 18563)
    ...
    prop._addConstant("telemetrySnCertDownloadStatus", "status-of-service-node-certs-download-(telemetry.sncertdownloadstatus)", 18850)
    ...
    prop._addConstant("thirdpartyappAppGlobalConfig", "node-group-global-config-(thirdpartyapp.appglobalconfig)", 20216)
    prop._addConstant("thirdpartyappPodGrp", "pod-management-(thirdpartyapp.podgrp)", 20219)
    prop._addConstant("thirdpartyappRsToGlobalConfig", "node-group-global-config-(thirdpartyapp.rstoglobalconfig)", 20220)
    prop._addConstant("thirdpartyappRsToNodeGlobalConfig", "relation-to-global-config-policy-(thirdpartyapp.rstonodeglobalconfig)", 20217)
    ...
    prop._addConstant("trigSchedP", "scheduler-(trig.schedp)", 1810)
    ...
    prop._addConstant("uribv4Db", "database-(uribv4.db)", 3783)
    prop._addConstant("uribv4Dom", "domain-(uribv4.dom)", 3777)
    prop._addConstant("uribv4Entity", "ipv4-unicast-routing-information-base-entity-(uribv4.entity)", 3776)
    prop._addConstant("uribv4Nexthop", "nexthop-record-(uribv4.nexthop)", 3782)
    prop._addConstant("uribv4Route", "route-(uribv4.route)", 3778)
    prop._addConstant("uribv4RouteOwner", "route-owner-(uribv4.routeowner)", 3779)
    prop._addConstant("usrsyslogRecord", "user-syslog-record-(usrsyslog.record)", 9323)
    prop._addConstant("usrtacacsRecord", "user-tacacs+-record-(usrtacacs.record)", 20075)
    ...
    prop._addConstant("vnsRsLIfDomP", "relation-from-lif-to-a-vlan-namespace-instance-profile-(vns.rslifdomp)", 17980)
    ...
    prop._addConstant("xcvrZRFabIfPol", "zr-s-policy-(xcvr.zrfabifpol)", 19936)
    prop._addConstant("xcvrZRPFabIfPol", "zrp-s-policy-(xcvr.zrpfabifpol)", 19937)
