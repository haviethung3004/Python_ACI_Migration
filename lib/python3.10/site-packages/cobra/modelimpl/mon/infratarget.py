...
class InfraTarget(Mo):
    ...
    meta.writeAccessMask = 0x8c001
    meta.readAccessMask = 0x9d001
    ...
    prop._addConstant("compAddrMgmtAddrBlk", "dhcp-address-block-(comp.addrmgmtaddrblk)", 20264)
    prop._addConstant("compAddrMgmtPolCont", "vm-address-management-policy-container-(comp.addrmgmtpolcont)", 20265)
    prop._addConstant("compAddrMgmtPool", "dhcp-address-pool-(comp.addrmgmtpool)", 20263)
    prop._addConstant("compClusterCtrlr", "cluster-controller-(comp.clusterctrlr)", 20261)
    prop._addConstant("compClusterCtrlrCont", "cluster-ctrlr-setting-(comp.clusterctrlrcont)", 20260)
    prop._addConstant("compCtrctCont", "contract-container-(comp.ctrctcont)", 7979)
    prop._addConstant("compCtrlr", "controller-(comp.ctrlr)", 1275)
    ...
    prop._addConstant("compHpNic", "hypervisor-interface-(comp.hpnic)", 1120)
    prop._addConstant("compHv", "hypervisor-(comp.hv)", 1291)
    prop._addConstant("compHvAdjTaskCont", "to-fix---comp.hvadjtaskcont", 18753)
    ...
    prop._addConstant("compMgmtNic", "management-inteface-(comp.mgmtnic)", 1129)
    ...
    prop._addConstant("compRsFvAddrMgmtPool", "relation-to-address-management-pool-(comp.rsfvaddrmgmtpool)", 20266)
    ...
    prop._addConstant("compVmInfoCont", "vm-info-container-(comp.vminfocont)", 19140)
    prop._addConstant("compWebhookInfo", "webhook-information-(comp.webhookinfo)", 20262)
    ...
    prop._addConstant("hvsLNode", "virtual-switch-(hvs.lnode)", 103)
    ...
    prop._addConstant("vmmClusterCtrlrP", "vmm-cluster-controller-(vmm.clusterctrlrp)", 20254)
    prop._addConstant("vmmClusterFaultInfo", "concrete-class-to-raise-faults-for-cluster-issues-in-vmm-(vmm.clusterfaultinfo)", 18561)
    ...
    prop._addConstant("vmmInjectedClusterDetails", "injected-cluster-details-(vmm.injectedclusterdetails)", 17958)
    prop._addConstant("vmmInjectedClusterInfo", "injected-cluster-info-(vmm.injectedclusterinfo)", 16796)
    prop._addConstant("vmmInjectedClusterSubnet", "injected-cluster-info-(vmm.injectedclustersubnet)", 16797)
    ...
    prop._addConstant("vmmInjectedLabel", "injected-label-(vmm.injectedlabel)", 16795)
    prop._addConstant("vmmInjectedNs", "namespace-(vmm.injectedns)", 10846)
    prop._addConstant("vmmInjectedNwPol", "injected-network-policy-(vmm.injectednwpol)", 16794)
    ...
    prop._addConstant("vmmRsClusterAcc", "user-access-profile-(vmm.rsclusteracc)", 20255)
