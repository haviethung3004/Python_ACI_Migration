...
class TacacsDest(Mo):
    ...
    prop = PropMeta("str", "populateCmdArgs", "populateCmdArgs", 64320, PropCategory.REGULAR)
    prop.label = "Send changes as command arguments"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("populateCmdArgs", prop)
