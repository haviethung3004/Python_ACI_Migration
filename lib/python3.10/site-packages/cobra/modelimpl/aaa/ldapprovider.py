...
class LdapProvider(Mo):
    ...
    prop = PropMeta("str", "authMethod", "authMethod", 67834, PropCategory.REGULAR)
    prop.label = "Authentication Method"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "LdapBind"
    prop._addConstant("LdapBind", "ldap-bind", 0)
    prop._addConstant("PasswordCompare", "password-compare", 1)
