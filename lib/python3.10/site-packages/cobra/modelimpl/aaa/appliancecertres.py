...
class ApplianceCertRes(Mo):
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 68007, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 16000)]
    ...
    prop = PropMeta("str", "nodeIp", "nodeIp", 68754, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "serial", "serial", 68008, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
