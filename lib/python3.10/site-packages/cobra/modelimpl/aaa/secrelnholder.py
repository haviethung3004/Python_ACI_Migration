...
class SecRelnHolder(Mo):
    ...
    meta.childClasses.add("cobra.model.aaa.RsCtrlrInst")
    ...
    meta.childClasses.add("cobra.model.aaa.RsProxyServer")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RsProxyServer", "rsproxyServer"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RsTenantInfra", "rstenantInfra"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RsCtrlrInst", "rsctrlrInst"))
