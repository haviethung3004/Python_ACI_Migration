...
class RbacDomain(Mo):
    ...
    meta = ClassMeta("cobra.model.aaa.RbacDomain")

    meta.moClassName = "aaaRbacDomain"
    meta.rnFormat = "rbacdomain-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Rbac Security Domain"
    ...
    prop = PropMeta("str", "annotation", "annotation", 59695, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 59696, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 59689, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
