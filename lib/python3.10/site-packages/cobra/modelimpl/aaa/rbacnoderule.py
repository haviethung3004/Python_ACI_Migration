...
# ##################################################
class RbacNodeRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.aaa.RbacNodeRule")

    meta.moClassName = "aaaRbacNodeRule"
    meta.rnFormat = "rbacnoderule-%(nodeId)s"
    meta.category = MoCategory.REGULAR
    meta.label = "RBAC rule for node"
    ...
    meta.childClasses.add("cobra.model.aaa.RbacPortRule")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacPortRule", "rbacportrule-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 57389, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 57390, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 57381, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
