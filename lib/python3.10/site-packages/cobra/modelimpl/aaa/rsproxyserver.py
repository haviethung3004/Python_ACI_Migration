...
# ##################################################
class RsProxyServer(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsProxyServer", "cobra.model.proxy.Server")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsProxyServer"
    meta.rnFormat = "rsproxyServer"
    ...
    prop = PropMeta("str", "tCl", "tCl", 67551, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 67550, PropCategory.REGULAR)
