...
# ##################################################
class RsCtrlrInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.aaa.RsCtrlrInst", "cobra.model.ctrlr.Inst")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "aaaRsCtrlrInst"
    meta.rnFormat = "rsctrlrInst"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63216, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1737
    prop.defaultValueStr = "ctrlrInst"
    prop._addConstant("ctrlrInst", None, 1737)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63215, PropCategory.REGULAR)
