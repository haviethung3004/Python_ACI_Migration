...
# ##################################################
class BgpAfPolicyNBLSupport(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.pres.BgpAfPolicyNBLSupport")

    meta.moClassName = "presBgpAfPolicyNBLSupport"
    meta.rnFormat = "bgpAfPolicyNBLSupport"
