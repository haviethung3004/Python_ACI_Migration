...
# ##################################################
class RsRouteToLeakRouteIntPfx(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.ip.RsRouteToLeakRouteIntPfx", "cobra.model.leak.RouteIntPfx")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "ipRsRouteToLeakRouteIntPfx"
    meta.rnFormat = "rsrouteToLeakRouteIntPfx-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Connection to internal leaked route from different VRF"
    ...
    prop = PropMeta("str", "tCl", "tCl", 58466, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16934
    prop.defaultValueStr = "leakRouteIntPfx"
    prop._addConstant("leakRouteIntPfx", None, 16934)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 58465, PropCategory.REGULAR)
