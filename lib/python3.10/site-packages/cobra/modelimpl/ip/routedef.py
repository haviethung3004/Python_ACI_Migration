...
class RouteDef(Mo):
    ...
    meta.childClasses.add("cobra.model.ip.DisableDPLearningDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.ip.DisableDPLearningDef", "dsblDPLearn"))
    ...
    prop = PropMeta("str", "ipDPLearning", "ipDPLearning", 62845, PropCategory.REGULAR)
    prop.label = "Flag for enable/disable IP Learning Through Dataplane"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 2
    ...
    meta.props.add("ipDPLearning", prop)
