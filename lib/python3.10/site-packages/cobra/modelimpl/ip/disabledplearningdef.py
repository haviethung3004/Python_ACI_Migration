...
# ##################################################
class DisableDPLearningDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.ip.DisableDPLearningDef")

    meta.moClassName = "ipDisableDPLearningDef"
    meta.rnFormat = "dsblDPLearn"
    meta.category = MoCategory.REGULAR
    meta.label = "Disable Ip Dataplane Learning per EPG Host"
