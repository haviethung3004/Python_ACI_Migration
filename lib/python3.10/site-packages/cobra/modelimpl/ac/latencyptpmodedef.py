...
class LatencyPtpModeDef(Mo):
    ...
    prop = PropMeta("str", "ttagEtherType0x8905Status", "ttagEtherType0x8905Status", 68758, PropCategory.REGULAR)
    prop.label = "ttag ether type 0x8905 status(enabled/disabled)"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("ttagEtherType0x8905Status", prop)
