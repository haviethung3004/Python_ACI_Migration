...
class InstPol(Mo):
    ...
    meta = ClassMeta("cobra.model.ptp.InstPol")

    meta.moClassName = "ptpInstPol"
    meta.rnFormat = "ptpInstP-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "PTP Node Policy"
    meta.writeAccessMask = 0xc001
    meta.readAccessMask = 0x1c001
    ...
    meta.childClasses.add("cobra.model.ptp.RtPtpInstPol")
    meta.childClasses.add("cobra.model.ptp.RtSysPtpInstPolCons")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.ptp.RtSysPtpInstPolCons", "rtsysPtpInstPolCons"))
    meta.childNamesAndRnPrefix.append(("cobra.model.ptp.RtPtpInstPol", "rtinfraPtpInstPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 63504, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63505, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 63493, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "nodeDomain", "nodeDomain", 63472, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodePrio1", "nodePrio1", 63473, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodePrio2", "nodePrio2", 63474, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeProfile", "nodeProfile", 63470, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operatingMode", "operatingMode", 63471, PropCategory.REGULAR)
    prop.label = "PTP Operating Mode"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 2
    prop.defaultValueStr = "hybrid"
