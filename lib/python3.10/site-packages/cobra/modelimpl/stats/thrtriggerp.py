...
class ThrTriggerP(Mo):
    ...
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsAvg", "number-of-accepted-paths-average-value", 53812)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsCum", "number-of-accepted-paths-cumulative", 53808)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsLast", "number-of-accepted-paths-current-value", 53806)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsMax", "number-of-accepted-paths-maximum-value", 53811)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsMin", "number-of-accepted-paths-minimum-value", 53810)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsPer", "number-of-accepted-paths-periodic", 53809)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsRate", "number-of-accepted-paths-rate", 53817)
    prop._addConstant("bgpBgpRtPrefixCountAcceptedPathsTr", "number-of-accepted-paths-trend", 53816)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedAvg", "prefixes-saved-from-peer-average-value", 53833)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedCum", "prefixes-saved-from-peer-cumulative", 53829)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedLast", "prefixes-saved-from-peer-current-value", 53827)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedMax", "prefixes-saved-from-peer-maximum-value", 53832)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedMin", "prefixes-saved-from-peer-minimum-value", 53831)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedPer", "prefixes-saved-from-peer-periodic", 53830)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedRate", "prefixes-saved-from-peer-rate", 53838)
    prop._addConstant("bgpBgpRtPrefixCountPfxSavedTr", "prefixes-saved-from-peer-trend", 53837)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentAvg", "prefixes-sent-to-peer-average-value", 53854)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentCum", "prefixes-sent-to-peer-cumulative", 53850)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentLast", "prefixes-sent-to-peer-current-value", 53848)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentMax", "prefixes-sent-to-peer-maximum-value", 53853)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentMin", "prefixes-sent-to-peer-minimum-value", 53852)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentPer", "prefixes-sent-to-peer-periodic", 53851)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentRate", "prefixes-sent-to-peer-rate", 53859)
    prop._addConstant("bgpBgpRtPrefixCountPfxSentTr", "prefixes-sent-to-peer-trend", 53858)
    ...
    prop._addConstant("cloudAzNLBStatsAgByteCountCum", "azure-nlb-bytecount-cumulative", 60318)
    prop._addConstant("cloudAzNLBStatsAgByteCountPer", "azure-nlb-bytecount-periodic", 60319)
    prop._addConstant("cloudAzNLBStatsAgByteCountRate", "azure-nlb-bytecount-rate", 60324)
    prop._addConstant("cloudAzNLBStatsAgByteCountTr", "azure-nlb-bytecount-trend", 60323)
    prop._addConstant("cloudAzNLBStatsAgDataPathAvailabilityCum", "azure-nlb-data-path-availability-cumulative", 60352)
    prop._addConstant("cloudAzNLBStatsAgDataPathAvailabilityPer", "azure-nlb-data-path-availability-periodic", 60353)
    prop._addConstant("cloudAzNLBStatsAgDataPathAvailabilityRate", "azure-nlb-data-path-availability-rate", 60358)
    prop._addConstant("cloudAzNLBStatsAgDataPathAvailabilityTr", "azure-nlb-data-path-availability-trend", 60357)
    prop._addConstant("cloudAzNLBStatsAgHealthProbeStatusCum", "azure-nlb-healthprobe-status-cumulative", 60386)
    prop._addConstant("cloudAzNLBStatsAgHealthProbeStatusPer", "azure-nlb-healthprobe-status-periodic", 60387)
    prop._addConstant("cloudAzNLBStatsAgHealthProbeStatusRate", "azure-nlb-healthprobe-status-rate", 60392)
    prop._addConstant("cloudAzNLBStatsAgHealthProbeStatusTr", "azure-nlb-healthprobe-status-trend", 60391)
    prop._addConstant("cloudAzNLBStatsAgPacketCountCum", "azure-nlb-current-connections-cumulative", 60420)
    prop._addConstant("cloudAzNLBStatsAgPacketCountPer", "azure-nlb-current-connections-periodic", 60421)
    prop._addConstant("cloudAzNLBStatsAgPacketCountRate", "azure-nlb-current-connections-rate", 60426)
    prop._addConstant("cloudAzNLBStatsAgPacketCountTr", "azure-nlb-current-connections-trend", 60425)
    prop._addConstant("cloudAzNLBStatsByteCountAvg", "azure-nlb-bytecount-average-value", 60303)
    prop._addConstant("cloudAzNLBStatsByteCountCum", "azure-nlb-bytecount-cumulative", 60299)
    prop._addConstant("cloudAzNLBStatsByteCountLast", "azure-nlb-bytecount-current-value", 60297)
    prop._addConstant("cloudAzNLBStatsByteCountMax", "azure-nlb-bytecount-maximum-value", 60302)
    prop._addConstant("cloudAzNLBStatsByteCountMin", "azure-nlb-bytecount-minimum-value", 60301)
    prop._addConstant("cloudAzNLBStatsByteCountPer", "azure-nlb-bytecount-periodic", 60300)
    prop._addConstant("cloudAzNLBStatsByteCountRate", "azure-nlb-bytecount-rate", 60308)
    prop._addConstant("cloudAzNLBStatsByteCountTr", "azure-nlb-bytecount-trend", 60307)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityAvg", "azure-nlb-data-path-availability-average-value", 60337)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityCum", "azure-nlb-data-path-availability-cumulative", 60333)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityLast", "azure-nlb-data-path-availability-current-value", 60331)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityMax", "azure-nlb-data-path-availability-maximum-value", 60336)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityMin", "azure-nlb-data-path-availability-minimum-value", 60335)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityPer", "azure-nlb-data-path-availability-periodic", 60334)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityRate", "azure-nlb-data-path-availability-rate", 60342)
    prop._addConstant("cloudAzNLBStatsDataPathAvailabilityTr", "azure-nlb-data-path-availability-trend", 60341)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusAvg", "azure-nlb-healthprobe-status-average-value", 60371)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusCum", "azure-nlb-healthprobe-status-cumulative", 60367)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusLast", "azure-nlb-healthprobe-status-current-value", 60365)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusMax", "azure-nlb-healthprobe-status-maximum-value", 60370)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusMin", "azure-nlb-healthprobe-status-minimum-value", 60369)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusPer", "azure-nlb-healthprobe-status-periodic", 60368)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusRate", "azure-nlb-healthprobe-status-rate", 60376)
    prop._addConstant("cloudAzNLBStatsHealthProbeStatusTr", "azure-nlb-healthprobe-status-trend", 60375)
    prop._addConstant("cloudAzNLBStatsPacketCountAvg", "azure-nlb-current-connections-average-value", 60405)
    prop._addConstant("cloudAzNLBStatsPacketCountCum", "azure-nlb-current-connections-cumulative", 60401)
    prop._addConstant("cloudAzNLBStatsPacketCountLast", "azure-nlb-current-connections-current-value", 60399)
    prop._addConstant("cloudAzNLBStatsPacketCountMax", "azure-nlb-current-connections-maximum-value", 60404)
    prop._addConstant("cloudAzNLBStatsPacketCountMin", "azure-nlb-current-connections-minimum-value", 60403)
    prop._addConstant("cloudAzNLBStatsPacketCountPer", "azure-nlb-current-connections-periodic", 60402)
    prop._addConstant("cloudAzNLBStatsPacketCountRate", "azure-nlb-current-connections-rate", 60410)
    prop._addConstant("cloudAzNLBStatsPacketCountTr", "azure-nlb-current-connections-trend", 60409)
    prop._addConstant("cloudEgressBytesAgDropCum", "egress-drop-bytes-cumulative", 50949)
    prop._addConstant("cloudEgressBytesAgDropPer", "egress-drop-bytes-periodic", 50950)
    prop._addConstant("cloudEgressBytesAgDropRate", "egress-drop-bytes-rate", 50955)
    prop._addConstant("cloudEgressBytesAgDropTr", "egress-drop-bytes-trend", 50954)
    ...
    prop._addConstant("cloudEgressBytesDropAvg", "egress-drop-bytes-average-value", 50934)
    prop._addConstant("cloudEgressBytesDropCum", "egress-drop-bytes-cumulative", 50930)
    prop._addConstant("cloudEgressBytesDropLast", "egress-drop-bytes-current-value", 50928)
    prop._addConstant("cloudEgressBytesDropMax", "egress-drop-bytes-maximum-value", 50933)
    prop._addConstant("cloudEgressBytesDropMin", "egress-drop-bytes-minimum-value", 50932)
    prop._addConstant("cloudEgressBytesDropPer", "egress-drop-bytes-periodic", 50931)
    prop._addConstant("cloudEgressBytesDropRate", "egress-drop-bytes-rate", 50939)
    prop._addConstant("cloudEgressBytesDropTr", "egress-drop-bytes-trend", 50938)
    ...
    prop._addConstant("cloudExtTrafficAgEgressBytesCum", "egress-unicast-bytes-cumulative", 66898)
    prop._addConstant("cloudExtTrafficAgEgressBytesPer", "egress-unicast-bytes-periodic", 66899)
    prop._addConstant("cloudExtTrafficAgEgressBytesRate", "egress-unicast-bytes-rate", 66904)
    prop._addConstant("cloudExtTrafficAgEgressBytesTr", "egress-unicast-bytes-trend", 66903)
    prop._addConstant("cloudExtTrafficAgEgressPacketsCum", "egress-unicast-packets-cumulative", 66932)
    prop._addConstant("cloudExtTrafficAgEgressPacketsPer", "egress-unicast-packets-periodic", 66933)
    prop._addConstant("cloudExtTrafficAgEgressPacketsRate", "egress-unicast-packets-rate", 66938)
    prop._addConstant("cloudExtTrafficAgEgressPacketsTr", "egress-unicast-packets-trend", 66937)
    prop._addConstant("cloudExtTrafficAgIngressBytesCum", "ingress-unicast-bytes-cumulative", 66966)
    prop._addConstant("cloudExtTrafficAgIngressBytesPer", "ingress-unicast-bytes-periodic", 66967)
    prop._addConstant("cloudExtTrafficAgIngressBytesRate", "ingress-unicast-bytes-rate", 66972)
    prop._addConstant("cloudExtTrafficAgIngressBytesTr", "ingress-unicast-bytes-trend", 66971)
    prop._addConstant("cloudExtTrafficAgIngressPacketsCum", "ingress-unicast-packets-cumulative", 67000)
    prop._addConstant("cloudExtTrafficAgIngressPacketsPer", "ingress-unicast-packets-periodic", 67001)
    prop._addConstant("cloudExtTrafficAgIngressPacketsRate", "ingress-unicast-packets-rate", 67006)
    prop._addConstant("cloudExtTrafficAgIngressPacketsTr", "ingress-unicast-packets-trend", 67005)
    prop._addConstant("cloudExtTrafficEgressBytesAvg", "egress-unicast-bytes-average-value", 66883)
    prop._addConstant("cloudExtTrafficEgressBytesCum", "egress-unicast-bytes-cumulative", 66879)
    prop._addConstant("cloudExtTrafficEgressBytesLast", "egress-unicast-bytes-current-value", 66877)
    prop._addConstant("cloudExtTrafficEgressBytesMax", "egress-unicast-bytes-maximum-value", 66882)
    prop._addConstant("cloudExtTrafficEgressBytesMin", "egress-unicast-bytes-minimum-value", 66881)
    prop._addConstant("cloudExtTrafficEgressBytesPer", "egress-unicast-bytes-periodic", 66880)
    prop._addConstant("cloudExtTrafficEgressBytesRate", "egress-unicast-bytes-rate", 66888)
    prop._addConstant("cloudExtTrafficEgressBytesTr", "egress-unicast-bytes-trend", 66887)
    prop._addConstant("cloudExtTrafficEgressPacketsAvg", "egress-unicast-packets-average-value", 66917)
    prop._addConstant("cloudExtTrafficEgressPacketsCum", "egress-unicast-packets-cumulative", 66913)
    prop._addConstant("cloudExtTrafficEgressPacketsLast", "egress-unicast-packets-current-value", 66911)
    prop._addConstant("cloudExtTrafficEgressPacketsMax", "egress-unicast-packets-maximum-value", 66916)
    prop._addConstant("cloudExtTrafficEgressPacketsMin", "egress-unicast-packets-minimum-value", 66915)
    prop._addConstant("cloudExtTrafficEgressPacketsPer", "egress-unicast-packets-periodic", 66914)
    prop._addConstant("cloudExtTrafficEgressPacketsRate", "egress-unicast-packets-rate", 66922)
    prop._addConstant("cloudExtTrafficEgressPacketsTr", "egress-unicast-packets-trend", 66921)
    prop._addConstant("cloudExtTrafficIngressBytesAvg", "ingress-unicast-bytes-average-value", 66951)
    prop._addConstant("cloudExtTrafficIngressBytesCum", "ingress-unicast-bytes-cumulative", 66947)
    prop._addConstant("cloudExtTrafficIngressBytesLast", "ingress-unicast-bytes-current-value", 66945)
    prop._addConstant("cloudExtTrafficIngressBytesMax", "ingress-unicast-bytes-maximum-value", 66950)
    prop._addConstant("cloudExtTrafficIngressBytesMin", "ingress-unicast-bytes-minimum-value", 66949)
    prop._addConstant("cloudExtTrafficIngressBytesPer", "ingress-unicast-bytes-periodic", 66948)
    prop._addConstant("cloudExtTrafficIngressBytesRate", "ingress-unicast-bytes-rate", 66956)
    prop._addConstant("cloudExtTrafficIngressBytesTr", "ingress-unicast-bytes-trend", 66955)
    prop._addConstant("cloudExtTrafficIngressPacketsAvg", "ingress-unicast-packets-average-value", 66985)
    prop._addConstant("cloudExtTrafficIngressPacketsCum", "ingress-unicast-packets-cumulative", 66981)
    prop._addConstant("cloudExtTrafficIngressPacketsLast", "ingress-unicast-packets-current-value", 66979)
    prop._addConstant("cloudExtTrafficIngressPacketsMax", "ingress-unicast-packets-maximum-value", 66984)
    prop._addConstant("cloudExtTrafficIngressPacketsMin", "ingress-unicast-packets-minimum-value", 66983)
    prop._addConstant("cloudExtTrafficIngressPacketsPer", "ingress-unicast-packets-periodic", 66982)
    prop._addConstant("cloudExtTrafficIngressPacketsRate", "ingress-unicast-packets-rate", 66990)
    prop._addConstant("cloudExtTrafficIngressPacketsTr", "ingress-unicast-packets-trend", 66989)
    prop._addConstant("cloudHostRouterEgrUnicastBytesAvg", "host-router-egress-unicast-bytes-average-value", 56203)
    prop._addConstant("cloudHostRouterEgrUnicastBytesCum", "host-router-egress-unicast-bytes-cumulative", 56199)
    prop._addConstant("cloudHostRouterEgrUnicastBytesLast", "host-router-egress-unicast-bytes-current-value", 56197)
    prop._addConstant("cloudHostRouterEgrUnicastBytesMax", "host-router-egress-unicast-bytes-maximum-value", 56202)
    prop._addConstant("cloudHostRouterEgrUnicastBytesMin", "host-router-egress-unicast-bytes-minimum-value", 56201)
    prop._addConstant("cloudHostRouterEgrUnicastBytesPer", "host-router-egress-unicast-bytes-periodic", 56200)
    prop._addConstant("cloudHostRouterEgrUnicastBytesRate", "host-router-egress-unicast-bytes-rate", 56208)
    prop._addConstant("cloudHostRouterEgrUnicastBytesTr", "host-router-egress-unicast-bytes-trend", 56207)
    prop._addConstant("cloudHostRouterEgrUnicastPktsAvg", "host-router-egress-unicast-packets-average-value", 56224)
    prop._addConstant("cloudHostRouterEgrUnicastPktsCum", "host-router-egress-unicast-packets-cumulative", 56220)
    prop._addConstant("cloudHostRouterEgrUnicastPktsLast", "host-router-egress-unicast-packets-current-value", 56218)
    prop._addConstant("cloudHostRouterEgrUnicastPktsMax", "host-router-egress-unicast-packets-maximum-value", 56223)
    prop._addConstant("cloudHostRouterEgrUnicastPktsMin", "host-router-egress-unicast-packets-minimum-value", 56222)
    prop._addConstant("cloudHostRouterEgrUnicastPktsPer", "host-router-egress-unicast-packets-periodic", 56221)
    prop._addConstant("cloudHostRouterEgrUnicastPktsRate", "host-router-egress-unicast-packets-rate", 56229)
    prop._addConstant("cloudHostRouterEgrUnicastPktsTr", "host-router-egress-unicast-packets-trend", 56228)
    ...
    prop._addConstant("cloudHostRouterIngrUnicastBytesAvg", "host-router-ingress-unicast-bytes-average-value", 56245)
    prop._addConstant("cloudHostRouterIngrUnicastBytesCum", "host-router-ingress-unicast-bytes-cumulative", 56241)
    prop._addConstant("cloudHostRouterIngrUnicastBytesLast", "host-router-ingress-unicast-bytes-current-value", 56239)
    prop._addConstant("cloudHostRouterIngrUnicastBytesMax", "host-router-ingress-unicast-bytes-maximum-value", 56244)
    prop._addConstant("cloudHostRouterIngrUnicastBytesMin", "host-router-ingress-unicast-bytes-minimum-value", 56243)
    prop._addConstant("cloudHostRouterIngrUnicastBytesPer", "host-router-ingress-unicast-bytes-periodic", 56242)
    prop._addConstant("cloudHostRouterIngrUnicastBytesRate", "host-router-ingress-unicast-bytes-rate", 56250)
    prop._addConstant("cloudHostRouterIngrUnicastBytesTr", "host-router-ingress-unicast-bytes-trend", 56249)
    prop._addConstant("cloudHostRouterIngrUnicastPktsAvg", "host-router-ingress-unicast-packets-average-value", 56266)
    prop._addConstant("cloudHostRouterIngrUnicastPktsCum", "host-router-ingress-unicast-packets-cumulative", 56262)
    prop._addConstant("cloudHostRouterIngrUnicastPktsLast", "host-router-ingress-unicast-packets-current-value", 56260)
    prop._addConstant("cloudHostRouterIngrUnicastPktsMax", "host-router-ingress-unicast-packets-maximum-value", 56265)
    prop._addConstant("cloudHostRouterIngrUnicastPktsMin", "host-router-ingress-unicast-packets-minimum-value", 56264)
    prop._addConstant("cloudHostRouterIngrUnicastPktsPer", "host-router-ingress-unicast-packets-periodic", 56263)
    prop._addConstant("cloudHostRouterIngrUnicastPktsRate", "host-router-ingress-unicast-packets-rate", 56271)
    prop._addConstant("cloudHostRouterIngrUnicastPktsTr", "host-router-ingress-unicast-packets-trend", 56270)
    ...
    prop._addConstant("cloudInterZnLatencyInterZoneAvg", "latency-for-inter-zone-traffic-average-value", 67441)
    prop._addConstant("cloudInterZnLatencyInterZoneLast", "latency-for-inter-zone-traffic-current-value", 67438)
    prop._addConstant("cloudInterZnLatencyInterZoneMax", "latency-for-inter-zone-traffic-maximum-value", 67440)
    prop._addConstant("cloudInterZnLatencyInterZoneMin", "latency-for-inter-zone-traffic-minimum-value", 67439)
    prop._addConstant("cloudInterZnLatencyInterZoneTr", "latency-for-inter-zone-traffic-trend", 67446)
    prop._addConstant("cloudIpTrafficAgEgressBytesCum", "egress-unicast-bytes-cumulative", 67034)
    prop._addConstant("cloudIpTrafficAgEgressBytesPer", "egress-unicast-bytes-periodic", 67035)
    prop._addConstant("cloudIpTrafficAgEgressBytesRate", "egress-unicast-bytes-rate", 67040)
    prop._addConstant("cloudIpTrafficAgEgressBytesTr", "egress-unicast-bytes-trend", 67039)
    prop._addConstant("cloudIpTrafficAgEgressPacketsCum", "egress-unicast-packets-cumulative", 67068)
    prop._addConstant("cloudIpTrafficAgEgressPacketsPer", "egress-unicast-packets-periodic", 67069)
    prop._addConstant("cloudIpTrafficAgEgressPacketsRate", "egress-unicast-packets-rate", 67074)
    prop._addConstant("cloudIpTrafficAgEgressPacketsTr", "egress-unicast-packets-trend", 67073)
    prop._addConstant("cloudIpTrafficAgIngressBytesCum", "ingress-unicast-bytes-cumulative", 67102)
    prop._addConstant("cloudIpTrafficAgIngressBytesPer", "ingress-unicast-bytes-periodic", 67103)
    prop._addConstant("cloudIpTrafficAgIngressBytesRate", "ingress-unicast-bytes-rate", 67108)
    prop._addConstant("cloudIpTrafficAgIngressBytesTr", "ingress-unicast-bytes-trend", 67107)
    prop._addConstant("cloudIpTrafficAgIngressPacketsCum", "ingress-unicast-packets-cumulative", 67136)
    prop._addConstant("cloudIpTrafficAgIngressPacketsPer", "ingress-unicast-packets-periodic", 67137)
    prop._addConstant("cloudIpTrafficAgIngressPacketsRate", "ingress-unicast-packets-rate", 67142)
    prop._addConstant("cloudIpTrafficAgIngressPacketsTr", "ingress-unicast-packets-trend", 67141)
    prop._addConstant("cloudIpTrafficEgressBytesAvg", "egress-unicast-bytes-average-value", 67019)
    prop._addConstant("cloudIpTrafficEgressBytesCum", "egress-unicast-bytes-cumulative", 67015)
    prop._addConstant("cloudIpTrafficEgressBytesLast", "egress-unicast-bytes-current-value", 67013)
    prop._addConstant("cloudIpTrafficEgressBytesMax", "egress-unicast-bytes-maximum-value", 67018)
    prop._addConstant("cloudIpTrafficEgressBytesMin", "egress-unicast-bytes-minimum-value", 67017)
    prop._addConstant("cloudIpTrafficEgressBytesPer", "egress-unicast-bytes-periodic", 67016)
    prop._addConstant("cloudIpTrafficEgressBytesRate", "egress-unicast-bytes-rate", 67024)
    prop._addConstant("cloudIpTrafficEgressBytesTr", "egress-unicast-bytes-trend", 67023)
    prop._addConstant("cloudIpTrafficEgressPacketsAvg", "egress-unicast-packets-average-value", 67053)
    prop._addConstant("cloudIpTrafficEgressPacketsCum", "egress-unicast-packets-cumulative", 67049)
    prop._addConstant("cloudIpTrafficEgressPacketsLast", "egress-unicast-packets-current-value", 67047)
    prop._addConstant("cloudIpTrafficEgressPacketsMax", "egress-unicast-packets-maximum-value", 67052)
    prop._addConstant("cloudIpTrafficEgressPacketsMin", "egress-unicast-packets-minimum-value", 67051)
    prop._addConstant("cloudIpTrafficEgressPacketsPer", "egress-unicast-packets-periodic", 67050)
    prop._addConstant("cloudIpTrafficEgressPacketsRate", "egress-unicast-packets-rate", 67058)
    prop._addConstant("cloudIpTrafficEgressPacketsTr", "egress-unicast-packets-trend", 67057)
    prop._addConstant("cloudIpTrafficIngressBytesAvg", "ingress-unicast-bytes-average-value", 67087)
    prop._addConstant("cloudIpTrafficIngressBytesCum", "ingress-unicast-bytes-cumulative", 67083)
    prop._addConstant("cloudIpTrafficIngressBytesLast", "ingress-unicast-bytes-current-value", 67081)
    prop._addConstant("cloudIpTrafficIngressBytesMax", "ingress-unicast-bytes-maximum-value", 67086)
    prop._addConstant("cloudIpTrafficIngressBytesMin", "ingress-unicast-bytes-minimum-value", 67085)
    prop._addConstant("cloudIpTrafficIngressBytesPer", "ingress-unicast-bytes-periodic", 67084)
    prop._addConstant("cloudIpTrafficIngressBytesRate", "ingress-unicast-bytes-rate", 67092)
    prop._addConstant("cloudIpTrafficIngressBytesTr", "ingress-unicast-bytes-trend", 67091)
    prop._addConstant("cloudIpTrafficIngressPacketsAvg", "ingress-unicast-packets-average-value", 67121)
    prop._addConstant("cloudIpTrafficIngressPacketsCum", "ingress-unicast-packets-cumulative", 67117)
    prop._addConstant("cloudIpTrafficIngressPacketsLast", "ingress-unicast-packets-current-value", 67115)
    prop._addConstant("cloudIpTrafficIngressPacketsMax", "ingress-unicast-packets-maximum-value", 67120)
    prop._addConstant("cloudIpTrafficIngressPacketsMin", "ingress-unicast-packets-minimum-value", 67119)
    prop._addConstant("cloudIpTrafficIngressPacketsPer", "ingress-unicast-packets-periodic", 67118)
    prop._addConstant("cloudIpTrafficIngressPacketsRate", "ingress-unicast-packets-rate", 67126)
    prop._addConstant("cloudIpTrafficIngressPacketsTr", "ingress-unicast-packets-trend", 67125)
    ...
    prop._addConstant("cloudNLBStatsActiveFlowCountAvg", "network-lb-active-flow-count-average-value", 60439)
    prop._addConstant("cloudNLBStatsActiveFlowCountCum", "network-lb-active-flow-count-cumulative", 60435)
    prop._addConstant("cloudNLBStatsActiveFlowCountLast", "network-lb-active-flow-count-current-value", 60433)
    prop._addConstant("cloudNLBStatsActiveFlowCountMax", "network-lb-active-flow-count-maximum-value", 60438)
    prop._addConstant("cloudNLBStatsActiveFlowCountMin", "network-lb-active-flow-count-minimum-value", 60437)
    prop._addConstant("cloudNLBStatsActiveFlowCountPer", "network-lb-active-flow-count-periodic", 60436)
    prop._addConstant("cloudNLBStatsActiveFlowCountRate", "network-lb-active-flow-count-rate", 60444)
    prop._addConstant("cloudNLBStatsActiveFlowCountTr", "network-lb-active-flow-count-trend", 60443)
    prop._addConstant("cloudNLBStatsAgActiveFlowCountCum", "network-lb-active-flow-count-cumulative", 60454)
    prop._addConstant("cloudNLBStatsAgActiveFlowCountPer", "network-lb-active-flow-count-periodic", 60455)
    prop._addConstant("cloudNLBStatsAgActiveFlowCountRate", "network-lb-active-flow-count-rate", 60460)
    prop._addConstant("cloudNLBStatsAgActiveFlowCountTr", "network-lb-active-flow-count-trend", 60459)
    prop._addConstant("cloudNLBStatsAgConsumedLCUsCum", "network-lb-consumed-lcus-cumulative", 60488)
    prop._addConstant("cloudNLBStatsAgConsumedLCUsPer", "network-lb-consumed-lcus-periodic", 60489)
    prop._addConstant("cloudNLBStatsAgConsumedLCUsRate", "network-lb-consumed-lcus-rate", 60494)
    prop._addConstant("cloudNLBStatsAgConsumedLCUsTr", "network-lb-consumed-lcus-trend", 60493)
    prop._addConstant("cloudNLBStatsAgNewFlowCountCum", "network-lb-newflow-count-cumulative", 60522)
    prop._addConstant("cloudNLBStatsAgNewFlowCountPer", "network-lb-newflow-count-periodic", 60523)
    prop._addConstant("cloudNLBStatsAgNewFlowCountRate", "network-lb-newflow-count-rate", 60528)
    prop._addConstant("cloudNLBStatsAgNewFlowCountTr", "network-lb-newflow-count-trend", 60527)
    prop._addConstant("cloudNLBStatsAgProcessedBytesCum", "network-lb-processed-bytes-cumulative", 60556)
    prop._addConstant("cloudNLBStatsAgProcessedBytesPer", "network-lb-processed-bytes-periodic", 60557)
    prop._addConstant("cloudNLBStatsAgProcessedBytesRate", "network-lb-processed-bytes-rate", 60562)
    prop._addConstant("cloudNLBStatsAgProcessedBytesTr", "network-lb-processed-bytes-trend", 60561)
    prop._addConstant("cloudNLBStatsConsumedLCUsAvg", "network-lb-consumed-lcus-average-value", 60473)
    prop._addConstant("cloudNLBStatsConsumedLCUsCum", "network-lb-consumed-lcus-cumulative", 60469)
    prop._addConstant("cloudNLBStatsConsumedLCUsLast", "network-lb-consumed-lcus-current-value", 60467)
    prop._addConstant("cloudNLBStatsConsumedLCUsMax", "network-lb-consumed-lcus-maximum-value", 60472)
    prop._addConstant("cloudNLBStatsConsumedLCUsMin", "network-lb-consumed-lcus-minimum-value", 60471)
    prop._addConstant("cloudNLBStatsConsumedLCUsPer", "network-lb-consumed-lcus-periodic", 60470)
    prop._addConstant("cloudNLBStatsConsumedLCUsRate", "network-lb-consumed-lcus-rate", 60478)
    prop._addConstant("cloudNLBStatsConsumedLCUsTr", "network-lb-consumed-lcus-trend", 60477)
    prop._addConstant("cloudNLBStatsNewFlowCountAvg", "network-lb-newflow-count-average-value", 60507)
    prop._addConstant("cloudNLBStatsNewFlowCountCum", "network-lb-newflow-count-cumulative", 60503)
    prop._addConstant("cloudNLBStatsNewFlowCountLast", "network-lb-newflow-count-current-value", 60501)
    prop._addConstant("cloudNLBStatsNewFlowCountMax", "network-lb-newflow-count-maximum-value", 60506)
    prop._addConstant("cloudNLBStatsNewFlowCountMin", "network-lb-newflow-count-minimum-value", 60505)
    prop._addConstant("cloudNLBStatsNewFlowCountPer", "network-lb-newflow-count-periodic", 60504)
    prop._addConstant("cloudNLBStatsNewFlowCountRate", "network-lb-newflow-count-rate", 60512)
    prop._addConstant("cloudNLBStatsNewFlowCountTr", "network-lb-newflow-count-trend", 60511)
    prop._addConstant("cloudNLBStatsProcessedBytesAvg", "network-lb-processed-bytes-average-value", 60541)
    prop._addConstant("cloudNLBStatsProcessedBytesCum", "network-lb-processed-bytes-cumulative", 60537)
    prop._addConstant("cloudNLBStatsProcessedBytesLast", "network-lb-processed-bytes-current-value", 60535)
    prop._addConstant("cloudNLBStatsProcessedBytesMax", "network-lb-processed-bytes-maximum-value", 60540)
    prop._addConstant("cloudNLBStatsProcessedBytesMin", "network-lb-processed-bytes-minimum-value", 60539)
    prop._addConstant("cloudNLBStatsProcessedBytesPer", "network-lb-processed-bytes-periodic", 60538)
    prop._addConstant("cloudNLBStatsProcessedBytesRate", "network-lb-processed-bytes-rate", 60546)
    prop._addConstant("cloudNLBStatsProcessedBytesTr", "network-lb-processed-bytes-trend", 60545)
    prop._addConstant("cloudNwEgressBytesAgDropCum", "egress-drop-bytes-cumulative", 58069)
    prop._addConstant("cloudNwEgressBytesAgDropPer", "egress-drop-bytes-periodic", 58070)
    prop._addConstant("cloudNwEgressBytesAgDropRate", "egress-drop-bytes-rate", 58075)
    prop._addConstant("cloudNwEgressBytesAgDropTr", "egress-drop-bytes-trend", 58074)
    prop._addConstant("cloudNwEgressBytesAgUnicastCum", "egress-unicast-bytes-cumulative", 58103)
    prop._addConstant("cloudNwEgressBytesAgUnicastPer", "egress-unicast-bytes-periodic", 58104)
    prop._addConstant("cloudNwEgressBytesAgUnicastRate", "egress-unicast-bytes-rate", 58109)
    prop._addConstant("cloudNwEgressBytesAgUnicastTr", "egress-unicast-bytes-trend", 58108)
    prop._addConstant("cloudNwEgressBytesDropAvg", "egress-drop-bytes-average-value", 58054)
    prop._addConstant("cloudNwEgressBytesDropCum", "egress-drop-bytes-cumulative", 58050)
    prop._addConstant("cloudNwEgressBytesDropLast", "egress-drop-bytes-current-value", 58048)
    prop._addConstant("cloudNwEgressBytesDropMax", "egress-drop-bytes-maximum-value", 58053)
    prop._addConstant("cloudNwEgressBytesDropMin", "egress-drop-bytes-minimum-value", 58052)
    prop._addConstant("cloudNwEgressBytesDropPer", "egress-drop-bytes-periodic", 58051)
    prop._addConstant("cloudNwEgressBytesDropRate", "egress-drop-bytes-rate", 58059)
    prop._addConstant("cloudNwEgressBytesDropTr", "egress-drop-bytes-trend", 58058)
    prop._addConstant("cloudNwEgressBytesUnicastAvg", "egress-unicast-bytes-average-value", 58088)
    prop._addConstant("cloudNwEgressBytesUnicastCum", "egress-unicast-bytes-cumulative", 58084)
    prop._addConstant("cloudNwEgressBytesUnicastLast", "egress-unicast-bytes-current-value", 58082)
    prop._addConstant("cloudNwEgressBytesUnicastMax", "egress-unicast-bytes-maximum-value", 58087)
    prop._addConstant("cloudNwEgressBytesUnicastMin", "egress-unicast-bytes-minimum-value", 58086)
    prop._addConstant("cloudNwEgressBytesUnicastPer", "egress-unicast-bytes-periodic", 58085)
    prop._addConstant("cloudNwEgressBytesUnicastRate", "egress-unicast-bytes-rate", 58093)
    prop._addConstant("cloudNwEgressBytesUnicastTr", "egress-unicast-bytes-trend", 58092)
    prop._addConstant("cloudNwEgressPktsAgDropCum", "egress-drop-packets-cumulative", 58137)
    prop._addConstant("cloudNwEgressPktsAgDropPer", "egress-drop-packets-periodic", 58138)
    prop._addConstant("cloudNwEgressPktsAgDropRate", "egress-drop-packets-rate", 58143)
    prop._addConstant("cloudNwEgressPktsAgDropTr", "egress-drop-packets-trend", 58142)
    prop._addConstant("cloudNwEgressPktsAgUnicastCum", "egress-unicast-packets-cumulative", 58171)
    prop._addConstant("cloudNwEgressPktsAgUnicastPer", "egress-unicast-packets-periodic", 58172)
    prop._addConstant("cloudNwEgressPktsAgUnicastRate", "egress-unicast-packets-rate", 58177)
    prop._addConstant("cloudNwEgressPktsAgUnicastTr", "egress-unicast-packets-trend", 58176)
    prop._addConstant("cloudNwEgressPktsDropAvg", "egress-drop-packets-average-value", 58122)
    prop._addConstant("cloudNwEgressPktsDropCum", "egress-drop-packets-cumulative", 58118)
    prop._addConstant("cloudNwEgressPktsDropLast", "egress-drop-packets-current-value", 58116)
    prop._addConstant("cloudNwEgressPktsDropMax", "egress-drop-packets-maximum-value", 58121)
    prop._addConstant("cloudNwEgressPktsDropMin", "egress-drop-packets-minimum-value", 58120)
    prop._addConstant("cloudNwEgressPktsDropPer", "egress-drop-packets-periodic", 58119)
    prop._addConstant("cloudNwEgressPktsDropRate", "egress-drop-packets-rate", 58127)
    prop._addConstant("cloudNwEgressPktsDropTr", "egress-drop-packets-trend", 58126)
    prop._addConstant("cloudNwEgressPktsUnicastAvg", "egress-unicast-packets-average-value", 58156)
    prop._addConstant("cloudNwEgressPktsUnicastCum", "egress-unicast-packets-cumulative", 58152)
    prop._addConstant("cloudNwEgressPktsUnicastLast", "egress-unicast-packets-current-value", 58150)
    prop._addConstant("cloudNwEgressPktsUnicastMax", "egress-unicast-packets-maximum-value", 58155)
    prop._addConstant("cloudNwEgressPktsUnicastMin", "egress-unicast-packets-minimum-value", 58154)
    prop._addConstant("cloudNwEgressPktsUnicastPer", "egress-unicast-packets-periodic", 58153)
    prop._addConstant("cloudNwEgressPktsUnicastRate", "egress-unicast-packets-rate", 58161)
    prop._addConstant("cloudNwEgressPktsUnicastTr", "egress-unicast-packets-trend", 58160)
    prop._addConstant("cloudNwIngressBytesAgDropCum", "ingress-drop-bytes-cumulative", 58205)
    prop._addConstant("cloudNwIngressBytesAgDropPer", "ingress-drop-bytes-periodic", 58206)
    prop._addConstant("cloudNwIngressBytesAgDropRate", "ingress-drop-bytes-rate", 58211)
    prop._addConstant("cloudNwIngressBytesAgDropTr", "ingress-drop-bytes-trend", 58210)
    prop._addConstant("cloudNwIngressBytesAgUnicastCum", "ingress-unicast-bytes-cumulative", 58239)
    prop._addConstant("cloudNwIngressBytesAgUnicastPer", "ingress-unicast-bytes-periodic", 58240)
    prop._addConstant("cloudNwIngressBytesAgUnicastRate", "ingress-unicast-bytes-rate", 58245)
    prop._addConstant("cloudNwIngressBytesAgUnicastTr", "ingress-unicast-bytes-trend", 58244)
    prop._addConstant("cloudNwIngressBytesDropAvg", "ingress-drop-bytes-average-value", 58190)
    prop._addConstant("cloudNwIngressBytesDropCum", "ingress-drop-bytes-cumulative", 58186)
    prop._addConstant("cloudNwIngressBytesDropLast", "ingress-drop-bytes-current-value", 58184)
    prop._addConstant("cloudNwIngressBytesDropMax", "ingress-drop-bytes-maximum-value", 58189)
    prop._addConstant("cloudNwIngressBytesDropMin", "ingress-drop-bytes-minimum-value", 58188)
    prop._addConstant("cloudNwIngressBytesDropPer", "ingress-drop-bytes-periodic", 58187)
    prop._addConstant("cloudNwIngressBytesDropRate", "ingress-drop-bytes-rate", 58195)
    prop._addConstant("cloudNwIngressBytesDropTr", "ingress-drop-bytes-trend", 58194)
    prop._addConstant("cloudNwIngressBytesUnicastAvg", "ingress-unicast-bytes-average-value", 58224)
    prop._addConstant("cloudNwIngressBytesUnicastCum", "ingress-unicast-bytes-cumulative", 58220)
    prop._addConstant("cloudNwIngressBytesUnicastLast", "ingress-unicast-bytes-current-value", 58218)
    prop._addConstant("cloudNwIngressBytesUnicastMax", "ingress-unicast-bytes-maximum-value", 58223)
    prop._addConstant("cloudNwIngressBytesUnicastMin", "ingress-unicast-bytes-minimum-value", 58222)
    prop._addConstant("cloudNwIngressBytesUnicastPer", "ingress-unicast-bytes-periodic", 58221)
    prop._addConstant("cloudNwIngressBytesUnicastRate", "ingress-unicast-bytes-rate", 58229)
    prop._addConstant("cloudNwIngressBytesUnicastTr", "ingress-unicast-bytes-trend", 58228)
    prop._addConstant("cloudNwIngressPktsAgDropCum", "ingress-drop-packets-cumulative", 58273)
    prop._addConstant("cloudNwIngressPktsAgDropPer", "ingress-drop-packets-periodic", 58274)
    prop._addConstant("cloudNwIngressPktsAgDropRate", "ingress-drop-packets-rate", 58279)
    prop._addConstant("cloudNwIngressPktsAgDropTr", "ingress-drop-packets-trend", 58278)
    prop._addConstant("cloudNwIngressPktsAgUnicastCum", "ingress-unicast-packets-cumulative", 58307)
    prop._addConstant("cloudNwIngressPktsAgUnicastPer", "ingress-unicast-packets-periodic", 58308)
    prop._addConstant("cloudNwIngressPktsAgUnicastRate", "ingress-unicast-packets-rate", 58313)
    prop._addConstant("cloudNwIngressPktsAgUnicastTr", "ingress-unicast-packets-trend", 58312)
    prop._addConstant("cloudNwIngressPktsDropAvg", "ingress-drop-packets-average-value", 58258)
    prop._addConstant("cloudNwIngressPktsDropCum", "ingress-drop-packets-cumulative", 58254)
    prop._addConstant("cloudNwIngressPktsDropLast", "ingress-drop-packets-current-value", 58252)
    prop._addConstant("cloudNwIngressPktsDropMax", "ingress-drop-packets-maximum-value", 58257)
    prop._addConstant("cloudNwIngressPktsDropMin", "ingress-drop-packets-minimum-value", 58256)
    prop._addConstant("cloudNwIngressPktsDropPer", "ingress-drop-packets-periodic", 58255)
    prop._addConstant("cloudNwIngressPktsDropRate", "ingress-drop-packets-rate", 58263)
    prop._addConstant("cloudNwIngressPktsDropTr", "ingress-drop-packets-trend", 58262)
    prop._addConstant("cloudNwIngressPktsUnicastAvg", "ingress-unicast-packets-average-value", 58292)
    prop._addConstant("cloudNwIngressPktsUnicastCum", "ingress-unicast-packets-cumulative", 58288)
    prop._addConstant("cloudNwIngressPktsUnicastLast", "ingress-unicast-packets-current-value", 58286)
    prop._addConstant("cloudNwIngressPktsUnicastMax", "ingress-unicast-packets-maximum-value", 58291)
    prop._addConstant("cloudNwIngressPktsUnicastMin", "ingress-unicast-packets-minimum-value", 58290)
    prop._addConstant("cloudNwIngressPktsUnicastPer", "ingress-unicast-packets-periodic", 58289)
    prop._addConstant("cloudNwIngressPktsUnicastRate", "ingress-unicast-packets-rate", 58297)
    prop._addConstant("cloudNwIngressPktsUnicastTr", "ingress-unicast-packets-trend", 58296)
    ...
    prop._addConstant("cloudRgTrafficAgEgressBytesCum", "egress-unicast-bytes-cumulative", 67170)
    prop._addConstant("cloudRgTrafficAgEgressBytesPer", "egress-unicast-bytes-periodic", 67171)
    prop._addConstant("cloudRgTrafficAgEgressBytesRate", "egress-unicast-bytes-rate", 67176)
    prop._addConstant("cloudRgTrafficAgEgressBytesTr", "egress-unicast-bytes-trend", 67175)
    prop._addConstant("cloudRgTrafficAgEgressPacketsCum", "egress-unicast-packets-cumulative", 67204)
    prop._addConstant("cloudRgTrafficAgEgressPacketsPer", "egress-unicast-packets-periodic", 67205)
    prop._addConstant("cloudRgTrafficAgEgressPacketsRate", "egress-unicast-packets-rate", 67210)
    prop._addConstant("cloudRgTrafficAgEgressPacketsTr", "egress-unicast-packets-trend", 67209)
    prop._addConstant("cloudRgTrafficAgIngressBytesCum", "ingress-unicast-bytes-cumulative", 67238)
    prop._addConstant("cloudRgTrafficAgIngressBytesPer", "ingress-unicast-bytes-periodic", 67239)
    prop._addConstant("cloudRgTrafficAgIngressBytesRate", "ingress-unicast-bytes-rate", 67244)
    prop._addConstant("cloudRgTrafficAgIngressBytesTr", "ingress-unicast-bytes-trend", 67243)
    prop._addConstant("cloudRgTrafficAgIngressPacketsCum", "ingress-unicast-packets-cumulative", 67272)
    prop._addConstant("cloudRgTrafficAgIngressPacketsPer", "ingress-unicast-packets-periodic", 67273)
    prop._addConstant("cloudRgTrafficAgIngressPacketsRate", "ingress-unicast-packets-rate", 67278)
    prop._addConstant("cloudRgTrafficAgIngressPacketsTr", "ingress-unicast-packets-trend", 67277)
    prop._addConstant("cloudRgTrafficEgressBytesAvg", "egress-unicast-bytes-average-value", 67155)
    prop._addConstant("cloudRgTrafficEgressBytesCum", "egress-unicast-bytes-cumulative", 67151)
    prop._addConstant("cloudRgTrafficEgressBytesLast", "egress-unicast-bytes-current-value", 67149)
    prop._addConstant("cloudRgTrafficEgressBytesMax", "egress-unicast-bytes-maximum-value", 67154)
    prop._addConstant("cloudRgTrafficEgressBytesMin", "egress-unicast-bytes-minimum-value", 67153)
    prop._addConstant("cloudRgTrafficEgressBytesPer", "egress-unicast-bytes-periodic", 67152)
    prop._addConstant("cloudRgTrafficEgressBytesRate", "egress-unicast-bytes-rate", 67160)
    prop._addConstant("cloudRgTrafficEgressBytesTr", "egress-unicast-bytes-trend", 67159)
    prop._addConstant("cloudRgTrafficEgressPacketsAvg", "egress-unicast-packets-average-value", 67189)
    prop._addConstant("cloudRgTrafficEgressPacketsCum", "egress-unicast-packets-cumulative", 67185)
    prop._addConstant("cloudRgTrafficEgressPacketsLast", "egress-unicast-packets-current-value", 67183)
    prop._addConstant("cloudRgTrafficEgressPacketsMax", "egress-unicast-packets-maximum-value", 67188)
    prop._addConstant("cloudRgTrafficEgressPacketsMin", "egress-unicast-packets-minimum-value", 67187)
    prop._addConstant("cloudRgTrafficEgressPacketsPer", "egress-unicast-packets-periodic", 67186)
    prop._addConstant("cloudRgTrafficEgressPacketsRate", "egress-unicast-packets-rate", 67194)
    prop._addConstant("cloudRgTrafficEgressPacketsTr", "egress-unicast-packets-trend", 67193)
    prop._addConstant("cloudRgTrafficIngressBytesAvg", "ingress-unicast-bytes-average-value", 67223)
    prop._addConstant("cloudRgTrafficIngressBytesCum", "ingress-unicast-bytes-cumulative", 67219)
    prop._addConstant("cloudRgTrafficIngressBytesLast", "ingress-unicast-bytes-current-value", 67217)
    prop._addConstant("cloudRgTrafficIngressBytesMax", "ingress-unicast-bytes-maximum-value", 67222)
    prop._addConstant("cloudRgTrafficIngressBytesMin", "ingress-unicast-bytes-minimum-value", 67221)
    prop._addConstant("cloudRgTrafficIngressBytesPer", "ingress-unicast-bytes-periodic", 67220)
    prop._addConstant("cloudRgTrafficIngressBytesRate", "ingress-unicast-bytes-rate", 67228)
    prop._addConstant("cloudRgTrafficIngressBytesTr", "ingress-unicast-bytes-trend", 67227)
    prop._addConstant("cloudRgTrafficIngressPacketsAvg", "ingress-unicast-packets-average-value", 67257)
    prop._addConstant("cloudRgTrafficIngressPacketsCum", "ingress-unicast-packets-cumulative", 67253)
    prop._addConstant("cloudRgTrafficIngressPacketsLast", "ingress-unicast-packets-current-value", 67251)
    prop._addConstant("cloudRgTrafficIngressPacketsMax", "ingress-unicast-packets-maximum-value", 67256)
    prop._addConstant("cloudRgTrafficIngressPacketsMin", "ingress-unicast-packets-minimum-value", 67255)
    prop._addConstant("cloudRgTrafficIngressPacketsPer", "ingress-unicast-packets-periodic", 67254)
    prop._addConstant("cloudRgTrafficIngressPacketsRate", "ingress-unicast-packets-rate", 67262)
    prop._addConstant("cloudRgTrafficIngressPacketsTr", "ingress-unicast-packets-trend", 67261)
    prop._addConstant("cloudZnLatencyExternalAvg", "latency-for-all-external-traffic-average-value", 67456)
    prop._addConstant("cloudZnLatencyExternalLast", "latency-for-all-external-traffic-current-value", 67453)
    prop._addConstant("cloudZnLatencyExternalMax", "latency-for-all-external-traffic-maximum-value", 67455)
    prop._addConstant("cloudZnLatencyExternalMin", "latency-for-all-external-traffic-minimum-value", 67454)
    prop._addConstant("cloudZnLatencyExternalTr", "latency-for-all-external-traffic-trend", 67461)
    prop._addConstant("cloudZnTrafficAgEgressBytesCum", "egress-unicast-bytes-cumulative", 67306)
    prop._addConstant("cloudZnTrafficAgEgressBytesPer", "egress-unicast-bytes-periodic", 67307)
    prop._addConstant("cloudZnTrafficAgEgressBytesRate", "egress-unicast-bytes-rate", 67312)
    prop._addConstant("cloudZnTrafficAgEgressBytesTr", "egress-unicast-bytes-trend", 67311)
    prop._addConstant("cloudZnTrafficAgEgressPacketsCum", "egress-unicast-packets-cumulative", 67340)
    prop._addConstant("cloudZnTrafficAgEgressPacketsPer", "egress-unicast-packets-periodic", 67341)
    prop._addConstant("cloudZnTrafficAgEgressPacketsRate", "egress-unicast-packets-rate", 67346)
    prop._addConstant("cloudZnTrafficAgEgressPacketsTr", "egress-unicast-packets-trend", 67345)
    prop._addConstant("cloudZnTrafficAgIngressBytesCum", "ingress-unicast-bytes-cumulative", 67374)
    prop._addConstant("cloudZnTrafficAgIngressBytesPer", "ingress-unicast-bytes-periodic", 67375)
    prop._addConstant("cloudZnTrafficAgIngressBytesRate", "ingress-unicast-bytes-rate", 67380)
    prop._addConstant("cloudZnTrafficAgIngressBytesTr", "ingress-unicast-bytes-trend", 67379)
    prop._addConstant("cloudZnTrafficAgIngressPacketsCum", "ingress-unicast-packets-cumulative", 67408)
    prop._addConstant("cloudZnTrafficAgIngressPacketsPer", "ingress-unicast-packets-periodic", 67409)
    prop._addConstant("cloudZnTrafficAgIngressPacketsRate", "ingress-unicast-packets-rate", 67414)
    prop._addConstant("cloudZnTrafficAgIngressPacketsTr", "ingress-unicast-packets-trend", 67413)
    prop._addConstant("cloudZnTrafficEgressBytesAvg", "egress-unicast-bytes-average-value", 67291)
    prop._addConstant("cloudZnTrafficEgressBytesCum", "egress-unicast-bytes-cumulative", 67287)
    prop._addConstant("cloudZnTrafficEgressBytesLast", "egress-unicast-bytes-current-value", 67285)
    prop._addConstant("cloudZnTrafficEgressBytesMax", "egress-unicast-bytes-maximum-value", 67290)
    prop._addConstant("cloudZnTrafficEgressBytesMin", "egress-unicast-bytes-minimum-value", 67289)
    prop._addConstant("cloudZnTrafficEgressBytesPer", "egress-unicast-bytes-periodic", 67288)
    prop._addConstant("cloudZnTrafficEgressBytesRate", "egress-unicast-bytes-rate", 67296)
    prop._addConstant("cloudZnTrafficEgressBytesTr", "egress-unicast-bytes-trend", 67295)
    prop._addConstant("cloudZnTrafficEgressPacketsAvg", "egress-unicast-packets-average-value", 67325)
    prop._addConstant("cloudZnTrafficEgressPacketsCum", "egress-unicast-packets-cumulative", 67321)
    prop._addConstant("cloudZnTrafficEgressPacketsLast", "egress-unicast-packets-current-value", 67319)
    prop._addConstant("cloudZnTrafficEgressPacketsMax", "egress-unicast-packets-maximum-value", 67324)
    prop._addConstant("cloudZnTrafficEgressPacketsMin", "egress-unicast-packets-minimum-value", 67323)
    prop._addConstant("cloudZnTrafficEgressPacketsPer", "egress-unicast-packets-periodic", 67322)
    prop._addConstant("cloudZnTrafficEgressPacketsRate", "egress-unicast-packets-rate", 67330)
    prop._addConstant("cloudZnTrafficEgressPacketsTr", "egress-unicast-packets-trend", 67329)
    prop._addConstant("cloudZnTrafficIngressBytesAvg", "ingress-unicast-bytes-average-value", 67359)
    prop._addConstant("cloudZnTrafficIngressBytesCum", "ingress-unicast-bytes-cumulative", 67355)
    prop._addConstant("cloudZnTrafficIngressBytesLast", "ingress-unicast-bytes-current-value", 67353)
    prop._addConstant("cloudZnTrafficIngressBytesMax", "ingress-unicast-bytes-maximum-value", 67358)
    prop._addConstant("cloudZnTrafficIngressBytesMin", "ingress-unicast-bytes-minimum-value", 67357)
    prop._addConstant("cloudZnTrafficIngressBytesPer", "ingress-unicast-bytes-periodic", 67356)
    prop._addConstant("cloudZnTrafficIngressBytesRate", "ingress-unicast-bytes-rate", 67364)
    prop._addConstant("cloudZnTrafficIngressBytesTr", "ingress-unicast-bytes-trend", 67363)
    prop._addConstant("cloudZnTrafficIngressPacketsAvg", "ingress-unicast-packets-average-value", 67393)
    prop._addConstant("cloudZnTrafficIngressPacketsCum", "ingress-unicast-packets-cumulative", 67389)
    prop._addConstant("cloudZnTrafficIngressPacketsLast", "ingress-unicast-packets-current-value", 67387)
    prop._addConstant("cloudZnTrafficIngressPacketsMax", "ingress-unicast-packets-maximum-value", 67392)
    prop._addConstant("cloudZnTrafficIngressPacketsMin", "ingress-unicast-packets-minimum-value", 67391)
    prop._addConstant("cloudZnTrafficIngressPacketsPer", "ingress-unicast-packets-periodic", 67390)
    prop._addConstant("cloudZnTrafficIngressPacketsRate", "ingress-unicast-packets-rate", 67398)
    prop._addConstant("cloudZnTrafficIngressPacketsTr", "ingress-unicast-packets-trend", 67397)
    ...
    prop._addConstant("eqptcapacityEstPGLabelEntryNormalizedAvg", "pg-label-entries-usage-from-policy-estimator-average-value", 56832)
    prop._addConstant("eqptcapacityEstPGLabelEntryNormalizedLast", "pg-label-entries-usage-from-policy-estimator-current-value", 56829)
    prop._addConstant("eqptcapacityEstPGLabelEntryNormalizedMax", "pg-label-entries-usage-from-policy-estimator-maximum-value", 56831)
    prop._addConstant("eqptcapacityEstPGLabelEntryNormalizedMin", "pg-label-entries-usage-from-policy-estimator-minimum-value", 56830)
    prop._addConstant("eqptcapacityEstPGLabelEntryNormalizedTr", "pg-label-entries-usage-from-policy-estimator-trend", 56837)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapAvg", "pg-label-usage-capacity-from-policy-estimator-average-value", 56850)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapCum", "pg-label-usage-capacity-from-policy-estimator-cumulative", 56846)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapLast", "pg-label-usage-capacity-from-policy-estimator-current-value", 56844)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapMax", "pg-label-usage-capacity-from-policy-estimator-maximum-value", 56849)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapMin", "pg-label-usage-capacity-from-policy-estimator-minimum-value", 56848)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapPer", "pg-label-usage-capacity-from-policy-estimator-periodic", 56847)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapRate", "pg-label-usage-capacity-from-policy-estimator-rate", 56855)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblCapTr", "pg-label-usage-capacity-from-policy-estimator-trend", 56854)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageAvg", "pg-label-usage-from-policy-estimator-average-value", 56871)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageCum", "pg-label-usage-from-policy-estimator-cumulative", 56867)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageLast", "pg-label-usage-from-policy-estimator-current-value", 56865)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageMax", "pg-label-usage-from-policy-estimator-maximum-value", 56870)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageMin", "pg-label-usage-from-policy-estimator-minimum-value", 56869)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsagePer", "pg-label-usage-from-policy-estimator-periodic", 56868)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageRate", "pg-label-usage-from-policy-estimator-rate", 56876)
    prop._addConstant("eqptcapacityEstPGLabelUsagePgLblUsageTr", "pg-label-usage-from-policy-estimator-trend", 56875)
    prop._addConstant("eqptcapacityEstPolEntryNormalizedAvg", "policy-cam-entries-usage-from-estimator-average-value", 56889)
    prop._addConstant("eqptcapacityEstPolEntryNormalizedLast", "policy-cam-entries-usage-from-estimator-current-value", 56886)
    prop._addConstant("eqptcapacityEstPolEntryNormalizedMax", "policy-cam-entries-usage-from-estimator-maximum-value", 56888)
    prop._addConstant("eqptcapacityEstPolEntryNormalizedMin", "policy-cam-entries-usage-from-estimator-minimum-value", 56887)
    prop._addConstant("eqptcapacityEstPolEntryNormalizedTr", "policy-cam-entries-usage-from-estimator-trend", 56894)
    prop._addConstant("eqptcapacityEstPolOTCAMEntryNormalizedAvg", "policy-otcam-entries-usage-from-policy-estimator-average-value", 56904)
    prop._addConstant("eqptcapacityEstPolOTCAMEntryNormalizedLast", "policy-otcam-entries-usage-from-policy-estimator-current-value", 56901)
    prop._addConstant("eqptcapacityEstPolOTCAMEntryNormalizedMax", "policy-otcam-entries-usage-from-policy-estimator-maximum-value", 56903)
    prop._addConstant("eqptcapacityEstPolOTCAMEntryNormalizedMin", "policy-otcam-entries-usage-from-policy-estimator-minimum-value", 56902)
    prop._addConstant("eqptcapacityEstPolOTCAMEntryNormalizedTr", "policy-otcam-entries-usage-from-policy-estimator-trend", 56909)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapAvg", "policy-otcam-usage-capacity-from-policy-estimator-average-value", 56922)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapCum", "policy-otcam-usage-capacity-from-policy-estimator-cumulative", 56918)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapLast", "policy-otcam-usage-capacity-from-policy-estimator-current-value", 56916)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapMax", "policy-otcam-usage-capacity-from-policy-estimator-maximum-value", 56921)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapMin", "policy-otcam-usage-capacity-from-policy-estimator-minimum-value", 56920)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapPer", "policy-otcam-usage-capacity-from-policy-estimator-periodic", 56919)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapRate", "policy-otcam-usage-capacity-from-policy-estimator-rate", 56927)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMCapTr", "policy-otcam-usage-capacity-from-policy-estimator-trend", 56926)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageAvg", "policy-otcam-usage-from-policy-estimator-average-value", 56943)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageCum", "policy-otcam-usage-from-policy-estimator-cumulative", 56939)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageLast", "policy-otcam-usage-from-policy-estimator-current-value", 56937)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageMax", "policy-otcam-usage-from-policy-estimator-maximum-value", 56942)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageMin", "policy-otcam-usage-from-policy-estimator-minimum-value", 56941)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsagePer", "policy-otcam-usage-from-policy-estimator-periodic", 56940)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageRate", "policy-otcam-usage-from-policy-estimator-rate", 56948)
    prop._addConstant("eqptcapacityEstPolOTCAMUsagePolOTCAMUsageTr", "policy-otcam-usage-from-policy-estimator-trend", 56947)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageAvg", "policy-usage-from-policy-estimator-average-value", 56985)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapAvg", "policy-usage-capacity-from-policy-estimator-average-value", 56964)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapCum", "policy-usage-capacity-from-policy-estimator-cumulative", 56960)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapLast", "policy-usage-capacity-from-policy-estimator-current-value", 56958)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapMax", "policy-usage-capacity-from-policy-estimator-maximum-value", 56963)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapMin", "policy-usage-capacity-from-policy-estimator-minimum-value", 56962)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapPer", "policy-usage-capacity-from-policy-estimator-periodic", 56961)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapRate", "policy-usage-capacity-from-policy-estimator-rate", 56969)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCapTr", "policy-usage-capacity-from-policy-estimator-trend", 56968)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageCum", "policy-usage-from-policy-estimator-cumulative", 56981)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageLast", "policy-usage-from-policy-estimator-current-value", 56979)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageMax", "policy-usage-from-policy-estimator-maximum-value", 56984)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageMin", "policy-usage-from-policy-estimator-minimum-value", 56983)
    prop._addConstant("eqptcapacityEstPolUsagePolUsagePer", "policy-usage-from-policy-estimator-periodic", 56982)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageRate", "policy-usage-from-policy-estimator-rate", 56990)
    prop._addConstant("eqptcapacityEstPolUsagePolUsageTr", "policy-usage-from-policy-estimator-trend", 56989)
    ...
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateAvg", "numer-of-mo-create-average-value", 63237)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateCum", "numer-of-mo-create-cumulative", 63233)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateLast", "numer-of-mo-create-current-value", 63231)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateMax", "numer-of-mo-create-maximum-value", 63236)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateMin", "numer-of-mo-create-minimum-value", 63235)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreatePer", "numer-of-mo-create-periodic", 63234)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateRate", "numer-of-mo-create-rate", 63242)
    prop._addConstant("infraReplicaPerfStatsDoerMoCreateTr", "numer-of-mo-create-trend", 63241)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteAvg", "numer-of-mo-delete-average-value", 63258)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteCum", "numer-of-mo-delete-cumulative", 63254)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteLast", "numer-of-mo-delete-current-value", 63252)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteMax", "numer-of-mo-delete-maximum-value", 63257)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteMin", "numer-of-mo-delete-minimum-value", 63256)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeletePer", "numer-of-mo-delete-periodic", 63255)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteRate", "numer-of-mo-delete-rate", 63263)
    prop._addConstant("infraReplicaPerfStatsDoerMoDeleteTr", "numer-of-mo-delete-trend", 63262)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyAvg", "numer-of-mo-modify-average-value", 63279)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyCum", "numer-of-mo-modify-cumulative", 63275)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyLast", "numer-of-mo-modify-current-value", 63273)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyMax", "numer-of-mo-modify-maximum-value", 63278)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyMin", "numer-of-mo-modify-minimum-value", 63277)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyPer", "numer-of-mo-modify-periodic", 63276)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyRate", "numer-of-mo-modify-rate", 63284)
    prop._addConstant("infraReplicaPerfStatsDoerMoModifyTr", "numer-of-mo-modify-trend", 63283)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusAvg", "numer-of-doer-stimulus-average-value", 63300)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusCum", "numer-of-doer-stimulus-cumulative", 63296)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusLast", "numer-of-doer-stimulus-current-value", 63294)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusMax", "numer-of-doer-stimulus-maximum-value", 63299)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusMin", "numer-of-doer-stimulus-minimum-value", 63298)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusPer", "numer-of-doer-stimulus-periodic", 63297)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusRate", "numer-of-doer-stimulus-rate", 63305)
    prop._addConstant("infraReplicaPerfStatsDoerStimulusTr", "numer-of-doer-stimulus-trend", 63304)
    prop._addConstant("infraReplicaStatsDoerTAvg", "liveliness-of-doer-average-value", 63318)
    prop._addConstant("infraReplicaStatsDoerTLast", "liveliness-of-doer-current-value", 63315)
    prop._addConstant("infraReplicaStatsDoerTMax", "liveliness-of-doer-maximum-value", 63317)
    prop._addConstant("infraReplicaStatsDoerTMin", "liveliness-of-doer-minimum-value", 63316)
    prop._addConstant("infraReplicaStatsDoerTTr", "liveliness-of-doer-trend", 63323)
    ...
    prop._addConstant("l3EgrBytesAdmitAvg", "mpls-vrf-egress-admit-bytes-average-value", 57575)
    prop._addConstant("l3EgrBytesAdmitCum", "mpls-vrf-egress-admit-bytes-cumulative", 57571)
    prop._addConstant("l3EgrBytesAdmitLast", "mpls-vrf-egress-admit-bytes-current-value", 57569)
    prop._addConstant("l3EgrBytesAdmitMax", "mpls-vrf-egress-admit-bytes-maximum-value", 57574)
    prop._addConstant("l3EgrBytesAdmitMin", "mpls-vrf-egress-admit-bytes-minimum-value", 57573)
    prop._addConstant("l3EgrBytesAdmitPer", "mpls-vrf-egress-admit-bytes-periodic", 57572)
    prop._addConstant("l3EgrBytesAdmitRate", "mpls-vrf-egress-admit-bytes-rate", 57580)
    prop._addConstant("l3EgrBytesAdmitTr", "mpls-vrf-egress-admit-bytes-trend", 57579)
    prop._addConstant("l3EgrBytesAgAdmitCum", "mpls-vrf-egress-admit-bytes-cumulative", 58693)
    prop._addConstant("l3EgrBytesAgAdmitPer", "mpls-vrf-egress-admit-bytes-periodic", 58694)
    prop._addConstant("l3EgrBytesAgAdmitRate", "mpls-vrf-egress-admit-bytes-rate", 58699)
    prop._addConstant("l3EgrBytesAgAdmitTr", "mpls-vrf-egress-admit-bytes-trend", 58698)
    prop._addConstant("l3EgrBytesAgDropCum", "mpls-vrf-egress-drop-bytes-cumulative", 58727)
    prop._addConstant("l3EgrBytesAgDropPer", "mpls-vrf-egress-drop-bytes-periodic", 58728)
    prop._addConstant("l3EgrBytesAgDropRate", "mpls-vrf-egress-drop-bytes-rate", 58733)
    prop._addConstant("l3EgrBytesAgDropTr", "mpls-vrf-egress-drop-bytes-trend", 58732)
    prop._addConstant("l3EgrBytesDropAvg", "mpls-vrf-egress-drop-bytes-average-value", 57596)
    prop._addConstant("l3EgrBytesDropCum", "mpls-vrf-egress-drop-bytes-cumulative", 57592)
    prop._addConstant("l3EgrBytesDropLast", "mpls-vrf-egress-drop-bytes-current-value", 57590)
    prop._addConstant("l3EgrBytesDropMax", "mpls-vrf-egress-drop-bytes-maximum-value", 57595)
    prop._addConstant("l3EgrBytesDropMin", "mpls-vrf-egress-drop-bytes-minimum-value", 57594)
    prop._addConstant("l3EgrBytesDropPer", "mpls-vrf-egress-drop-bytes-periodic", 57593)
    prop._addConstant("l3EgrBytesDropRate", "mpls-vrf-egress-drop-bytes-rate", 57601)
    prop._addConstant("l3EgrBytesDropTr", "mpls-vrf-egress-drop-bytes-trend", 57600)
    prop._addConstant("l3EgrBytesPartAdmitAvg", "mpls-vrf-egress-admit-bytes-average-value", 58678)
    prop._addConstant("l3EgrBytesPartAdmitCum", "mpls-vrf-egress-admit-bytes-cumulative", 58674)
    prop._addConstant("l3EgrBytesPartAdmitLast", "mpls-vrf-egress-admit-bytes-current-value", 58672)
    prop._addConstant("l3EgrBytesPartAdmitMax", "mpls-vrf-egress-admit-bytes-maximum-value", 58677)
    prop._addConstant("l3EgrBytesPartAdmitMin", "mpls-vrf-egress-admit-bytes-minimum-value", 58676)
    prop._addConstant("l3EgrBytesPartAdmitPer", "mpls-vrf-egress-admit-bytes-periodic", 58675)
    prop._addConstant("l3EgrBytesPartAdmitRate", "mpls-vrf-egress-admit-bytes-rate", 58683)
    prop._addConstant("l3EgrBytesPartAdmitTr", "mpls-vrf-egress-admit-bytes-trend", 58682)
    prop._addConstant("l3EgrBytesPartDropAvg", "mpls-vrf-egress-drop-bytes-average-value", 58712)
    prop._addConstant("l3EgrBytesPartDropCum", "mpls-vrf-egress-drop-bytes-cumulative", 58708)
    prop._addConstant("l3EgrBytesPartDropLast", "mpls-vrf-egress-drop-bytes-current-value", 58706)
    prop._addConstant("l3EgrBytesPartDropMax", "mpls-vrf-egress-drop-bytes-maximum-value", 58711)
    prop._addConstant("l3EgrBytesPartDropMin", "mpls-vrf-egress-drop-bytes-minimum-value", 58710)
    prop._addConstant("l3EgrBytesPartDropPer", "mpls-vrf-egress-drop-bytes-periodic", 58709)
    prop._addConstant("l3EgrBytesPartDropRate", "mpls-vrf-egress-drop-bytes-rate", 58717)
    prop._addConstant("l3EgrBytesPartDropTr", "mpls-vrf-egress-drop-bytes-trend", 58716)
    prop._addConstant("l3EgrPktsAdmitAvg", "mpls-vrf-egress-admit-packets-average-value", 57617)
    prop._addConstant("l3EgrPktsAdmitCum", "mpls-vrf-egress-admit-packets-cumulative", 57613)
    prop._addConstant("l3EgrPktsAdmitLast", "mpls-vrf-egress-admit-packets-current-value", 57611)
    prop._addConstant("l3EgrPktsAdmitMax", "mpls-vrf-egress-admit-packets-maximum-value", 57616)
    prop._addConstant("l3EgrPktsAdmitMin", "mpls-vrf-egress-admit-packets-minimum-value", 57615)
    prop._addConstant("l3EgrPktsAdmitPer", "mpls-vrf-egress-admit-packets-periodic", 57614)
    prop._addConstant("l3EgrPktsAdmitRate", "mpls-vrf-egress-admit-packets-rate", 57622)
    prop._addConstant("l3EgrPktsAdmitTr", "mpls-vrf-egress-admit-packets-trend", 57621)
    prop._addConstant("l3EgrPktsAgAdmitCum", "mpls-vrf-egress-admit-packets-cumulative", 58761)
    prop._addConstant("l3EgrPktsAgAdmitPer", "mpls-vrf-egress-admit-packets-periodic", 58762)
    prop._addConstant("l3EgrPktsAgAdmitRate", "mpls-vrf-egress-admit-packets-rate", 58767)
    prop._addConstant("l3EgrPktsAgAdmitTr", "mpls-vrf-egress-admit-packets-trend", 58766)
    prop._addConstant("l3EgrPktsAgDropCum", "mpls-vrf-egress-drop-packets-cumulative", 58795)
    prop._addConstant("l3EgrPktsAgDropPer", "mpls-vrf-egress-drop-packets-periodic", 58796)
    prop._addConstant("l3EgrPktsAgDropRate", "mpls-vrf-egress-drop-packets-rate", 58801)
    prop._addConstant("l3EgrPktsAgDropTr", "mpls-vrf-egress-drop-packets-trend", 58800)
    prop._addConstant("l3EgrPktsDropAvg", "mpls-vrf-egress-drop-packets-average-value", 57638)
    prop._addConstant("l3EgrPktsDropCum", "mpls-vrf-egress-drop-packets-cumulative", 57634)
    prop._addConstant("l3EgrPktsDropLast", "mpls-vrf-egress-drop-packets-current-value", 57632)
    prop._addConstant("l3EgrPktsDropMax", "mpls-vrf-egress-drop-packets-maximum-value", 57637)
    prop._addConstant("l3EgrPktsDropMin", "mpls-vrf-egress-drop-packets-minimum-value", 57636)
    prop._addConstant("l3EgrPktsDropPer", "mpls-vrf-egress-drop-packets-periodic", 57635)
    prop._addConstant("l3EgrPktsDropRate", "mpls-vrf-egress-drop-packets-rate", 57643)
    prop._addConstant("l3EgrPktsDropTr", "mpls-vrf-egress-drop-packets-trend", 57642)
    prop._addConstant("l3EgrPktsPartAdmitAvg", "mpls-vrf-egress-admit-packets-average-value", 58746)
    prop._addConstant("l3EgrPktsPartAdmitCum", "mpls-vrf-egress-admit-packets-cumulative", 58742)
    prop._addConstant("l3EgrPktsPartAdmitLast", "mpls-vrf-egress-admit-packets-current-value", 58740)
    prop._addConstant("l3EgrPktsPartAdmitMax", "mpls-vrf-egress-admit-packets-maximum-value", 58745)
    prop._addConstant("l3EgrPktsPartAdmitMin", "mpls-vrf-egress-admit-packets-minimum-value", 58744)
    prop._addConstant("l3EgrPktsPartAdmitPer", "mpls-vrf-egress-admit-packets-periodic", 58743)
    prop._addConstant("l3EgrPktsPartAdmitRate", "mpls-vrf-egress-admit-packets-rate", 58751)
    prop._addConstant("l3EgrPktsPartAdmitTr", "mpls-vrf-egress-admit-packets-trend", 58750)
    prop._addConstant("l3EgrPktsPartDropAvg", "mpls-vrf-egress-drop-packets-average-value", 58780)
    prop._addConstant("l3EgrPktsPartDropCum", "mpls-vrf-egress-drop-packets-cumulative", 58776)
    prop._addConstant("l3EgrPktsPartDropLast", "mpls-vrf-egress-drop-packets-current-value", 58774)
    prop._addConstant("l3EgrPktsPartDropMax", "mpls-vrf-egress-drop-packets-maximum-value", 58779)
    prop._addConstant("l3EgrPktsPartDropMin", "mpls-vrf-egress-drop-packets-minimum-value", 58778)
    prop._addConstant("l3EgrPktsPartDropPer", "mpls-vrf-egress-drop-packets-periodic", 58777)
    prop._addConstant("l3EgrPktsPartDropRate", "mpls-vrf-egress-drop-packets-rate", 58785)
    prop._addConstant("l3EgrPktsPartDropTr", "mpls-vrf-egress-drop-packets-trend", 58784)
    prop._addConstant("l3IngrBytesAdmitAvg", "mpls-vrf-ingress-admit-bytes-average-value", 57659)
    prop._addConstant("l3IngrBytesAdmitCum", "mpls-vrf-ingress-admit-bytes-cumulative", 57655)
    prop._addConstant("l3IngrBytesAdmitLast", "mpls-vrf-ingress-admit-bytes-current-value", 57653)
    prop._addConstant("l3IngrBytesAdmitMax", "mpls-vrf-ingress-admit-bytes-maximum-value", 57658)
    prop._addConstant("l3IngrBytesAdmitMin", "mpls-vrf-ingress-admit-bytes-minimum-value", 57657)
    prop._addConstant("l3IngrBytesAdmitPer", "mpls-vrf-ingress-admit-bytes-periodic", 57656)
    prop._addConstant("l3IngrBytesAdmitRate", "mpls-vrf-ingress-admit-bytes-rate", 57664)
    prop._addConstant("l3IngrBytesAdmitTr", "mpls-vrf-ingress-admit-bytes-trend", 57663)
    prop._addConstant("l3IngrBytesAgAdmitCum", "mpls-vrf-ingress-admit-bytes-cumulative", 58829)
    prop._addConstant("l3IngrBytesAgAdmitPer", "mpls-vrf-ingress-admit-bytes-periodic", 58830)
    prop._addConstant("l3IngrBytesAgAdmitRate", "mpls-vrf-ingress-admit-bytes-rate", 58835)
    prop._addConstant("l3IngrBytesAgAdmitTr", "mpls-vrf-ingress-admit-bytes-trend", 58834)
    prop._addConstant("l3IngrBytesAgDropCum", "mpls-vrf-ingress-drop-bytes-cumulative", 58863)
    prop._addConstant("l3IngrBytesAgDropPer", "mpls-vrf-ingress-drop-bytes-periodic", 58864)
    prop._addConstant("l3IngrBytesAgDropRate", "mpls-vrf-ingress-drop-bytes-rate", 58869)
    prop._addConstant("l3IngrBytesAgDropTr", "mpls-vrf-ingress-drop-bytes-trend", 58868)
    prop._addConstant("l3IngrBytesDropAvg", "mpls-vrf-ingress-drop-bytes-average-value", 57680)
    prop._addConstant("l3IngrBytesDropCum", "mpls-vrf-ingress-drop-bytes-cumulative", 57676)
    prop._addConstant("l3IngrBytesDropLast", "mpls-vrf-ingress-drop-bytes-current-value", 57674)
    prop._addConstant("l3IngrBytesDropMax", "mpls-vrf-ingress-drop-bytes-maximum-value", 57679)
    prop._addConstant("l3IngrBytesDropMin", "mpls-vrf-ingress-drop-bytes-minimum-value", 57678)
    prop._addConstant("l3IngrBytesDropPer", "mpls-vrf-ingress-drop-bytes-periodic", 57677)
    prop._addConstant("l3IngrBytesDropRate", "mpls-vrf-ingress-drop-bytes-rate", 57685)
    prop._addConstant("l3IngrBytesDropTr", "mpls-vrf-ingress-drop-bytes-trend", 57684)
    prop._addConstant("l3IngrBytesPartAdmitAvg", "mpls-vrf-ingress-admit-bytes-average-value", 58814)
    prop._addConstant("l3IngrBytesPartAdmitCum", "mpls-vrf-ingress-admit-bytes-cumulative", 58810)
    prop._addConstant("l3IngrBytesPartAdmitLast", "mpls-vrf-ingress-admit-bytes-current-value", 58808)
    prop._addConstant("l3IngrBytesPartAdmitMax", "mpls-vrf-ingress-admit-bytes-maximum-value", 58813)
    prop._addConstant("l3IngrBytesPartAdmitMin", "mpls-vrf-ingress-admit-bytes-minimum-value", 58812)
    prop._addConstant("l3IngrBytesPartAdmitPer", "mpls-vrf-ingress-admit-bytes-periodic", 58811)
    prop._addConstant("l3IngrBytesPartAdmitRate", "mpls-vrf-ingress-admit-bytes-rate", 58819)
    prop._addConstant("l3IngrBytesPartAdmitTr", "mpls-vrf-ingress-admit-bytes-trend", 58818)
    prop._addConstant("l3IngrBytesPartDropAvg", "mpls-vrf-ingress-drop-bytes-average-value", 58848)
    prop._addConstant("l3IngrBytesPartDropCum", "mpls-vrf-ingress-drop-bytes-cumulative", 58844)
    prop._addConstant("l3IngrBytesPartDropLast", "mpls-vrf-ingress-drop-bytes-current-value", 58842)
    prop._addConstant("l3IngrBytesPartDropMax", "mpls-vrf-ingress-drop-bytes-maximum-value", 58847)
    prop._addConstant("l3IngrBytesPartDropMin", "mpls-vrf-ingress-drop-bytes-minimum-value", 58846)
    prop._addConstant("l3IngrBytesPartDropPer", "mpls-vrf-ingress-drop-bytes-periodic", 58845)
    prop._addConstant("l3IngrBytesPartDropRate", "mpls-vrf-ingress-drop-bytes-rate", 58853)
    prop._addConstant("l3IngrBytesPartDropTr", "mpls-vrf-ingress-drop-bytes-trend", 58852)
    prop._addConstant("l3IngrPktsAdmitAvg", "mpls-vrf-ingress-admit-packets-average-value", 57701)
    prop._addConstant("l3IngrPktsAdmitCum", "mpls-vrf-ingress-admit-packets-cumulative", 57697)
    prop._addConstant("l3IngrPktsAdmitLast", "mpls-vrf-ingress-admit-packets-current-value", 57695)
    prop._addConstant("l3IngrPktsAdmitMax", "mpls-vrf-ingress-admit-packets-maximum-value", 57700)
    prop._addConstant("l3IngrPktsAdmitMin", "mpls-vrf-ingress-admit-packets-minimum-value", 57699)
    prop._addConstant("l3IngrPktsAdmitPer", "mpls-vrf-ingress-admit-packets-periodic", 57698)
    prop._addConstant("l3IngrPktsAdmitRate", "mpls-vrf-ingress-admit-packets-rate", 57706)
    prop._addConstant("l3IngrPktsAdmitTr", "mpls-vrf-ingress-admit-packets-trend", 57705)
    prop._addConstant("l3IngrPktsAgAdmitCum", "mpls-vrf-ingress-admit-packets-cumulative", 58897)
    prop._addConstant("l3IngrPktsAgAdmitPer", "mpls-vrf-ingress-admit-packets-periodic", 58898)
    prop._addConstant("l3IngrPktsAgAdmitRate", "mpls-vrf-ingress-admit-packets-rate", 58903)
    prop._addConstant("l3IngrPktsAgAdmitTr", "mpls-vrf-ingress-admit-packets-trend", 58902)
    prop._addConstant("l3IngrPktsAgDropCum", "mpls-vrf-ingress-drop-packets-cumulative", 58931)
    prop._addConstant("l3IngrPktsAgDropPer", "mpls-vrf-ingress-drop-packets-periodic", 58932)
    prop._addConstant("l3IngrPktsAgDropRate", "mpls-vrf-ingress-drop-packets-rate", 58937)
    prop._addConstant("l3IngrPktsAgDropTr", "mpls-vrf-ingress-drop-packets-trend", 58936)
    prop._addConstant("l3IngrPktsDropAvg", "mpls-vrf-ingress-drop-packets-average-value", 57722)
    prop._addConstant("l3IngrPktsDropCum", "mpls-vrf-ingress-drop-packets-cumulative", 57718)
    prop._addConstant("l3IngrPktsDropLast", "mpls-vrf-ingress-drop-packets-current-value", 57716)
    prop._addConstant("l3IngrPktsDropMax", "mpls-vrf-ingress-drop-packets-maximum-value", 57721)
    prop._addConstant("l3IngrPktsDropMin", "mpls-vrf-ingress-drop-packets-minimum-value", 57720)
    prop._addConstant("l3IngrPktsDropPer", "mpls-vrf-ingress-drop-packets-periodic", 57719)
    prop._addConstant("l3IngrPktsDropRate", "mpls-vrf-ingress-drop-packets-rate", 57727)
    prop._addConstant("l3IngrPktsDropTr", "mpls-vrf-ingress-drop-packets-trend", 57726)
    prop._addConstant("l3IngrPktsPartAdmitAvg", "mpls-vrf-ingress-admit-packets-average-value", 58882)
    prop._addConstant("l3IngrPktsPartAdmitCum", "mpls-vrf-ingress-admit-packets-cumulative", 58878)
    prop._addConstant("l3IngrPktsPartAdmitLast", "mpls-vrf-ingress-admit-packets-current-value", 58876)
    prop._addConstant("l3IngrPktsPartAdmitMax", "mpls-vrf-ingress-admit-packets-maximum-value", 58881)
    prop._addConstant("l3IngrPktsPartAdmitMin", "mpls-vrf-ingress-admit-packets-minimum-value", 58880)
    prop._addConstant("l3IngrPktsPartAdmitPer", "mpls-vrf-ingress-admit-packets-periodic", 58879)
    prop._addConstant("l3IngrPktsPartAdmitRate", "mpls-vrf-ingress-admit-packets-rate", 58887)
    prop._addConstant("l3IngrPktsPartAdmitTr", "mpls-vrf-ingress-admit-packets-trend", 58886)
    prop._addConstant("l3IngrPktsPartDropAvg", "mpls-vrf-ingress-drop-packets-average-value", 58916)
    prop._addConstant("l3IngrPktsPartDropCum", "mpls-vrf-ingress-drop-packets-cumulative", 58912)
    prop._addConstant("l3IngrPktsPartDropLast", "mpls-vrf-ingress-drop-packets-current-value", 58910)
    prop._addConstant("l3IngrPktsPartDropMax", "mpls-vrf-ingress-drop-packets-maximum-value", 58915)
    prop._addConstant("l3IngrPktsPartDropMin", "mpls-vrf-ingress-drop-packets-minimum-value", 58914)
    prop._addConstant("l3IngrPktsPartDropPer", "mpls-vrf-ingress-drop-packets-periodic", 58913)
    prop._addConstant("l3IngrPktsPartDropRate", "mpls-vrf-ingress-drop-packets-rate", 58921)
    prop._addConstant("l3IngrPktsPartDropTr", "mpls-vrf-ingress-drop-packets-trend", 58920)
    prop._addConstant("l3MplsEgrBytesAdmitAvg", "mpls-egress-admit-bytes-average-value", 57743)
    prop._addConstant("l3MplsEgrBytesAdmitCum", "mpls-egress-admit-bytes-cumulative", 57739)
    prop._addConstant("l3MplsEgrBytesAdmitLast", "mpls-egress-admit-bytes-current-value", 57737)
    prop._addConstant("l3MplsEgrBytesAdmitMax", "mpls-egress-admit-bytes-maximum-value", 57742)
    prop._addConstant("l3MplsEgrBytesAdmitMin", "mpls-egress-admit-bytes-minimum-value", 57741)
    prop._addConstant("l3MplsEgrBytesAdmitPer", "mpls-egress-admit-bytes-periodic", 57740)
    prop._addConstant("l3MplsEgrBytesAdmitRate", "mpls-egress-admit-bytes-rate", 57748)
    prop._addConstant("l3MplsEgrBytesAdmitTr", "mpls-egress-admit-bytes-trend", 57747)
    prop._addConstant("l3MplsEgrBytesAgAdmitCum", "mpls-egress-admit-bytes-cumulative", 59984)
    prop._addConstant("l3MplsEgrBytesAgAdmitPer", "mpls-egress-admit-bytes-periodic", 59985)
    prop._addConstant("l3MplsEgrBytesAgAdmitRate", "mpls-egress-admit-bytes-rate", 59990)
    prop._addConstant("l3MplsEgrBytesAgAdmitTr", "mpls-egress-admit-bytes-trend", 59989)
    prop._addConstant("l3MplsEgrBytesAgDropCum", "mpls-egress-drop-bytes-cumulative", 60018)
    prop._addConstant("l3MplsEgrBytesAgDropPer", "mpls-egress-drop-bytes-periodic", 60019)
    prop._addConstant("l3MplsEgrBytesAgDropRate", "mpls-egress-drop-bytes-rate", 60024)
    prop._addConstant("l3MplsEgrBytesAgDropTr", "mpls-egress-drop-bytes-trend", 60023)
    prop._addConstant("l3MplsEgrBytesDropAvg", "mpls-egress-drop-bytes-average-value", 57764)
    prop._addConstant("l3MplsEgrBytesDropCum", "mpls-egress-drop-bytes-cumulative", 57760)
    prop._addConstant("l3MplsEgrBytesDropLast", "mpls-egress-drop-bytes-current-value", 57758)
    prop._addConstant("l3MplsEgrBytesDropMax", "mpls-egress-drop-bytes-maximum-value", 57763)
    prop._addConstant("l3MplsEgrBytesDropMin", "mpls-egress-drop-bytes-minimum-value", 57762)
    prop._addConstant("l3MplsEgrBytesDropPer", "mpls-egress-drop-bytes-periodic", 57761)
    prop._addConstant("l3MplsEgrBytesDropRate", "mpls-egress-drop-bytes-rate", 57769)
    prop._addConstant("l3MplsEgrBytesDropTr", "mpls-egress-drop-bytes-trend", 57768)
    prop._addConstant("l3MplsEgrBytesPartAdmitAvg", "mpls-egress-admit-bytes-average-value", 59969)
    prop._addConstant("l3MplsEgrBytesPartAdmitCum", "mpls-egress-admit-bytes-cumulative", 59965)
    prop._addConstant("l3MplsEgrBytesPartAdmitLast", "mpls-egress-admit-bytes-current-value", 59963)
    prop._addConstant("l3MplsEgrBytesPartAdmitMax", "mpls-egress-admit-bytes-maximum-value", 59968)
    prop._addConstant("l3MplsEgrBytesPartAdmitMin", "mpls-egress-admit-bytes-minimum-value", 59967)
    prop._addConstant("l3MplsEgrBytesPartAdmitPer", "mpls-egress-admit-bytes-periodic", 59966)
    prop._addConstant("l3MplsEgrBytesPartAdmitRate", "mpls-egress-admit-bytes-rate", 59974)
    prop._addConstant("l3MplsEgrBytesPartAdmitTr", "mpls-egress-admit-bytes-trend", 59973)
    prop._addConstant("l3MplsEgrBytesPartDropAvg", "mpls-egress-drop-bytes-average-value", 60003)
    prop._addConstant("l3MplsEgrBytesPartDropCum", "mpls-egress-drop-bytes-cumulative", 59999)
    prop._addConstant("l3MplsEgrBytesPartDropLast", "mpls-egress-drop-bytes-current-value", 59997)
    prop._addConstant("l3MplsEgrBytesPartDropMax", "mpls-egress-drop-bytes-maximum-value", 60002)
    prop._addConstant("l3MplsEgrBytesPartDropMin", "mpls-egress-drop-bytes-minimum-value", 60001)
    prop._addConstant("l3MplsEgrBytesPartDropPer", "mpls-egress-drop-bytes-periodic", 60000)
    prop._addConstant("l3MplsEgrBytesPartDropRate", "mpls-egress-drop-bytes-rate", 60008)
    prop._addConstant("l3MplsEgrBytesPartDropTr", "mpls-egress-drop-bytes-trend", 60007)
    prop._addConstant("l3MplsEgrPktsAdmitAvg", "mpls-egress-admit-packets-average-value", 57785)
    prop._addConstant("l3MplsEgrPktsAdmitCum", "mpls-egress-admit-packets-cumulative", 57781)
    prop._addConstant("l3MplsEgrPktsAdmitLast", "mpls-egress-admit-packets-current-value", 57779)
    prop._addConstant("l3MplsEgrPktsAdmitMax", "mpls-egress-admit-packets-maximum-value", 57784)
    prop._addConstant("l3MplsEgrPktsAdmitMin", "mpls-egress-admit-packets-minimum-value", 57783)
    prop._addConstant("l3MplsEgrPktsAdmitPer", "mpls-egress-admit-packets-periodic", 57782)
    prop._addConstant("l3MplsEgrPktsAdmitRate", "mpls-egress-admit-packets-rate", 57790)
    prop._addConstant("l3MplsEgrPktsAdmitTr", "mpls-egress-admit-packets-trend", 57789)
    prop._addConstant("l3MplsEgrPktsAgAdmitCum", "mpls-egress-admit-packets-cumulative", 60052)
    prop._addConstant("l3MplsEgrPktsAgAdmitPer", "mpls-egress-admit-packets-periodic", 60053)
    prop._addConstant("l3MplsEgrPktsAgAdmitRate", "mpls-egress-admit-packets-rate", 60058)
    prop._addConstant("l3MplsEgrPktsAgAdmitTr", "mpls-egress-admit-packets-trend", 60057)
    prop._addConstant("l3MplsEgrPktsAgDropCum", "mpls-egress-drop-packets-cumulative", 60086)
    prop._addConstant("l3MplsEgrPktsAgDropPer", "mpls-egress-drop-packets-periodic", 60087)
    prop._addConstant("l3MplsEgrPktsAgDropRate", "mpls-egress-drop-packets-rate", 60092)
    prop._addConstant("l3MplsEgrPktsAgDropTr", "mpls-egress-drop-packets-trend", 60091)
    prop._addConstant("l3MplsEgrPktsDropAvg", "mpls-egress-drop-packets-average-value", 57806)
    prop._addConstant("l3MplsEgrPktsDropCum", "mpls-egress-drop-packets-cumulative", 57802)
    prop._addConstant("l3MplsEgrPktsDropLast", "mpls-egress-drop-packets-current-value", 57800)
    prop._addConstant("l3MplsEgrPktsDropMax", "mpls-egress-drop-packets-maximum-value", 57805)
    prop._addConstant("l3MplsEgrPktsDropMin", "mpls-egress-drop-packets-minimum-value", 57804)
    prop._addConstant("l3MplsEgrPktsDropPer", "mpls-egress-drop-packets-periodic", 57803)
    prop._addConstant("l3MplsEgrPktsDropRate", "mpls-egress-drop-packets-rate", 57811)
    prop._addConstant("l3MplsEgrPktsDropTr", "mpls-egress-drop-packets-trend", 57810)
    prop._addConstant("l3MplsEgrPktsPartAdmitAvg", "mpls-egress-admit-packets-average-value", 60037)
    prop._addConstant("l3MplsEgrPktsPartAdmitCum", "mpls-egress-admit-packets-cumulative", 60033)
    prop._addConstant("l3MplsEgrPktsPartAdmitLast", "mpls-egress-admit-packets-current-value", 60031)
    prop._addConstant("l3MplsEgrPktsPartAdmitMax", "mpls-egress-admit-packets-maximum-value", 60036)
    prop._addConstant("l3MplsEgrPktsPartAdmitMin", "mpls-egress-admit-packets-minimum-value", 60035)
    prop._addConstant("l3MplsEgrPktsPartAdmitPer", "mpls-egress-admit-packets-periodic", 60034)
    prop._addConstant("l3MplsEgrPktsPartAdmitRate", "mpls-egress-admit-packets-rate", 60042)
    prop._addConstant("l3MplsEgrPktsPartAdmitTr", "mpls-egress-admit-packets-trend", 60041)
    prop._addConstant("l3MplsEgrPktsPartDropAvg", "mpls-egress-drop-packets-average-value", 60071)
    prop._addConstant("l3MplsEgrPktsPartDropCum", "mpls-egress-drop-packets-cumulative", 60067)
    prop._addConstant("l3MplsEgrPktsPartDropLast", "mpls-egress-drop-packets-current-value", 60065)
    prop._addConstant("l3MplsEgrPktsPartDropMax", "mpls-egress-drop-packets-maximum-value", 60070)
    prop._addConstant("l3MplsEgrPktsPartDropMin", "mpls-egress-drop-packets-minimum-value", 60069)
    prop._addConstant("l3MplsEgrPktsPartDropPer", "mpls-egress-drop-packets-periodic", 60068)
    prop._addConstant("l3MplsEgrPktsPartDropRate", "mpls-egress-drop-packets-rate", 60076)
    prop._addConstant("l3MplsEgrPktsPartDropTr", "mpls-egress-drop-packets-trend", 60075)
    prop._addConstant("l3MplsIngrBytesAdmitAvg", "mpls-ingress-admit-bytes-average-value", 57827)
    prop._addConstant("l3MplsIngrBytesAdmitCum", "mpls-ingress-admit-bytes-cumulative", 57823)
    prop._addConstant("l3MplsIngrBytesAdmitLast", "mpls-ingress-admit-bytes-current-value", 57821)
    prop._addConstant("l3MplsIngrBytesAdmitMax", "mpls-ingress-admit-bytes-maximum-value", 57826)
    prop._addConstant("l3MplsIngrBytesAdmitMin", "mpls-ingress-admit-bytes-minimum-value", 57825)
    prop._addConstant("l3MplsIngrBytesAdmitPer", "mpls-ingress-admit-bytes-periodic", 57824)
    prop._addConstant("l3MplsIngrBytesAdmitRate", "mpls-ingress-admit-bytes-rate", 57832)
    prop._addConstant("l3MplsIngrBytesAdmitTr", "mpls-ingress-admit-bytes-trend", 57831)
    prop._addConstant("l3MplsIngrBytesAgAdmitCum", "mpls-ingress-admit-bytes-cumulative", 60120)
    prop._addConstant("l3MplsIngrBytesAgAdmitPer", "mpls-ingress-admit-bytes-periodic", 60121)
    prop._addConstant("l3MplsIngrBytesAgAdmitRate", "mpls-ingress-admit-bytes-rate", 60126)
    prop._addConstant("l3MplsIngrBytesAgAdmitTr", "mpls-ingress-admit-bytes-trend", 60125)
    prop._addConstant("l3MplsIngrBytesAgDropCum", "mpls-ingress-drop-bytes-cumulative", 60154)
    prop._addConstant("l3MplsIngrBytesAgDropPer", "mpls-ingress-drop-bytes-periodic", 60155)
    prop._addConstant("l3MplsIngrBytesAgDropRate", "mpls-ingress-drop-bytes-rate", 60160)
    prop._addConstant("l3MplsIngrBytesAgDropTr", "mpls-ingress-drop-bytes-trend", 60159)
    prop._addConstant("l3MplsIngrBytesDropAvg", "mpls-ingress-drop-bytes-average-value", 57848)
    prop._addConstant("l3MplsIngrBytesDropCum", "mpls-ingress-drop-bytes-cumulative", 57844)
    prop._addConstant("l3MplsIngrBytesDropLast", "mpls-ingress-drop-bytes-current-value", 57842)
    prop._addConstant("l3MplsIngrBytesDropMax", "mpls-ingress-drop-bytes-maximum-value", 57847)
    prop._addConstant("l3MplsIngrBytesDropMin", "mpls-ingress-drop-bytes-minimum-value", 57846)
    prop._addConstant("l3MplsIngrBytesDropPer", "mpls-ingress-drop-bytes-periodic", 57845)
    prop._addConstant("l3MplsIngrBytesDropRate", "mpls-ingress-drop-bytes-rate", 57853)
    prop._addConstant("l3MplsIngrBytesDropTr", "mpls-ingress-drop-bytes-trend", 57852)
    prop._addConstant("l3MplsIngrBytesPartAdmitAvg", "mpls-ingress-admit-bytes-average-value", 60105)
    prop._addConstant("l3MplsIngrBytesPartAdmitCum", "mpls-ingress-admit-bytes-cumulative", 60101)
    prop._addConstant("l3MplsIngrBytesPartAdmitLast", "mpls-ingress-admit-bytes-current-value", 60099)
    prop._addConstant("l3MplsIngrBytesPartAdmitMax", "mpls-ingress-admit-bytes-maximum-value", 60104)
    prop._addConstant("l3MplsIngrBytesPartAdmitMin", "mpls-ingress-admit-bytes-minimum-value", 60103)
    prop._addConstant("l3MplsIngrBytesPartAdmitPer", "mpls-ingress-admit-bytes-periodic", 60102)
    prop._addConstant("l3MplsIngrBytesPartAdmitRate", "mpls-ingress-admit-bytes-rate", 60110)
    prop._addConstant("l3MplsIngrBytesPartAdmitTr", "mpls-ingress-admit-bytes-trend", 60109)
    prop._addConstant("l3MplsIngrBytesPartDropAvg", "mpls-ingress-drop-bytes-average-value", 60139)
    prop._addConstant("l3MplsIngrBytesPartDropCum", "mpls-ingress-drop-bytes-cumulative", 60135)
    prop._addConstant("l3MplsIngrBytesPartDropLast", "mpls-ingress-drop-bytes-current-value", 60133)
    prop._addConstant("l3MplsIngrBytesPartDropMax", "mpls-ingress-drop-bytes-maximum-value", 60138)
    prop._addConstant("l3MplsIngrBytesPartDropMin", "mpls-ingress-drop-bytes-minimum-value", 60137)
    prop._addConstant("l3MplsIngrBytesPartDropPer", "mpls-ingress-drop-bytes-periodic", 60136)
    prop._addConstant("l3MplsIngrBytesPartDropRate", "mpls-ingress-drop-bytes-rate", 60144)
    prop._addConstant("l3MplsIngrBytesPartDropTr", "mpls-ingress-drop-bytes-trend", 60143)
    prop._addConstant("l3MplsIngrPktsAdmitAvg", "mpls-ingress-admit-packets-average-value", 57869)
    prop._addConstant("l3MplsIngrPktsAdmitCum", "mpls-ingress-admit-packets-cumulative", 57865)
    prop._addConstant("l3MplsIngrPktsAdmitLast", "mpls-ingress-admit-packets-current-value", 57863)
    prop._addConstant("l3MplsIngrPktsAdmitMax", "mpls-ingress-admit-packets-maximum-value", 57868)
    prop._addConstant("l3MplsIngrPktsAdmitMin", "mpls-ingress-admit-packets-minimum-value", 57867)
    prop._addConstant("l3MplsIngrPktsAdmitPer", "mpls-ingress-admit-packets-periodic", 57866)
    prop._addConstant("l3MplsIngrPktsAdmitRate", "mpls-ingress-admit-packets-rate", 57874)
    prop._addConstant("l3MplsIngrPktsAdmitTr", "mpls-ingress-admit-packets-trend", 57873)
    prop._addConstant("l3MplsIngrPktsAgAdmitCum", "mpls-ingress-admit-packets-cumulative", 60188)
    prop._addConstant("l3MplsIngrPktsAgAdmitPer", "mpls-ingress-admit-packets-periodic", 60189)
    prop._addConstant("l3MplsIngrPktsAgAdmitRate", "mpls-ingress-admit-packets-rate", 60194)
    prop._addConstant("l3MplsIngrPktsAgAdmitTr", "mpls-ingress-admit-packets-trend", 60193)
    prop._addConstant("l3MplsIngrPktsAgDropCum", "mpls-ingress-drop-packets-cumulative", 60222)
    prop._addConstant("l3MplsIngrPktsAgDropPer", "mpls-ingress-drop-packets-periodic", 60223)
    prop._addConstant("l3MplsIngrPktsAgDropRate", "mpls-ingress-drop-packets-rate", 60228)
    prop._addConstant("l3MplsIngrPktsAgDropTr", "mpls-ingress-drop-packets-trend", 60227)
    prop._addConstant("l3MplsIngrPktsDropAvg", "mpls-ingress-drop-packets-average-value", 57890)
    prop._addConstant("l3MplsIngrPktsDropCum", "mpls-ingress-drop-packets-cumulative", 57886)
    prop._addConstant("l3MplsIngrPktsDropLast", "mpls-ingress-drop-packets-current-value", 57884)
    prop._addConstant("l3MplsIngrPktsDropMax", "mpls-ingress-drop-packets-maximum-value", 57889)
    prop._addConstant("l3MplsIngrPktsDropMin", "mpls-ingress-drop-packets-minimum-value", 57888)
    prop._addConstant("l3MplsIngrPktsDropPer", "mpls-ingress-drop-packets-periodic", 57887)
    prop._addConstant("l3MplsIngrPktsDropRate", "mpls-ingress-drop-packets-rate", 57895)
    prop._addConstant("l3MplsIngrPktsDropTr", "mpls-ingress-drop-packets-trend", 57894)
    prop._addConstant("l3MplsIngrPktsPartAdmitAvg", "mpls-ingress-admit-packets-average-value", 60173)
    prop._addConstant("l3MplsIngrPktsPartAdmitCum", "mpls-ingress-admit-packets-cumulative", 60169)
    prop._addConstant("l3MplsIngrPktsPartAdmitLast", "mpls-ingress-admit-packets-current-value", 60167)
    prop._addConstant("l3MplsIngrPktsPartAdmitMax", "mpls-ingress-admit-packets-maximum-value", 60172)
    prop._addConstant("l3MplsIngrPktsPartAdmitMin", "mpls-ingress-admit-packets-minimum-value", 60171)
    prop._addConstant("l3MplsIngrPktsPartAdmitPer", "mpls-ingress-admit-packets-periodic", 60170)
    prop._addConstant("l3MplsIngrPktsPartAdmitRate", "mpls-ingress-admit-packets-rate", 60178)
    prop._addConstant("l3MplsIngrPktsPartAdmitTr", "mpls-ingress-admit-packets-trend", 60177)
    prop._addConstant("l3MplsIngrPktsPartDropAvg", "mpls-ingress-drop-packets-average-value", 60207)
    prop._addConstant("l3MplsIngrPktsPartDropCum", "mpls-ingress-drop-packets-cumulative", 60203)
    prop._addConstant("l3MplsIngrPktsPartDropLast", "mpls-ingress-drop-packets-current-value", 60201)
    prop._addConstant("l3MplsIngrPktsPartDropMax", "mpls-ingress-drop-packets-maximum-value", 60206)
    prop._addConstant("l3MplsIngrPktsPartDropMin", "mpls-ingress-drop-packets-minimum-value", 60205)
    prop._addConstant("l3MplsIngrPktsPartDropPer", "mpls-ingress-drop-packets-periodic", 60204)
    prop._addConstant("l3MplsIngrPktsPartDropRate", "mpls-ingress-drop-packets-rate", 60212)
    prop._addConstant("l3MplsIngrPktsPartDropTr", "mpls-ingress-drop-packets-trend", 60211)
    ...
    prop._addConstant("opflexIDEpRxDropPktsIdsDropAvg", "received-malformed-dropped-packets-average-value", 60704)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropCum", "received-malformed-dropped-packets-cumulative", 60700)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropLast", "received-malformed-dropped-packets-current-value", 60698)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropMax", "received-malformed-dropped-packets-maximum-value", 60703)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropMin", "received-malformed-dropped-packets-minimum-value", 60702)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropPer", "received-malformed-dropped-packets-periodic", 60701)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropRate", "received-malformed-dropped-packets-rate", 60709)
    prop._addConstant("opflexIDEpRxDropPktsIdsDropTr", "received-malformed-dropped-packets-trend", 60708)
    ...
    prop._addConstant("opflexIDEpTxDropPktsIdsDropAvg", "transmitted-malformed-dropped-packets-average-value", 60725)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropCum", "transmitted-malformed-dropped-packets-cumulative", 60721)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropLast", "transmitted-malformed-dropped-packets-current-value", 60719)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropMax", "transmitted-malformed-dropped-packets-maximum-value", 60724)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropMin", "transmitted-malformed-dropped-packets-minimum-value", 60723)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropPer", "transmitted-malformed-dropped-packets-periodic", 60722)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropRate", "transmitted-malformed-dropped-packets-rate", 60730)
    prop._addConstant("opflexIDEpTxDropPktsIdsDropTr", "transmitted-malformed-dropped-packets-trend", 60729)
    ...
    prop._addConstant("procMemoryUsageFreeAvg", "free-memory-average-value", 69926)
    prop._addConstant("procMemoryUsageFreeLast", "free-memory-current-value", 69923)
    prop._addConstant("procMemoryUsageFreeMax", "free-memory-maximum-value", 69925)
    prop._addConstant("procMemoryUsageFreeMin", "free-memory-minimum-value", 69924)
    prop._addConstant("procMemoryUsageFreeTr", "free-memory-trend", 69931)
    prop._addConstant("procMemoryUsagePercUsedMemoryAvg", "percentage-of-memory-used-average-value", 69941)
    prop._addConstant("procMemoryUsagePercUsedMemoryLast", "percentage-of-memory-used-current-value", 69938)
    prop._addConstant("procMemoryUsagePercUsedMemoryMax", "percentage-of-memory-used-maximum-value", 69940)
    prop._addConstant("procMemoryUsagePercUsedMemoryMin", "percentage-of-memory-used-minimum-value", 69939)
    prop._addConstant("procMemoryUsagePercUsedMemoryTr", "percentage-of-memory-used-trend", 69946)
    prop._addConstant("procMemoryUsageTotalAvg", "total-memory-average-value", 69956)
    prop._addConstant("procMemoryUsageTotalLast", "total-memory-current-value", 69953)
    prop._addConstant("procMemoryUsageTotalMax", "total-memory-maximum-value", 69955)
    prop._addConstant("procMemoryUsageTotalMin", "total-memory-minimum-value", 69954)
    prop._addConstant("procMemoryUsageTotalTr", "total-memory-trend", 69961)
    prop._addConstant("procMemoryUsageUsedAvg", "used-memory-average-value", 69971)
    prop._addConstant("procMemoryUsageUsedLast", "used-memory-current-value", 69968)
    prop._addConstant("procMemoryUsageUsedMax", "used-memory-maximum-value", 69970)
    prop._addConstant("procMemoryUsageUsedMin", "used-memory-minimum-value", 69969)
    prop._addConstant("procMemoryUsageUsedTr", "used-memory-trend", 69976)
    ...
    prop._addConstant("procSysMemPercUsedMemoryAvg", "percentage-of-memory-used-average-value", 69986)
    prop._addConstant("procSysMemPercUsedMemoryLast", "percentage-of-memory-used-current-value", 69983)
    prop._addConstant("procSysMemPercUsedMemoryMax", "percentage-of-memory-used-maximum-value", 69985)
    prop._addConstant("procSysMemPercUsedMemoryMin", "percentage-of-memory-used-minimum-value", 69984)
    prop._addConstant("procSysMemPercUsedMemoryTr", "percentage-of-memory-used-trend", 69991)
    ...
    prop._addConstant("tunnelEgrTepCntrsAgDropBytesCum", "drop-bytes-cumulative", 59073)
    prop._addConstant("tunnelEgrTepCntrsAgDropBytesPer", "drop-bytes-periodic", 59074)
    prop._addConstant("tunnelEgrTepCntrsAgDropBytesRate", "drop-bytes-rate", 59079)
    prop._addConstant("tunnelEgrTepCntrsAgDropBytesTr", "drop-bytes-trend", 59078)
    prop._addConstant("tunnelEgrTepCntrsAgDropPktsCum", "drop-packets-cumulative", 59086)
    prop._addConstant("tunnelEgrTepCntrsAgDropPktsPer", "drop-packets-periodic", 59087)
    prop._addConstant("tunnelEgrTepCntrsAgDropPktsRate", "drop-packets-rate", 59092)
    prop._addConstant("tunnelEgrTepCntrsAgDropPktsTr", "drop-packets-trend", 59091)
    prop._addConstant("tunnelEgrTepCntrsAgFwdBytesCum", "forwarded-bytes-cumulative", 59099)
    prop._addConstant("tunnelEgrTepCntrsAgFwdBytesPer", "forwarded-bytes-periodic", 59100)
    prop._addConstant("tunnelEgrTepCntrsAgFwdBytesRate", "forwarded-bytes-rate", 59105)
    prop._addConstant("tunnelEgrTepCntrsAgFwdBytesTr", "forwarded-bytes-trend", 59104)
    prop._addConstant("tunnelEgrTepCntrsAgFwdPktsCum", "forwarded-packets-cumulative", 59112)
    prop._addConstant("tunnelEgrTepCntrsAgFwdPktsPer", "forwarded-packets-periodic", 59113)
    prop._addConstant("tunnelEgrTepCntrsAgFwdPktsRate", "forwarded-packets-rate", 59118)
    prop._addConstant("tunnelEgrTepCntrsAgFwdPktsTr", "forwarded-packets-trend", 59117)
    ...
    prop._addConstant("tunnelIngrTepCntrsAgDropBytesCum", "drop-bytes-cumulative", 59125)
    prop._addConstant("tunnelIngrTepCntrsAgDropBytesPer", "drop-bytes-periodic", 59126)
    prop._addConstant("tunnelIngrTepCntrsAgDropBytesRate", "drop-bytes-rate", 59131)
    prop._addConstant("tunnelIngrTepCntrsAgDropBytesTr", "drop-bytes-trend", 59130)
    prop._addConstant("tunnelIngrTepCntrsAgDropPktsCum", "drop-packets-cumulative", 59138)
    prop._addConstant("tunnelIngrTepCntrsAgDropPktsPer", "drop-packets-periodic", 59139)
    prop._addConstant("tunnelIngrTepCntrsAgDropPktsRate", "drop-packets-rate", 59144)
    prop._addConstant("tunnelIngrTepCntrsAgDropPktsTr", "drop-packets-trend", 59143)
    prop._addConstant("tunnelIngrTepCntrsAgFwdBytesCum", "forwarded-bytes-cumulative", 59151)
    prop._addConstant("tunnelIngrTepCntrsAgFwdBytesPer", "forwarded-bytes-periodic", 59152)
    prop._addConstant("tunnelIngrTepCntrsAgFwdBytesRate", "forwarded-bytes-rate", 59157)
    prop._addConstant("tunnelIngrTepCntrsAgFwdBytesTr", "forwarded-bytes-trend", 59156)
    prop._addConstant("tunnelIngrTepCntrsAgFwdPktsCum", "forwarded-packets-cumulative", 59164)
    prop._addConstant("tunnelIngrTepCntrsAgFwdPktsPer", "forwarded-packets-periodic", 59165)
    prop._addConstant("tunnelIngrTepCntrsAgFwdPktsRate", "forwarded-packets-rate", 59170)
    prop._addConstant("tunnelIngrTepCntrsAgFwdPktsTr", "forwarded-packets-trend", 59169)
    ...
    prop._addConstant("uribv4EgrBytesAdmitAvg", "l3-lsp-egress-admit-bytes-average-value", 59320)
    prop._addConstant("uribv4EgrBytesAdmitCum", "l3-lsp-egress-admit-bytes-cumulative", 59316)
    prop._addConstant("uribv4EgrBytesAdmitLast", "l3-lsp-egress-admit-bytes-current-value", 59314)
    prop._addConstant("uribv4EgrBytesAdmitMax", "l3-lsp-egress-admit-bytes-maximum-value", 59319)
    prop._addConstant("uribv4EgrBytesAdmitMin", "l3-lsp-egress-admit-bytes-minimum-value", 59318)
    prop._addConstant("uribv4EgrBytesAdmitPer", "l3-lsp-egress-admit-bytes-periodic", 59317)
    prop._addConstant("uribv4EgrBytesAdmitRate", "l3-lsp-egress-admit-bytes-rate", 59325)
    prop._addConstant("uribv4EgrBytesAdmitTr", "l3-lsp-egress-admit-bytes-trend", 59324)
    prop._addConstant("uribv4EgrBytesAgAdmitCum", "l3-lsp-egress-admit-bytes-cumulative", 59356)
    prop._addConstant("uribv4EgrBytesAgAdmitPer", "l3-lsp-egress-admit-bytes-periodic", 59357)
    prop._addConstant("uribv4EgrBytesAgAdmitRate", "l3-lsp-egress-admit-bytes-rate", 59362)
    prop._addConstant("uribv4EgrBytesAgAdmitTr", "l3-lsp-egress-admit-bytes-trend", 59361)
    prop._addConstant("uribv4EgrBytesAgDropCum", "l3-lsp-egress-drop-bytes-cumulative", 59411)
    prop._addConstant("uribv4EgrBytesAgDropPer", "l3-lsp-egress-drop-bytes-periodic", 59412)
    prop._addConstant("uribv4EgrBytesAgDropRate", "l3-lsp-egress-drop-bytes-rate", 59417)
    prop._addConstant("uribv4EgrBytesAgDropTr", "l3-lsp-egress-drop-bytes-trend", 59416)
    prop._addConstant("uribv4EgrBytesDropAvg", "l3-lsp-egress-drop-bytes-average-value", 59375)
    prop._addConstant("uribv4EgrBytesDropCum", "l3-lsp-egress-drop-bytes-cumulative", 59371)
    prop._addConstant("uribv4EgrBytesDropLast", "l3-lsp-egress-drop-bytes-current-value", 59369)
    prop._addConstant("uribv4EgrBytesDropMax", "l3-lsp-egress-drop-bytes-maximum-value", 59374)
    prop._addConstant("uribv4EgrBytesDropMin", "l3-lsp-egress-drop-bytes-minimum-value", 59373)
    prop._addConstant("uribv4EgrBytesDropPer", "l3-lsp-egress-drop-bytes-periodic", 59372)
    prop._addConstant("uribv4EgrBytesDropRate", "l3-lsp-egress-drop-bytes-rate", 59380)
    prop._addConstant("uribv4EgrBytesDropTr", "l3-lsp-egress-drop-bytes-trend", 59379)
    prop._addConstant("uribv4EgrPktsAdmitAvg", "l3-lsp-egress-admit-packets-average-value", 59430)
    prop._addConstant("uribv4EgrPktsAdmitCum", "l3-lsp-egress-admit-packets-cumulative", 59426)
    prop._addConstant("uribv4EgrPktsAdmitLast", "l3-lsp-egress-admit-packets-current-value", 59424)
    prop._addConstant("uribv4EgrPktsAdmitMax", "l3-lsp-egress-admit-packets-maximum-value", 59429)
    prop._addConstant("uribv4EgrPktsAdmitMin", "l3-lsp-egress-admit-packets-minimum-value", 59428)
    prop._addConstant("uribv4EgrPktsAdmitPer", "l3-lsp-egress-admit-packets-periodic", 59427)
    prop._addConstant("uribv4EgrPktsAdmitRate", "l3-lsp-egress-admit-packets-rate", 59435)
    prop._addConstant("uribv4EgrPktsAdmitTr", "l3-lsp-egress-admit-packets-trend", 59434)
    prop._addConstant("uribv4EgrPktsAgAdmitCum", "l3-lsp-egress-admit-packets-cumulative", 59466)
    prop._addConstant("uribv4EgrPktsAgAdmitPer", "l3-lsp-egress-admit-packets-periodic", 59467)
    prop._addConstant("uribv4EgrPktsAgAdmitRate", "l3-lsp-egress-admit-packets-rate", 59472)
    prop._addConstant("uribv4EgrPktsAgAdmitTr", "l3-lsp-egress-admit-packets-trend", 59471)
    prop._addConstant("uribv4EgrPktsAgDropCum", "l3-lsp-egress-drop-packets-cumulative", 59521)
    prop._addConstant("uribv4EgrPktsAgDropPer", "l3-lsp-egress-drop-packets-periodic", 59522)
    prop._addConstant("uribv4EgrPktsAgDropRate", "l3-lsp-egress-drop-packets-rate", 59527)
    prop._addConstant("uribv4EgrPktsAgDropTr", "l3-lsp-egress-drop-packets-trend", 59526)
    prop._addConstant("uribv4EgrPktsDropAvg", "l3-lsp-egress-drop-packets-average-value", 59485)
    prop._addConstant("uribv4EgrPktsDropCum", "l3-lsp-egress-drop-packets-cumulative", 59481)
    prop._addConstant("uribv4EgrPktsDropLast", "l3-lsp-egress-drop-packets-current-value", 59479)
    prop._addConstant("uribv4EgrPktsDropMax", "l3-lsp-egress-drop-packets-maximum-value", 59484)
    prop._addConstant("uribv4EgrPktsDropMin", "l3-lsp-egress-drop-packets-minimum-value", 59483)
    prop._addConstant("uribv4EgrPktsDropPer", "l3-lsp-egress-drop-packets-periodic", 59482)
    prop._addConstant("uribv4EgrPktsDropRate", "l3-lsp-egress-drop-packets-rate", 59490)
    prop._addConstant("uribv4EgrPktsDropTr", "l3-lsp-egress-drop-packets-trend", 59489)
