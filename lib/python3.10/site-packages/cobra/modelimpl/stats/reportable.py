...
class Reportable(Mo):
    ...
    prop._addConstant("cloudAzNLBStats", "azure-nlb-front-end-stats", 17913)
    prop._addConstant("cloudAzNLBStatsAg", "aggregated-azure-nlb-front-end-stats", 17931)
    ...
    prop._addConstant("cloudExtTraffic", "cloud-traffic-with-a-source/destination-external-to-provider", 19658)
    prop._addConstant("cloudExtTrafficAg", "aggregated-cloud-traffic-with-a-source/destination-external-to-provider", 19676)
    prop._addConstant("cloudHostRouter", "host-router-stats", 16509)
    ...
    prop._addConstant("cloudInterZnLatency", "cloud-inter-zone-latency", 19749)
    prop._addConstant("cloudIpTraffic", "cloud-traffic", 19586)
    prop._addConstant("cloudIpTrafficAg", "aggregated-cloud-traffic", 19604)
    ...
    prop._addConstant("cloudNLBStats", "nlb-front-end-stats", 17877)
    prop._addConstant("cloudNLBStatsAg", "aggregated-nlb-front-end-stats", 17895)
    prop._addConstant("cloudNwEgressBytes", "cloud-egress-bytes", 17203)
    prop._addConstant("cloudNwEgressBytesAg", "aggregated-cloud-egress-bytes", 17221)
    prop._addConstant("cloudNwEgressPkts", "cloud-egress-packets", 17167)
    prop._addConstant("cloudNwEgressPktsAg", "aggregated-cloud-egress-packets", 17185)
    prop._addConstant("cloudNwIngressBytes", "cloud-ingress-bytess", 17131)
    prop._addConstant("cloudNwIngressBytesAg", "aggregated-cloud-ingress-bytess", 17149)
    prop._addConstant("cloudNwIngressPkts", "cloud-ingress-packets", 17095)
    prop._addConstant("cloudNwIngressPktsAg", "aggregated-cloud-ingress-packets", 17113)
    ...
    prop._addConstant("cloudRgTraffic", "all-traffic-to/from-another-cloud-region", 19694)
    prop._addConstant("cloudRgTrafficAg", "aggregated-all-traffic-to/from-another-cloud-region", 19712)
    prop._addConstant("cloudZnLatency", "cloud-zone-latency-for-external-traffic", 19731)
    prop._addConstant("cloudZnTraffic", "cloud-inter-zone-traffic", 19622)
    prop._addConstant("cloudZnTrafficAg", "aggregated-cloud-inter-zone-traffic", 19640)
    ...
    prop._addConstant("dppIfCktAllow", "ifckt-ingress-data-plane-policer-allow-counters", 10575)
    prop._addConstant("dppIfCktAllowAg", "aggregated-ifckt-ingress-data-plane-policer-allow-counters", 10872)
    prop._addConstant("dppIfCktAllowPart", "part-of-ifckt-ingress-data-plane-policer-allow-counters", 10854)
    prop._addConstant("dppIfCktDrop", "ifckt-ingress-data-plane-policer-drop-counters", 10593)
    prop._addConstant("dppIfCktDropAg", "aggregated-ifckt-ingress-data-plane-policer-drop-counters", 10908)
    prop._addConstant("dppIfCktDropPart", "part-of-ifckt-ingress-data-plane-policer-drop-counters", 10890)
    ...
    prop._addConstant("eqptcapacityEstPGLabelEntry", "estimator-pg-label-entry", 16687)
    prop._addConstant("eqptcapacityEstPGLabelUsage", "pg-label-entries-usage-from-estimator", 16741)
    prop._addConstant("eqptcapacityEstPolEntry", "estimator-policy-entry", 16669)
    prop._addConstant("eqptcapacityEstPolOTCAMEntry", "policy-overflow-tcam-entry-from-policy-estimator", 16705)
    prop._addConstant("eqptcapacityEstPolOTCAMUsage", "policy-overflow-tcam-entries-usage-from-policy-estimator", 16759)
    prop._addConstant("eqptcapacityEstPolUsage", "policy-entries-usage-from-policy-estimator", 16723)
    ...
    prop._addConstant("eqptcapacityPrefixEntries", "prefix-(ipv4-and-ipv6)-entries", 6626)
    ...
    prop._addConstant("eqptcapacityRouterIpEntries", "router-ip-(ipv4-and-ipv6)-entries", 6761)
    ...
    prop._addConstant("eqptcapacityWideTcamPrefixEntries", "wide-tcam-prefix-ipv6-entries", 11276)
    ...
    prop._addConstant("infraReplicaPerfStats", "replicaperf", 18623)
    ...
    prop._addConstant("l3EgrBytes", "mpls-vrf-egress-bytes", 16990)
    prop._addConstant("l3EgrBytesAg", "aggregated-mpls-vrf-egress-bytes", 17449)
    prop._addConstant("l3EgrBytesPart", "part-of-mpls-vrf-egress-bytes", 17431)
    prop._addConstant("l3EgrPkts", "mpls-vrf-egress-packets", 16972)
    prop._addConstant("l3EgrPktsAg", "aggregated-mpls-vrf-egress-packets", 17413)
    prop._addConstant("l3EgrPktsPart", "part-of-mpls-vrf-egress-packets", 17395)
    prop._addConstant("l3IngrBytes", "mpls-vrf-ingress-bytes", 16954)
    prop._addConstant("l3IngrBytesAg", "aggregated-mpls-vrf-ingress-bytes", 17377)
    prop._addConstant("l3IngrBytesPart", "part-of-mpls-vrf-ingress-bytes", 17359)
    prop._addConstant("l3IngrPkts", "mpls-vrf-ingress-packets", 16936)
    prop._addConstant("l3IngrPktsAg", "aggregated-mpls-vrf-ingress-packets", 17341)
    prop._addConstant("l3IngrPktsPart", "part-of-mpls-vrf-ingress-packets", 17323)
    prop._addConstant("l3MplsEgrBytes", "mpls-egress-bytes", 17062)
    prop._addConstant("l3MplsEgrBytesAg", "aggregated-mpls-egress-bytes", 17859)
    prop._addConstant("l3MplsEgrBytesPart", "part-of-mpls-egress-bytes", 17841)
    prop._addConstant("l3MplsEgrPkts", "mpls-egress-packets", 17044)
    prop._addConstant("l3MplsEgrPktsAg", "aggregated-mpls-egress-packets", 17823)
    prop._addConstant("l3MplsEgrPktsPart", "part-of-mpls-egress-packets", 17805)
    prop._addConstant("l3MplsIngrBytes", "mpls-ingress-bytes", 17026)
    prop._addConstant("l3MplsIngrBytesAg", "aggregated-mpls-ingress-bytes", 17787)
    prop._addConstant("l3MplsIngrBytesPart", "part-of-mpls-ingress-bytes", 17769)
    prop._addConstant("l3MplsIngrPkts", "mpls-ingress-packets", 17008)
    prop._addConstant("l3MplsIngrPktsAg", "aggregated-mpls-ingress-packets", 17751)
    prop._addConstant("l3MplsIngrPktsPart", "part-of-mpls-ingress-packets", 17733)
    ...
    prop._addConstant("opflexIDEpRxDropPkts", "received-malformed-dropped-packets", 17985)
    prop._addConstant("opflexIDEpRxPkts", "received-packets", 1026)
    prop._addConstant("opflexIDEpTxBytes", "transmitted-bytes", 1083)
    prop._addConstant("opflexIDEpTxDropPkts", "transmitted-malformed-dropped-packets", 18003)
    ...
    prop._addConstant("procMemoryUsage", "system-memory", 20288)
    ...
    prop._addConstant("tunnelEgrTepCntrsAg", "aggregated-egress-tep-counters", 17512)
    prop._addConstant("tunnelIngrTepCntrs", "ingress-tep-counters", 13215)
    prop._addConstant("tunnelIngrTepCntrsAg", "aggregated-ingress-tep-counters", 17494)
    prop._addConstant("tunnelTunnelFlapCntrs", "tuennl-flap-counters", 13251)
    prop._addConstant("unspecified", None, 0)
    prop._addConstant("uribv4EgrBytes", "l3-lsp-egress-bytes", 17605)
    prop._addConstant("uribv4EgrBytesAg", "aggregated-l3-lsp-egress-bytes", 17641)
    prop._addConstant("uribv4EgrPkts", "l3-lsp-egress-packets", 17551)
    prop._addConstant("uribv4EgrPktsAg", "aggregated-l3-lsp-egress-packets", 17587)
