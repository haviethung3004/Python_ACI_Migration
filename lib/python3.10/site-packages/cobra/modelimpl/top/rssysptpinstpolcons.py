...
# ##################################################
class RsSysPtpInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysPtpInstPolCons", "cobra.model.ptp.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysPtpInstPolCons"
    meta.rnFormat = "rssysPtpInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "PTP Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63495, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63494, PropCategory.REGULAR)
