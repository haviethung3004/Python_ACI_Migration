...
# ##################################################
class RsSysUsbConfigProfilePolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysUsbConfigProfilePolCons", "cobra.model.topoctrl.UsbConfigProfilePol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysUsbConfigProfilePolCons"
    meta.rnFormat = "rssysUsbConfigProfilePolCons"
    ...
    meta.rnPrefixes = [
        ('rssysUsbConfigProfilePolCons', False),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 64572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 64571, PropCategory.REGULAR)
