...
# ##################################################
class RsSysSynceInstPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.top.RsSysSynceInstPolCons", "cobra.model.synce.InstPol")
    meta.cardinality = SourceRelationMeta.ONE_TO_ONE

    meta.moClassName = "topRsSysSynceInstPolCons"
    meta.rnFormat = "rssysSynceInstPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "syncE Instance Policy"
    ...
    prop = PropMeta("str", "tCl", "tCl", 63049, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 63048, PropCategory.REGULAR)
