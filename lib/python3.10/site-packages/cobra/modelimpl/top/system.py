...
class System(Mo):
    ...
    meta.childClasses.add("cobra.model.analytics.HwTelemetry")
    meta.childClasses.add("cobra.model.apphosting.AppHosting")
    meta.childClasses.add("cobra.model.apphosting.AppmgrStat")
    ...
    meta.childClasses.add("cobra.model.bgp.Tbgp")
    meta.childClasses.add("cobra.model.bgp.Tcbgp2")
    ...
    meta.childClasses.add("cobra.model.dmemotltest.DmeMotlRoot")
    ...
    meta.childClasses.add("cobra.model.fv.IfConnOper")
    meta.childClasses.add("cobra.model.fv.IfMtuOper")
    ...
    meta.childClasses.add("cobra.model.infrasec.Entity")
    ...
    meta.childClasses.add("cobra.model.l3.MixedModeCont")
    ...
    meta.childClasses.add("cobra.model.mpls.Entity")
    meta.childClasses.add("cobra.model.mrib.Entity")
    meta.childClasses.add("cobra.model.multidomain.InternalCtxInfo")
    meta.childClasses.add("cobra.model.multidomain.MultiDomainIps")
    meta.childClasses.add("cobra.model.multidomain.MultiDomainVnids")
    ...
    meta.childClasses.add("cobra.model.patching.Entity")
    ...
    meta.childClasses.add("cobra.model.pie.PIE")
    ...
    meta.childClasses.add("cobra.model.proc.Job")
    meta.childClasses.add("cobra.model.proc.Memory")
    meta.childClasses.add("cobra.model.proc.Platform")
    ...
    meta.childClasses.add("cobra.model.segrt.Entity")
    ...
    meta.childClasses.add("cobra.model.statspref.Cont")
    ...
    meta.childClasses.add("cobra.model.synce.Entity")
    ...
    meta.childClasses.add("cobra.model.top.RsSysPtpInstPolCons")
    meta.childClasses.add("cobra.model.top.RsSysSynceInstPolCons")
    meta.childClasses.add("cobra.model.top.RsSysUsbConfigProfilePolCons")
    ...
    meta.childClasses.add("cobra.model.usrtacacs.Record")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.top.RsSysUsbConfigProfilePolCons", "rssysUsbConfigProfilePolCons"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.top.RsSysSynceInstPolCons", "rssysSynceInstPolCons"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.top.RsSysPtpInstPolCons", "rssysPtpInstPolCons"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.multidomain.MultiDomainVnids", "MultiDomainVnids-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.multidomain.InternalCtxInfo", "mdpIntCtxInfo-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.multidomain.MultiDomainIps", "multiDomainIps"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.dmemotltest.DmeMotlRoot", "dme_motl_root"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fabric.SpineNodeRole", "SpineNodeRole"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3.MixedModeCont", "mixedModeCont"))
    meta.childNamesAndRnPrefix.append(("cobra.model.opflexp.ReportedEpReg", "reportedepreg"))
    meta.childNamesAndRnPrefix.append(("cobra.model.statspref.Cont", "statsprefcont"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.analytics.HwTelemetry", "hwtelemetry"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IfConnOper", "ifconnOper-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.apphosting.AppHosting", "apphosting"))
    meta.childNamesAndRnPrefix.append(("cobra.model.apphosting.AppmgrStat", "appmgrstat"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.Tcbgp2", "cbgp2trap"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.proc.Platform", "platform-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.usrtacacs.Record", "usrtacacs"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.infrasec.Entity", "infrasec"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.patching.Entity", "patching"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.Tbgp", "bgptrap"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.proc.Memory", "procmem"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.segrt.Entity", "segrt"))
    meta.childNamesAndRnPrefix.append(("cobra.model.span.RetryCont", "retry"))
    meta.childNamesAndRnPrefix.append(("cobra.model.synce.Entity", "synce"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.mpls.Entity", "mpls"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.proc.Job", "job-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.IfMtuOper", "If-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.pie.PIE", "pie"))
    ...
    prop.defaultValue = 0
    prop.defaultValueStr = "none"
    prop._addConstant("cimc-addr-set-failure", "cimc-addr-set-failure", 128)
    ...
    prop._addConstant("route-table-modify-fail", "route-table-modify-fail", 64)
    ...
    prop._addConstant("act2-authen-fail", "reset-due-to-act2-authentication-failure", 159)
    prop._addConstant("app-init-reload", "reload-initiated-by-application", 130)
    prop._addConstant("asic", "reset-performed-due-to-component-error", 22)
    prop._addConstant("asic-mem-err", "multiple-uncorrectable-asic-memory-errors-detected", 160)
    ...
    prop._addConstant("bios-boot-fail", "bios-boot-fail-and-bios-failed-to-set-bios-boot-timer", 169)
    prop._addConstant("bios-check-fail", "bios-secure-boot-check-fail", 170)
    ...
    prop._addConstant("buffer-stuck-reset", "buffer-stuck-reset", 163)
    ...
    prop._addConstant("cli-soft-reload", "reset-due-to-soft-reload-via-cli", 157)
    ...
    prop._addConstant("cold-reboot", "system-cold-rebooted", 180)
    prop._addConstant("cpu-caterr-signal", "cpu-caterr-signal-asserted", 131)
    prop._addConstant("cpu-crc-err", "cpu-processor-crc-error", 167)
    prop._addConstant("cpu-hot-err", "cpu-processor-hot-error", 166)
    prop._addConstant("cpu-thermal-dimm-err", "cpu-processor-thermal-dimm-error", 168)
    prop._addConstant("cpu-thermal-trip-err", "cpu-thermal-trip-error", 165)
    prop._addConstant("crash-soft-reload", "reset-due-to-soft-reload-via-crash", 156)
    prop._addConstant("decommissioned", "reloading-because-of-decommissioning-of-switch", 174)
    prop._addConstant("deep-sleep", "preparing-to-enter-deep-sleep-mode", 126)
    prop._addConstant("diag-fail", "reset-due-to-critical-failure-detected-by-online-diagnostic", 162)
    prop._addConstant("dme-reset", "dme-clean-config-reset", 150)
    ...
    prop._addConstant("enhanced-virtualization-disabled", "switch-mode-enhanced-virtualization-disabled", 143)
    prop._addConstant("enhanced-virtualization-enabled", "switch-mode-enhanced-virtualization-enabled", 142)
    prop._addConstant("eobc", "reset-triggered-due-to-bad-backplane-communication-channel", 25)
    prop._addConstant("epc-fail", "reset-triggered-due-to-bad-(epc)-packet-communication-channel", 146)
    ...
    prop._addConstant("fabric-mode", "powered-down-due-to-fabric-configured-in-frm-mode", 145)
    prop._addConstant("fan-airflow-err", "powered-down-due-to-fan-air-flow-policy-trigger", 151)
    prop._addConstant("fanlet-fail", "power-down-due-to-fanlet-failures", 177)
    prop._addConstant("fast-reload", "reset-due-to-fast-reload", 133)
    prop._addConstant("firmware-upgrade", "reload-due-to-firmware-upgrade", 140)
    ...
    prop._addConstant("hg-link-down", "reloaded-since-a-hg-link-went-down-on-this-lc", 137)
    ...
    prop._addConstant("interop-mode-change", "reload-due-to-interop-mode-change", 155)
    prop._addConstant("issu-restart", "reset-due-to-upgrade", 88)
    prop._addConstant("klm-fail", "klm-load-failure", 172)
    prop._addConstant("last-fc-remove", "reloading-linecard-on-removal-of-last-fabric-card", 173)
    prop._addConstant("last-sc-remove", "reloading-linecard-and-fabric-card-on-removal-of-last-sc", 176)
    prop._addConstant("lc-breakout", "reloaded-since-breakout-was-configured/deconfigured-on-the-lc", 136)
    ...
    prop._addConstant("maintenance-mode", "reset-due-to-switch-in-maintenance-mode", 182)
    ...
    prop._addConstant("mis-card-insert", "mismatch-fc/lc-card-insertion", 178)
    prop._addConstant("mo-sync-fail", "standby-reset-due-to-failure-on-large-mos-sync", 152)
    prop._addConstant("mod-authen-fail", "reset-(powered-down)-due-to-module-authentication-failure", 148)
    prop._addConstant("mod-authen-start-fail", "reset-(powered-down)-due-to-module-authentication-start-failure", 149)
    ...
    prop._addConstant("no-fm", "powered-down-due-to-absence-of-fabric-module", 135)
    prop._addConstant("no-fm-connect", "powered-down-due-to-no-connectivity-to-fabric-modules", 144)
    prop._addConstant("no-good-fan", "reloading-because-there-is-no-good-fan-present", 175)
    prop._addConstant("no-plugin", "plugin-absent/-not-loaded", 117)
    prop._addConstant("no-sc", "powered-down-due-to-absence-of-system-controller-module", 134)
    prop._addConstant("no-sup", "reset-due-to-no-sup", 92)
    prop._addConstant("non-disruptive-reload", "reload-due-to-non-disruptive-system-reload", 164)
    prop._addConstant("non-disruptive-upgrade", "reset-due-to-non-disruptive-upgrade", 153)
    prop._addConstant("outofservice", "out-of-service", 86)
    prop._addConstant("panic", "kernel-panic", 19)
    prop._addConstant("patch-install", "reset-due-to-patch-install", 132)
    ...
    prop._addConstant("power-err", "reset-due-to-power-error", 139)
    ...
    prop._addConstant("removed-from-controller", "reset-due-to-switch-removed-from-controller", 183)
    prop._addConstant("reset-no-boot-usb", "reset-due-to-no-boot-from-usb-policy", 184)
    prop._addConstant("serdes-firmware-fail", "reset-due-to-loading-serdes-firmware-failure", 161)
    prop._addConstant("sigkill-fail", "reset-triggered-due-to-failure-to-respond-to-sigkill", 34)
    prop._addConstant("slot-id-parity-err", "reset-due-to-fpga-slot-id-parity-error", 138)
    prop._addConstant("soft-reload-fail", "reset-due-to-soft-reload-attempt-failure", 158)
    prop._addConstant("sprom-upd", "reset-requested-due-to-sprom-update", 10)
    prop._addConstant("ssd-firmware-upgrade", "system-power-cycled-due-to-ssd-firmware-upgrade", 179)
    prop._addConstant("ssd-op-reload", "ssd-over-provisioning-reload", 181)
    ...
    prop._addConstant("tcam-change", "reload-due-to-change-in-tcam-service-template", 154)
    ...
    prop._addConstant("unsupp-dist-arbit-mode", "powered-down-since-linecard/spine/supervisor-does-not-support-distributed-arbitration-mode", 141)
    ...
    prop._addConstant("vdc-offline", "reset-(powered-down)-because-all-vdcs-for-module-need-to-be-online", 147)
    prop._addConstant("warm-reset", "reload-due-to-warm-reset", 171)
