...
# ##################################################
class RsPullRemoteCloudGatewayRouterPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteCloudGatewayRouterPDef", "cobra.model.cloud.GatewayRouterPDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteCloudGatewayRouterPDef"
    meta.rnFormat = "rspullRemoteCloudGatewayRouterPDef-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Cloud Gateway Router Profile Resolved data"
    ...
    meta.rnPrefixes = [
        ('rspullRemoteCloudGatewayRouterPDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 57261, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16829
    prop.defaultValueStr = "cloudGatewayRouterPDef"
    prop._addConstant("cloudGatewayRouterPDef", None, 16829)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 57260, PropCategory.REGULAR)
