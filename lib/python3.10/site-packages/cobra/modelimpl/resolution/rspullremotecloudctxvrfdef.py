...
# ##################################################
class RsPullRemoteCloudCtxVrfDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.resolution.RsPullRemoteCloudCtxVrfDef", "cobra.model.cloud.CtxProfileVrfDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "resolutionRsPullRemoteCloudCtxVrfDef"
    meta.rnFormat = "rspullRemoteCloudCtxVrfDef-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rspullRemoteCloudCtxVrfDef-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 61070, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 18093
    prop.defaultValueStr = "cloudCtxProfileVrfDef"
    prop._addConstant("cloudCtxProfileVrfDef", None, 18093)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 61069, PropCategory.REGULAR)
