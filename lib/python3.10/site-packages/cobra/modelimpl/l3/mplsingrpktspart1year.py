...
# ##################################################
class MplsIngrPktsPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart1year", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart1year"
    meta.rnFormat = "CDl3MplsIngrPktsPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDl3MplsIngrPktsPart1year-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59945, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
