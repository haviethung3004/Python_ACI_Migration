...
# ##################################################
class MplsEgrPktsPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart1h", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart1h"
    meta.rnFormat = "CDl3MplsEgrPktsPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59877, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
