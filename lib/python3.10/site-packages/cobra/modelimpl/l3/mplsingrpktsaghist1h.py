...
# ##################################################
class MplsIngrPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist1h", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist1h"
    meta.rnFormat = "HDl3MplsIngrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59933, PropCategory.REGULAR)
