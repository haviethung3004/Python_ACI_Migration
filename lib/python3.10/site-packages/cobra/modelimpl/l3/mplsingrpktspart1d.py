...
# ##################################################
class MplsIngrPktsPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart1d", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart1d"
    meta.rnFormat = "CDl3MplsIngrPktsPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59940, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
