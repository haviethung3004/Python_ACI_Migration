...
class IngrPktsAgHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist1w", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist1w"
    meta.rnFormat = "HDl3IngrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 58645, PropCategory.REGULAR)
