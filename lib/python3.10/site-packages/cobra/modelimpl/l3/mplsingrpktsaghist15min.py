...
# ##################################################
class MplsIngrPktsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist15min", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist15min"
    meta.rnFormat = "HDl3MplsIngrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3MplsIngrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59931, PropCategory.REGULAR)
