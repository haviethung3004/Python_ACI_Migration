...
class IngrBytesAgHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist15min", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist15min"
    meta.rnFormat = "HDl3IngrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.IngrBytesAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3IngrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 58608, PropCategory.REGULAR)
