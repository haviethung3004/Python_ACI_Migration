...
# ##################################################
class MplsIngrPktsPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart15min", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart15min"
    meta.rnFormat = "CDl3MplsIngrPktsPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrPktsPart")
    meta.superClasses.add("cobra.model.stats.CurrAgPart")

    meta.rnPrefixes = [
        ('CDl3MplsIngrPktsPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59939, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
