...
# ##################################################
class MplsIngrBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAg15min", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAg15min"
    meta.rnFormat = "CDl3MplsIngrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrBytesAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3MplsIngrBytesAg15min', False),
    ]
