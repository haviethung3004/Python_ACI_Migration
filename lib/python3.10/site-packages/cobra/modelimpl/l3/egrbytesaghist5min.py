...
class EgrBytesAgHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist5min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist5min"
    meta.rnFormat = "HDl3EgrBytesAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 58551, PropCategory.REGULAR)
