...
class EgrBytesHist(Mo):
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist"


    meta.moClassName = "l3EgrBytesHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats"
    ...
    prop = PropMeta("str", "admitAvg", "admitAvg", 57585, PropCategory.IMPLICIT_AVG)
    prop.label = "mpls vrf egress admit bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitAvg", prop)

    prop = PropMeta("str", "admitCum", "admitCum", 57581, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress admit bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitCum", prop)

    prop = PropMeta("str", "admitMax", "admitMax", 57584, PropCategory.IMPLICIT_MAX)
    prop.label = "mpls vrf egress admit bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMax", prop)

    prop = PropMeta("str", "admitMin", "admitMin", 57583, PropCategory.IMPLICIT_MIN)
    prop.label = "mpls vrf egress admit bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMin", prop)

    prop = PropMeta("str", "admitPer", "admitPer", 57582, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress admit bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitPer", prop)

    prop = PropMeta("str", "admitRate", "admitRate", 57589, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress admit bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitRate", prop)

    prop = PropMeta("str", "admitSpct", "admitSpct", 57586, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress admit bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitSpct", prop)

    prop = PropMeta("str", "admitThr", "admitThr", 57587, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "admitTr", "admitTr", 57588, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 57606, PropCategory.IMPLICIT_AVG)
    prop.label = "mpls vrf egress drop bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 57602, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 57605, PropCategory.IMPLICIT_MAX)
    prop.label = "mpls vrf egress drop bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 57604, PropCategory.IMPLICIT_MIN)
    prop.label = "mpls vrf egress drop bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 57603, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 57610, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 57607, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 57608, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 57609, PropCategory.IMPLICIT_TREND)
