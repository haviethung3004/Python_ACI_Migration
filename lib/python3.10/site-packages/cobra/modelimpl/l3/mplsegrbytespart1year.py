...
# ##################################################
class MplsEgrBytesPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart1year", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart1year"
    meta.rnFormat = "CDl3MplsEgrBytesPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDl3MplsEgrBytesPart1year-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59849, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
