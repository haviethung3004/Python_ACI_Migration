...
class EgrBytesAgHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist1d", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist1d"
    meta.rnFormat = "HDl3EgrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 58545, PropCategory.REGULAR)
