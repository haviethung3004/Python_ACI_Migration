...
# ##################################################
class MplsEgrBytesPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart1w", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart1w"
    meta.rnFormat = "CDl3MplsEgrBytesPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59848, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
