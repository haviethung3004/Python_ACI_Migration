...
class EgrBytesPartHist(Mo):
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist"


    meta.moClassName = "l3EgrBytesPartHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats"
    ...
    prop = PropMeta("str", "admitAvg", "admitAvg", 58688, PropCategory.IMPLICIT_AVG)
    prop.label = "mpls vrf egress admit bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitAvg", prop)

    prop = PropMeta("str", "admitCum", "admitCum", 58684, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress admit bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitCum", prop)

    prop = PropMeta("str", "admitMax", "admitMax", 58687, PropCategory.IMPLICIT_MAX)
    prop.label = "mpls vrf egress admit bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMax", prop)

    prop = PropMeta("str", "admitMin", "admitMin", 58686, PropCategory.IMPLICIT_MIN)
    prop.label = "mpls vrf egress admit bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMin", prop)

    prop = PropMeta("str", "admitPer", "admitPer", 58685, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress admit bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitPer", prop)

    prop = PropMeta("str", "admitRate", "admitRate", 58692, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress admit bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitRate", prop)

    prop = PropMeta("str", "admitSpct", "admitSpct", 58689, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress admit bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitSpct", prop)

    prop = PropMeta("str", "admitThr", "admitThr", 58690, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "admitTr", "admitTr", 58691, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 58722, PropCategory.IMPLICIT_AVG)
    prop.label = "mpls vrf egress drop bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 58718, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 58721, PropCategory.IMPLICIT_MAX)
    prop.label = "mpls vrf egress drop bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 58720, PropCategory.IMPLICIT_MIN)
    prop.label = "mpls vrf egress drop bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 58719, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 58726, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 58723, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 58724, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 58725, PropCategory.IMPLICIT_TREND)
