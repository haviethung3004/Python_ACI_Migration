...
# ##################################################
class MplsIngrPktsPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart1mo", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart1mo"
    meta.rnFormat = "CDl3MplsIngrPktsPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59942, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
