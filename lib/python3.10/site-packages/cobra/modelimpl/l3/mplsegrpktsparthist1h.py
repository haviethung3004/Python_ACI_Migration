...
# ##################################################
class MplsEgrPktsPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist1h", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist1h"
    meta.rnFormat = "HDl3MplsEgrPktsPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59887, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59888, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
