...
# ##################################################
class MplsIngrBytesPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist1mo", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist1mo"
    meta.rnFormat = "HDl3MplsIngrBytesPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59921, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59922, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
