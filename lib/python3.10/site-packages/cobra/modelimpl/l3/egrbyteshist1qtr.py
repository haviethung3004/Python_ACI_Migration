...
class EgrBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist1qtr", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist1qtr"
    meta.rnFormat = "HDl3EgrBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 57509, PropCategory.REGULAR)
