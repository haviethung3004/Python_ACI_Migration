...
# ##################################################
class MplsIngrBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAg1h", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAg1h"
    meta.rnFormat = "CDl3MplsIngrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress bytes stats in 1 hour"
