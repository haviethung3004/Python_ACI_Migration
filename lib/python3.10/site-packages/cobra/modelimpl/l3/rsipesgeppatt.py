...
# ##################################################
class RsIpESgEpPAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsIpESgEpPAtt", "cobra.model.fv.AREpP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l3RsIpESgEpPAtt"
    meta.rnFormat = "rsipESgEpPAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ESgEpP Attachment"
    ...
    prop = PropMeta("str", "tCl", "tCl", 56093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 56092, PropCategory.REGULAR)
