...
class EgrBytesPart1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart1w", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart1w"
    meta.rnFormat = "CDl3EgrBytesPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58557, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
