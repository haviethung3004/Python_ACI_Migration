...
class EgrBytesPartHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist1d", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist1d"
    meta.rnFormat = "HDl3EgrBytesPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 58562, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58563, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
