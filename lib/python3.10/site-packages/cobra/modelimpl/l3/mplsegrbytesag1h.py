...
# ##################################################
class MplsEgrBytesAg1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAg1h", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAg1h"
    meta.rnFormat = "CDl3MplsEgrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress bytes stats in 1 hour"
