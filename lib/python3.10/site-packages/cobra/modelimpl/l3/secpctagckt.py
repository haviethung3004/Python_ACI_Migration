...
# ##################################################
class SecPcTagCkt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.l3.SecPcTagCkt")

    meta.moClassName = "l3SecPcTagCkt"
    meta.rnFormat = "secpctagckt-%(pcTag)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Secure pcTag Circuit Endpoint"
    ...
    prop = PropMeta("str", "annotation", "annotation", 63220, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 63221, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 63219, PropCategory.REGULAR)
