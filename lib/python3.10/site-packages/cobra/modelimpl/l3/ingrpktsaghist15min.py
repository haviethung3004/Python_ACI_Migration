...
class IngrPktsAgHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist15min", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist15min"
    meta.rnFormat = "HDl3IngrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.IngrPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3IngrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 58640, PropCategory.REGULAR)
