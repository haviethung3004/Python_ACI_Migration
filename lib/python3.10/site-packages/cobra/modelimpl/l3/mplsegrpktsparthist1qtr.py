...
# ##################################################
class MplsEgrPktsPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist1qtr", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist1qtr"
    meta.rnFormat = "HDl3MplsEgrPktsPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59891, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59892, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
