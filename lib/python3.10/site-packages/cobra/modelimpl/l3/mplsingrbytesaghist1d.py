...
# ##################################################
class MplsIngrBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist1d", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist1d"
    meta.rnFormat = "HDl3MplsIngrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59900, PropCategory.REGULAR)
