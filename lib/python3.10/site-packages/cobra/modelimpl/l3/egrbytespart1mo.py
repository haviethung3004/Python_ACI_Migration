...
class EgrBytesPart1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart1mo", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart1mo"
    meta.rnFormat = "CDl3EgrBytesPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58555, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
