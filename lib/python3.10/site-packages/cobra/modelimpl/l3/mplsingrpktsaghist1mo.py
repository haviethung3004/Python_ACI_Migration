...
# ##################################################
class MplsIngrPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist1mo", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist1mo"
    meta.rnFormat = "HDl3MplsIngrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59934, PropCategory.REGULAR)
