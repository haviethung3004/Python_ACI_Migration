...
class EgrBytesPart5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart5min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart5min"
    meta.rnFormat = "CDl3EgrBytesPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58559, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
