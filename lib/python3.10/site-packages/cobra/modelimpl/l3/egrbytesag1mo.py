...
class EgrBytesAg1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg1mo", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg1mo"
    meta.rnFormat = "CDl3EgrBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 1 month"
