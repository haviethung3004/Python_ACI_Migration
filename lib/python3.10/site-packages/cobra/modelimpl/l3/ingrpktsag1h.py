...
class IngrPktsAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg1h", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg1h"
    meta.rnFormat = "CDl3IngrPktsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 1 hour"
