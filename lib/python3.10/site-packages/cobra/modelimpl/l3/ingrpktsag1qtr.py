...
class IngrPktsAg1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg1qtr", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg1qtr"
    meta.rnFormat = "CDl3IngrPktsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 1 quarter"
