...
class IngrBytesAg1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAg1mo", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAg1mo"
    meta.rnFormat = "CDl3IngrBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress bytes stats in 1 month"
