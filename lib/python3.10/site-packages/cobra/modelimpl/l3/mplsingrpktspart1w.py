...
# ##################################################
class MplsIngrPktsPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart1w", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart1w"
    meta.rnFormat = "CDl3MplsIngrPktsPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59944, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
