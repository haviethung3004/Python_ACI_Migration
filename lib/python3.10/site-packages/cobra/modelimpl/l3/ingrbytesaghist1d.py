...
class IngrBytesAgHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist1d", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist1d"
    meta.rnFormat = "HDl3IngrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 58609, PropCategory.REGULAR)
