...
# ##################################################
class RsIngressMplsRuleAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsIngressMplsRuleAtt", "cobra.model.qosp.IngressMplsRule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3RsIngressMplsRuleAtt"
    meta.rnFormat = "rsingressMplsRuleAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Ingress MPLS Rule Attachment"
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 56605, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "operState", "operState", 56606, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 56689, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 56608, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16576
    prop.defaultValueStr = "qospIngressMplsRule"
    prop._addConstant("qospIngressMplsRule", None, 16576)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56607, PropCategory.REGULAR)
