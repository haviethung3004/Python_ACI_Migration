...
# ##################################################
class MplsEgrBytesPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist1h", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist1h"
    meta.rnFormat = "HDl3MplsEgrBytesPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59855, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59856, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
