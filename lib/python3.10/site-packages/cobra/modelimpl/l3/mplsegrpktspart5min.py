...
# ##################################################
class MplsEgrPktsPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart5min", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart5min"
    meta.rnFormat = "CDl3MplsEgrPktsPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59882, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
