...
class EgrBytesAgHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist1w", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist1w"
    meta.rnFormat = "HDl3EgrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 58549, PropCategory.REGULAR)
