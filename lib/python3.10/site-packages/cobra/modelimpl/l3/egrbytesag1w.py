...
class EgrBytesAg1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg1w", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg1w"
    meta.rnFormat = "CDl3EgrBytesAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 1 week"
