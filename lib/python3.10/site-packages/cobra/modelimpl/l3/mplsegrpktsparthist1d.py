...
# ##################################################
class MplsEgrPktsPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist1d", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist1d"
    meta.rnFormat = "HDl3MplsEgrPktsPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59885, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59886, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
