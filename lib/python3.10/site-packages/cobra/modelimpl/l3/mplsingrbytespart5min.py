...
# ##################################################
class MplsIngrBytesPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart5min", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart5min"
    meta.rnFormat = "CDl3MplsIngrBytesPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('CDl3MplsIngrBytesPart5min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59914, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
