...
class EgrBytesPartHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist1h", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist1h"
    meta.rnFormat = "HDl3EgrBytesPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 58564, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58565, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
