...
class IngrBytesAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAg1h", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAg1h"
    meta.rnFormat = "CDl3IngrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress bytes stats in 1 hour"
