...
# ##################################################
class MplsIngrPktsPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist15min", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist15min"
    meta.rnFormat = "HDl3MplsIngrPktsPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrPktsPartHist")
    meta.superClasses.add("cobra.model.stats.HistAgPart")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3MplsIngrPktsPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59947, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59948, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
