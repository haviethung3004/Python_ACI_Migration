...
class IngrBytesAgHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist1w", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist1w"
    meta.rnFormat = "HDl3IngrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 58613, PropCategory.REGULAR)
