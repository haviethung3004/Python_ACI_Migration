...
class EgrBytes1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes1d", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes1d"
    meta.rnFormat = "CDl3EgrBytes1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 1 day"
