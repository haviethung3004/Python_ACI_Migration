...
class IngrPktsAgHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist1year", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist1year"
    meta.rnFormat = "HDl3IngrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 58646, PropCategory.REGULAR)
