...
# ##################################################
class MplsIngrBytesPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist1d", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist1d"
    meta.rnFormat = "HDl3MplsIngrBytesPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59917, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59918, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
