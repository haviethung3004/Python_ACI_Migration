...
# ##################################################
class MplsIngrPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist1year", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist1year"
    meta.rnFormat = "HDl3MplsIngrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59937, PropCategory.REGULAR)
