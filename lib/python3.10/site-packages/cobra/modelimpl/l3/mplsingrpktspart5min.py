...
# ##################################################
class MplsIngrPktsPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart5min", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart5min"
    meta.rnFormat = "CDl3MplsIngrPktsPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59946, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
