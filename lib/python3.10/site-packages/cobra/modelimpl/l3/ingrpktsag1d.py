...
class IngrPktsAg1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg1d", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg1d"
    meta.rnFormat = "CDl3IngrPktsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 1 day"
