...
# ##################################################
class MplsEgrBytesPart5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart5min", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart5min"
    meta.rnFormat = "CDl3MplsEgrBytesPart5min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59850, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
