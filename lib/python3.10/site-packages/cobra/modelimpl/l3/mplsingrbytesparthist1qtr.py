...
# ##################################################
class MplsIngrBytesPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist1qtr", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist1qtr"
    meta.rnFormat = "HDl3MplsIngrBytesPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('HDl3MplsIngrBytesPart1qtr-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59923, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59924, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
