...
class EgrBytesPart(Mo):
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart"


    meta.moClassName = "l3EgrBytesPart"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats"
