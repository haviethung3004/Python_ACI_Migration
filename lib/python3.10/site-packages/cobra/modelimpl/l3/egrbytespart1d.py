...
class EgrBytesPart1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart1d", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart1d"
    meta.rnFormat = "CDl3EgrBytesPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58553, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
