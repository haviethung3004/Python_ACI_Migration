...
class EgrPktsAg15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg15min", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg15min"
    meta.rnFormat = "CDl3EgrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrPktsAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3EgrPktsAg15min', False),
    ]
