...
class EgrPktsAg1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg1mo", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg1mo"
    meta.rnFormat = "CDl3EgrPktsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 1 month"
