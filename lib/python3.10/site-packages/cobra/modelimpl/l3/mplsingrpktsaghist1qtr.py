...
# ##################################################
class MplsIngrPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist1qtr", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist1qtr"
    meta.rnFormat = "HDl3MplsIngrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59935, PropCategory.REGULAR)
