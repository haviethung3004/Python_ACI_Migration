...
# ##################################################
class MplsIngrBytesPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart15min", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart15min"
    meta.rnFormat = "CDl3MplsIngrBytesPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrBytesPart")
    meta.superClasses.add("cobra.model.stats.CurrAgPart")

    meta.rnPrefixes = [
        ('CDl3MplsIngrBytesPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59907, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
