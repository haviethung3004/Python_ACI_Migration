...
class EgrBytesAg5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg5min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg5min"
    meta.rnFormat = "CDl3EgrBytesAg5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 5 minute"
