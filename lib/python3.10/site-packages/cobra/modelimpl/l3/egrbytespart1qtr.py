...
class EgrBytesPart1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart1qtr", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart1qtr"
    meta.rnFormat = "CDl3EgrBytesPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58556, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
