...
class EgrBytesAg15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg15min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg15min"
    meta.rnFormat = "CDl3EgrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrBytesAg")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3EgrBytesAg15min', False),
    ]
