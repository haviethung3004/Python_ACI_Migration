...
# ##################################################
class MplsEgrBytesPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist1year", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist1year"
    meta.rnFormat = "HDl3MplsEgrBytesPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDl3MplsEgrBytesPart1year-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59863, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59864, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
