...
# ##################################################
class MplsIngrBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist1qtr", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist1qtr"
    meta.rnFormat = "HDl3MplsIngrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59903, PropCategory.REGULAR)
