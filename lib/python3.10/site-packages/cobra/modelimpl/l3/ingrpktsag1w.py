...
class IngrPktsAg1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg1w", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg1w"
    meta.rnFormat = "CDl3IngrPktsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 1 week"
