...
# ##################################################
class MplsEgrPktsPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart1w", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart1w"
    meta.rnFormat = "CDl3MplsEgrPktsPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59880, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
