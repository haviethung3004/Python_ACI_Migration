...
# ##################################################
class MplsIngrBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAg1qtr", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAg1qtr"
    meta.rnFormat = "CDl3MplsIngrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress bytes stats in 1 quarter"
