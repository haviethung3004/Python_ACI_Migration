...
class IngrPktsAg1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg1year", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg1year"
    meta.rnFormat = "CDl3IngrPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 1 year"
