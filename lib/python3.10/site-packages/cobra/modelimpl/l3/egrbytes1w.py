...
class EgrBytes1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes1w", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes1w"
    meta.rnFormat = "CDl3EgrBytes1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 1 week"
