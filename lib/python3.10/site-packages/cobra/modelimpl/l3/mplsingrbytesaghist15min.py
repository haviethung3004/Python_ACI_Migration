...
# ##################################################
class MplsIngrBytesAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist15min", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist15min"
    meta.rnFormat = "HDl3MplsIngrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrBytesAgHist")

    meta.rnPrefixes = [
        ('HDl3MplsIngrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59899, PropCategory.REGULAR)
