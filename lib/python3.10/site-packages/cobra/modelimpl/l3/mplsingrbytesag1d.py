...
# ##################################################
class MplsIngrBytesAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAg1d", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAg1d"
    meta.rnFormat = "CDl3MplsIngrBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress bytes stats in 1 day"
