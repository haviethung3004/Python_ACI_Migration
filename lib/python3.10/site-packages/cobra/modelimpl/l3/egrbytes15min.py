...
class EgrBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes15min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes15min"
    meta.rnFormat = "CDl3EgrBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrBytes")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3EgrBytes15min', False),
    ]
