...
class IngrPktsAg15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg15min", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg15min"
    meta.rnFormat = "CDl3IngrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.IngrPktsAg")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3IngrPktsAg15min', False),
    ]
