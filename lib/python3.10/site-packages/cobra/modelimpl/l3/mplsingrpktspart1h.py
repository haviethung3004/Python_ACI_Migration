...
# ##################################################
class MplsIngrPktsPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart1h", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart1h"
    meta.rnFormat = "CDl3MplsIngrPktsPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59941, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
