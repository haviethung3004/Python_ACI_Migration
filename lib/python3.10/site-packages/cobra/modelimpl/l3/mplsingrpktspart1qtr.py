...
# ##################################################
class MplsIngrPktsPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPart1qtr", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPart1qtr"
    meta.rnFormat = "CDl3MplsIngrPktsPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59943, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
