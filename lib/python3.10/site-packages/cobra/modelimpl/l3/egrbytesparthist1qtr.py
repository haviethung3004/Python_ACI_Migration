...
class EgrBytesPartHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist1qtr", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist1qtr"
    meta.rnFormat = "HDl3EgrBytesPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 58568, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58569, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
