...
# ##################################################
class MplsEgrBytesAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist1d", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist1d"
    meta.rnFormat = "HDl3MplsEgrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59836, PropCategory.REGULAR)
