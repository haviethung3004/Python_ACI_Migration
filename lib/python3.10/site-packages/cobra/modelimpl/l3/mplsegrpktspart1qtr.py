...
# ##################################################
class MplsEgrPktsPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart1qtr", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart1qtr"
    meta.rnFormat = "CDl3MplsEgrPktsPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59879, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
