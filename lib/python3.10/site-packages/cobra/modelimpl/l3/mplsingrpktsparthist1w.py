...
# ##################################################
class MplsIngrPktsPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist1w", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist1w"
    meta.rnFormat = "HDl3MplsIngrPktsPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59957, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59958, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
