...
# ##################################################
class MplsIngrBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist1h", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist1h"
    meta.rnFormat = "HDl3MplsIngrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59901, PropCategory.REGULAR)
