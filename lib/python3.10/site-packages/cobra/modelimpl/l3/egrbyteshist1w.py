...
class EgrBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist1w", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist1w"
    meta.rnFormat = "HDl3EgrBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 57510, PropCategory.REGULAR)
