...
# ##################################################
class MplsEgrPktsPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart15min", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart15min"
    meta.rnFormat = "CDl3MplsEgrPktsPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrPktsPart")
    meta.superClasses.add("cobra.model.stats.CurrAgPart")

    meta.rnPrefixes = [
        ('CDl3MplsEgrPktsPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59875, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
