...
# ##################################################
class MplsEgrBytesPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist1qtr", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist1qtr"
    meta.rnFormat = "HDl3MplsEgrBytesPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59859, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59860, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
