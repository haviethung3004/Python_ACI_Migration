...
# ##################################################
class MplsIngrBytesPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist1h", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist1h"
    meta.rnFormat = "HDl3MplsIngrBytesPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59919, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59920, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
