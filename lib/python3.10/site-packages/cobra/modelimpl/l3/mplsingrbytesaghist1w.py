...
# ##################################################
class MplsIngrBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist1w", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist1w"
    meta.rnFormat = "HDl3MplsIngrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59904, PropCategory.REGULAR)
