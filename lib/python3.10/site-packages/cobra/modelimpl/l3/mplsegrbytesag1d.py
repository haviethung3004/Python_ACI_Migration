...
# ##################################################
class MplsEgrBytesAg1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAg1d", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAg1d"
    meta.rnFormat = "CDl3MplsEgrBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress bytes stats in 1 day"
