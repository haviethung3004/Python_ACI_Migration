...
class IngrPktsAg1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAg1mo", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAg1mo"
    meta.rnFormat = "CDl3IngrPktsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress packets stats in 1 month"
