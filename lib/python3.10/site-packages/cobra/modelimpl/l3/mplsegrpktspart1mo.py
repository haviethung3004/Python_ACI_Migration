...
# ##################################################
class MplsEgrPktsPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart1mo", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart1mo"
    meta.rnFormat = "CDl3MplsEgrPktsPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59878, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
