...
# ##################################################
class MplsEgrPktsAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist1qtr", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist1qtr"
    meta.rnFormat = "HDl3MplsEgrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59871, PropCategory.REGULAR)
