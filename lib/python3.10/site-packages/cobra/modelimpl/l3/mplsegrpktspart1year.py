...
# ##################################################
class MplsEgrPktsPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart1year", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart1year"
    meta.rnFormat = "CDl3MplsEgrPktsPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59881, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
