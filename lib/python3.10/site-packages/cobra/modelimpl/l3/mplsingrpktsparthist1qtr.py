...
# ##################################################
class MplsIngrPktsPartHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist1qtr", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist1qtr"
    meta.rnFormat = "HDl3MplsIngrPktsPart1qtr-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59955, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59956, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
