...
class EgrPktsAgHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist1w", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist1w"
    meta.rnFormat = "HDl3EgrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 58581, PropCategory.REGULAR)
