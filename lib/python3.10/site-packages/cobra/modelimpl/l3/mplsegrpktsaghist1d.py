...
# ##################################################
class MplsEgrPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist1d", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist1d"
    meta.rnFormat = "HDl3MplsEgrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59868, PropCategory.REGULAR)
