...
# ##################################################
class MplsIngrBytesPart1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart1w", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart1w"
    meta.rnFormat = "CDl3MplsIngrBytesPart1w-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59912, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
