...
# ##################################################
class MplsEgrBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAg1mo", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAg1mo"
    meta.rnFormat = "CDl3MplsEgrBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress bytes stats in 1 month"
