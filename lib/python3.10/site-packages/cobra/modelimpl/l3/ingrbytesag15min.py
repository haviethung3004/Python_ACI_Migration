...
class IngrBytesAg15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAg15min", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAg15min"
    meta.rnFormat = "CDl3IngrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.IngrBytesAg")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3IngrBytesAg15min', False),
    ]
