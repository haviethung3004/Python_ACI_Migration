...
class EgrPktsAgHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist1d", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist1d"
    meta.rnFormat = "HDl3EgrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 58577, PropCategory.REGULAR)
