...
# ##################################################
class MplsIngrPktsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist1d", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist1d"
    meta.rnFormat = "HDl3MplsIngrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59932, PropCategory.REGULAR)
