...
# ##################################################
class MplsIngrBytesPart1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart1year", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart1year"
    meta.rnFormat = "CDl3MplsIngrBytesPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDl3MplsIngrBytesPart1year-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59913, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
