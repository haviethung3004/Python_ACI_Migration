...
# ##################################################
class MplsIngrPktsPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist1year", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist1year"
    meta.rnFormat = "HDl3MplsIngrPktsPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDl3MplsIngrPktsPart1year-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59959, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59960, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
