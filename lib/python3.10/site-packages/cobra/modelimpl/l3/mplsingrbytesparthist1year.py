...
# ##################################################
class MplsIngrBytesPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist1year", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist1year"
    meta.rnFormat = "HDl3MplsIngrBytesPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDl3MplsIngrBytesPart1year-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59927, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59928, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
