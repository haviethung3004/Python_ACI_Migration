...
class EgrBytesAg1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg1d", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg1d"
    meta.rnFormat = "CDl3EgrBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 1 day"
