...
# ##################################################
class MplsEgrPktsAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist1mo", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist1mo"
    meta.rnFormat = "HDl3MplsEgrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59870, PropCategory.REGULAR)
