...
class IngrBytesAgHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist1year", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist1year"
    meta.rnFormat = "HDl3IngrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 58614, PropCategory.REGULAR)
