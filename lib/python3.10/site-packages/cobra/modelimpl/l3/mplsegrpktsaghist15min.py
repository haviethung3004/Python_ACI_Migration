...
# ##################################################
class MplsEgrPktsAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist15min", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist15min"
    meta.rnFormat = "HDl3MplsEgrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3MplsEgrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59867, PropCategory.REGULAR)
