...
# ##################################################
class MplsEgrBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist1mo", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist1mo"
    meta.rnFormat = "HDl3MplsEgrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59838, PropCategory.REGULAR)
