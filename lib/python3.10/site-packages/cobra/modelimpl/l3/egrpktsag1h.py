...
class EgrPktsAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg1h", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg1h"
    meta.rnFormat = "CDl3EgrPktsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 1 hour"
