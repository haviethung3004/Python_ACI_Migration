...
# ##################################################
class MplsEgrBytesPart15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart15min", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart15min"
    meta.rnFormat = "CDl3MplsEgrBytesPart15min-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrBytesPart")
    meta.superClasses.add("cobra.model.stats.CurrAgPart")

    meta.rnPrefixes = [
        ('CDl3MplsEgrBytesPart15min-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59843, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
