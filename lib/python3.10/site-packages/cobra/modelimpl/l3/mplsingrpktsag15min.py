...
# ##################################################
class MplsIngrPktsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAg15min", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAg15min"
    meta.rnFormat = "CDl3MplsIngrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrPktsAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3MplsIngrPktsAg15min', False),
    ]
