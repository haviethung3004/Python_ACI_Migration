...
# ##################################################
class MplsEgrPktsPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist5min", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist5min"
    meta.rnFormat = "HDl3MplsEgrPktsPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 59897, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59898, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
