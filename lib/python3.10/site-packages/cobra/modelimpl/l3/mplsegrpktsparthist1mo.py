...
# ##################################################
class MplsEgrPktsPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist1mo", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist1mo"
    meta.rnFormat = "HDl3MplsEgrPktsPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59889, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59890, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
