...
# ##################################################
class MplsIngrBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist1year", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist1year"
    meta.rnFormat = "HDl3MplsIngrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59905, PropCategory.REGULAR)
