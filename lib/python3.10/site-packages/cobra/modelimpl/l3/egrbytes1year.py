...
class EgrBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes1year", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes1year"
    meta.rnFormat = "CDl3EgrBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 1 year"
