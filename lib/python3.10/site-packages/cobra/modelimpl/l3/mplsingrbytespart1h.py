...
# ##################################################
class MplsIngrBytesPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart1h", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart1h"
    meta.rnFormat = "CDl3MplsIngrBytesPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59909, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
