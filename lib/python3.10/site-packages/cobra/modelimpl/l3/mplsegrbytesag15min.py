...
# ##################################################
class MplsEgrBytesAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAg15min", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAg15min"
    meta.rnFormat = "CDl3MplsEgrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrBytesAg")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3MplsEgrBytesAg15min', False),
    ]
