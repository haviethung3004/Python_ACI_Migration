...
class EgrBytesPartHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist15min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist15min"
    meta.rnFormat = "HDl3EgrBytesPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrBytesPartHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.HistAgPart")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3EgrBytesPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 58560, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58561, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
