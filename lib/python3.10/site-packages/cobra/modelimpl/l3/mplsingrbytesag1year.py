...
# ##################################################
class MplsIngrBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAg1year", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAg1year"
    meta.rnFormat = "CDl3MplsIngrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress bytes stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDl3MplsIngrBytesAg1year', False),
    ]
