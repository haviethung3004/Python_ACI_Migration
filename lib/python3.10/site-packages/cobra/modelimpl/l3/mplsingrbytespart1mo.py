...
# ##################################################
class MplsIngrBytesPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart1mo", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart1mo"
    meta.rnFormat = "CDl3MplsIngrBytesPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59910, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
