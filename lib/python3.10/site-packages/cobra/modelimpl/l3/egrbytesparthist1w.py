...
class EgrBytesPartHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist1w", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist1w"
    meta.rnFormat = "HDl3EgrBytesPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 58570, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58571, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
