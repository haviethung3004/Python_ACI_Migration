...
class EgrBytes1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes1qtr", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes1qtr"
    meta.rnFormat = "CDl3EgrBytes1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 1 quarter"
