...
class EgrBytesPart1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart1h", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart1h"
    meta.rnFormat = "CDl3EgrBytesPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58554, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
