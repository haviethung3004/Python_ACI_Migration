...
# ##################################################
class MplsEgrPktsAg15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAg15min", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAg15min"
    meta.rnFormat = "CDl3MplsEgrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrPktsAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDl3MplsEgrPktsAg15min', False),
    ]
