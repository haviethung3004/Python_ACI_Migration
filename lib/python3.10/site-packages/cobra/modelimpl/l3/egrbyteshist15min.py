...
class EgrBytesHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist15min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist15min"
    meta.rnFormat = "HDl3EgrBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrBytesHist")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3EgrBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 57505, PropCategory.REGULAR)
