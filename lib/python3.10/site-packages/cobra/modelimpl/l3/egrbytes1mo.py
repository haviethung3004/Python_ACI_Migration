...
class EgrBytes1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes1mo", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes1mo"
    meta.rnFormat = "CDl3EgrBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 1 month"
