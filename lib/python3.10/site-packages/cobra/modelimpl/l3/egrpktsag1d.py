...
class EgrPktsAg1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg1d", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg1d"
    meta.rnFormat = "CDl3EgrPktsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 1 day"
