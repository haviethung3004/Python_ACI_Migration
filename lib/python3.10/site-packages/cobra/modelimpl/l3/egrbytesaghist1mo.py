...
class EgrBytesAgHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist1mo", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist1mo"
    meta.rnFormat = "HDl3EgrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 58547, PropCategory.REGULAR)
