...
# ##################################################
class MplsIngrBytesPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist1w", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist1w"
    meta.rnFormat = "HDl3MplsIngrBytesPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59925, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59926, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
