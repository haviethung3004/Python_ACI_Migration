...
# ##################################################
class MplsIngrPktsPartHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist1h", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist1h"
    meta.rnFormat = "HDl3MplsIngrPktsPart1h-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59951, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59952, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
