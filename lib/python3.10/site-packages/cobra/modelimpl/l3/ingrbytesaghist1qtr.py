...
class IngrBytesAgHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist1qtr", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist1qtr"
    meta.rnFormat = "HDl3IngrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 58612, PropCategory.REGULAR)
