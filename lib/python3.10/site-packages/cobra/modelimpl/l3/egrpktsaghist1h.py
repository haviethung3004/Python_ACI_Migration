...
class EgrPktsAgHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist1h", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist1h"
    meta.rnFormat = "HDl3EgrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 58578, PropCategory.REGULAR)
