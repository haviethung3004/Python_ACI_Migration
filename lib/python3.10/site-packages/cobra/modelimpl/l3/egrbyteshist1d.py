...
class EgrBytesHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist1d", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist1d"
    meta.rnFormat = "HDl3EgrBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 57506, PropCategory.REGULAR)
