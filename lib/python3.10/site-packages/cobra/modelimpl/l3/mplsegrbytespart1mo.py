...
# ##################################################
class MplsEgrBytesPart1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart1mo", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart1mo"
    meta.rnFormat = "CDl3MplsEgrBytesPart1mo-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59846, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
