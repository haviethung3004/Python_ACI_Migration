...
class IngrBytesAgHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist1mo", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist1mo"
    meta.rnFormat = "HDl3IngrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 58611, PropCategory.REGULAR)
