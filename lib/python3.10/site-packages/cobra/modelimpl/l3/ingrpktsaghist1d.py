...
class IngrPktsAgHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist1d", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist1d"
    meta.rnFormat = "HDl3IngrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 58641, PropCategory.REGULAR)
