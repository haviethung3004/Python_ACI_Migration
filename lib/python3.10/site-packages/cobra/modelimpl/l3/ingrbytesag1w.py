...
class IngrBytesAg1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAg1w", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAg1w"
    meta.rnFormat = "CDl3IngrBytesAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress bytes stats in 1 week"
