...
# ##################################################
class MplsEgrPktsAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist1h", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist1h"
    meta.rnFormat = "HDl3MplsEgrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59869, PropCategory.REGULAR)
