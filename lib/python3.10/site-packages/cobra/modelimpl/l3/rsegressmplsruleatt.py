...
# ##################################################
class RsEgressMplsRuleAtt(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l3.RsEgressMplsRuleAtt", "cobra.model.qosp.EgressMplsRule")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "l3RsEgressMplsRuleAtt"
    meta.rnFormat = "rsegressMplsRuleAtt-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Egress MPLS Rule Attachment"
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 56599, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "operState", "operState", 56600, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 56687, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 16)]
    ...
    prop = PropMeta("str", "tCl", "tCl", 56602, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 16577
    prop.defaultValueStr = "qospEgressMplsRule"
    prop._addConstant("qospEgressMplsRule", None, 16577)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 56601, PropCategory.REGULAR)
