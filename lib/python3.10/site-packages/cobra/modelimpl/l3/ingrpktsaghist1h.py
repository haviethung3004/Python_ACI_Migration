...
class IngrPktsAgHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist1h", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist1h"
    meta.rnFormat = "HDl3IngrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 58642, PropCategory.REGULAR)
