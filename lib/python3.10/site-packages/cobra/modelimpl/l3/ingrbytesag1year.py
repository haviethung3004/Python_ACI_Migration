...
class IngrBytesAg1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAg1year", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAg1year"
    meta.rnFormat = "CDl3IngrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress bytes stats in 1 year"
