...
class EgrBytesAgHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist1h", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist1h"
    meta.rnFormat = "HDl3EgrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 58546, PropCategory.REGULAR)
