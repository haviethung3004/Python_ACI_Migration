...
class EgrBytesHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist1year", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist1year"
    meta.rnFormat = "HDl3EgrBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 57511, PropCategory.REGULAR)
