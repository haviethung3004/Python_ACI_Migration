...
# ##################################################
class MplsEgrBytesPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart1d", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart1d"
    meta.rnFormat = "CDl3MplsEgrBytesPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59844, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
