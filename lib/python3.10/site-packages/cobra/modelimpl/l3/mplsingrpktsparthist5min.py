...
# ##################################################
class MplsIngrPktsPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist5min", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist5min"
    meta.rnFormat = "HDl3MplsIngrPktsPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 59961, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59962, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
