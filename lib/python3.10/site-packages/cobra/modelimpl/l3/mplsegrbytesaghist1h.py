...
# ##################################################
class MplsEgrBytesAgHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist1h", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist1h"
    meta.rnFormat = "HDl3MplsEgrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59837, PropCategory.REGULAR)
