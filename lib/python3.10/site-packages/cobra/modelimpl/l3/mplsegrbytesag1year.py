...
# ##################################################
class MplsEgrBytesAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAg1year", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAg1year"
    meta.rnFormat = "CDl3MplsEgrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress bytes stats in 1 year"
