...
# ##################################################
class MplsEgrBytesPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist1w", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist1w"
    meta.rnFormat = "HDl3MplsEgrBytesPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59861, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59862, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
