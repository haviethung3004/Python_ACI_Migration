...
class EgrPktsAg1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg1qtr", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg1qtr"
    meta.rnFormat = "CDl3EgrPktsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 1 quarter"
