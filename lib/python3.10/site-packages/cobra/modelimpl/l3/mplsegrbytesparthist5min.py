...
# ##################################################
class MplsEgrBytesPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist5min", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist5min"
    meta.rnFormat = "HDl3MplsEgrBytesPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 59865, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59866, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
