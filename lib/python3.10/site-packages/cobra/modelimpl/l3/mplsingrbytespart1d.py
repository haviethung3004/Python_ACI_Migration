...
# ##################################################
class MplsIngrBytesPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart1d", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart1d"
    meta.rnFormat = "CDl3MplsIngrBytesPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59908, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
