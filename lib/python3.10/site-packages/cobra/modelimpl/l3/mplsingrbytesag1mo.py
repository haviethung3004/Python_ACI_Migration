...
# ##################################################
class MplsIngrBytesAg1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAg1mo", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAg1mo"
    meta.rnFormat = "CDl3MplsIngrBytesAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls ingress bytes stats in 1 month"
