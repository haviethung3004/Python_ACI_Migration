...
# ##################################################
class MplsIngrBytesPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPart1qtr", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPart1qtr"
    meta.rnFormat = "CDl3MplsIngrBytesPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls ingress bytes stats in 1 quarter"
    ...
    meta.rnPrefixes = [
        ('CDl3MplsIngrBytesPart1qtr-', True),
    ]
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59911, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
