...
class EgrPktsAgHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist15min", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist15min"
    meta.rnFormat = "HDl3EgrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrPktsAgHist")

    meta.rnPrefixes = [
        ('HDl3EgrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 58576, PropCategory.REGULAR)
