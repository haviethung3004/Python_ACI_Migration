...
# ##################################################
class MplsIngrBytesPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist15min", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist15min"
    meta.rnFormat = "HDl3MplsIngrBytesPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsIngrBytesPartHist")

    meta.rnPrefixes = [
        ('HDl3MplsIngrBytesPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59915, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59916, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
