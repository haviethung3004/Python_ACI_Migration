...
# ##################################################
class MplsEgrPktsPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist15min", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist15min"
    meta.rnFormat = "HDl3MplsEgrPktsPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrPktsPartHist")
    meta.superClasses.add("cobra.model.stats.HistAgPart")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3MplsEgrPktsPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59883, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59884, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
