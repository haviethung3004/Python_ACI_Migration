...
# ##################################################
class MplsEgrBytesAgHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist15min", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist15min"
    meta.rnFormat = "HDl3MplsEgrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrBytesAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3MplsEgrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59835, PropCategory.REGULAR)
