...
class EgrBytesPartHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist1year", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist1year"
    meta.rnFormat = "HDl3EgrBytesPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 58572, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58573, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
