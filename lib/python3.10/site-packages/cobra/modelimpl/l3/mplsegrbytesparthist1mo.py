...
# ##################################################
class MplsEgrBytesPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist1mo", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist1mo"
    meta.rnFormat = "HDl3MplsEgrBytesPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59857, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59858, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
