...
class EgrPktsAg1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg1year", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg1year"
    meta.rnFormat = "CDl3EgrPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 1 year"
