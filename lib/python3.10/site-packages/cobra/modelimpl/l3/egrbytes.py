...
# ##################################################
class EgrBytes(Mo):
    meta = StatsClassMeta("cobra.model.l3.EgrBytes", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes"


    meta.moClassName = "l3EgrBytes"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats"
    ...
    prop = PropMeta("str", "admitAvg", "admitAvg", 57575, PropCategory.IMPLICIT_AVG)
    prop.label = "mpls vrf egress admit bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitAvg", prop)

    prop = PropMeta("str", "admitBase", "admitBase", 57570, PropCategory.IMPLICIT_BASELINE)
    prop.label = "mpls vrf egress admit bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitBase", prop)

    prop = PropMeta("str", "admitCum", "admitCum", 57571, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress admit bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitCum", prop)

    prop = PropMeta("str", "admitLast", "admitLast", 57569, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "mpls vrf egress admit bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitLast", prop)

    prop = PropMeta("str", "admitMax", "admitMax", 57574, PropCategory.IMPLICIT_MAX)
    prop.label = "mpls vrf egress admit bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMax", prop)

    prop = PropMeta("str", "admitMin", "admitMin", 57573, PropCategory.IMPLICIT_MIN)
    prop.label = "mpls vrf egress admit bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitMin", prop)

    prop = PropMeta("str", "admitPer", "admitPer", 57572, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress admit bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitPer", prop)

    prop = PropMeta("str", "admitRate", "admitRate", 57580, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress admit bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitRate", prop)

    prop = PropMeta("str", "admitSpct", "admitSpct", 57576, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress admit bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitSpct", prop)

    prop = PropMeta("str", "admitThr", "admitThr", 57577, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "admitTr", "admitTr", 57579, PropCategory.IMPLICIT_TREND)
    prop.label = "mpls vrf egress admit bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitTr", prop)

    prop = PropMeta("str", "admitTrBase", "admitTrBase", 57578, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "dropAvg", "dropAvg", 57596, PropCategory.IMPLICIT_AVG)
    prop.label = "mpls vrf egress drop bytes average value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropAvg", prop)

    prop = PropMeta("str", "dropBase", "dropBase", 57591, PropCategory.IMPLICIT_BASELINE)
    prop.label = "mpls vrf egress drop bytes baseline"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropBase", prop)

    prop = PropMeta("str", "dropCum", "dropCum", 57592, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropLast", "dropLast", 57590, PropCategory.IMPLICIT_LASTREADING)
    prop.label = "mpls vrf egress drop bytes current value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropLast", prop)

    prop = PropMeta("str", "dropMax", "dropMax", 57595, PropCategory.IMPLICIT_MAX)
    prop.label = "mpls vrf egress drop bytes maximum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMax", prop)

    prop = PropMeta("str", "dropMin", "dropMin", 57594, PropCategory.IMPLICIT_MIN)
    prop.label = "mpls vrf egress drop bytes minimum value"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropMin", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 57593, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 57601, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 57597, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 57598, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 57600, PropCategory.IMPLICIT_TREND)
    prop.label = "mpls vrf egress drop bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 57599, PropCategory.IMPLICIT_TREND_BASE)
