...
# ##################################################
class MplsEgrBytesPart1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart1qtr", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart1qtr"
    meta.rnFormat = "CDl3MplsEgrBytesPart1qtr-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59847, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
