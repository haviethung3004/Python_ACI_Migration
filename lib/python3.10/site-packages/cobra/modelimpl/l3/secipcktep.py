...
class SecIpCktEp(Mo):
    ...
    meta = ClassMeta("cobra.model.l3.SecIpCktEp")

    meta.moClassName = "l3SecIpCktEp"
    meta.rnFormat = "secipcktep-[%(addr)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Secure IP Circuit Endpoint"
    ...
    meta.childClasses.add("cobra.model.l3.RsIpESgEpPAtt")
    meta.childClasses.add("cobra.model.tag.Annotation")
    meta.childClasses.add("cobra.model.tag.Tag")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3.RsIpESgEpPAtt", "rsipESgEpPAtt"))
    ...
    prop = PropMeta("str", "addr", "addr", 56076, PropCategory.REGULAR)
    prop.label = "Identifier of the Secure IP circuit Endpoint"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "annotation", "annotation", 56105, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 56106, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 56078, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcTag", "pcTag", 56077, PropCategory.REGULAR)
