...
class EgrBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist1h", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist1h"
    meta.rnFormat = "HDl3EgrBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 57507, PropCategory.REGULAR)
