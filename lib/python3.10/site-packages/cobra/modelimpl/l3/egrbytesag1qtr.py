...
class EgrBytesAg1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg1qtr", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg1qtr"
    meta.rnFormat = "CDl3EgrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 1 quarter"
