...
class EgrBytesPartHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist5min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist5min"
    meta.rnFormat = "HDl3EgrBytesPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 58574, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58575, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
