...
class EgrBytesAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg1h", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg1h"
    meta.rnFormat = "CDl3EgrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 1 hour"
