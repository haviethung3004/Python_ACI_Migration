...
# ##################################################
class MplsEgrPktsAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist1year", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist1year"
    meta.rnFormat = "HDl3MplsEgrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59873, PropCategory.REGULAR)
