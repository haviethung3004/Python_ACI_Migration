...
# ##################################################
class MplsIngrPktsPartHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist1mo", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist1mo"
    meta.rnFormat = "HDl3MplsIngrPktsPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59953, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59954, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
