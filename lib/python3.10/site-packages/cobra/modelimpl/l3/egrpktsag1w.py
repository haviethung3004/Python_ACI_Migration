...
class EgrPktsAg1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAg1w", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAg1w"
    meta.rnFormat = "CDl3EgrPktsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress packets stats in 1 week"
