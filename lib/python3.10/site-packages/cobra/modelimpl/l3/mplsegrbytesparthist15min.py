...
# ##################################################
class MplsEgrBytesPartHist15min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist15min", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist15min"
    meta.rnFormat = "HDl3MplsEgrBytesPart15min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.MplsEgrBytesPartHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.HistAgPart")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDl3MplsEgrBytesPart15min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59851, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59852, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
