...
class EgrPktsAgHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist1year", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist1year"
    meta.rnFormat = "HDl3EgrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 58582, PropCategory.REGULAR)
