...
class EgrBytesAgHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist1year", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist1year"
    meta.rnFormat = "HDl3EgrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 58550, PropCategory.REGULAR)
