...
class EgrBytesAgHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist15min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist15min"
    meta.rnFormat = "HDl3EgrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.l3.EgrBytesAgHist")

    meta.rnPrefixes = [
        ('HDl3EgrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 58544, PropCategory.REGULAR)
