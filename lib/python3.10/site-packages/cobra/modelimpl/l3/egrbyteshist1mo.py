...
class EgrBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist1mo", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist1mo"
    meta.rnFormat = "HDl3EgrBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 57508, PropCategory.REGULAR)
