...
# ##################################################
class MplsEgrBytesAgHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist1year", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist1year"
    meta.rnFormat = "HDl3MplsEgrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59841, PropCategory.REGULAR)
