...
# ##################################################
class MplsEgrBytesAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist1w", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist1w"
    meta.rnFormat = "HDl3MplsEgrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59840, PropCategory.REGULAR)
