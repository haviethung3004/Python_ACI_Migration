...
# ##################################################
class MplsIngrPktsPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsPartHist1d", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsPartHist1d"
    meta.rnFormat = "HDl3MplsIngrPktsPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59949, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59950, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
