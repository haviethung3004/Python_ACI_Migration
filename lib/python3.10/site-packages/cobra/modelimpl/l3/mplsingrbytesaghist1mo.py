...
# ##################################################
class MplsIngrBytesAgHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesAgHist1mo", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesAgHist1mo"
    meta.rnFormat = "HDl3MplsIngrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59902, PropCategory.REGULAR)
