...
class IngrPktsAgHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist1mo", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist1mo"
    meta.rnFormat = "HDl3IngrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 58643, PropCategory.REGULAR)
