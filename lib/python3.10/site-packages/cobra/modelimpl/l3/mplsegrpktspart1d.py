...
# ##################################################
class MplsEgrPktsPart1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPart1d", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPart1d"
    meta.rnFormat = "CDl3MplsEgrPktsPart1d-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59876, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
