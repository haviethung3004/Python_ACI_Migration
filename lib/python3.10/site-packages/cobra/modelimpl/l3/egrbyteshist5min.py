...
class EgrBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesHist5min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesHist5min"
    meta.rnFormat = "HDl3EgrBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical mpls vrf egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 57512, PropCategory.REGULAR)
