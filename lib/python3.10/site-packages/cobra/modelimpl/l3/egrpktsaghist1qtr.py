...
class EgrPktsAgHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist1qtr", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist1qtr"
    meta.rnFormat = "HDl3EgrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 58580, PropCategory.REGULAR)
