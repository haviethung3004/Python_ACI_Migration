...
class EgrBytesAgHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist1qtr", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist1qtr"
    meta.rnFormat = "HDl3EgrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 58548, PropCategory.REGULAR)
