...
class IngrBytesAg1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAg1qtr", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAg1qtr"
    meta.rnFormat = "CDl3IngrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf ingress bytes stats in 1 quarter"
