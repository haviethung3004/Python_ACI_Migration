...
# ##################################################
class MplsIngrBytesPartHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrBytesPartHist5min", "mpls ingress bytes")
    ...
    meta.moClassName = "l3MplsIngrBytesPartHist5min"
    meta.rnFormat = "HDl3MplsIngrBytesPart5min-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls ingress bytes stats in 5 minute"
    ...
    meta.rnPrefixes = [
        ('HDl3MplsIngrBytesPart5min-', True),
        ('-node-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59929, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59930, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
