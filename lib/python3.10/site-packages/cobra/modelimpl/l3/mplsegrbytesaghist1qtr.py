...
# ##################################################
class MplsEgrBytesAgHist1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAgHist1qtr", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAgHist1qtr"
    meta.rnFormat = "HDl3MplsEgrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59839, PropCategory.REGULAR)
