...
# ##################################################
class MplsIngrPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsIngrPktsAgHist1w", "mpls ingress packets")
    ...
    meta.moClassName = "l3MplsIngrPktsAgHist1w"
    meta.rnFormat = "HDl3MplsIngrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls ingress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59936, PropCategory.REGULAR)
