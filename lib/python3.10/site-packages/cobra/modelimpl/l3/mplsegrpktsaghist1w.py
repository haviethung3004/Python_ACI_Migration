...
# ##################################################
class MplsEgrPktsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsAgHist1w", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsAgHist1w"
    meta.rnFormat = "HDl3MplsEgrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59872, PropCategory.REGULAR)
