...
class EgrBytes1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes1h", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes1h"
    meta.rnFormat = "CDl3EgrBytes1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 1 hour"
