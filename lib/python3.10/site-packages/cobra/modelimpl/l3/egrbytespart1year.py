...
class EgrBytesPart1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPart1year", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPart1year"
    meta.rnFormat = "CDl3EgrBytesPart1year-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls vrf egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58558, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
