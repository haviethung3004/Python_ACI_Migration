...
# ##################################################
class EgrBytesAg(Mo):
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg"


    meta.moClassName = "l3EgrBytesAg"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats"
    ...
    prop = PropMeta("str", "admitCum", "admitCum", 58693, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress admit bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitCum", prop)

    prop = PropMeta("str", "admitPer", "admitPer", 58694, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress admit bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitPer", prop)

    prop = PropMeta("str", "admitRate", "admitRate", 58699, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress admit bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitRate", prop)

    prop = PropMeta("str", "admitSpct", "admitSpct", 58695, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress admit bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitSpct", prop)

    prop = PropMeta("str", "admitThr", "admitThr", 58696, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "admitTr", "admitTr", 58698, PropCategory.IMPLICIT_TREND)
    prop.label = "mpls vrf egress admit bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitTr", prop)

    prop = PropMeta("str", "admitTrBase", "admitTrBase", 58697, PropCategory.IMPLICIT_TREND_BASE)
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 58727, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 58728, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 58733, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 58729, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 58730, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 58732, PropCategory.IMPLICIT_TREND)
    prop.label = "mpls vrf egress drop bytes trend"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropTr", prop)

    prop = PropMeta("str", "dropTrBase", "dropTrBase", 58731, PropCategory.IMPLICIT_TREND_BASE)
