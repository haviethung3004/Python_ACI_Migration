...
class EgrBytesAgHist(Mo):
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAgHist", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAgHist"


    meta.moClassName = "l3EgrBytesAgHist"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress bytes stats"
    ...
    prop = PropMeta("str", "admitCum", "admitCum", 58700, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress admit bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitCum", prop)

    prop = PropMeta("str", "admitPer", "admitPer", 58701, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress admit bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitPer", prop)

    prop = PropMeta("str", "admitRate", "admitRate", 58705, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress admit bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitRate", prop)

    prop = PropMeta("str", "admitSpct", "admitSpct", 58702, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress admit bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("admitSpct", prop)

    prop = PropMeta("str", "admitThr", "admitThr", 58703, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "admitTr", "admitTr", 58704, PropCategory.IMPLICIT_TREND)
    ...
    prop = PropMeta("str", "dropCum", "dropCum", 58734, PropCategory.IMPLICIT_CUMULATIVE)
    prop.label = "mpls vrf egress drop bytes cumulative"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropCum", prop)

    prop = PropMeta("str", "dropPer", "dropPer", 58735, PropCategory.IMPLICIT_PERIODIC)
    prop.label = "mpls vrf egress drop bytes periodic"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropPer", prop)

    prop = PropMeta("str", "dropRate", "dropRate", 58739, PropCategory.IMPLICIT_RATE)
    prop.label = "mpls vrf egress drop bytes rate"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropRate", prop)

    prop = PropMeta("str", "dropSpct", "dropSpct", 58736, PropCategory.IMPLICIT_SUSPECT)
    prop.label = "mpls vrf egress drop bytes suspect count"
    prop.isOper = True
    prop.isStats = True
    meta.props.add("dropSpct", prop)

    prop = PropMeta("str", "dropThr", "dropThr", 58737, PropCategory.IMPLICIT_THRESHOLDED)
    ...
    prop = PropMeta("str", "dropTr", "dropTr", 58738, PropCategory.IMPLICIT_TREND)
