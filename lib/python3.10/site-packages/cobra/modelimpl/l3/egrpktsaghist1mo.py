...
class EgrPktsAgHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrPktsAgHist1mo", "mpls vrf egress packets")
    ...
    meta.moClassName = "l3EgrPktsAgHist1mo"
    meta.rnFormat = "HDl3EgrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 58579, PropCategory.REGULAR)
