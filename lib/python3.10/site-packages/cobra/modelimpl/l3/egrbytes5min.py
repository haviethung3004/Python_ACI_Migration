...
class EgrBytes5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytes5min", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytes5min"
    meta.rnFormat = "CDl3EgrBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current mpls vrf egress bytes stats in 5 minute"
