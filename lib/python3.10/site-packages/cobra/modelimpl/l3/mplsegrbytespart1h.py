...
# ##################################################
class MplsEgrBytesPart1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPart1h", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPart1h"
    meta.rnFormat = "CDl3MplsEgrBytesPart1h-%(nodeId)s"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current portion of the mpls egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59845, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
