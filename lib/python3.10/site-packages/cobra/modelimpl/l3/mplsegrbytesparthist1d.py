...
# ##################################################
class MplsEgrBytesPartHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesPartHist1d", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesPartHist1d"
    meta.rnFormat = "HDl3MplsEgrBytesPart1d-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59853, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59854, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
