...
class EgrBytesAg1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesAg1year", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesAg1year"
    meta.rnFormat = "CDl3EgrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls vrf egress bytes stats in 1 year"
