...
class IngrBytesAgHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrBytesAgHist1h", "mpls vrf ingress bytes")
    ...
    meta.moClassName = "l3IngrBytesAgHist1h"
    meta.rnFormat = "HDl3IngrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 58610, PropCategory.REGULAR)
