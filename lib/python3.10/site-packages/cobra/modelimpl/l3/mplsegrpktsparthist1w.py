...
# ##################################################
class MplsEgrPktsPartHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist1w", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist1w"
    meta.rnFormat = "HDl3MplsEgrPktsPart1w-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59893, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59894, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
