...
# ##################################################
class MplsEgrPktsPartHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrPktsPartHist1year", "mpls egress packets")
    ...
    meta.moClassName = "l3MplsEgrPktsPartHist1year"
    meta.rnFormat = "HDl3MplsEgrPktsPart1year-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59895, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 59896, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
