...
class IngrPktsAgHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.IngrPktsAgHist1qtr", "mpls vrf ingress packets")
    ...
    meta.moClassName = "l3IngrPktsAgHist1qtr"
    meta.rnFormat = "HDl3IngrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated mpls vrf ingress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 58644, PropCategory.REGULAR)
