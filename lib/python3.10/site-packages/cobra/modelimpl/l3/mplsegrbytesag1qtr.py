...
# ##################################################
class MplsEgrBytesAg1qtr(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.l3.MplsEgrBytesAg1qtr", "mpls egress bytes")
    ...
    meta.moClassName = "l3MplsEgrBytesAg1qtr"
    meta.rnFormat = "CDl3MplsEgrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated mpls egress bytes stats in 1 quarter"
