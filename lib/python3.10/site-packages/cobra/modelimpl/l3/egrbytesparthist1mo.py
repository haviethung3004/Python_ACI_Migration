...
class EgrBytesPartHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.l3.EgrBytesPartHist1mo", "mpls vrf egress bytes")
    ...
    meta.moClassName = "l3EgrBytesPartHist1mo"
    meta.rnFormat = "HDl3EgrBytesPart1mo-%(index)s-node-%(nodeId)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical portion of the mpls vrf egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 58566, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodeId", "nodeId", 58567, PropCategory.REGULAR)
    prop.label = "Node Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
