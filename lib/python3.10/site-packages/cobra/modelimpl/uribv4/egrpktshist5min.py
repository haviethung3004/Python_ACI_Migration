...
class EgrPktsHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist5min", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist5min"
    meta.rnFormat = "HDuribv4EgrPkts5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 59289, PropCategory.REGULAR)
