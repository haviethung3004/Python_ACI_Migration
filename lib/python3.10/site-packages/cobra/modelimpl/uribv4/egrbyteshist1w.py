...
class EgrBytesHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist1w", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist1w"
    meta.rnFormat = "HDuribv4EgrBytes1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59247, PropCategory.REGULAR)
