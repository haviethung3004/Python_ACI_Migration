...
class EgrPktsHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist15min", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist15min"
    meta.rnFormat = "HDuribv4EgrPkts15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrPktsHist")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDuribv4EgrPkts15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59282, PropCategory.REGULAR)
