...
class EgrPktsAgHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist1qtr", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist1qtr"
    meta.rnFormat = "HDuribv4EgrPktsAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59278, PropCategory.REGULAR)
