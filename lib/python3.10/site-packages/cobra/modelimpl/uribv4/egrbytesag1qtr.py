...
class EgrBytesAg1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAg1qtr", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAg1qtr"
    meta.rnFormat = "CDuribv4EgrBytesAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress bytes stats in 1 quarter"
