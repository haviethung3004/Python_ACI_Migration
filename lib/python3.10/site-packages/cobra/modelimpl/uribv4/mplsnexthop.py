...
# ##################################################
class MplsNexthop(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.uribv4.MplsNexthop")

    meta.moClassName = "uribv4MplsNexthop"
    meta.rnFormat = "mpls-%(label)s"
    ...
    prop = PropMeta("str", "label", "label", 58945, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, label, markDirty=True, **creationProps):
        namingVals = [label]
