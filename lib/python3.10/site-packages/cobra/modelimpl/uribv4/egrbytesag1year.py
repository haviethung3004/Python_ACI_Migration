...
class EgrBytesAg1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAg1year", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAg1year"
    meta.rnFormat = "CDuribv4EgrBytesAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress bytes stats in 1 year"
