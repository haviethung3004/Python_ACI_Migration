...
class EgrBytes5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytes5min", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytes5min"
    meta.rnFormat = "CDuribv4EgrBytes5min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current l3 LSP egress bytes stats in 5 minute"
