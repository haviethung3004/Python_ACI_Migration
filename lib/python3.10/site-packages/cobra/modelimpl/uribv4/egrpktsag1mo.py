...
class EgrPktsAg1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg1mo", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg1mo"
    meta.rnFormat = "CDuribv4EgrPktsAg1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 1 month"
