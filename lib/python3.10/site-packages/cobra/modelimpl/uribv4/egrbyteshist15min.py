...
class EgrBytesHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist15min", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist15min"
    meta.rnFormat = "HDuribv4EgrBytes15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrBytesHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDuribv4EgrBytes15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59242, PropCategory.REGULAR)
