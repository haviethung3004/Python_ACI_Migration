...
class EgrPktsAgHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist1h", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist1h"
    meta.rnFormat = "HDuribv4EgrPktsAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59276, PropCategory.REGULAR)
