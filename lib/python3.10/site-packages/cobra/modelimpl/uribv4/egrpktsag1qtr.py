...
class EgrPktsAg1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg1qtr", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg1qtr"
    meta.rnFormat = "CDuribv4EgrPktsAg1qtr"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 1 quarter"
