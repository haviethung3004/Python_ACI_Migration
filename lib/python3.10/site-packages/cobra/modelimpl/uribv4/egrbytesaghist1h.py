...
class EgrBytesAgHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist1h", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist1h"
    meta.rnFormat = "HDuribv4EgrBytesAg1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59236, PropCategory.REGULAR)
