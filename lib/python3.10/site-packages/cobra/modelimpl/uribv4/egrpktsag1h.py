...
class EgrPktsAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg1h", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg1h"
    meta.rnFormat = "CDuribv4EgrPktsAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 1 hour"
