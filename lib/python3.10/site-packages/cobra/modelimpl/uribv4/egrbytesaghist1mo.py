...
class EgrBytesAgHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist1mo", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist1mo"
    meta.rnFormat = "HDuribv4EgrBytesAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59237, PropCategory.REGULAR)
