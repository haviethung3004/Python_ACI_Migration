...
class EgrBytesHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist1h", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist1h"
    meta.rnFormat = "HDuribv4EgrBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59244, PropCategory.REGULAR)
