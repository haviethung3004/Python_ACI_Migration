...
class EgrPktsAgHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist1year", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist1year"
    meta.rnFormat = "HDuribv4EgrPktsAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59280, PropCategory.REGULAR)
