...
class EgrBytesAg1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAg1h", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAg1h"
    meta.rnFormat = "CDuribv4EgrBytesAg1h"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress bytes stats in 1 hour"
