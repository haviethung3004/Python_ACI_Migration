...
class EgrPktsAgHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist1mo", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist1mo"
    meta.rnFormat = "HDuribv4EgrPktsAg1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59277, PropCategory.REGULAR)
