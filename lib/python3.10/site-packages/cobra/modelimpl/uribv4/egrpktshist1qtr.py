...
class EgrPktsHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist1qtr", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist1qtr"
    meta.rnFormat = "HDuribv4EgrPkts1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59286, PropCategory.REGULAR)
