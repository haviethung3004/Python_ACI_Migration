...
class EgrPktsAg1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg1d", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg1d"
    meta.rnFormat = "CDuribv4EgrPktsAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 1 day"
