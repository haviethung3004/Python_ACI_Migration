...
class EgrPktsHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist1w", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist1w"
    meta.rnFormat = "HDuribv4EgrPkts1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59287, PropCategory.REGULAR)
