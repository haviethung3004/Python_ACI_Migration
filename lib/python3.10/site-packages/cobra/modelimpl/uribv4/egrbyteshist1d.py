...
class EgrBytesHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist1d", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist1d"
    meta.rnFormat = "HDuribv4EgrBytes1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59243, PropCategory.REGULAR)
