...
class EgrPktsAgHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist15min", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist15min"
    meta.rnFormat = "HDuribv4EgrPktsAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrPktsAgHist")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDuribv4EgrPktsAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59274, PropCategory.REGULAR)
