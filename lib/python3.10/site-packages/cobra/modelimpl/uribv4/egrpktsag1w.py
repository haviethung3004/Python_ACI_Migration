...
class EgrPktsAg1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg1w", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg1w"
    meta.rnFormat = "CDuribv4EgrPktsAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 1 week"
