...
class EgrBytesHist5min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist5min", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist5min"
    meta.rnFormat = "HDuribv4EgrBytes5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 59249, PropCategory.REGULAR)
