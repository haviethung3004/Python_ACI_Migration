...
class EgrPktsAg1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg1year", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg1year"
    meta.rnFormat = "CDuribv4EgrPktsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 1 year"
