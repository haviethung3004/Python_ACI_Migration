...
class EgrBytesHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist1year", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist1year"
    meta.rnFormat = "HDuribv4EgrBytes1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59248, PropCategory.REGULAR)
