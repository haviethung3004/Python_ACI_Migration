...
class EgrPktsHist1h(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist1h", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist1h"
    meta.rnFormat = "HDuribv4EgrPkts1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 59284, PropCategory.REGULAR)
