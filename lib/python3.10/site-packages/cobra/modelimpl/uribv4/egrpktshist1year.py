...
class EgrPktsHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist1year", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist1year"
    meta.rnFormat = "HDuribv4EgrPkts1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59288, PropCategory.REGULAR)
