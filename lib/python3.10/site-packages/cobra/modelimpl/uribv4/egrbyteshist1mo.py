...
class EgrBytesHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist1mo", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist1mo"
    meta.rnFormat = "HDuribv4EgrBytes1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59245, PropCategory.REGULAR)
