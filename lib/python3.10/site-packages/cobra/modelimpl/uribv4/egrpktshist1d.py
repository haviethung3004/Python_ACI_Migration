...
class EgrPktsHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist1d", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist1d"
    meta.rnFormat = "HDuribv4EgrPkts1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59283, PropCategory.REGULAR)
