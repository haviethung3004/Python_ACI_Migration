...
class EgrBytes1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytes1mo", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytes1mo"
    meta.rnFormat = "CDuribv4EgrBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current l3 LSP egress bytes stats in 1 month"
