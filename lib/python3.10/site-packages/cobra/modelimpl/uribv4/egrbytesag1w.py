...
class EgrBytesAg1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAg1w", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAg1w"
    meta.rnFormat = "CDuribv4EgrBytesAg1w"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress bytes stats in 1 week"
