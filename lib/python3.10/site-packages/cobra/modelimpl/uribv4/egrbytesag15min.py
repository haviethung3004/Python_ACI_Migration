...
class EgrBytesAg15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAg15min", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAg15min"
    meta.rnFormat = "CDuribv4EgrBytesAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrBytesAg")
    meta.superClasses.add("cobra.model.stats.Item")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDuribv4EgrBytesAg15min', False),
    ]
