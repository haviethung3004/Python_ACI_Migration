...
class EgrBytesAgHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist1w", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist1w"
    meta.rnFormat = "HDuribv4EgrBytesAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59239, PropCategory.REGULAR)
