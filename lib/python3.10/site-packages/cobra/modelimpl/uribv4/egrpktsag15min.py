...
class EgrPktsAg15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAg15min", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAg15min"
    meta.rnFormat = "CDuribv4EgrPktsAg15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress packets stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrPktsAg")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDuribv4EgrPktsAg15min', False),
    ]
