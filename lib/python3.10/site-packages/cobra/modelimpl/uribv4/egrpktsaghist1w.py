...
class EgrPktsAgHist1w(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist1w", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist1w"
    meta.rnFormat = "HDuribv4EgrPktsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 59279, PropCategory.REGULAR)
