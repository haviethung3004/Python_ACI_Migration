...
class EgrBytesAgHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist1d", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist1d"
    meta.rnFormat = "HDuribv4EgrBytesAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59235, PropCategory.REGULAR)
