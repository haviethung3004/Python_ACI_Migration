...
class EgrPktsAgHist1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsAgHist1d", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsAgHist1d"
    meta.rnFormat = "HDuribv4EgrPktsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress packets stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 59275, PropCategory.REGULAR)
