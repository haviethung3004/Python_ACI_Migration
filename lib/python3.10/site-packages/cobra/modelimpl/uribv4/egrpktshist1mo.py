...
class EgrPktsHist1mo(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrPktsHist1mo", "l3 LSP egress packets")
    ...
    meta.moClassName = "uribv4EgrPktsHist1mo"
    meta.rnFormat = "HDuribv4EgrPkts1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress packets stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 59285, PropCategory.REGULAR)
