...
class EgrBytes15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytes15min", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytes15min"
    meta.rnFormat = "CDuribv4EgrBytes15min"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current l3 LSP egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrBytes")
    meta.superClasses.add("cobra.model.stats.Curr")

    meta.rnPrefixes = [
        ('CDuribv4EgrBytes15min', False),
    ]
