...
class EgrBytesAgHist1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist1year", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist1year"
    meta.rnFormat = "HDuribv4EgrBytesAg1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 59240, PropCategory.REGULAR)
