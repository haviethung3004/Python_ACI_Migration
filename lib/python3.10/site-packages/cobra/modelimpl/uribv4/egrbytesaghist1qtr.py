...
class EgrBytesAgHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist1qtr", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist1qtr"
    meta.rnFormat = "HDuribv4EgrBytesAg1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59238, PropCategory.REGULAR)
