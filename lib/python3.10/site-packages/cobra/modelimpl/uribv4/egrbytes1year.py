...
class EgrBytes1year(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytes1year", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytes1year"
    meta.rnFormat = "CDuribv4EgrBytes1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current l3 LSP egress bytes stats in 1 year"
