...
class EgrBytesAg1d(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAg1d", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAg1d"
    meta.rnFormat = "CDuribv4EgrBytesAg1d"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated l3 LSP egress bytes stats in 1 day"
