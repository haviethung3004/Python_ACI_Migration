...
class EgrBytesAgHist15min(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesAgHist15min", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesAgHist15min"
    meta.rnFormat = "HDuribv4EgrBytesAg15min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated l3 LSP egress bytes stats in 15 minute"
    ...
    meta.superClasses.add("cobra.model.uribv4.EgrBytesAgHist")
    meta.superClasses.add("cobra.model.stats.Hist")

    meta.rnPrefixes = [
        ('HDuribv4EgrBytesAg15min-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 59234, PropCategory.REGULAR)
