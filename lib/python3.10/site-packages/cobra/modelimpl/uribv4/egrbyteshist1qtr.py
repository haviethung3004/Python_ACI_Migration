...
class EgrBytesHist1qtr(Mo):
    ...
    meta = StatsClassMeta("cobra.model.uribv4.EgrBytesHist1qtr", "l3 LSP egress bytes")
    ...
    meta.moClassName = "uribv4EgrBytesHist1qtr"
    meta.rnFormat = "HDuribv4EgrBytes1qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical l3 LSP egress bytes stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 59246, PropCategory.REGULAR)
