...
class PfxEntry(Mo):
    ...
    meta.childClasses.add("cobra.model.actrl.RsPfxEntryToSubnet")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.ip.Cons")

    meta.childNamesAndRnPrefix.append(("cobra.model.actrl.RsPfxEntryToSubnet", "rspfxEntryToSubnet-"))
    ...
    prop._addConstant("actrl:PfxEntrymodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("actrl:PfxEntryserviceEnabled_failed_flag", None, 2048)
    ...
    prop = PropMeta("str", "serviceEnabled", "serviceEnabled", 61902, PropCategory.REGULAR)
