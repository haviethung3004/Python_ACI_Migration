...
# ##################################################
class RsPfxEntryToSubnet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsPfxEntryToSubnet", "cobra.model.l3ext.SubnetDef")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "actrlRsPfxEntryToSubnet"
    meta.rnFormat = "rspfxEntryToSubnet-[%(tDn)s]"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Relation to L3out SubnetDef"
    meta.writeAccessMask = 0x4101
    ...
    prop = PropMeta("str", "pfxOwner", "pfxOwner", 63447, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 63449, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1802
    prop.defaultValueStr = "l3extSubnetDef"
    prop._addConstant("l3extSubnetDef", None, 1802)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 63448, PropCategory.REGULAR)
