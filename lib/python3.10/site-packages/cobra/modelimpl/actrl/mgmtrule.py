...
class MgmtRule(Mo):
    ...
    meta.childClasses.add("cobra.model.actrl.RsToAclRule")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.actrl.RsToAclRule", "rstoAclRule"))
    ...
    prop._addConstant("actrl:MgmtRulemodTs_failed_flag", None, 1152921504606846976)
    prop._addConstant("actrl:MgmtRulemonPolDn_failed_flag", None, 4194304)
    ...
    prop._addConstant("actrl:MgmtRulesessionId_failed_flag", None, 131072)
    prop._addConstant("actrl:MgmtRuletype_failed_flag", None, 262144)
    ...
    prop = PropMeta("str", "sessionId", "sessionId", 68803, PropCategory.REGULAR)
    prop.label = "Rule Session Id"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop._addConstant("msite", "msite", 9)
    prop._addConstant("msite_pbr", "msite-pbr-rule", 7)
    prop._addConstant("msite_pbr_service", "msite-pbr-rule-from-service-node", 8)
