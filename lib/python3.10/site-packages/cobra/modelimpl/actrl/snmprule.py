...
class SnmpRule(Mo):
    ...
    prop._addConstant("actrl:SnmpRulemodTs_failed_flag", None, 1152921504606846976)
    ...
    prop._addConstant("actrl:SnmpRulesessionId_failed_flag", None, 131072)
    prop._addConstant("actrl:SnmpRuletype_failed_flag", None, 262144)
