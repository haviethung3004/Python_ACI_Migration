...
# ##################################################
class RsToAclRule(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.actrl.RsToAclRule", "cobra.model.svcredir.AclRule")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "actrlRsToAclRule"
    meta.rnFormat = "rstoAclRule"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "ACL rule attachement"
    ...
    prop = PropMeta("str", "tCl", "tCl", 68817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 68816, PropCategory.REGULAR)
