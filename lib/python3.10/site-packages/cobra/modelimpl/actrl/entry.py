...
class Entry(Mo):
    ...
    prop = PropMeta("str", "portZero", "portZero", 69738, PropCategory.REGULAR)
    prop.label = "Port Zero Entry Flag"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    ...
    prop = PropMeta("str", "pzDirection", "pzDirection", 69739, PropCategory.REGULAR)
    ...
    meta.props.add("pzDirection", prop)
