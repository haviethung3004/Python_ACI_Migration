...
class UsbConfig(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.UsbConfig")

    meta.moClassName = "eqptUsbConfig"
    meta.rnFormat = "usbconfig"
    meta.category = MoCategory.REGULAR
    meta.label = "USBConfig"
    ...
    prop = PropMeta("str", "annotation", "annotation", 64340, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "disabled", "disabled", 64336, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 64341, PropCategory.REGULAR)
