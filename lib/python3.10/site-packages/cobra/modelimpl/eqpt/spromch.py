...
class SpromCH(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.SpromCH")

    meta.moClassName = "eqptSpromCH"
    meta.rnFormat = "spch"
    meta.category = MoCategory.REGULAR
    meta.label = "Chaiss Backplane Sprom"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 69197, PropCategory.REGULAR)
