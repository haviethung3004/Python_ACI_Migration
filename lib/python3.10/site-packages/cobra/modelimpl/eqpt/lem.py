...
class LEM(Mo):
    ...
    meta = ClassMeta("cobra.model.eqpt.LEM")

    meta.moClassName = "eqptLEM"
    meta.rnFormat = "lem-%(lemid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "The line card information"
    ...
    prop = PropMeta("str", "breakoutFactor", "breakoutFactor", 63921, PropCategory.REGULAR)
    prop.label = "The LEM card breakout factor"
    prop.isOper = True
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("breakoutFactor", prop)
    ...
    prop = PropMeta("str", "fwVer", "fwVer", 63925, PropCategory.REGULAR)
    prop.label = "The card firmware revision"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    prop.defaultValue = "0"
    ...
    prop = PropMeta("str", "isSame", "isSame", 63922, PropCategory.REGULAR)
    prop.label = "Value of the is_same flag set in the lem mgr process to indicate if the lem has changed or not prior to lem_insert sequence"
    prop.isOper = True
    meta.props.add("isSame", prop)

    prop = PropMeta("str", "lemid", "lemid", 63920, PropCategory.REGULAR)
    prop.label = "LEM Module Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("lemid", prop)
    ...
    prop = PropMeta("str", "macE", "macE", 63915, PropCategory.REGULAR)
    prop.label = "The card MAC address end"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("macE", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 63926, PropCategory.REGULAR)
    ...
    prop._addConstant("lem-mismatch", "lem-type-mismatch", 19)
    ...
    prop = PropMeta("str", "partNumber", "partNumber", 63917, PropCategory.REGULAR)
    prop.label = "The card part number"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("partNumber", prop)

    prop = PropMeta("str", "purgeLemCfg", "purgeLemCfg", 63923, PropCategory.REGULAR)
    prop.label = "Purge Config for LEM"
    prop.isOper = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("purgeLemCfg", prop)
    ...
    prop = PropMeta("str", "rdSt", "rdSt", 63924, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "swVer", "swVer", 3322, PropCategory.REGULAR)
    prop.label = "The card software revision"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    prop.defaultValue = "0"
    ...
    prop = PropMeta("str", "type", "type", 63919, PropCategory.REGULAR)
    prop.label = "The card type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9
    prop.defaultValueStr = "lemcard"
    ...
    prop._addConstant("lemcard", "lem-card", 9)
    ...
    prop = PropMeta("str", "vId", "vId", 63657, PropCategory.REGULAR)
    prop.label = "Version or Vendor ID"
    prop.isOper = True
    prop.range = [(0, 512)]
    meta.props.add("vId", prop)

    prop = PropMeta("str", "vdrId", "vdrId", 63918, PropCategory.REGULAR)
    prop.label = "The card vdrId"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    meta.namingProps.append(getattr(meta.props, "lemid"))
    ...
    def __init__(self, parentMoOrDn, lemid, markDirty=True, **creationProps):
        namingVals = [lemid]
