...
class Storage(Mo):
    ...
    prop = PropMeta("str", "inodesFree", "inodesFree", 68455, PropCategory.REGULAR)
    prop.label = "Inodes Free"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("inodesFree", prop)

    prop = PropMeta("str", "inodesTotal", "inodesTotal", 68453, PropCategory.REGULAR)
    prop.label = "Inodes total"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("inodesTotal", prop)

    prop = PropMeta("str", "inodesUsed", "inodesUsed", 68454, PropCategory.REGULAR)
    prop.label = "Inodes Used"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("inodesUsed", prop)

    prop = PropMeta("str", "inodesUtilized", "inodesUtilized", 68456, PropCategory.REGULAR)
    prop.label = "Inodes Utilized"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("inodesUtilized", prop)
