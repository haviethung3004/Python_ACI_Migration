...
# ##################################################
class RsNtpProvToNtpAuthKey2(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.datetime.RsNtpProvToNtpAuthKey2", "cobra.model.datetime.NtpAuthKey")
    meta.targetNameProps["id"] = "tnDatetimeNtpAuthKeyId"
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "datetimeRsNtpProvToNtpAuthKey2"
    meta.rnFormat = "rsntpProvToNtpAuthKey2-%(tnDatetimeNtpAuthKeyId)s"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "New (n-to-m) Relation to Datetime Authentication Key"
    ...
    meta.rnPrefixes = [
        ('rsntpProvToNtpAuthKey2-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 62788, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 62789, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 62787, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 62784, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnDatetimeNtpAuthKeyId", "tnDatetimeNtpAuthKeyId", 62783, PropCategory.REGULAR)
