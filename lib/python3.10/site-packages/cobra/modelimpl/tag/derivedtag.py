...
class DerivedTag(Mo):
    ...
    meta = ClassMeta("cobra.model.tag.DerivedTag")

    meta.moClassName = "tagDerivedTag"
    meta.rnFormat = "derivedtagKey-%(key)s-value-%(value)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Derived Tag"
    ...
    meta.childClasses.add("cobra.model.tag.DerivedTagCons")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.DerivedTagCons", "cons-"))
    ...
    prop = PropMeta("str", "key", "key", 63211, PropCategory.REGULAR)
    prop.label = "Key"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "value", "value", 63212, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    def __init__(self, parentMoOrDn, key, value, markDirty=True, **creationProps):
        namingVals = [key, value]
