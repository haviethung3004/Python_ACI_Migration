...
# ##################################################
class DerivedTagCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.tag.DerivedTagCons")

    meta.moClassName = "tagDerivedTagCons"
    meta.rnFormat = "cons-[%(consumerDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "DerivedTag consumer"
    ...
    meta.parentClasses.add("cobra.model.tag.DerivedTag")
    ...
    prop = PropMeta("str", "consumerDn", "consumerDn", 68677, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
