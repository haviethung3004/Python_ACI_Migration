...
# ##################################################
class NodeConvPOper(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.dhcp.NodeConvPOper")

    meta.moClassName = "dhcpNodeConvPOper"
    meta.rnFormat = "nodeconvpoper"
    meta.category = MoCategory.REGULAR
    meta.label = "Fabric NodeConvP Oper"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 65295, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "operSt", "operSt", 65293, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
