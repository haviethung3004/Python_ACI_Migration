...
class TunnIfOper(Mo):
    ...
    meta = ClassMeta("cobra.model.hcextnw.TunnIfOper")

    meta.moClassName = "hcextnwTunnIfOper"
    meta.rnFormat = "tunnifoper"
    ...
    prop = PropMeta("str", "ipv4Addr", "ipv4Addr", 65526, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
