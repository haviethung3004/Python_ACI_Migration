...
class Entity(Mo):
    ...
    prop = PropMeta("str", "esg", "esg", 59714, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4294967295)]
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("esg", prop)

    prop = PropMeta("str", "esgIp", "esgIp", 63901, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4294967295)]
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("esgIp", prop)

    prop = PropMeta("str", "esgMac", "esgMac", 63900, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4294967295)]
    ...
    prop = PropMeta("str", "sharedVrfs", "sharedVrfs", 69694, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4294967295)]
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("sharedVrfs", prop)
    ...
    prop = PropMeta("str", "syntheticIp", "syntheticIp", 65364, PropCategory.REGULAR)
    prop.label = "Value"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 4294967295)]
    prop.defaultValue = 1
    prop.defaultValueStr = "1"
    meta.props.add("syntheticIp", prop)
