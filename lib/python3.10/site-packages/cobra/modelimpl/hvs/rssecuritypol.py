...
# ##################################################
class RsSecurityPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hvs.RsSecurityPol", "cobra.model.comp.EpPD")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hvsRsSecurityPol"
    meta.rnFormat = "rsSecurityPol"
    ...
    meta.parentClasses.add("cobra.model.hvs.SecurityPol")
    ...
    prop = PropMeta("str", "tCl", "tCl", 69817, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 69816, PropCategory.REGULAR)
