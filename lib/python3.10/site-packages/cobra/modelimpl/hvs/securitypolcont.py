...
# ##################################################
class SecurityPolCont(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hvs.SecurityPolCont")

    meta.moClassName = "hvsSecurityPolCont"
    meta.rnFormat = "secpolcont"
    meta.category = MoCategory.REGULAR
    meta.label = "Security policy entity container"
    ...
    meta.childClasses.add("cobra.model.hvs.SecurityPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.SecurityPol", "secpol-"))
