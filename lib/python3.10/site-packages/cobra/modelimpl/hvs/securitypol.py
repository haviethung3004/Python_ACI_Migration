...
# ##################################################
class SecurityPol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hvs.SecurityPol")

    meta.moClassName = "hvsSecurityPol"
    meta.rnFormat = "secpol-%(oid)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Security policy"
    ...
    meta.childClasses.add("cobra.model.hvs.RsSecurityPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.RsSecurityPol", "rsSecurityPol"))

    meta.parentClasses.add("cobra.model.hvs.SecurityPolCont")
    ...
    prop = PropMeta("str", "allowIpv6", "allowIpv6", 70040, PropCategory.REGULAR)
    prop.label = "Allow IPv6 traffic"
    ...
    meta.props.add("allowIpv6", prop)

    prop = PropMeta("str", "appTier", "appTier", 69783, PropCategory.REGULAR)
    prop.label = "App Tier label"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("appTier", prop)

    prop = PropMeta("str", "appType", "appType", 69782, PropCategory.REGULAR)
    prop.label = "App Type label"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "enableHitLogs", "enableHitLogs", 70041, PropCategory.REGULAR)
    prop.label = "Enable policy hitlogs"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("enableHitLogs", prop)
    ...
    prop = PropMeta("str", "inboundPolicyType", "inboundPolicyType", 69786, PropCategory.REGULAR)
    prop.label = "Inbound filter type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "allow-all"
    prop._addConstant("allow-all", "allow-all", 0)
    prop._addConstant("filtered", "filtered", 1)
    meta.props.add("inboundPolicyType", prop)

    prop = PropMeta("str", "isEpgPolicy", "isEpgPolicy", 69784, PropCategory.REGULAR)
    prop.label = "Security policy is for an epg"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("isEpgPolicy", prop)

    prop = PropMeta("str", "isIntraEpgIsolationPolicy", "isIntraEpgIsolationPolicy", 69785, PropCategory.REGULAR)
    prop.label = "Security policy specify intra epg isolation"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = False
    prop.defaultValueStr = "no"
    prop._addConstant("no", "no", False)
    prop._addConstant("yes", "yes", True)
    meta.props.add("isIntraEpgIsolationPolicy", prop)
    ...
    prop = PropMeta("str", "mode", "mode", 70042, PropCategory.REGULAR)
    prop.label = "Policy Mode"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "enforce"
    prop._addConstant("enforce", "enforce", 0)
    prop._addConstant("monitor", "monitor", 1)
    ...
    prop = PropMeta("str", "oid", "oid", 69780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "outboundPolicyType", "outboundPolicyType", 69787, PropCategory.REGULAR)
    prop.label = "Outbound filter type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "allow-all"
    prop._addConstant("allow-all", "allow-all", 0)
    prop._addConstant("filtered", "filtered", 1)
    meta.props.add("outboundPolicyType", prop)

    prop = PropMeta("str", "polType", "polType", 69781, PropCategory.REGULAR)
    prop.label = "Policy Type"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "invalid"
    prop._addConstant("app-type", "app-type", 1)
    prop._addConstant("invalid", "invalid", 0)
    meta.props.add("polType", prop)
