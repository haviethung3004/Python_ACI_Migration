...
class AddrMgmtPolCont(Mo):
    ...
    meta = ClassMeta("cobra.model.hvs.AddrMgmtPolCont")

    meta.moClassName = "hvsAddrMgmtPolCont"
    ...
    meta.childClasses.add("cobra.model.hvs.AddrMgmtPool")

    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.AddrMgmtPool", "ipampool"))
    ...
    prop = PropMeta("str", "ipamDhcpOverride", "ipamDhcpOverride", 69790, PropCategory.REGULAR)
    prop.label = "DHCP server address override"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ipamDhcpOverride", prop)

    prop = PropMeta("str", "ipamGateway", "ipamGateway", 69789, PropCategory.REGULAR)
