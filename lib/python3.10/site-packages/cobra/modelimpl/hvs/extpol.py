...
class ExtPol(Mo):
    ...
    meta.childClasses.add("cobra.model.hvs.AddrMgmtPolCont")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hvs.AddrMgmtPolCont", "ipampolcont"))
    ...
    prop = PropMeta("str", "segmentId", "segmentId", 69169, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("segmentId", prop)
