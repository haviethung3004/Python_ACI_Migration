...
class AbstractQuery(AbstractRequest):
    ...
    def batchSize(self):
        ...
        Returns:
          int: The number of results to be returned by a query.
        """
        return self.__options.get('batch-size', None)
    ...
    def batchSize(self, batchSize):
        ...
        Args:
          batchSize (int): The number of results to be returned by a query.
        """
        try:
            numVal = int(batchSize)
        except:
            raise ValueError('{} batchSize needs to be an integer'.format(batchSize))
        self.__options['batch-size'] = str(numVal)
    ...
    def cursor(self):
        ...
        Returns the cursor
        """
        return self.__options.get('cursor', None)

    @cursor.setter
    def cursor(self, cursor):
        """
        Args:
            cursor (str): cursor to query next set of output
        """
        self.__options['cursor'] = cursor
